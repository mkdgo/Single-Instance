(function(a,b){function d(){a.removeEventListener("load",d,!1);l=!0}function c(a){return n=n||new c.Class(a)}function e(a,c){for(var b in c)a[b]=c[b];return a}function f(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);h.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(h,"$1"));p.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(p,"$2"))}var g="addEventListener"in a,l=!1;
"complete"===b.readyState?l=!0:g&&a.addEventListener("load",d,!1);var h=/\/ath(\/)?$/,p=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,n;c.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
android:"To add this web app to the home screen open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>"}};for(var m in c.intl)c.intl[m.substr(0,2)]=c.intl[m];c.defaults={appID:"org.cubiq.addtohome",fontSize:15,debug:!1,logging:!1,modal:!1,mandatory:!1,autostart:!0,skipFirstVisit:!1,startDelay:1,lifespan:15,displayPace:1440,maxDisplayCount:0,
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};m=a.navigator.userAgent;var r=a.navigator;e(c,{hasToken:"#ath"==b.location.hash||h.test(b.location.href)||p.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(m),isMobileChrome:-1<m.indexOf("Android")&&/Chrome\/[.0-9]*/.test(m)&&-1==m.indexOf("Version"),isMobileIE:-1<m.indexOf("Windows Phone"),language:r.language&&
r.language.toLowerCase().replace("-","_")||""});c.language=c.language&&c.language in c.intl?c.language:"en_us";c.isMobileSafari=c.isIDevice&&-1<m.indexOf("Safari")&&0>m.indexOf("CriOS");c.OS=c.isIDevice?"ios":c.isMobileChrome?"android":c.isMobileIE?"windows":"unsupported";c.OSVersion=m.match(/(OS|Android) (\d+[_\.]\d+)/);c.OSVersion=c.OSVersion&&c.OSVersion[2]?+c.OSVersion[2].replace("_","."):0;c.isStandalone="standalone"in a.navigator&&a.navigator.standalone;c.isTablet=c.isMobileSafari&&-1<m.indexOf("iPad")||
c.isMobileChrome&&0>m.indexOf("Mobile");c.isCompatible=c.isMobileSafari&&6<=c.OSVersion||c.isMobileChrome;var w={lastDisplayTime:0,returningVisitor:!1,displayCount:0,optedout:!1,added:!1};c.removeSession=function(a){try{if(!localStorage)throw Error("localStorage is not defined");localStorage.removeItem(a||c.defaults.appID)}catch(b){}};c.doLog=function(a){this.options.logging&&console.log(a)};c.Class=function(d){this.doLog=c.doLog;this.options=e({},c.defaults);e(this.options,d);d&&d.debug&&"undefined"===
...
".keyword .remove",function(){var a=c.val(),a=a.split(","),a=a.toString(),a=a.replace(/[\])}[{(]/g,""),a=a.split(","),b=$(this).parent().index()-2;a.splice(b,1);c.val(a);$(this).parent().remove();$(".list").html("")});$(document).click(function(a){var c=$(".input-container input").val();""!=c&&(f(c),$(".input-container input").val(""));void 0===$(a.target).closest("li")[0]&&$(".list").html("")})});$(".keystudents").each(function(){var a=this,d=$(a),c=$("> input#keystudents",a),e=$("> input#keystudents_a",
a),f=e.val(),g=c.val();kest=f.slice(1,-1);kest1=g.slice(1,-1);var f=kest.split(","),g=kest1.split(","),l=function(d,f,g){if(d){if(!g){g=e.val();var m=c.val(),m=m+f+",";e.val(g+d+",");c.val(m)}$(".input-container",a).before('<div class="keystudent"><span>'+d+'</span><a class="remove"></a></div>');$(".list").html("")}};e.css({display:"none"});d.append('<div class="input-container"><input value="" type="text"><div><div class="list"></div>');f.length&&$.each(f,function(a,c){l(c,a,!0)});d.on("keyup",".input-container input",
function(){var a=$(this).val(),c=d.data("to");c&&clearTimeout(c);c=!1;a&&(c=setTimeout(function(){$.ajax({url:"/f2c_teacher/suggestKeystudents",data:{q:a},dataType:"json",success:function(a){var c="";$.each(a,function(a,b){c+='<li rel="'+a+'">'+b+"</li>"});$(".list").html("<ul>"+c+"</ul>");updateSlideHeight(".step.s3")}})},200),d.data("to",c))}).on("keydown",".input-container input",function(a){var c=$(this).val(),b=$(this).attr("rel");13==a.keyCode&&c&&($(this).val(""),l(c,b))}).on("click",".list li",
function(){var c=$(this).text(),e=$(this).attr("rel");c&&($(".input-container input",a).val(""),l(c,e))}).on("click",".keystudent .remove",function(){var a=e.val(),a=a.split(","),a=a.toString(),a=a.replace(/[\])}[{(]/g,""),a=a.split(","),c=$(this).parent().index()-2;a.splice(c,1);e.val(a);$(this).parent().remove();$(".list").html("")});$(document).click(function(a){var c=$(".input-container input").val();""!=c&&(l(c),$(".input-container input").val(""));void 0===$(a.target).closest("li")[0]&&$(".list").html("")})});
...
(0<$("#grade_categories_holder tr").length?($(".add_cat #mark").removeClass("required"),$(".add_cat #catg").removeClass("required")):($(".add_cat #catg").addClass("required"),$(".add_cat #mark").addClass("required")));$("input, select").each(function(a,c){var e=$(this);if($(e).hasClass("required"))if(""==e.val().trim()||void 0===e.val()){e.css({border:"1px dashed red"});var f=e.attr("data-validation-required-message");e.prev("span").attr("id","scrolled");e.prev("span").html("").removeClass("tip2").addClass("tip2").append(f).css({display:"block"});
...
(function(a,b){"object"==typeof exports?module.exports=b():"function"==typeof define&&define.amd?define(b):a.Spinner=b()})(this,function(){function a(a,c){var b,e=document.createElement(a||"div");for(b in c)e[b]=c[b];return e}function b(a){for(var c=1,b=arguments.length;b>c;c++)a.appendChild(arguments[c]);return a}function d(a,c,b,e){var d=["opacity",c,~~(100*a),b,e].join("-");b=.01+b/e*100;e=Math.max(1-(1-a)/c*(100-b),a);var f=p.substring(0,p.indexOf("Animation")).toLowerCase();return m[d]||(r.insertRule("@"+
(f&&"-"+f+"-"||"")+"keyframes "+d+"{0%{opacity:"+e+"}"+b+"%{opacity:"+a+"}"+(b+.01)+"%{opacity:1}"+(b+c)%100+"%{opacity:"+a+"}100%{opacity:"+e+"}}",r.cssRules.length),m[d]=1),d}function c(a,c){var b,e,d=a.style;c=c.charAt(0).toUpperCase()+c.slice(1);for(e=0;n.length>e;e++)if(b=n[e]+c,void 0!==d[b])return b;return void 0!==d[c]?c:void 0}function e(a,b){for(var e in b)a.style[c(a,e)||e]=b[e];return a}function f(a){for(var c=1;arguments.length>c;c++){var b=arguments[c],e;for(e in b)void 0===a[e]&&(a[e]=
b[e])}return a}function g(a,c){return"string"==typeof a?a:a[c%a.length]}function l(a){this.opts=f(a||{},l.defaults,w)}function h(){function c(b,e){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}r.addRule(".spin-vml","behavior:url(#default#VML)");l.prototype.lines=function(a,d){function f(){return e(c("group",{coordsize:l+" "+l,coordorigin:-m+" "+-m}),{width:l,height:l})}function h(a,p,l){b(n,b(e(f(),{rotation:360/d.lines*a+"deg",left:~~p}),b(e(c("roundrect",{arcsize:d.corners}),
{width:m,height:d.width,left:d.radius,top:-d.width>>1,filter:l}),c("fill",{color:g(d.color,a),opacity:d.opacity}),c("stroke",{opacity:0}))))}var p,m=d.length+d.width,l=2*m;p=2*-(d.width+d.length)+"px";var n=e(f(),{position:"absolute",top:p,left:p});if(d.shadow)for(p=1;d.lines>=p;p++)h(p,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(p=1;d.lines>=p;p++)h(p);return b(a,n)};l.prototype.opacity=function(a,c,b,e){a=a.firstChild;e=e.shadow&&e.lines||0;a&&a.childNodes.length>
c+e&&(a=a.childNodes[c+e],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=b))}}var p,n=["webkit","Moz","ms","O"],m={},r=function(){var c=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],c),c.sheet||c.styleSheet}(),w={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};l.defaults={};f(l.prototype,{spin:function(c){this.stop();var b=
this,d=b.opts,f=b.el=e(a(0,{className:d.className}),{position:d.position,width:0,zIndex:d.zIndex});if(d.radius+d.length+d.width,e(f,{left:d.left,top:d.top}),c&&c.insertBefore(f,c.firstChild||null),f.setAttribute("role","progressbar"),b.lines(f,b.opts),!p){var g,h=0,m=(d.lines-1)*(1-d.direction)/2,l=d.fps,n=l/d.speed,w=(1-d.opacity)/(n*d.trail/100),r=n/d.lines;(function T(){h++;for(var a=0;d.lines>a;a++)g=Math.max(1-(h+(d.lines-a)*r)%n*w,d.opacity),b.opacity(f,a*d.direction+m,g,d);b.timeout=b.el&&
setTimeout(T,~~(1E3/l))})()}return b},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(c,f){function h(c,b){return e(a(),{position:"absolute",width:f.length+f.width+"px",height:f.width+"px",background:c,boxShadow:b,transformOrigin:"left",transform:"rotate("+~~(360/f.lines*l+f.rotate)+"deg) translate("+f.radius+"px,0)",borderRadius:(f.corners*f.width>>1)+"px"})}for(var m,l=0,n=(f.lines-1)*(1-f.direction)/
2;f.lines>l;l++)m=e(a(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:p&&d(f.opacity,f.trail,n+l*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&b(m,e(h("#000","0 0 4px #000"),{top:"2px"})),b(c,b(m,h(g(f.color,l),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,c,b){a.childNodes.length>c&&(a.childNodes[c].style.opacity=b)}});var K=e(a("group"),{behavior:"url(#default#VML)"});return!c(K,"transform")&&
K.adj?h():p=c(K,"animation"),l});
...
qq.AjaxRequestor=function(a){function b(a){var c=qq.indexOf(h,a),b=n.maxConnections;delete p[a];h.splice(c,1);h.length>=b&&c<b&&(a=h[b-1],d(a))}function d(a){var b=new XMLHttpRequest,d=f(),h={},B;n.onSend(a);n.paramsStore.getParams&&(h=n.paramsStore.getParams(a));B=h;var u=n.endpointStore.getEndpoint(a),t=p[a].addToPath;void 0!==t&&(u+="/"+t);B=l&&B?qq.obj2url(B,u):u;p[a].xhr=b;b.onreadystatechange=c(a);b.open(d,B,!0);n.cors.expected&&n.cors.sendCredentials&&(b.withCredentials=!0);e(a);g("Sending "+
d+" request for "+a);!l&&h?b.send(qq.obj2url(h,"")):b.send()}function c(a){var c=p[a].xhr;return function(){if(4===c.readyState){var e=p[a].xhr,d=f(),h=!1;b(a);0<=qq.indexOf(n.successfulResponseCodes,e.status)||(h=!0,g(d+" request for "+a+" has failed - response code "+e.status,"error"));n.onComplete(a,e,h)}}}function e(a){var c=p[a].xhr;a=n.customHeaders;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,b){c.setRequestHeader(a,
b)})}function f(){return n.demoMode?"GET":n.method}var g,l,h=[],p=[],n={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(n,a);g=n.log;l="GET"===f()||"DELETE"===f();return{send:function(a,c){p[a]={addToPath:c};h.push(a)<=n.maxConnections&&d(a)},cancel:function(a){var c=p[a].xhr,e=f();c?(c.onreadystatechange=
null,c.abort(),b(a),g("Cancelled "+e+" for "+a),n.onCancel(a),a=!0):a=!1;return a}}};
...
qq.UploadHandlerForm=function(a,b,d){function c(a){void 0!==m[a]&&(m[a](),delete m[a])}function e(a,b){var e=a.id;B[n[e]]=b;m[e]=qq(a).attach("load",function(){p[e]&&(w("Received iframe load event for CORS upload request (file id "+e+")"),r[e]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+e;w(a,"error");b({error:a})},1E3))});K.receiveMessage(e,function(a){w("Received the following window message: '"+a+"'");var b=qq.parseJson(a),d=b.uuid;d&&B[d]?(clearTimeout(r[e]),
delete r[e],c(e),a=B[d],delete B[d],K.stopReceivingMessages(e),a(b)):d||w("'"+a+"' does not contain a UUID - ignoring.")})}function f(a,c){h.cors.expected?e(a,c):m[a.id]=qq(a).attach("load",function(){w("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(b){w("Error when attempting to access iframe during handling of upload response ("+b+")","error")}c()}})}function g(a){var c=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');c.setAttribute("id",a);c.style.display="none";document.body.appendChild(c);return c}function l(a,c){var b=h.paramsStore.getParams(a),e=qq.toElement('<form method="'+(h.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),d=h.endpointStore.getEndpoint(a),f=d;b[h.uuidParamName]=n[a];h.paramsInBody?qq.obj2Inputs(b,e):f=qq.obj2url(b,d);e.setAttribute("action",f);e.setAttribute("target",c.name);e.style.display="none";document.body.appendChild(e);return e}var h=a,p=[],n=[],m={},r=
{},w=d,K=new qq.WindowReceiveMessage({log:w}),B={},u;return u={add:function(a){a.setAttribute("name",h.inputName);var c=p.push(a)-1;n[c]=qq.getUniqueId();a.parentNode&&qq(a).remove();return c},getName:function(a){if(u.isValid(a))return p[a].value.replace(/.*(\/|\\)/,"");w(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==p[a]},reset:function(){p=[];n=[];m={}},getUuid:function(a){return n[a]},cancel:function(a){h.onCancel(a,this.getName(a));delete p[a];delete n[a];delete m[a];
...
w("converting iframe's innerHTML to JSON");w("innerHTML = "+l);l&&l.match(/^<pre/i)&&(l=g.body.firstChild.firstChild.nodeValue);f=qq.parseJson(l)}catch(p){w("Error when attempting to parse form upload response ("+p+")","error"),f={success:!1}}e=f}c(a);h.cors.expected||qq(m).remove();if(e.success||!h.onAutoRetry(a,d,e))h.onComplete(a,d,e),b(a)});w("Sending upload request for "+a);n.submit();qq(n).remove();return a}}};
qq.UploadHandlerXhr=function(a,b,d){function c(a,c,b){var e=y.getSize(a);a=y.getName(a);c[t.chunking.paramNames.partIndex]=b.part;c[t.chunking.paramNames.partByteOffset]=b.start;c[t.chunking.paramNames.chunkSize]=b.size;c[t.chunking.paramNames.totalParts]=b.count;c[t.totalFileSizeParamName]=e;x&&(c[t.chunking.paramNames.filename]=a)}function e(a,c){var b=t.chunking.partSize,e=y.getSize(a),d=q[a].file||q[a].blobData.blob,h=b*c,b=h+b>=e?e:h+b,e=f(a),g;d.slice?g=d.slice(h,b):d.mozSlice?g=d.mozSlice(h,
b):d.webkitSlice&&(g=d.webkitSlice(h,b));return{part:c,start:h,end:b,count:e,blob:g,size:b-h}}function f(a){a=y.getSize(a);return Math.ceil(a/t.chunking.partSize)}function g(a,c,b,e){var d=new FormData,f=t.demoMode?"GET":"POST",h=t.endpointStore.getEndpoint(e),g=h,l=y.getName(e),m=y.getSize(e),p=q[e].blobData;a[t.uuidParamName]=q[e].uuid;x&&(a[t.totalFileSizeParamName]=m,p&&(a[t.blobs.paramNames.name]=p.name));t.paramsInBody||(x||(a[t.inputName]=l),g=qq.obj2url(a,h));c.open(f,g,!0);t.cors.expected&&
t.cors.sendCredentials&&(c.withCredentials=!0);return x?(t.paramsInBody&&qq.obj2FormData(a,d),d.append(t.inputName,b),d):b}function l(a,c){var b=t.customHeaders,e=q[a].file||q[a].blobData.blob;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");x||(c.setRequestHeader("Content-Type","application/octet-stream"),c.setRequestHeader("X-Mime-Type",e.type));qq.each(b,function(a,b){c.setRequestHeader(a,b)})}function h(a,c,b){var e=y.getName(a),d=y.getSize(a);
q[a].attemptingResume=!1;t.onProgress(a,e,d,d);t.onComplete(a,e,c,b);delete q[a].xhr;F(a)}function p(a){var b=q[a].remainingChunkIdxs[0],d=e(a,b),f=q[a].xhr=new XMLHttpRequest,h=y.getSize(a),p=y.getName(a),n;void 0===q[a].loaded&&(q[a].loaded=0);z&&q[a].file&&w(a,d);f.onreadystatechange=r(a,f);f.upload.onprogress=function(c){if(c.lengthComputable){var d=c.loaded+q[a].loaded;c=c.total;var f=e(a,b);c-=f.size;var h=y.getSize(a),f=f.count,g=c-q[a].initialRequestOverhead;q[a].lastRequestOverhead=c;0===
b?(q[a].lastChunkIdxProgress=0,q[a].initialRequestOverhead=c,q[a].estTotalRequestsSize=h+f*c):q[a].lastChunkIdxProgress!==b&&(q[a].lastChunkIdxProgress=b,q[a].estTotalRequestsSize+=g);t.onProgress(a,p,d,q[a].estTotalRequestsSize)}};t.onUploadChunk(a,p,m(d));n=t.paramsStore.getParams(a);c(a,n,d);q[a].attemptingResume&&(n[t.resume.paramNames.resuming]=!0);n=g(n,f,d.blob,a);l(a,f);J("Sending chunked upload request for item "+a+": bytes "+(d.start+1)+"-"+d.end+" of "+h);f.send(n)}function n(a){J("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");z&&(K(a),q[a].attemptingResume=!1);q[a].remainingChunkIdxs=[];delete q[a].loaded;delete q[a].estTotalRequestsSize;delete q[a].initialRequestOverhead}function m(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function r(a,c){return function(){if(4===c.readyState){var b;if(q[a]){J("xhr - server response received for "+a);J("responseText = "+c.responseText);try{b=qq.parseJson(c.responseText)}catch(d){J("Error when attempting to parse xhr response text ("+d+
")","error"),b={}}if(200!==c.status||!b.success||b.reset)if(b.reset&&n(a),q[a].attemptingResume&&b.reset)q[a].attemptingResume=!1,J("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),n(a),y.upload(a,!0);else{var f=y.getName(a);t.onAutoRetry(a,f,b,c)||h(a,b,c)}else if(Q){var f=q[a].remainingChunkIdxs.shift(),g=e(a,f);q[a].attemptingResume=!1;var f=q[a],l=f.loaded,g=g.size;f.loaded=l+(g+(x?q[a].lastRequestOverhead:0));0<q[a].remainingChunkIdxs.length?
p(a):(z&&K(a),h(a,b,c))}else h(a,b,c)}}}}function w(a,c){var b=y.getUuid(a),e=q[a].loaded,d=q[a].initialRequestOverhead,f=q[a].estTotalRequestsSize,h=B(a);qq.setCookie(h,b+E+c.part+E+e+E+d+E+f,t.resume.cookiesExpireIn)}function K(a){q[a].file&&(a=B(a),qq.deleteCookie(a))}function B(a){var c=y.getName(a);a=y.getSize(a);var b=t.chunking.partSize,c="qqfilechunk"+E+encodeURIComponent(c)+E+a+E+b;void 0!==I&&(c+=E+I);return c}function u(a){var c=q[a].file||q[a].blobData.blob,b=y.getName(a),e,d;q[a].loaded=
0;e=q[a].xhr=new XMLHttpRequest;e.upload.onprogress=function(c){c.lengthComputable&&(q[a].loaded=c.loaded,t.onProgress(a,b,c.loaded,c.total))};e.onreadystatechange=r(a,e);d=t.paramsStore.getParams(a);c=g(d,e,c,a);l(a,e);J("Sending upload request for "+a);e.send(c)}var t=a,F=b,J=d,q=[],E="|",Q=t.chunking.enabled&&qq.supportedFeatures.chunking,z=t.resume.enabled&&Q&&qq.supportedFeatures.resume,I;I=null===t.resume.id||void 0===t.resume.id||qq.isFunction(t.resume.id)||qq.isObject(t.resume.id)?void 0:
t.resume.id;var x=t.forceMultipart||t.paramsInBody,y;return y={add:function(a){if(a instanceof File)a=q.push({file:a})-1;else if(qq.isBlob(a.blob))a=q.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");q[a].uuid=qq.getUniqueId();return a},getName:function(a){if(y.isValid(a)){var c=q[a].file;a=q[a].blobData;return c?null!==c.fileName&&void 0!==c.fileName?c.fileName:c.name:a.name}J(a+" is not a valid item ID.","error")},getSize:function(a){a=q[a].file||
q[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(q[a])return q[a].file||q[a].blobData.blob},getLoaded:function(a){return q[a].loaded||0},isValid:function(a){return void 0!==q[a]},reset:function(){q=[]},getUuid:function(a){return q[a].uuid},upload:function(a,c){var b=this.getName(a);t.onUpload(a,b);if(Q){var d=y.getName(a),b=0,h,g;if(!q[a].remainingChunkIdxs||0===q[a].remainingChunkIdxs.length){q[a].remainingChunkIdxs=[];if(z&&!c&&q[a].file){a:{h=
qq.getCookie(B(a));g=y.getName(a);var l,n,k;if(h){h=h.split(E);if(5===h.length){g=h[0];l=parseInt(h[1],10);n=parseInt(h[2],10);k=parseInt(h[3],10);h=parseInt(h[4],10);h={uuid:g,part:l,lastByteSent:n,initialRequestOverhead:k,estTotalRequestsSize:h};break a}J("Ignoring previously stored resume/chunk cookie for "+g+" - old cookie format","warn")}h=void 0}h&&(g=e(a,h.part),!1!==t.onResume(a,d,m(g))&&(b=h.part,q[a].uuid=h.uuid,q[a].loaded=h.lastByteSent,q[a].estTotalRequestsSize=h.estTotalRequestsSize,
q[a].initialRequestOverhead=h.initialRequestOverhead,q[a].attemptingResume=!0,J("Resuming "+d+" at partition index "+b)))}for(d=f(a)-1;d>=b;--d)q[a].remainingChunkIdxs.unshift(d)}p(a)}else u(a)},cancel:function(a){var c=q[a].xhr;t.onCancel(a,this.getName(a));c&&(c.onreadystatechange=null,c.abort());z&&K(a);delete q[a]},getResumableFilesData:function(){var a=[],c=[];return Q&&z?(a=void 0===I?qq.getCookieNames(RegExp("^qqfilechunk\\"+E+".+\\"+E+"\\d+\\"+E+t.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
E+".+\\"+E+"\\d+\\"+E+t.chunking.partSize+"\\"+E+I+"=")),qq.each(a,function(a,b){var e=b.split(E),d=qq.getCookie(b).split(E);c.push({name:decodeURIComponent(e[1]),size:e[2],uuid:d[0],partIdx:d[1]})}),c):[]}}};
(function(a){var b,d,c,e,f,g,l,h,p,n;g=["uploaderType"];c=function(a){a&&(a=h(a),l(a),"basic"===f("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return d};e=function(a,c){var b=d.data("fineuploader");if(c)void 0===b&&(b={}),b[a]=c,d.data("fineuploader",b);else return void 0===b?null:b[a]};b=function(a){return e("uploader",a)};f=function(a,c){return e(a,c)};l=function(c){var b=c.callbacks={};c=new qq.FineUploaderBasic;a.each(c._options.callbacks,function(a){var c,e;c=/^on(\w+)/.exec(a)[1];
c=c.substring(0,1).toLowerCase()+c.substring(1);e=d;b[a]=function(){var a=Array.prototype.slice.call(arguments);return e.triggerHandler(c,a)}})};h=function(c,b){var e,l;e=void 0===b?"basic"!==c.uploaderType?{element:d[0]}:{}:b;a.each(c,function(c,b){0<=a.inArray(c,g)?f(c,b):b instanceof a?e[c]=b[0]:a.isPlainObject(b)?(e[c]={},h(b,e[c])):a.isArray(b)?(l=[],a.each(b,function(c,b){b instanceof a?a.merge(l,b):l.push(b)}),e[c]=l):e[c]=b});if(void 0===b)return e};p=function(c){return"string"===a.type(c)&&
!c.match(/^_/)&&void 0!==b()[c]};n=function(a){var c=[],e=Array.prototype.slice.call(arguments,1);h(e,c);return b()[a].apply(b(),c)};a.fn.fineUploader=function(e){var f=this,h=arguments,g=[];this.each(function(l,u){d=a(u);if(b()&&p(e)){if(g.push(n.apply(f,h)),1===f.length)return!1}else"object"!==typeof e&&e?a.error("Method "+e+" does not exist on jQuery.fineUploader"):c.apply(f,h)});return 1===g.length?g[0]:1<g.length?g:this}})(jQuery);
...
b){b instanceof a?d[c]=b[0]:a.isPlainObject(b)?(d[c]={},e(b,d[c])):a.isArray(b)?(f=[],a.each(b,function(c,b){b instanceof a?a.merge(f,b):f.push(b)}),d[c]=f):d[c]=b});if(void 0===b)return d}function f(a){var c=[],b=Array.prototype.slice.call(arguments,1);e(b,c);return d()[a].apply(d(),c)}var g="fineUploaderDnd",l;a.fn.fineUploaderDnd=function(c){var e=this,g=arguments,m=[];this.each(function(r,w){l=a(w);if(d()&&"string"===a.type(c)&&"dispose"===c&&void 0!==d()[c]){if(m.push(f.apply(e,g)),1===e.length)return!1}else"object"!==
typeof c&&c?a.error("Method "+c+" does not exist in Fine Uploader's DnD module."):b.apply(e,g)});return 1===m.length?m[0]:1<m.length?m:this}})(jQuery);
...
function(c){return c||(this.paused=!0),this.$element.find(".next, .prev").length&&a.support.transition.end&&(this.$element.trigger(a.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this};b.prototype.next=function(){return this.sliding?void 0:this.slide("next")};b.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")};b.prototype.slide=function(c,b){var d=this.$element.find(".item.active"),g=b||d[c](),l=this.interval,h="next"==c?"left":"right",p=
"next"==c?"first":"last",n=this;if(!g.length){if(!this.options.wrap)return;g=this.$element.find(".item")[p]()}this.sliding=!0;l&&this.pause();p=a.Event("slide.bs.carousel",{relatedTarget:g[0],direction:h});if(!g.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var c=a(n.$indicators.children()[n.getActiveIndex()]);c&&c.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(p),
p.isDefaultPrevented())return;g.addClass(c);g[0].offsetWidth;d.addClass(h);g.addClass(h);d.one(a.support.transition.end,function(){g.removeClass([c,h].join(" ")).addClass("active");d.removeClass(["active",h].join(" "));n.sliding=!1;setTimeout(function(){n.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{if(this.$element.trigger(p),p.isDefaultPrevented())return;d.removeClass("active");g.addClass("active");this.sliding=!1;this.$element.trigger("slid")}return l&&this.cycle(),this}};var d=
a.fn.carousel;a.fn.carousel=function(c){return this.each(function(){var e=a(this),d=e.data("bs.carousel"),g=a.extend({},b.DEFAULTS,e.data(),"object"==typeof c&&c),l="string"==typeof c?c:g.slide;d||e.data("bs.carousel",d=new b(this,g));"number"==typeof c?d.to(c):l?d[l]():g.interval&&d.pause().cycle()})};a.fn.carousel.Constructor=b;a.fn.carousel.noConflict=function(){return a.fn.carousel=d,this};a(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(c){var b,d=a(this),
...
+function(a){var b=function(c,e){this.$element=a(c);this.options=a.extend({},b.DEFAULTS,e);this.transitioning=null;this.options.parent&&(this.$parent=a(this.options.parent));this.options.toggle&&this.toggle()};b.DEFAULTS={toggle:!0};b.prototype.dimension=function(){return this.$element.hasClass("width")?"width":"height"};b.prototype.show=function(){if(!this.transitioning&&!this.$element.hasClass("in")){var c=a.Event("show.bs.collapse");if(this.$element.trigger(c),!c.isDefaultPrevented()){if((c=this.$parent&&
...
b.appendTo(this.options.container):b.insertAfter(this.$element);var d=this.getPosition(),l=b[0].offsetWidth,h=b[0].offsetHeight;if(g){var p=this.$element.parent(),g=c,n=document.documentElement.scrollTop||document.body.scrollTop,m="body"==this.options.container?window.innerWidth:p.outerWidth(),r="body"==this.options.container?window.innerHeight:p.outerHeight(),p="body"==this.options.container?0:p.offset().left,c="bottom"==c&&d.top+d.height+h-n>r?"top":"top"==c&&0>d.top-n-h?"bottom":"right"==c&&d.right+
l>m?"left":"left"==c&&d.left-l<p?"right":c;b.removeClass(g).addClass(c)}b=this.getCalculatedOffset(c,d,l,h);this.applyPlacement(b,c);this.$element.trigger("shown.bs."+this.type)}};b.prototype.applyPlacement=function(a,b){var d,g=this.tip(),l=g[0].offsetWidth,h=g[0].offsetHeight,p=parseInt(g.css("margin-top"),10),n=parseInt(g.css("margin-left"),10);isNaN(p)&&(p=0);isNaN(n)&&(n=0);a.top+=p;a.left+=n;g.offset(a).addClass("in");p=g[0].offsetWidth;n=g[0].offsetHeight;("top"==b&&n!=h&&(d=!0,a.top=a.top+
h-n),/bottom|top/.test(b))?(h=0,0>a.left&&(h=-2*a.left,a.left=0,g.offset(a),p=g[0].offsetWidth),this.replaceArrow(h-l+p,p,"left")):this.replaceArrow(n-h,n,"top");d&&g.offset(a)};b.prototype.replaceArrow=function(a,b,d){this.arrow().css(d,a?50*(1-a/b)+"%":"")};b.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};b.prototype.hide=function(){function c(){"in"!=b.hoverState&&d.detach()}
...
this.options.offset,d=(this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight)-this.$scrollElement.height(),g=this.offsets,l=this.targets,h=this.activeTarget;if(b>=d)return h!=(a=l.last()[0])&&this.activate(a);for(a=g.length;a--;)h!=l[a]&&b>=g[a]&&(!g[a+1]||b<=g[a+1])&&this.activate(l[a])};b.prototype.activate=function(c){this.activeTarget=c;a(this.selector).parents(".active").removeClass("active");c=a(this.selector+'[data-target="'+c+'"],'+this.selector+'[href="'+c+'"]').parents("li").addClass("active");
...
+function(a){var b=function(c){this.element=a(c)};b.prototype.show=function(){var c=this.element,b=c.closest("ul:not(.dropdown-menu)"),d=c.attr("data-target");if(d||(d=c.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!c.parent("li").hasClass("active")){var g=b.find(".active:last a")[0],l=a.Event("show.bs.tab",{relatedTarget:g});(c.trigger(l),l.isDefaultPrevented())||(d=a(d),this.activate(c.parent("li"),b),this.activate(d,d.parent(),function(){c.trigger({type:"shown.bs.tab",relatedTarget:g})}))}};
b.prototype.activate=function(c,b,d){function g(){l.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");c.addClass("active");h?(c[0].offsetWidth,c.addClass("in")):c.removeClass("fade");c.parent(".dropdown-menu")&&c.closest("li.dropdown").addClass("active");d&&d()}var l=b.find("> .active"),h=d&&a.support.transition&&l.hasClass("fade");h?l.one(a.support.transition.end,g).emulateTransitionEnd(150):g();l.removeClass("in")};var d=a.fn.tab;a.fn.tab=function(c){return this.each(function(){var d=
...
c(A,"LoadedContent","width:0; height:0; overflow:hidden"),F.css({width:"",height:""}).append(x),M=J.height()+Q.height()+F.outerHeight(!0)-F.height(),N=q.width()+E.width()+F.outerWidth(!0)-F.width(),R=x.outerHeight(!0),S=x.outerWidth(!0),k.w=g(k.initialWidth,"x"),k.h=g(k.initialHeight,"y"),x.css({width:"",height:k.h}),C.position(),n(pa,k.onOpen),ga.add(ea).hide(),u.focus(),k.trapFocus&&b.addEventListener&&(b.addEventListener("focus",h,!0),L.one(ja,function(){b.removeEventListener("focus",h,!0)})),
k.returnFocus&&L.one(ja,function(){a(H).focus()})),K())}function r(){!u&&b.body&&(ka=!1,I=a(d),u=c(A).attr({id:O,"class":!1===a.support.opacity?D+"IE":"",role:"dialog",tabindex:"-1"}).hide(),B=c(A,"Overlay").hide(),T=a([c(A,"LoadingOverlay")[0],c(A,"LoadingGraphic")[0]]),t=c(A,"Wrapper"),F=c(A,"Content").append(ea=c(A,"Title"),fa=c(A,"Current"),X=a('<button type="button"/>').attr({id:D+"Previous"}),W=a('<button type="button"/>').attr({id:D+"Next"}),U=c("button","Slideshow"),T),aa=a('<button type="button"/>').attr({id:D+
"Close"}),t.append(c(A).append(c(A,"TopLeft"),J=c(A,"TopCenter"),c(A,"TopRight")),c(A,!1,"clear:left").append(q=c(A,"MiddleLeft"),F,E=c(A,"MiddleRight")),c(A,!1,"clear:left").append(c(A,"BottomLeft"),Q=c(A,"BottomCenter"),c(A,"BottomRight"))).find("div div").css({"float":"left"}),y=c(A,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),ga=W.add(X).add(fa).add(U),a(b.body).append(B,u.append(t,y)))}function w(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),m(this))}return u?(ka||(ka=!0,W.click(function(){C.next()}),X.click(function(){C.prev()}),aa.click(function(){C.close()}),B.click(function(){k.overlayClose&&C.close()}),a(b).bind("keydown."+D,function(a){var b=a.keyCode;P&&k.escKey&&27===b&&(a.preventDefault(),C.close());P&&k.arrowKey&&z[1]&&!a.altKey&&(37===b?(a.preventDefault(),X.click()):39===b&&(a.preventDefault(),W.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+D,"."+V,c):a("."+V).live("click."+D,c)),!0):!1}
function K(){var e,f,h,m=C.prep,q=++la;Z=!0;v=!1;H=z[G];p();n(ba);n(ca,k.onLoad);k.h=k.height?g(k.height,"y")-R-M:k.innerHeight&&g(k.innerHeight,"y");k.w=k.width?g(k.width,"x")-S-N:k.innerWidth&&g(k.innerWidth,"x");k.mw=k.w;k.mh=k.h;k.maxWidth&&(k.mw=g(k.maxWidth,"x")-S-N,k.mw=k.w&&k.w<k.mw?k.w:k.mw);k.maxHeight&&(k.mh=g(k.maxHeight,"y")-R-M,k.mh=k.h&&k.h<k.mh?k.h:k.mh);e=k.href;na=setTimeout(function(){T.show()},100);k.inline?(h=c(A).hide().insertBefore(a(e)[0]),L.one(ba,function(){h.replaceWith(x.children())}),
m(a(e))):k.iframe?m(" "):k.html?m(k.html):k.photo||k.photoRegex.test(e)?(e=l(k,e),v=b.createElement("img"),a(v).addClass(D+"Photo").bind("error",function(){k.title=!1;m(c(A,"Error").html(k.imgError))}).one("load",function(){var b;q===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(H).attr(c)||a(H).attr("data-"+c);d&&v.setAttribute(c,d)}),k.retinaImage&&1<d.devicePixelRatio&&(v.height/=d.devicePixelRatio,v.width/=d.devicePixelRatio),k.scalePhotos&&(f=function(){v.height-=v.height*
b;v.width-=v.width*b},k.mw&&v.width>k.mw&&(b=(v.width-k.mw)/v.width,f()),k.mh&&v.height>k.mh&&(b=(v.height-k.mh)/v.height,f())),k.h&&(v.style.marginTop=Math.max(k.mh-v.height,0)/2+"px"),z[1]&&(k.loop||z[G+1])&&(v.style.cursor="pointer",v.onclick=function(){C.next()}),v.style.width=v.width+"px",v.style.height=v.height+"px",setTimeout(function(){m(v)},1))}),setTimeout(function(){v.src=e},1)):e&&y.load(e,k.data,function(b,d){q===la&&m("error"===d?c(A,"Error").html(k.xhrError):a(this).contents())})}var B,
...
b&&x.scrollTop(b),C.position("none"===k.transition?0:k.speed))},C.prep=function(d){if(P){var e,h="none"===k.transition?0:k.speed;x.empty().remove();x=c(A,"LoadedContent").append(d);x.hide().appendTo(y.show()).css({width:(k.w=k.w||x.width(),k.w=k.mw&&k.mw<k.w?k.mw:k.w,k.w),overflow:k.scrolling?"auto":"hidden"}).css({height:(k.h=k.h||x.height(),k.h=k.mh&&k.mh<k.h?k.mh:k.h,k.h)}).prependTo(F);y.hide();a(v).css({"float":"none"});e=function(){function d(){!1===a.support.opacity&&u[0].style.removeAttribute("filter")}
var e,g,m=z.length;P&&(g=function(){clearTimeout(na);T.hide();n(da,k.onComplete)},ea.html(k.title).add(x).show(),1<m?("string"==typeof k.current&&fa.html(k.current.replace("{current}",G+1).replace("{total}",m)).show(),W[k.loop||m-1>G?"show":"hide"]().html(k.next),X[k.loop||G?"show":"hide"]().html(k.previous),qa(),k.preloading&&a.each([f(-1),f(1)],function(){var c,d,e=z[this],f=a.data(e,O);f&&f.href?(c=f.href,a.isFunction(c)&&(c=c.call(e))):c=a(e).attr("href");c&&(f.photo||f.photoRegex.test(c))&&(c=
...
u.stop().remove(),B.remove(),Y=!1,u=null,a("."+V).removeData(O).removeClass(V),a(b).unbind("click."+D))},C.element=function(){return a(H)},C.settings=ha)})(jQuery,document,window);
$(function(){$(".teacher_select").on("change",function(){var a=$(this);a.prev("span").removeClass("a").addClass("preloader");data={teacher_id:$(this).find(":selected").val(),type:"teacher"};$.ajax({type:"POST",url:"/g1_teacher/sortable",data:data,dataType:"json",success:function(b){$(".f1").fadeOut(200).html("");""!=b.subjects_list&&void 0!=b.subjects_list?($.each(b.subjects_list,function(a,b){var e=""!=b.subject_years&&void 0!=b.subject_years?b.subject_years.length:0;if(0==e)var f="color:#aaa;",
g="background-image:none;",l="hidden";else l=g=f="";var h='<h3 class="acc_title" style="cursor:pointer;padding-left: 0px;padding-bottom:15px;border-bottom: 1px solid #ccc;'+f+'">'+b.name+"</h3>",h=h+('<div class="up_down" style="cursor:pointer;padding-right: 2px;'+g+'"><span class="count_lessons count_assigned" style="'+f+'">('+e+")</span></div>"),h=h+('<div class="collapsed '+l+'" style="display: none">'),h=h+'  <div class="row" style="width: 100%;margin-left: 0;" >';""!=b.subject_years&&void 0!=
...
b.ids+'">';h+='<span class="pull-left">'+b.first_name+" "+b.last_name+"</span>";h+='<span class="pull-right glyphicon glyphicon-chevron-right"></span></a>';h+="</div>"});h+="</div>";h+="</div>"});h+="</div>";h+="</div>"});h+="</div>";h+="</div>";$(".f1").append(h)}),a.prev("span").removeClass("preloader").addClass("a"),$(".f1").fadeIn(300)):a.prev("span").removeClass("preloader").addClass("a");""!=b.subjects?($(".subject_select").empty().append(b.subjects),$(".subject_select").parent().find(".v").html($(".subject_select").find("option:first").text())):
($(".subject_select").empty(),$(".subject_select").parent().find(".v").html("No results"));""!=b.years?($(".subject_year_select").empty().append(b.years),$(".subject_year_select").parent().find(".v").html($(".subject_year_select").find("option:first").text())):($(".subject_year_select").empty(),$(".subject_year_select").parent().find(".v").html("All"));""!=b["class"]?($(".class_select").empty().append(b["class"]),$(".class_select").parent().find(".v").html($(".class_select").find("option:first").text())):
($(".class_select").empty(),$(".class_select").parent().find(".v").html("All"))}})});$(".subject_select").on("change",function(){var a=$(this);a.prev("span").removeClass("a").addClass("preloader");var b=$(".teacher_select").find(":selected").val(),d=$(this).find(":selected").attr("subject_ids"),c=$(this).find(":selected").val();data={teacher_id:b,subject_ids:d,type:"subject",find:c};$.ajax({type:"POST",url:"/g1_teacher/sortable",data:data,dataType:"json",success:function(b){$(".f1").fadeOut(200).html("");
...
($(".class_select").empty(),$(".class_select").parent().find(".v").html("No results"))}})});$(".subject_year_select").on("change",function(){var a=$(this);a.prev("span").removeClass("a").addClass("preloader");var b=$(".teacher_select").find(":selected").val(),d=$(".subject_select").find(":selected").val(),c=$(this).find(":selected").attr("subjects_ids"),e=$(this).find(":selected").attr("classes_id"),f=$(this).find(":selected").val();data={teacher_id:b,subjects_ids:c,type:"year",classes_id:e,find:f,
...
$(".class_select").on("change",function(){var a=$(this);a.prev("span").removeClass("a").addClass("preloader");var b=$(".teacher_select").find(":selected").val(),d=$(".subject_select").find(":selected").val(),c=$(this).find(":selected").attr("classes_id"),e=$(this).find(":selected").val();data={teacher_id:b,subject_id:d,year:e,type:"class",classes_id:c};$.ajax({type:"POST",url:"/g1_teacher/sortable",data:data,dataType:"json",success:function(b){$(".f1").fadeOut(200).html("");""!=b.subjects_list&&void 0!=
...
$(document).ready(function(){if(0<g1_work_id){var a=$("#work-"+g1_work_id);if(1===a.length){var b=parseInt(a.attr("data-parent-subject-id"),10);if(0<b&&(a=$('[data-subject-id="'+b+'"]'),1===a.length)){var d=parseInt(a.attr("data-offset"),10),c=a.closest("div").find("div.up_down"),e=a.closest("div").find("div.collapsed");1===c.length&&1===e.length&&setTimeout(function(){c.css("background-position","0 -36px");e.css("display","block");$("#work-item-"+g1_work_id).addClass("in");var a=$("#work-item-"+
g1_work_id).parent().parent(),a=$("tr.tr-work-"+b).index(a);$(window).scrollTop(68*d+191+66*a)},1E3)}}}});
