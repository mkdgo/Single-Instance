...
$(function(){bkLib.onDomLoaded(function(){(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_intro");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_objectives");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_teaching_activities");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_assessment_opportunities");
(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_notes")})});
function publishModal(){$("#message").modal("hide");$(".publish_btn").hasClass("active")?$($("#popupPubl").find("p")[0]).html("This act will unpublish all related modules. Please confirm you would like to unpublish the Curriculum"):""!=$(".publish_btn").attr("rel")?$($("#popupPubl").find("p")[0]).html("You are trying to publish lesson from a "+$(".publish_btn").attr("rel")+" that are unpublished. Please confirm if you would like to publish the parent "+$(".publish_btn").attr("rel")+" , otherwise please cancel."):
$($("#popupPubl").find("p")[0]).html("Please confirm you would like to publish the Curriculum");$($("#popupPubl").find("h4")[0]).text("");$("#popupPubl").modal("show")}
function doPubl(){$("#subject_intro").val(nicEditors.findEditor("subject_intro").getContent());$("#subject_objectives").val(nicEditors.findEditor("subject_objectives").getContent());$("#subject_teaching_activities").val(nicEditors.findEditor("subject_teaching_activities").getContent());$("#subject_assessment_opportunities").val(nicEditors.findEditor("subject_assessment_opportunities").getContent());$("#subject_notes").val(nicEditors.findEditor("subject_notes").getContent());$.post("/d3_teacher/saveajax",
{data:$("#saveform").serializeArray()},function(a,b){$("#publish").val(a);1==a?($(".publish_btn").addClass("active"),$(".publish_btn span").text("PUBLISHED"),$(".publish_btn").attr("rel","")):($(".publish_btn").removeClass("active"),$(".publish_btn span").text("PUBLISH"));$("#popupPubl").modal("hide");$($($("#message").find("div")[0]).find("div")[0]).hide();1==a?showFooterMessage({status:"success",mess:"Successfully Published",clrT:"#fff",clr:"#128c44",anim_a:2E3,anim_b:1700}):showFooterMessage({status:"alert",
mess:"Successfully Unpublished",clrT:"#fff",clr:"#128c44",anim_a:2E3,anim_b:1700})},"json")};
