...
this.removePane()}});nicEditors.registerPlugin(nicPlugin,nicCodeOptions);$(function(){$("ul.sortable").sortable({update:function(a,b){var c=$("ul.sortable").sortable("toArray",{attribute:"id"});$.post("/e2/saveorder/",{data:JSON.stringify(c),cont_page_id:$("#cont_page_id").val()},function(a,b){},"json")}});$("ul.sortable").disableSelection()});
