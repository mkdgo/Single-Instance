...
this.removePane()}});nicEditors.registerPlugin(nicPlugin,nicCodeOptions);$(function(){});function resourceModal(a){$("#message").modal("hide");$($("#popupDelRes").find("p")[0]).html("Please confirm you would like to remove this Resource");$($("#popupDelRes").find("h4")[0]).text("");$("#popupDelRes .res_id").val(a);$("#popupDelRes").modal("show")}
