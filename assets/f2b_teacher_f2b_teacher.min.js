...
function initPublishButton(a,b,c,d){$(a).each(function(){$("input[name="+b+"]").size()&&"1"==$("input[name="+b+"]").val()&&$(this).addClass("active").text(c);$(this).off("click");$(this).on("click",function(){0==disablepublishandsave&&$("input[name="+b+"]").size()&&("1"==$("input[name="+b+"]").val()?(console.log(b),console.log($("input[name="+b+"]").val()),$("input[name="+b+"]").val("0"),$(this).removeClass("active").text(d)):(console.log(b),console.log($("input[name="+b+"]").val()),$("input[name="+
b+"]").val("1"),$(this).addClass("active").text(c)))})})}
