...
b+c&&(a=a.childNodes[b+c],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=d))}}var p,n=["webkit","Moz","ms","O"],q={},x=function(){var d=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],d),d.sheet||d.styleSheet}(),B={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};e(h.prototype,{spin:function(b){this.stop();var d=
...
qq.UploadHandlerForm=function(a,b,c){function d(a){void 0!==q[a]&&(q[a](),delete q[a])}function f(a,b){var c=a.id;E[n[c]]=b;q[c]=qq(a).attach("load",function(){p[c]&&(B("Received iframe load event for CORS upload request (file id "+c+")"),x[c]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+c;B(a,"error");b({error:a})},1E3))});I.receiveMessage(c,function(a){B("Received the following window message: '"+a+"'");var b=qq.parseJson(a),f=b.uuid;f&&E[f]?(clearTimeout(x[c]),
delete x[c],d(c),a=E[f],delete E[f],I.stopReceivingMessages(c),a(b)):f||B("'"+a+"' does not contain a UUID - ignoring.")})}function e(a,b){l.cors.expected?f(a,b):q[a.id]=qq(a).attach("load",function(){B("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(d){B("Error when attempting to access iframe during handling of upload response ("+d+")","error")}b()}})}function g(a){var b=qq.toElement('<iframe src="javascript:false;" name="'+
...
p(a):(w&&I(a),l(a,d,b))}else l(a,d,b)}}}}function B(a,b){var d=z.getUuid(a),c=m[a].loaded,f=m[a].initialRequestOverhead,e=m[a].estTotalRequestsSize,u=E(a);qq.setCookie(u,d+A+b.part+A+c+A+f+A+e,r.resume.cookiesExpireIn)}function I(a){m[a].file&&(a=E(a),qq.deleteCookie(a))}function E(a){var b=z.getName(a);a=z.getSize(a);var d=r.chunking.partSize,b="qqfilechunk"+A+encodeURIComponent(b)+A+a+A+d;void 0!==v&&(b+=A+v);return b}function t(a){var b=m[a].file||m[a].blobData.blob,d=z.getName(a),c,f;m[a].loaded=
0;c=m[a].xhr=new XMLHttpRequest;c.upload.onprogress=function(b){b.lengthComputable&&(m[a].loaded=b.loaded,r.onProgress(a,d,b.loaded,b.total))};c.onreadystatechange=x(a,c);f=r.paramsStore.getParams(a);b=g(f,c,b,a);h(a,c);K("Sending upload request for "+a);c.send(b)}var r=a,y=b,K=c,m=[],A="|",u=r.chunking.enabled&&qq.supportedFeatures.chunking,w=r.resume.enabled&&u&&qq.supportedFeatures.resume,v;v=null===r.resume.id||void 0===r.resume.id||qq.isFunction(r.resume.id)||qq.isObject(r.resume.id)?void 0:
...
"Close"}),r.append(d(F).append(d(F,"TopLeft"),K=d(F,"TopCenter"),d(F,"TopRight")),d(F,!1,"clear:left").append(m=d(F,"MiddleLeft"),y,A=d(F,"MiddleRight")),d(F,!1,"clear:left").append(d(F,"BottomLeft"),u=d(F,"BottomCenter"),d(F,"BottomRight"))).find("div div").css({"float":"left"}),z=d(F,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=Y.add(Z).add(ga).add(W),a(b.body).append(E,t.append(r,z)))}function B(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
...
g.addClass(c.className);null===c.minTime&&null===c.durationTime||!c.showDuration||(g.addClass("ui-timepicker-with-duration"),g.addClass("ui-timepicker-step-"+c.step));m=c.minTime;"function"===typeof c.durationTime?m=y(c.durationTime()):null!==c.durationTime&&(m=c.durationTime);l=null!==c.minTime?c.minTime:0;var n=null!==c.maxTime?c.maxTime:l+86400-1;n<l&&(n+=86400);86399===n&&"string"===a.type(c.timeFormat)&&c.show2400&&(n=86400);var q=c.disableTimeRanges,B=0,K=q.length,I=c.step;"function"!=typeof I&&
(I=function(){return c.step});for(var U=0;l<=n;U++,l+=60*I(U)){var O=l,k=r(O,c);if(c.useSelect)var J=a("<option />",{value:k});else J=a("<li />"),J.data("time",86400>=O?O:O%86400);J.text(k);if((null!==c.minTime||null!==c.durationTime)&&c.showDuration)if(k=t(l-m,c.step),c.useSelect)J.text(J.text()+" ("+k+")");else{var N=a("<span />",{"class":"ui-timepicker-duration"});N.text(" ("+k+")");J.append(N)}B<K&&(O>=q[B][1]&&(B+=1),q[B]&&O>=q[B][0]&&O<q[B][1]&&(c.useSelect?J.prop("disabled",!0):J.addClass("ui-timepicker-disabled")));
...
b.on("focus.timepicker-ie-hack",function(){b.off("focus.timepicker-ie-hack");b.on("focus.timepicker",A.show)});h(b)||b[0].focus();d.find("li").removeClass("ui-timepicker-selected");a(this).addClass("ui-timepicker-selected");E(b)&&(b.trigger("hideTimepicker"),d.on("mouseup.timepicker","li",function(a){d.off("mouseup.timepicker");g.hide()}))}))}function f(b,c){var d,e,f;"object"==typeof b?(d=b.label,e=b.className,f=b.value):"string"==typeof b?d=b:a.error("Invalid noneOption value");return c?a("<option />",
{value:f,"class":e,text:d}):a("<li />",{"class":e,text:d}).data("time",f)}function e(a,b){a=b.roundingFunction(a,b);if(null!==a)return r(a,b)}function g(b){b=a(b.target);0===b.closest(".ui-timepicker-input").length&&0===b.closest(".ui-timepicker-wrapper").length&&(A.hide(),a(document).unbind(".ui-timepicker"),a(window).unbind(".ui-timepicker"))}function h(a){a=a.data("timepicker-settings");return(window.navigator.msMaxTouchPoints||"ontouchstart"in document)&&a.disableTouchKeyboard}function l(b,c,
...
a.val():a.data("ui-timepicker-value")}function x(a,b,c){if(a.is("input")){a.val(b);var d=a.data("timepicker-settings");d.useSelect&&"select"!=c&&"initial"!=c&&a.data("timepicker-list").val(e(y(b),d))}if(a.data("ui-timepicker-value")!=b)return a.data("ui-timepicker-value",b),"select"==c?a.trigger("selectTime").trigger("changeTime").trigger("change","timepicker"):"error"!=c&&a.trigger("changeTime"),!0;a.trigger("selectTime");return!1}function B(c){var d=a(this),e=d.data("timepicker-list");if(!e||!b(e))if(40==
c.keyCode)A.show.call(d.get(0)),e=d.data("timepicker-list"),h(d)||d.focus();else return!0;switch(c.keyCode){case 13:return E(d)&&A.hide.apply(this),c.preventDefault(),!1;case 38:var f=e.find(".ui-timepicker-selected");f.length?f.is(":first-child")||(f.removeClass("ui-timepicker-selected"),f.prev().addClass("ui-timepicker-selected"),f.prev().position().top<f.outerHeight()&&e.scrollTop(e.scrollTop()-f.outerHeight())):(e.find("li").each(function(b,c){if(0<a(c).position().top)return f=a(c),!1}),f.addClass("ui-timepicker-selected"));
