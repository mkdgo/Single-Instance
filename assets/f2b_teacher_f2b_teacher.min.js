(function(a,b){function c(){a.removeEventListener("load",c,!1);h=!0}function d(a){return n=n||new d.Class(a)}function f(a,b){for(var d in b)a[d]=b[d];return a}function e(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);l.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(l,"$1"));p.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(p,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===b.readyState?h=!0:g&&a.addEventListener("load",c,!1);var l=/\/ath(\/)?$/,p=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,n;d.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
"ios"==d.OS?"8":"4"),this.container=b.documentElement,this.session=(this.session=this.getItem(this.options.appID))?JSON.parse(this.session):void 0,!d.hasToken||d.isCompatible&&this.session||(d.hasToken=!1,e()),d.isCompatible){this.session=this.session||A;try{if(!localStorage)throw Error("localStorage is not defined");localStorage.setItem(this.options.appID,JSON.stringify(this.session));d.hasLocalStorage=!0}catch(p){d.hasLocalStorage=!1,this.options.onPrivate&&this.options.onPrivate.call(this)}c=!this.options.validLocation.length;
for(var h=this.options.validLocation.length;h--;)if(this.options.validLocation[h].test(b.location.href)){c=!0;break}this.getItem("addToHome")&&this.optOut();if(this.session.optedout)this.doLog("Add to homescreen: not displaying callout because user opted out");else if(this.session.added)this.doLog("Add to homescreen: not displaying callout because already added to the homescreen");else if(c)if(d.isStandalone)this.session.added||(this.session.added=!0,this.updateSession(),this.options.onAdd&&d.hasLocalStorage&&
...
(function(a,b){"object"==typeof exports?module.exports=b():"function"==typeof define&&define.amd?define(b):a.Spinner=b()})(this,function(){function a(a,b){var d,c=document.createElement(a||"div");for(d in b)c[d]=b[d];return c}function b(a){for(var b=1,d=arguments.length;d>b;b++)a.appendChild(arguments[b]);return a}function c(a,b,d,c){var f=["opacity",b,~~(100*a),d,c].join("-");d=.01+d/c*100;c=Math.max(1-(1-a)/b*(100-d),a);var e=p.substring(0,p.indexOf("Animation")).toLowerCase();return q[f]||(w.insertRule("@"+
(e&&"-"+e+"-"||"")+"keyframes "+f+"{0%{opacity:"+c+"}"+d+"%{opacity:"+a+"}"+(d+.01)+"%{opacity:1}"+(d+b)%100+"%{opacity:"+a+"}100%{opacity:"+c+"}}",w.cssRules.length),q[f]=1),f}function d(a,b){var d,c,f=a.style;b=b.charAt(0).toUpperCase()+b.slice(1);for(c=0;n.length>c;c++)if(d=n[c]+b,void 0!==f[d])return d;return void 0!==f[b]?b:void 0}function f(a,b){for(var c in b)a.style[d(a,c)||c]=b[c];return a}function e(a){for(var b=1;arguments.length>b;b++){var d=arguments[b],c;for(c in d)void 0===a[c]&&(a[c]=
d[c])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=e(a||{},h.defaults,A)}function l(){function d(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}w.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,c){function e(){return f(d("group",{coordsize:u+" "+u,coordorigin:-l+" "+-l}),{width:u,height:u})}function p(a,u,h){b(v,b(f(e(),{rotation:360/c.lines*a+"deg",left:~~u}),b(f(d("roundrect",{arcsize:c.corners}),
{width:l,height:c.width,left:c.radius,top:-c.width>>1,filter:h}),d("fill",{color:g(c.color,a),opacity:c.opacity}),d("stroke",{opacity:0}))))}var h,l=c.length+c.width,u=2*l;h=2*-(c.width+c.length)+"px";var v=f(e(),{position:"absolute",top:h,left:h});if(c.shadow)for(h=1;c.lines>=h;h++)p(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;c.lines>=h;h++)p(h);return b(a,v)};h.prototype.opacity=function(a,b,d,c){a=a.firstChild;c=c.shadow&&c.lines||0;a&&a.childNodes.length>
b+c&&(a=a.childNodes[b+c],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=d))}}var p,n=["webkit","Moz","ms","O"],q={},w=function(){var d=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],d),d.sheet||d.styleSheet}(),A={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};e(h.prototype,{spin:function(b){this.stop();var d=
this,c=d.opts,e=d.el=f(a(0,{className:c.className}),{position:c.position,width:0,zIndex:c.zIndex});if(c.radius+c.length+c.width,f(e,{left:c.left,top:c.top}),b&&b.insertBefore(e,b.firstChild||null),e.setAttribute("role","progressbar"),d.lines(e,d.opts),!p){var g,h=0,l=(c.lines-1)*(1-c.direction)/2,u=c.fps,v=u/c.speed,x=(1-c.opacity)/(v*c.trail/100),C=v/c.lines;(function V(){h++;for(var a=0;c.lines>a;a++)g=Math.max(1-(h+(c.lines-a)*C)%v*x,c.opacity),d.opacity(e,a*c.direction+l,g,c);d.timeout=d.el&&
setTimeout(V,~~(1E3/u))})()}return d},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(d,e){function h(b,d){return f(a(),{position:"absolute",width:e.length+e.width+"px",height:e.width+"px",background:b,boxShadow:d,transformOrigin:"left",transform:"rotate("+~~(360/e.lines*n+e.rotate)+"deg) translate("+e.radius+"px,0)",borderRadius:(e.corners*e.width>>1)+"px"})}for(var l,n=0,q=(e.lines-1)*(1-e.direction)/
2;e.lines>n;n++)l=f(a(),{position:"absolute",top:1+~(e.width/2)+"px",transform:e.hwaccel?"translate3d(0,0,0)":"",opacity:e.opacity,animation:p&&c(e.opacity,e.trail,q+n*e.direction,e.lines)+" "+1/e.speed+"s linear infinite"}),e.shadow&&b(l,f(h("#000","0 0 4px #000"),{top:"2px"})),b(d,b(l,h(g(e.color,n),"0 0 1px rgba(0,0,0,.1)")));return d},opacity:function(a,b,d){a.childNodes.length>b&&(a.childNodes[b].style.opacity=d)}});var I=f(a("group"),{behavior:"url(#default#VML)"});return!d(I,"transform")&&
I.adj?l():p=d(I,"animation"),h});
...
l=b.offsetHeight;0===l&&(l=parseFloat(window.getComputedStyle(b).height));32<l&&(l*=.8);b.hasAttribute("data-spinner-size")&&(l=parseInt(b.getAttribute("data-spinner-size"),10));b.hasAttribute("data-spinner-color")&&(d=b.getAttribute("data-spinner-color"));l*=.2;c=new a({color:d||"#fff",lines:12,radius:l,length:.6*l,width:7>l?2:3,zIndex:"auto",top:"auto",left:"auto",className:""})}return b.setAttribute("disabled",""),b.setAttribute("data-loading",""),clearTimeout(h),c.spin(g),this.setProgress(0),
...
qq.AjaxRequestor=function(a){function b(a){var b=qq.indexOf(l,a),d=n.maxConnections;delete p[a];l.splice(b,1);l.length>=d&&b<d&&(a=l[d-1],c(a))}function c(a){var b=new XMLHttpRequest,c=e(),l={},E;n.onSend(a);n.paramsStore.getParams&&(l=n.paramsStore.getParams(a));E=l;var t=n.endpointStore.getEndpoint(a),r=p[a].addToPath;void 0!==r&&(t+="/"+r);E=h&&E?qq.obj2url(E,t):t;p[a].xhr=b;b.onreadystatechange=d(a);b.open(c,E,!0);n.cors.expected&&n.cors.sendCredentials&&(b.withCredentials=!0);f(a);g("Sending "+
c+" request for "+a);!h&&l?b.send(qq.obj2url(l,"")):b.send()}function d(a){var d=p[a].xhr;return function(){if(4===d.readyState){var c=p[a].xhr,f=e(),h=!1;b(a);0<=qq.indexOf(n.successfulResponseCodes,c.status)||(h=!0,g(f+" request for "+a+" has failed - response code "+c.status,"error"));n.onComplete(a,c,h)}}}function f(a){var b=p[a].xhr;a=n.customHeaders;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,d){b.setRequestHeader(a,
d)})}function e(){return n.demoMode?"GET":n.method}var g,h,l=[],p=[],n={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(n,a);g=n.log;h="GET"===e()||"DELETE"===e();return{send:function(a,b){p[a]={addToPath:b};l.push(a)<=n.maxConnections&&c(a)},cancel:function(a){var d=p[a].xhr,c=e();d?(d.onreadystatechange=
null,d.abort(),b(a),g("Cancelled "+c+" for "+a),n.onCancel(a),a=!0):a=!1;return a}}};
...
qq.UploadHandlerForm=function(a,b,c){function d(a){void 0!==q[a]&&(q[a](),delete q[a])}function f(a,b){var c=a.id;E[n[c]]=b;q[c]=qq(a).attach("load",function(){p[c]&&(A("Received iframe load event for CORS upload request (file id "+c+")"),w[c]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+c;A(a,"error");b({error:a})},1E3))});I.receiveMessage(c,function(a){A("Received the following window message: '"+a+"'");var b=qq.parseJson(a),f=b.uuid;f&&E[f]?(clearTimeout(w[c]),
delete w[c],d(c),a=E[f],delete E[f],I.stopReceivingMessages(c),a(b)):f||A("'"+a+"' does not contain a UUID - ignoring.")})}function e(a,b){l.cors.expected?f(a,b):q[a.id]=qq(a).attach("load",function(){A("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(d){A("Error when attempting to access iframe during handling of upload response ("+d+")","error")}b()}})}function g(a){var b=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');b.setAttribute("id",a);b.style.display="none";document.body.appendChild(b);return b}function h(a,b){var d=l.paramsStore.getParams(a),c=qq.toElement('<form method="'+(l.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),f=l.endpointStore.getEndpoint(a),e=f;d[l.uuidParamName]=n[a];l.paramsInBody?qq.obj2Inputs(d,c):e=qq.obj2url(d,f);c.setAttribute("action",e);c.setAttribute("target",b.name);c.style.display="none";document.body.appendChild(c);return c}var l=a,p=[],n=[],q={},w=
{},A=c,I=new qq.WindowReceiveMessage({log:A}),E={},t;return t={add:function(a){a.setAttribute("name",l.inputName);var b=p.push(a)-1;n[b]=qq.getUniqueId();a.parentNode&&qq(a).remove();return b},getName:function(a){if(t.isValid(a))return p[a].value.replace(/.*(\/|\\)/,"");A(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==p[a]},reset:function(){p=[];n=[];q={}},getUuid:function(a){return n[a]},cancel:function(a){l.onCancel(a,this.getName(a));delete p[a];delete n[a];delete q[a];
l.cors.expected&&(clearTimeout(w[a]),delete w[a],I.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var c=p[a],f=t.getName(a),n=g(a),q;if(!c)throw Error("file with passed id was not added, or already uploaded or cancelled");l.onUpload(a,this.getName(a));q=h(a,n);q.appendChild(c);e(n,function(c){A("iframe loaded");if(!c){var e;try{var g=n.contentDocument||n.contentWindow.document,h=g.body.innerHTML;
A("converting iframe's innerHTML to JSON");A("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);e=qq.parseJson(h)}catch(z){A("Error when attempting to parse form upload response ("+z+")","error"),e={success:!1}}c=e}d(a);l.cors.expected||qq(n).remove();if(c.success||!l.onAutoRetry(a,f,c))l.onComplete(a,f,c),b(a)});A("Sending upload request for "+a);q.submit();qq(q).remove();return a}}};
qq.UploadHandlerXhr=function(a,b,c){function d(a,b,d){var c=z.getSize(a);a=z.getName(a);b[r.chunking.paramNames.partIndex]=d.part;b[r.chunking.paramNames.partByteOffset]=d.start;b[r.chunking.paramNames.chunkSize]=d.size;b[r.chunking.paramNames.totalParts]=d.count;b[r.totalFileSizeParamName]=c;C&&(b[r.chunking.paramNames.filename]=a)}function f(a,b){var d=r.chunking.partSize,c=z.getSize(a),f=m[a].file||m[a].blobData.blob,u=d*b,d=u+d>=c?c:u+d,c=e(a),g;f.slice?g=f.slice(u,d):f.mozSlice?g=f.mozSlice(u,
d):f.webkitSlice&&(g=f.webkitSlice(u,d));return{part:b,start:u,end:d,count:c,blob:g,size:d-u}}function e(a){a=z.getSize(a);return Math.ceil(a/r.chunking.partSize)}function g(a,b,d,c){var f=new FormData,e=r.demoMode?"GET":"POST",u=r.endpointStore.getEndpoint(c),g=u,h=z.getName(c),l=z.getSize(c),v=m[c].blobData;a[r.uuidParamName]=m[c].uuid;C&&(a[r.totalFileSizeParamName]=l,v&&(a[r.blobs.paramNames.name]=v.name));r.paramsInBody||(C||(a[r.inputName]=h),g=qq.obj2url(a,u));b.open(e,g,!0);r.cors.expected&&
r.cors.sendCredentials&&(b.withCredentials=!0);return C?(r.paramsInBody&&qq.obj2FormData(a,f),f.append(r.inputName,d),f):d}function h(a,b){var d=r.customHeaders,c=m[a].file||m[a].blobData.blob;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");C||(b.setRequestHeader("Content-Type","application/octet-stream"),b.setRequestHeader("X-Mime-Type",c.type));qq.each(d,function(a,d){b.setRequestHeader(a,d)})}function l(a,b,d){var c=z.getName(a),f=z.getSize(a);
m[a].attemptingResume=!1;r.onProgress(a,c,f,f);r.onComplete(a,c,b,d);delete m[a].xhr;y(a)}function p(a){var b=m[a].remainingChunkIdxs[0],c=f(a,b),e=m[a].xhr=new XMLHttpRequest,u=z.getSize(a),l=z.getName(a),x;void 0===m[a].loaded&&(m[a].loaded=0);v&&m[a].file&&A(a,c);e.onreadystatechange=w(a,e);e.upload.onprogress=function(d){if(d.lengthComputable){var c=d.loaded+m[a].loaded;d=d.total;var e=f(a,b);d-=e.size;var u=z.getSize(a),e=e.count,g=d-m[a].initialRequestOverhead;m[a].lastRequestOverhead=d;0===
b?(m[a].lastChunkIdxProgress=0,m[a].initialRequestOverhead=d,m[a].estTotalRequestsSize=u+e*d):m[a].lastChunkIdxProgress!==b&&(m[a].lastChunkIdxProgress=b,m[a].estTotalRequestsSize+=g);r.onProgress(a,l,c,m[a].estTotalRequestsSize)}};r.onUploadChunk(a,l,q(c));x=r.paramsStore.getParams(a);d(a,x,c);m[a].attemptingResume&&(x[r.resume.paramNames.resuming]=!0);x=g(x,e,c.blob,a);h(a,e);K("Sending chunked upload request for item "+a+": bytes "+(c.start+1)+"-"+c.end+" of "+u);e.send(x)}function n(a){K("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");v&&(I(a),m[a].attemptingResume=!1);m[a].remainingChunkIdxs=[];delete m[a].loaded;delete m[a].estTotalRequestsSize;delete m[a].initialRequestOverhead}function q(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function w(a,b){return function(){if(4===b.readyState){var d;if(m[a]){K("xhr - server response received for "+a);K("responseText = "+b.responseText);try{d=qq.parseJson(b.responseText)}catch(c){K("Error when attempting to parse xhr response text ("+c+
")","error"),d={}}if(200!==b.status||!d.success||d.reset)if(d.reset&&n(a),m[a].attemptingResume&&d.reset)m[a].attemptingResume=!1,K("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),n(a),z.upload(a,!0);else{var e=z.getName(a);r.onAutoRetry(a,e,d,b)||l(a,d,b)}else if(u){var e=m[a].remainingChunkIdxs.shift(),g=f(a,e);m[a].attemptingResume=!1;var e=m[a],h=e.loaded,g=g.size;e.loaded=h+(g+(C?m[a].lastRequestOverhead:0));0<m[a].remainingChunkIdxs.length?
p(a):(v&&I(a),l(a,d,b))}else l(a,d,b)}}}}function A(a,b){var d=z.getUuid(a),c=m[a].loaded,f=m[a].initialRequestOverhead,e=m[a].estTotalRequestsSize,u=E(a);qq.setCookie(u,d+B+b.part+B+c+B+f+B+e,r.resume.cookiesExpireIn)}function I(a){m[a].file&&(a=E(a),qq.deleteCookie(a))}function E(a){var b=z.getName(a);a=z.getSize(a);var d=r.chunking.partSize,b="qqfilechunk"+B+encodeURIComponent(b)+B+a+B+d;void 0!==x&&(b+=B+x);return b}function t(a){var b=m[a].file||m[a].blobData.blob,d=z.getName(a),c,f;m[a].loaded=
0;c=m[a].xhr=new XMLHttpRequest;c.upload.onprogress=function(b){b.lengthComputable&&(m[a].loaded=b.loaded,r.onProgress(a,d,b.loaded,b.total))};c.onreadystatechange=w(a,c);f=r.paramsStore.getParams(a);b=g(f,c,b,a);h(a,c);K("Sending upload request for "+a);c.send(b)}var r=a,y=b,K=c,m=[],B="|",u=r.chunking.enabled&&qq.supportedFeatures.chunking,v=r.resume.enabled&&u&&qq.supportedFeatures.resume,x;x=null===r.resume.id||void 0===r.resume.id||qq.isFunction(r.resume.id)||qq.isObject(r.resume.id)?void 0:
r.resume.id;var C=r.forceMultipart||r.paramsInBody,z;return z={add:function(a){if(a instanceof File)a=m.push({file:a})-1;else if(qq.isBlob(a.blob))a=m.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");m[a].uuid=qq.getUniqueId();return a},getName:function(a){if(z.isValid(a)){var b=m[a].file;a=m[a].blobData;return b?null!==b.fileName&&void 0!==b.fileName?b.fileName:b.name:a.name}K(a+" is not a valid item ID.","error")},getSize:function(a){a=m[a].file||
m[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(m[a])return m[a].file||m[a].blobData.blob},getLoaded:function(a){return m[a].loaded||0},isValid:function(a){return void 0!==m[a]},reset:function(){m=[]},getUuid:function(a){return m[a].uuid},upload:function(a,b){var d=this.getName(a);r.onUpload(a,d);if(u){var c=z.getName(a),d=0,g,h;if(!m[a].remainingChunkIdxs||0===m[a].remainingChunkIdxs.length){m[a].remainingChunkIdxs=[];if(v&&!b&&m[a].file){a:{g=
qq.getCookie(E(a));h=z.getName(a);var l,x,k;if(g){g=g.split(B);if(5===g.length){h=g[0];l=parseInt(g[1],10);x=parseInt(g[2],10);k=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:l,lastByteSent:x,initialRequestOverhead:k,estTotalRequestsSize:g};break a}K("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=f(a,g.part),!1!==r.onResume(a,c,q(h))&&(d=g.part,m[a].uuid=g.uuid,m[a].loaded=g.lastByteSent,m[a].estTotalRequestsSize=g.estTotalRequestsSize,
m[a].initialRequestOverhead=g.initialRequestOverhead,m[a].attemptingResume=!0,K("Resuming "+c+" at partition index "+d)))}for(c=e(a)-1;c>=d;--c)m[a].remainingChunkIdxs.unshift(c)}p(a)}else t(a)},cancel:function(a){var b=m[a].xhr;r.onCancel(a,this.getName(a));b&&(b.onreadystatechange=null,b.abort());v&&I(a);delete m[a]},getResumableFilesData:function(){var a=[],b=[];return u&&v?(a=void 0===x?qq.getCookieNames(RegExp("^qqfilechunk\\"+B+".+\\"+B+"\\d+\\"+B+r.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
B+".+\\"+B+"\\d+\\"+B+r.chunking.partSize+"\\"+B+x+"=")),qq.each(a,function(a,d){var c=d.split(B),f=qq.getCookie(d).split(B);b.push({name:decodeURIComponent(c[1]),size:c[2],uuid:f[0],partIdx:f[1]})}),b):[]}}};
(function(a){var b,c,d,f,e,g,h,l,p,n;g=["uploaderType"];d=function(a){a&&(a=l(a),h(a),"basic"===e("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return c};f=function(a,b){var d=c.data("fineuploader");if(b)void 0===d&&(d={}),d[a]=b,c.data("fineuploader",d);else return void 0===d?null:d[a]};b=function(a){return f("uploader",a)};e=function(a,b){return f(a,b)};h=function(b){var d=b.callbacks={};b=new qq.FineUploaderBasic;a.each(b._options.callbacks,function(a){var b,f;b=/^on(\w+)/.exec(a)[1];
b=b.substring(0,1).toLowerCase()+b.substring(1);f=c;d[a]=function(){var a=Array.prototype.slice.call(arguments);return f.triggerHandler(b,a)}})};l=function(b,d){var f,h;f=void 0===d?"basic"!==b.uploaderType?{element:c[0]}:{}:d;a.each(b,function(b,d){0<=a.inArray(b,g)?e(b,d):d instanceof a?f[b]=d[0]:a.isPlainObject(d)?(f[b]={},l(d,f[b])):a.isArray(d)?(h=[],a.each(d,function(b,d){d instanceof a?a.merge(h,d):h.push(d)}),f[b]=h):f[b]=d});if(void 0===d)return f};p=function(d){return"string"===a.type(d)&&
!d.match(/^_/)&&void 0!==b()[d]};n=function(a){var d=[],c=Array.prototype.slice.call(arguments,1);l(c,d);return b()[a].apply(b(),d)};a.fn.fineUploader=function(f){var e=this,g=arguments,h=[];this.each(function(l,t){c=a(t);if(b()&&p(f)){if(h.push(n.apply(e,g)),1===e.length)return!1}else"object"!==typeof f&&f?a.error("Method "+f+" does not exist on jQuery.fineUploader"):d.apply(e,g)});return 1===h.length?h[0]:1<h.length?h:this}})(jQuery);
...
"next"==b?"first":"last",n=this;if(!g.length){if(!this.options.wrap)return;g=this.$element.find(".item")[p]()}this.sliding=!0;h&&this.pause();p=a.Event("slide.bs.carousel",{relatedTarget:g[0],direction:l});if(!g.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var b=a(n.$indicators.children()[n.getActiveIndex()]);b&&b.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(p),
p.isDefaultPrevented())return;g.addClass(b);g[0].offsetWidth;e.addClass(l);g.addClass(l);e.one(a.support.transition.end,function(){g.removeClass([b,l].join(" ")).addClass("active");e.removeClass(["active",l].join(" "));n.sliding=!1;setTimeout(function(){n.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{if(this.$element.trigger(p),p.isDefaultPrevented())return;e.removeClass("active");g.addClass("active");this.sliding=!1;this.$element.trigger("slid")}return h&&this.cycle(),this}};var c=
...
c.appendTo(this.options.container):c.insertAfter(this.$element);var e=this.getPosition(),h=c[0].offsetWidth,l=c[0].offsetHeight;if(g){var p=this.$element.parent(),g=b,n=document.documentElement.scrollTop||document.body.scrollTop,q="body"==this.options.container?window.innerWidth:p.outerWidth(),w="body"==this.options.container?window.innerHeight:p.outerHeight(),p="body"==this.options.container?0:p.offset().left,b="bottom"==b&&e.top+e.height+l-n>w?"top":"top"==b&&0>e.top-n-l?"bottom":"right"==b&&e.right+
h>q?"left":"left"==b&&e.left-h<p?"right":b;c.removeClass(g).addClass(b)}c=this.getCalculatedOffset(b,e,h,l);this.applyPlacement(c,b);this.$element.trigger("shown.bs."+this.type)}};b.prototype.applyPlacement=function(a,b){var c,g=this.tip(),h=g[0].offsetWidth,l=g[0].offsetHeight,p=parseInt(g.css("margin-top"),10),n=parseInt(g.css("margin-left"),10);isNaN(p)&&(p=0);isNaN(n)&&(n=0);a.top+=p;a.left+=n;g.offset(a).addClass("in");p=g[0].offsetWidth;n=g[0].offsetHeight;("top"==b&&n!=l&&(c=!0,a.top=a.top+
l-n),/bottom|top/.test(b))?(l=0,0>a.left&&(l=-2*a.left,a.left=0,g.offset(a),p=g[0].offsetWidth),this.replaceArrow(l-h+p,p,"left")):this.replaceArrow(n-l,n,"top");c&&g.offset(a)};b.prototype.replaceArrow=function(a,b,c){this.arrow().css(c,a?50*(1-a/b)+"%":"")};b.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};b.prototype.hide=function(){function b(){"in"!=c.hoverState&&e.detach()}
...
(function(a,b,c){function d(c,d,e){c=b.createElement(c);return d&&(c.id=H+d),e&&(c.style.cssText=e),a(c)}function f(){return c.innerHeight?c.innerHeight:a(c).height()}function e(a){var b=v.length;a=(L+a)%b;return 0>a?b+a:a}function g(a,b){return Math.round((/%/.test(a)?("x"===b?x.width():f())/100:1)*parseInt(a,10))}function h(a,b){return a.retinaUrl&&1<c.devicePixelRatio?b.replace(a.photoRegex,a.retinaSuffix):b}function l(a){"contains"in t[0]&&!t[0].contains(a.target)&&(a.stopPropagation(),t.focus())}
function p(){var b,c=a.data(M,Q);null==c?(k=a.extend({},ha),console&&console.log&&console.log("Error: cboxElement missing settings object")):k=a.extend({},c);for(b in k)a.isFunction(k[b])&&"on"!==b.slice(0,2)&&(k[b]=k[b].call(M));k.rel=k.rel||M.rel||a(M).data("rel")||"nofollow";k.href=k.href||a(M).attr("href");k.title=k.title||M.title;"string"==typeof k.href&&(k.href=a.trim(k.href))}function n(c,d){a(b).trigger(c);P.triggerHandler(c);a.isFunction(d)&&d.call(M)}function q(c){aa||(M=c,p(),v=a(M),L=
0,"nofollow"!==k.rel&&(v=a("."+X).filter(function(){var b,c=a.data(this,Q);return c&&(b=a(this).data("rel")||c.rel||this.rel),b===k.rel}),L=v.index(M),-1===L&&(v=v.add(M),L=v.length-1)),E.css({opacity:parseFloat(k.opacity),cursor:k.overlayClose?"pointer":"auto",visibility:"visible"}).show(),ia&&t.add(E).removeClass(ia),k.className&&t.add(E).addClass(k.className),ia=k.className,k.closeButton?U.html(k.close).appendTo(y):U.appendTo("<div/>"),R||(R=ba=!0,t.css({visibility:"hidden",display:"block"}),C=
d(F,"LoadedContent","width:0; height:0; overflow:hidden"),y.css({width:"",height:""}).append(C),J=K.height()+u.height()+y.outerHeight(!0)-y.height(),N=m.width()+B.width()+y.outerWidth(!0)-y.width(),S=C.outerHeight(!0),T=C.outerWidth(!0),k.w=g(k.initialWidth,"x"),k.h=g(k.initialHeight,"y"),C.css({width:"",height:k.h}),G.position(),n(pa,k.onOpen),O.add(fa).hide(),t.focus(),k.trapFocus&&b.addEventListener&&(b.addEventListener("focus",l,!0),P.one(ja,function(){b.removeEventListener("focus",l,!0)})),k.returnFocus&&
P.one(ja,function(){a(M).focus()})),I())}function w(){!t&&b.body&&(ka=!1,x=a(c),t=d(F).attr({id:Q,"class":!1===a.support.opacity?H+"IE":"",role:"dialog",tabindex:"-1"}).hide(),E=d(F,"Overlay").hide(),V=a([d(F,"LoadingOverlay")[0],d(F,"LoadingGraphic")[0]]),r=d(F,"Wrapper"),y=d(F,"Content").append(fa=d(F,"Title"),ga=d(F,"Current"),Z=a('<button type="button"/>').attr({id:H+"Previous"}),Y=a('<button type="button"/>').attr({id:H+"Next"}),W=d("button","Slideshow"),V),U=a('<button type="button"/>').attr({id:H+
"Close"}),r.append(d(F).append(d(F,"TopLeft"),K=d(F,"TopCenter"),d(F,"TopRight")),d(F,!1,"clear:left").append(m=d(F,"MiddleLeft"),y,B=d(F,"MiddleRight")),d(F,!1,"clear:left").append(d(F,"BottomLeft"),u=d(F,"BottomCenter"),d(F,"BottomRight"))).find("div div").css({"float":"left"}),z=d(F,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=Y.add(Z).add(ga).add(W),a(b.body).append(E,t.append(r,z)))}function A(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),q(this))}return t?(ka||(ka=!0,Y.click(function(){G.next()}),Z.click(function(){G.prev()}),U.click(function(){G.close()}),E.click(function(){k.overlayClose&&G.close()}),a(b).bind("keydown."+H,function(a){var b=a.keyCode;R&&k.escKey&&27===b&&(a.preventDefault(),G.close());R&&k.arrowKey&&v[1]&&!a.altKey&&(37===b?(a.preventDefault(),Z.click()):39===b&&(a.preventDefault(),Y.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+H,"."+X,c):a("."+X).live("click."+H,c)),!0):!1}
function I(){var e,f,u,x=G.prep,l=++la;ba=!0;D=!1;M=v[L];p();n(ca);n(da,k.onLoad);k.h=k.height?g(k.height,"y")-S-J:k.innerHeight&&g(k.innerHeight,"y");k.w=k.width?g(k.width,"x")-T-N:k.innerWidth&&g(k.innerWidth,"x");k.mw=k.w;k.mh=k.h;k.maxWidth&&(k.mw=g(k.maxWidth,"x")-T-N,k.mw=k.w&&k.w<k.mw?k.w:k.mw);k.maxHeight&&(k.mh=g(k.maxHeight,"y")-S-J,k.mh=k.h&&k.h<k.mh?k.h:k.mh);e=k.href;na=setTimeout(function(){V.show()},100);k.inline?(u=d(F).hide().insertBefore(a(e)[0]),P.one(ca,function(){u.replaceWith(C.children())}),
x(a(e))):k.iframe?x(" "):k.html?x(k.html):k.photo||k.photoRegex.test(e)?(e=h(k,e),D=b.createElement("img"),a(D).addClass(H+"Photo").bind("error",function(){k.title=!1;x(d(F,"Error").html(k.imgError))}).one("load",function(){var b;l===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(M).attr(c)||a(M).attr("data-"+c);d&&D.setAttribute(c,d)}),k.retinaImage&&1<c.devicePixelRatio&&(D.height/=c.devicePixelRatio,D.width/=c.devicePixelRatio),k.scalePhotos&&(f=function(){D.height-=D.height*
b;D.width-=D.width*b},k.mw&&D.width>k.mw&&(b=(D.width-k.mw)/D.width,f()),k.mh&&D.height>k.mh&&(b=(D.height-k.mh)/D.height,f())),k.h&&(D.style.marginTop=Math.max(k.mh-D.height,0)/2+"px"),v[1]&&(k.loop||v[L+1])&&(D.style.cursor="pointer",D.onclick=function(){G.next()}),D.style.width=D.width+"px",D.style.height=D.height+"px",setTimeout(function(){x(D)},1))}),setTimeout(function(){D.src=e},1)):e&&z.load(e,k.data,function(b,c){l===la&&x("error"===c?d(F,"Error").html(k.xhrError):a(this).contents())})}var E,
t,r,y,K,m,B,u,v,x,C,z,V,fa,ga,W,Y,Z,U,O,k,J,N,S,T,M,L,D,R,ba,aa,na,G,ia,ka,ha={html:!1,photo:!1,iframe:!1,inline:!1,transition:"elastic",speed:300,fadeOut:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,href:!1,title:!1,rel:!1,opacity:.9,preloading:!0,className:!1,overlayClose:!0,escKey:!0,arrowKey:!0,top:!1,bottom:!1,left:!1,right:!1,fixed:!1,data:void 0,closeButton:!0,fastIframe:!0,open:!1,reposition:!0,
...
X=H+"Element",pa=H+"_open",da=H+"_load",ea=H+"_complete",ma=H+"_cleanup",ja=H+"_closed",ca=H+"_purge",P=a("<a/>"),F="div",la=0,oa={},qa=function(){function a(){clearTimeout(u)}function b(){(k.loop||v[L+1])&&(a(),u=setTimeout(G.next,k.slideshowSpeed))}function c(){W.html(k.slideshowStop).unbind(h).one(h,d);P.bind(ea,b).bind(da,a);t.removeClass(g+"off").addClass(g+"on")}function d(){a();P.unbind(ea,b).unbind(da,a);W.html(k.slideshowStart).unbind(h).one(h,function(){G.next();c()});t.removeClass(g+"on").addClass(g+
"off")}function e(){f=!1;W.hide();a();P.unbind(ea,b).unbind(da,a);t.removeClass(g+"off "+g+"on")}var f,u,g=H+"Slideshow_",h="click."+H;return function(){f?k.slideshow||(P.unbind(ma,e),e()):k.slideshow&&v[1]&&(f=!0,P.one(ma,e),k.slideshowAuto?c():d(),W.show())}}();a.colorbox||(a(w),G=a.fn[Q]=a[Q]=function(b,c){var d=this;if(b=b||{},w(),A()){if(a.isFunction(d))d=a("<a/>"),b.open=!0;else if(!d[0])return d;c&&(b.onComplete=c);d.each(function(){a.data(this,Q,a.extend({},a.data(this,Q)||ha,b))}).addClass(X);
(a.isFunction(b.open)&&b.open.call(d)||b.open)&&q(d[0])}return d},G.position=function(b,c){function d(){K[0].style.width=u[0].style.width=y[0].style.width=parseInt(t[0].style.width,10)-N+"px";y[0].style.height=m[0].style.height=B[0].style.height=parseInt(t[0].style.height,10)-J+"px"}var e,h,v,C=0,l=0,z=t.offset();if(x.unbind("resize."+H),t.css({top:-9E4,left:-9E4}),h=x.scrollTop(),v=x.scrollLeft(),k.fixed?(z.top-=h,z.left-=v,t.css({position:"fixed"})):(C=h,l=v,t.css({position:"absolute"})),l+=!1!==
k.right?Math.max(x.width()-k.w-T-N-g(k.right,"x"),0):!1!==k.left?g(k.left,"x"):Math.round(Math.max(x.width()-k.w-T-N,0)/2),C+=!1!==k.bottom?Math.max(f()-k.h-S-J-g(k.bottom,"y"),0):!1!==k.top?g(k.top,"y"):Math.round(Math.max(f()-k.h-S-J,0)/2),t.css({top:z.top,left:z.left,visibility:"visible"}),r[0].style.width=r[0].style.height="9999px",e={width:k.w+T+N,height:k.h+S+J,top:C,left:l},b){var n=0;a.each(e,function(a){return e[a]!==oa[a]?(n=b,void 0):void 0});b=n}oa=e;b||t.css(e);t.dequeue().animate(e,
{duration:b||0,complete:function(){d();ba=!1;r[0].style.width=k.w+T+N+"px";r[0].style.height=k.h+S+J+"px";k.reposition&&setTimeout(function(){x.bind("resize."+H,G.position)},1);c&&c()},step:d})},G.resize=function(a){var b;R&&(a=a||{},a.width&&(k.w=g(a.width,"x")-T-N),a.innerWidth&&(k.w=g(a.innerWidth,"x")),C.css({width:k.w}),a.height&&(k.h=g(a.height,"y")-S-J),a.innerHeight&&(k.h=g(a.innerHeight,"y")),a.innerHeight||a.height||(b=C.scrollTop(),C.css({height:"auto"}),k.h=C.height()),C.css({height:k.h}),
b&&C.scrollTop(b),G.position("none"===k.transition?0:k.speed))},G.prep=function(c){if(R){var f,g="none"===k.transition?0:k.speed;C.empty().remove();C=d(F,"LoadedContent").append(c);C.hide().appendTo(z.show()).css({width:(k.w=k.w||C.width(),k.w=k.mw&&k.mw<k.w?k.mw:k.w,k.w),overflow:k.scrolling?"auto":"hidden"}).css({height:(k.h=k.h||C.height(),k.h=k.mh&&k.mh<k.h?k.mh:k.h,k.h)}).prependTo(y);z.hide();a(D).css({"float":"none"});f=function(){function c(){!1===a.support.opacity&&t[0].style.removeAttribute("filter")}
var f,u,x=v.length;R&&(u=function(){clearTimeout(na);V.hide();n(ea,k.onComplete)},fa.html(k.title).add(C).show(),1<x?("string"==typeof k.current&&ga.html(k.current.replace("{current}",L+1).replace("{total}",x)).show(),Y[k.loop||x-1>L?"show":"hide"]().html(k.next),Z[k.loop||L?"show":"hide"]().html(k.previous),qa(),k.preloading&&a.each([e(-1),e(1)],function(){var c,d,e=v[this],f=a.data(e,Q);f&&f.href?(c=f.href,a.isFunction(c)&&(c=c.call(e))):c=a(e).attr("href");c&&(f.photo||f.photoRegex.test(c))&&(c=
h(f,c),d=b.createElement("img"),d.src=c)})):O.hide(),k.iframe?(f=d("iframe")[0],"frameBorder"in f&&(f.frameBorder=0),"allowTransparency"in f&&(f.allowTransparency="true"),k.scrolling||(f.scrolling="no"),a(f).attr({src:k.href,name:(new Date).getTime(),"class":H+"Iframe",allowFullScreen:!0,webkitAllowFullScreen:!0,mozallowfullscreen:!0}).one("load",u).appendTo(C),P.one(ca,function(){f.src="//about:blank"}),k.fastIframe&&a(f).trigger("load")):u(),"fade"===k.transition?t.fadeTo(g,1,c):c())};"fade"===
k.transition?t.fadeTo(g,0,function(){G.position(0,f)}):G.position(g,f)}},G.next=function(){!ba&&v[1]&&(k.loop||v[L+1])&&(L=e(1),q(v[L]))},G.prev=function(){!ba&&v[1]&&(k.loop||L)&&(L=e(-1),q(v[L]))},G.close=function(){R&&!aa&&(aa=!0,R=!1,n(ma,k.onCleanup),x.unbind("."+H),E.fadeTo(k.fadeOut||0,0),t.stop().fadeTo(k.fadeOut||0,0,function(){t.add(E).css({opacity:1,cursor:"auto"}).hide();n(ca);C.empty().remove();setTimeout(function(){aa=!1;n(ja,k.onClosed)},1)}))},G.remove=function(){t&&(t.stop(),a.colorbox.close(),
t.stop().remove(),E.remove(),aa=!1,t=null,a("."+X).removeData(Q).removeClass(X),a(b).unbind("click."+H))},G.element=function(){return a(M)},G.settings=ha)})(jQuery,document,window);var bkExtend=function(){var a=arguments;1==a.length&&(a=[this,a[0]]);for(var b in a[1])a[0][b]=a[1][b];return a[0]};function bkClass(){}bkClass.prototype.construct=function(){};
...
g=a.nodeName.toLowerCase(),h=a.hasChildNodes&&a.hasChildNodes(),l=[];switch(e){case 1:var p=a.attributes;switch(g){case "b":g="strong";break;case "i":g="em";break;case "font":g="span"}if(b){for(e=0;e<p.length;e++){var n=p[e],q=n.nodeName.toLowerCase(),w=n.nodeValue;if(n.specified&&w&&!bkLib.inArray(this.stripAttributes,q)&&"function"!=typeof w){switch(q){case "style":n=w.replace(/ /g,"");for(itm in this.cssReplace)-1!=n.indexOf(itm)&&(l.push(this.cssReplace[itm]),n=n.replace(itm,""));f+=n;w="";break;
case "class":w=w.replace("Apple-style-span","");break;case "size":f+="font-size:"+this.sizes[w]+";",w=""}w&&(d+=" "+q+'="'+w+'"')}}f&&(d+=' style="'+f+'"');for(e=0;e<l.length;e++)c+="<"+l[e]+">";""==d&&"span"==g&&(b=!1);b&&(c+="<"+g,"br"!=g&&(c+=d))}if(h||bkLib.inArray(this.noShort,q))for(b&&(c+=">"),e=0;e<a.childNodes.length;e++)(q=this.toXHTML(a.childNodes[e],!0,!0))&&(c+=q);else b&&(c+=" />");b&&h&&(c+="</"+g+">");for(e=0;e<l.length;e++)c+="</"+l[e]+">";break;case 3:c+=a.nodeValue}return c}});
...
(function(a){"object"===typeof exports&&exports&&"object"===typeof module&&module&&module.exports===exports?a(require("jquery")):"function"===typeof define&&define.amd?define(["jquery"],a):a(jQuery)})(function(a){function b(a){a=a[0];return 0<a.offsetWidth&&0<a.offsetHeight}function c(b){b.minTime&&(b.minTime=y(b.minTime));b.maxTime&&(b.maxTime=y(b.maxTime));b.durationTime&&"function"!==typeof b.durationTime&&(b.durationTime=y(b.durationTime));if("now"==b.scrollDefault)b.scrollDefault=function(){return b.roundingFunction(y(new Date),
b)};else if(b.scrollDefault&&"function"!=typeof b.scrollDefault){var c=b.scrollDefault;b.scrollDefault=function(){return b.roundingFunction(y(c),b)}}else b.minTime&&(b.scrollDefault=function(){return b.roundingFunction(b.minTime,b)});"string"===a.type(b.timeFormat)&&b.timeFormat.match(/[gh]/)&&(b._twelveHourTime=!0);!1===b.showOnFocus&&"focus"==b.showOn&&(b.showOn=null);if(0<b.disableTimeRanges.length){for(var d in b.disableTimeRanges)b.disableTimeRanges[d]=[y(b.disableTimeRanges[d][0]),y(b.disableTimeRanges[d][1])];
...
g.addClass(c.className);null===c.minTime&&null===c.durationTime||!c.showDuration||(g.addClass("ui-timepicker-with-duration"),g.addClass("ui-timepicker-step-"+c.step));m=c.minTime;"function"===typeof c.durationTime?m=y(c.durationTime()):null!==c.durationTime&&(m=c.durationTime);l=null!==c.minTime?c.minTime:0;var n=null!==c.maxTime?c.maxTime:l+86400-1;n<l&&(n+=86400);86399===n&&"string"===a.type(c.timeFormat)&&c.show2400&&(n=86400);var q=c.disableTimeRanges,A=0,K=q.length,I=c.step;"function"!=typeof I&&
(I=function(){return c.step});for(var U=0;l<=n;U++,l+=60*I(U)){var O=l,k=r(O,c);if(c.useSelect)var J=a("<option />",{value:k});else J=a("<li />"),J.data("time",86400>=O?O:O%86400);J.text(k);if((null!==c.minTime||null!==c.durationTime)&&c.showDuration)if(k=t(l-m,c.step),c.useSelect)J.text(J.text()+" ("+k+")");else{var N=a("<span />",{"class":"ui-timepicker-duration"});N.text(" ("+k+")");J.append(N)}A<K&&(O>=q[A][1]&&(A+=1),q[A]&&O>=q[A][0]&&O<q[A][1]&&(c.useSelect?J.prop("disabled",!0):J.addClass("ui-timepicker-disabled")));
d.append(J)}g.data("timepicker-input",b);b.data("timepicker-list",g);c.useSelect?(b.val()&&d.val(e(y(b.val()),c)),d.on("focus",function(){a(this).data("timepicker-input").trigger("showTimepicker")}),d.on("blur",function(){a(this).data("timepicker-input").trigger("hideTimepicker")}),d.on("change",function(){w(b,a(this).val(),"select")}),w(b,d.val(),"initial"),b.hide().after(d)):(l=c.appendTo,"string"===typeof l?l=a(l):"function"===typeof l&&(l=l(b)),l.append(g),p(b,d),d.on("mousedown","li",function(c){b.off("focus.timepicker");
b.on("focus.timepicker-ie-hack",function(){b.off("focus.timepicker-ie-hack");b.on("focus.timepicker",B.show)});h(b)||b[0].focus();d.find("li").removeClass("ui-timepicker-selected");a(this).addClass("ui-timepicker-selected");E(b)&&(b.trigger("hideTimepicker"),d.on("mouseup.timepicker","li",function(a){d.off("mouseup.timepicker");g.hide()}))}))}function f(b,c){var d,e,f;"object"==typeof b?(d=b.label,e=b.className,f=b.value):"string"==typeof b?d=b:a.error("Invalid noneOption value");return c?a("<option />",
{value:f,"class":e,text:d}):a("<li />",{"class":e,text:d}).data("time",f)}function e(a,b){a=b.roundingFunction(a,b);if(null!==a)return r(a,b)}function g(b){b=a(b.target);0===b.closest(".ui-timepicker-input").length&&0===b.closest(".ui-timepicker-wrapper").length&&(B.hide(),a(document).unbind(".ui-timepicker"),a(window).unbind(".ui-timepicker"))}function h(a){a=a.data("timepicker-settings");return(window.navigator.msMaxTouchPoints||"ontouchstart"in document)&&a.disableTouchKeyboard}function l(b,c,
d){if(!d&&0!==d)return!1;b=b.data("timepicker-settings");var e=!1;d=b.roundingFunction(d,b);c.find("li").each(function(b,c){var f=a(c);if("number"==typeof f.data("time")&&f.data("time")==d)return e=f,!1});return e}function p(a,b){b.find("li").removeClass("ui-timepicker-selected");var c=y(q(a),a.data("timepicker-settings"));if(null!==c&&(c=l(a,b,c))){var d=c.offset().top-b.offset().top;(d+c.outerHeight()>b.outerHeight()||0>d)&&b.scrollTop(b.scrollTop()+c.position().top-c.outerHeight());c.addClass("ui-timepicker-selected")}}
function n(b,c){if(""!==this.value&&"timepicker"!=c){var d=a(this);if(!d.is(":focus")||b&&"change"==b.type){var e=d.data("timepicker-settings"),f=y(this.value,e);if(null===f)d.trigger("timeFormatError");else{var g=!1;null!==e.minTime&&f<e.minTime?g=!0:null!==e.maxTime&&f>e.maxTime&&(g=!0);a.each(e.disableTimeRanges,function(){if(f>=this[0]&&f<this[1])return g=!0,!1});e.forceRoundTime&&(f=e.roundingFunction(f,e));e=r(f,e);g?w(d,e,"error")&&d.trigger("timeRangeError"):w(d,e)}}}}function q(a){return a.is("input")?
a.val():a.data("ui-timepicker-value")}function w(a,b,c){if(a.is("input")){a.val(b);var d=a.data("timepicker-settings");d.useSelect&&"select"!=c&&"initial"!=c&&a.data("timepicker-list").val(e(y(b),d))}if(a.data("ui-timepicker-value")!=b)return a.data("ui-timepicker-value",b),"select"==c?a.trigger("selectTime").trigger("changeTime").trigger("change","timepicker"):"error"!=c&&a.trigger("changeTime"),!0;a.trigger("selectTime");return!1}function A(c){var d=a(this),e=d.data("timepicker-list");if(!e||!b(e))if(40==
c.keyCode)B.show.call(d.get(0)),e=d.data("timepicker-list"),h(d)||d.focus();else return!0;switch(c.keyCode){case 13:return E(d)&&B.hide.apply(this),c.preventDefault(),!1;case 38:var f=e.find(".ui-timepicker-selected");f.length?f.is(":first-child")||(f.removeClass("ui-timepicker-selected"),f.prev().addClass("ui-timepicker-selected"),f.prev().position().top<f.outerHeight()&&e.scrollTop(e.scrollTop()-f.outerHeight())):(e.find("li").each(function(b,c){if(0<a(c).position().top)return f=a(c),!1}),f.addClass("ui-timepicker-selected"));
return!1;case 40:return f=e.find(".ui-timepicker-selected"),0===f.length?(e.find("li").each(function(b,c){if(0<a(c).position().top)return f=a(c),!1}),f.addClass("ui-timepicker-selected")):f.is(":last-child")||(f.removeClass("ui-timepicker-selected"),f.next().addClass("ui-timepicker-selected"),f.next().position().top+2*f.outerHeight()>e.outerHeight()&&e.scrollTop(e.scrollTop()+f.outerHeight())),!1;case 27:e.find("li").removeClass("ui-timepicker-selected");B.hide();break;case 9:B.hide();break;default:return!0}}
function I(c){var d=a(this),e=d.data("timepicker-list"),f=d.data("timepicker-settings");if(!e||!b(e)||f.disableTextInput)return!0;switch(c.keyCode){case 96:case 97:case 98:case 99:case 100:case 101:case 102:case 103:case 104:case 105:case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:case 65:case 77:case 80:case 186:case 8:case 46:f.typeaheadHighlight?p(d,e):e.hide()}}function E(a){var b=a.data("timepicker-settings"),c=null,d=a.data("timepicker-list").find(".ui-timepicker-selected");
if(d.hasClass("ui-timepicker-disabled"))return!1;d.length&&(c=d.data("time"));null!==c&&("string"!=typeof c&&(c=r(c,b)),w(a,c,"select"));return!0}function t(a,b){a=Math.abs(a);var c=Math.round(a/60),d=[],e;60>c?d=[c,m.mins]:(e=Math.floor(c/60),c%=60,30==b&&30==c&&(e+=m.decimal+5),d.push(e),d.push(1==e?m.hr:m.hrs),30!=b&&c&&(d.push(c),d.push(m.mins)));return d.join(" ")}function r(b,c){if(null===b)return null;var d=new Date(K.valueOf()+1E3*b);if(isNaN(d.getTime()))return null;if("function"===a.type(c.timeFormat))return c.timeFormat(d);
for(var e="",f,g=0;g<c.timeFormat.length;g++)switch(f=c.timeFormat.charAt(g),f){case "a":e+=11<d.getHours()?m.pm:m.am;break;case "A":e+=11<d.getHours()?m.PM:m.AM;break;case "g":f=d.getHours()%12;e+=0===f?"12":f;break;case "G":f=d.getHours();86400===b&&(f=24);e+=f;break;case "h":f=d.getHours()%12;0!==f&&10>f&&(f="0"+f);e+=0===f?"12":f;break;case "H":f=d.getHours();86400===b&&(f=24);e+=9<f?f:"0"+f;break;case "i":f=d.getMinutes();e+=9<f?f:"0"+f;break;case "s":b=d.getSeconds();e+=9<b?b:"0"+b;break;case "\\":g++;
e+=c.timeFormat.charAt(g);break;default:e+=f}return e}function y(a,b){if(""===a)return null;if(!a||a+0==a)return a;if("object"==typeof a)return 3600*a.getHours()+60*a.getMinutes()+a.getSeconds();a=a.toLowerCase().replace(/[\s\.]/g,"");if("a"==a.slice(-1)||"p"==a.slice(-1))a+="m";var c="("+m.am.replace(".","")+"|"+m.pm.replace(".","")+"|"+m.AM.replace(".","")+"|"+m.PM.replace(".","")+")?",d=a.match(new RegExp("^"+c+"([0-2]?[0-9])\\W?([0-5][0-9])?\\W?([0-5][0-9])?"+c+"$"));if(!d)return null;var e=parseInt(1*
d[2],10),c=d[1]||d[5],f=e;12>=e&&c&&(f=c==m.pm||c==m.PM,f=12==e?f?12:0:e+(f?12:0));d=3600*f+60*(1*d[3]||0)+(1*d[4]||0);!c&&b&&b._twelveHourTime&&b.scrollDefault&&(c=d-b.scrollDefault(),0>c&&-43200<=c&&(d=(d+43200)%86400));return d}var K=new Date(1970,1,1,0,0,0),m={am:"am",pm:"pm",AM:"AM",PM:"PM",decimal:".",mins:"mins",hr:"hr",hrs:"hrs"},B={init:function(b){return this.each(function(){var e=a(this),f=[],g;for(g in a.fn.timepicker.defaults)e.data(g)&&(f[g]=e.data(g));f=a.extend({},a.fn.timepicker.defaults,
f,b);f.lang&&(m=a.extend(m,f.lang));f=c(f);e.data("timepicker-settings",f);e.addClass("ui-timepicker-input");if(f.useSelect)d(e);else{e.prop("autocomplete","off");e.on("click.timepicker focus.timepicker",B.show);e.on("change.timepicker",n);e.on("keydown.timepicker",A);e.on("keyup.timepicker",I);if(f.disableTextInput)e.on("keypress.timepicker",function(a){a.preventDefault()});n.call(e.get(0))}})},show:function(c){var e=a(this),f=e.data("timepicker-settings");if(c){if(f.showOn!==c.type)return!0;c.preventDefault()}if(f.useSelect)e.data("timepicker-list").focus();
else if(h(e)&&e.blur(),c=e.data("timepicker-list"),!e.prop("readonly")&&(c&&0!==c.length&&"function"!==typeof f.durationTime||(d(e),c=e.data("timepicker-list")),!b(c))){e.data("ui-timepicker-value",e.val());p(e,c);B.hide();c.show();var m={};f.orientation.match(/r/)?m.left=e.offset().left+e.outerWidth()-c.outerWidth()+parseInt(c.css("marginLeft").replace("px",""),10):m.left=e.offset().left+parseInt(c.css("marginLeft").replace("px",""),10);"t"==(f.orientation.match(/t/)?"t":f.orientation.match(/b/)?
"b":e.offset().top+e.outerHeight(!0)+c.outerHeight()>a(window).height()+a(window).scrollTop()?"t":"b")?(c.addClass("ui-timepicker-positioned-top"),m.top=e.offset().top-c.outerHeight()+parseInt(c.css("marginTop").replace("px",""),10)):(c.removeClass("ui-timepicker-positioned-top"),m.top=e.offset().top+e.outerHeight()+parseInt(c.css("marginTop").replace("px",""),10));c.offset(m);m=c.find(".ui-timepicker-selected");m.length||(q(e)?m=l(e,c,y(q(e))):f.scrollDefault&&(m=l(e,c,f.scrollDefault())));m&&m.length?
...
a(this);var d=c.data("timepicker-settings");d&&d.useSelect&&c.blur();a(".ui-timepicker-wrapper").each(function(){var c=a(this);if(b(c)){var d=c.data("timepicker-input"),e=d.data("timepicker-settings");e&&e.selectOnBlur&&E(d);c.hide();d.trigger("hideTimepicker")}});return this},option:function(b,e){return this.each(function(){var f=a(this),g=f.data("timepicker-settings"),h=f.data("timepicker-list");if("object"==typeof b)g=a.extend(g,b);else if("string"==typeof b&&"undefined"!=typeof e)g[b]=e;else if("string"==
typeof b)return g[b];g=c(g);f.data("timepicker-settings",g);h&&(h.remove(),f.data("timepicker-list",!1));g.useSelect&&d(f)})},getSecondsFromMidnight:function(){return y(q(this))},getTime:function(a){var b=q(this);if(!b)return null;b=y(b);if(null===b)return null;a||(a=new Date);a=new Date(a);a.setHours(b/3600);a.setMinutes(b%3600/60);a.setSeconds(b%60);a.setMilliseconds(0);return a},setTime:function(a){var b=this.data("timepicker-settings"),c=b.forceRoundTime?e(y(a),b):r(y(a),b);a&&null===c&&b.noneOption&&
(c=a);w(this,c);this.data("timepicker-list")&&p(this,this.data("timepicker-list"));return this},remove:function(){if(this.hasClass("ui-timepicker-input")){var a=this.data("timepicker-settings");this.removeAttr("autocomplete","off");this.removeClass("ui-timepicker-input");this.removeData("timepicker-settings");this.off(".timepicker");this.data("timepicker-list")&&this.data("timepicker-list").remove();a.useSelect&&this.show();this.removeData("timepicker-list");return this}}};a.fn.timepicker=function(b){if(!this.length)return this;
if(B[b])return this.hasClass("ui-timepicker-input")?B[b].apply(this,Array.prototype.slice.call(arguments,1)):this;if("object"!==typeof b&&b)a.error("Method "+b+" does not exist on jQuery.timepicker");else return B.init.apply(this,arguments)};a.fn.timepicker.defaults={className:null,minTime:null,maxTime:null,durationTime:null,step:30,showDuration:!1,showOnFocus:!0,showOn:"focus",timeFormat:"g:ia",scrollDefault:null,selectOnBlur:!1,disableTextInput:!1,disableTouchKeyboard:!1,forceRoundTime:!1,roundingFunction:function(a,
