...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};q=a.navigator.userAgent;var x=a.navigator;f(d,{hasToken:"#ath"==b.location.hash||l.test(b.location.href)||p.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(q),isMobileChrome:-1<q.indexOf("Android")&&/Chrome\/[.0-9]*/.test(q)&&-1==q.indexOf("Version"),isMobileIE:-1<q.indexOf("Windows Phone"),language:x.language&&
x.language.toLowerCase().replace("-","_")||""});d.language=d.language&&d.language in d.intl?d.language:"en_us";d.isMobileSafari=d.isIDevice&&-1<q.indexOf("Safari")&&0>q.indexOf("CriOS");d.OS=d.isIDevice?"ios":d.isMobileChrome?"android":d.isMobileIE?"windows":"unsupported";d.OSVersion=q.match(/(OS|Android) (\d+[_\.]\d+)/);d.OSVersion=d.OSVersion&&d.OSVersion[2]?+d.OSVersion[2].replace("_","."):0;d.isStandalone="standalone"in a.navigator&&a.navigator.standalone;d.isTablet=d.isMobileSafari&&-1<q.indexOf("iPad")||
...
for(var p=this.options.validLocation.length;p--;)if(this.options.validLocation[p].test(b.location.href)){c=!0;break}this.getItem("addToHome")&&this.optOut();if(this.session.optedout)this.doLog("Add to homescreen: not displaying callout because user opted out");else if(this.session.added)this.doLog("Add to homescreen: not displaying callout because already added to the homescreen");else if(c)if(d.isStandalone)this.session.added||(this.session.added=!0,this.updateSession(),this.options.onAdd&&d.hasLocalStorage&&
...
(function(a,b){"object"==typeof exports?module.exports=b():"function"==typeof define&&define.amd?define(b):a.Spinner=b()})(this,function(){function a(a,b){var d,c=document.createElement(a||"div");for(d in b)c[d]=b[d];return c}function b(a){for(var b=1,d=arguments.length;d>b;b++)a.appendChild(arguments[b]);return a}function c(a,b,d,c){var f=["opacity",b,~~(100*a),d,c].join("-");d=.01+d/c*100;c=Math.max(1-(1-a)/b*(100-d),a);var e=p.substring(0,p.indexOf("Animation")).toLowerCase();return q[f]||(x.insertRule("@"+
(e&&"-"+e+"-"||"")+"keyframes "+f+"{0%{opacity:"+c+"}"+d+"%{opacity:"+a+"}"+(d+.01)+"%{opacity:1}"+(d+b)%100+"%{opacity:"+a+"}100%{opacity:"+c+"}}",x.cssRules.length),q[f]=1),f}function d(a,b){var d,c,f=a.style;b=b.charAt(0).toUpperCase()+b.slice(1);for(c=0;n.length>c;c++)if(d=n[c]+b,void 0!==f[d])return d;return void 0!==f[b]?b:void 0}function f(a,b){for(var c in b)a.style[d(a,c)||c]=b[c];return a}function e(a){for(var b=1;arguments.length>b;b++){var d=arguments[b],c;for(c in d)void 0===a[c]&&(a[c]=
d[c])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=e(a||{},h.defaults,A)}function l(){function d(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}x.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,c){function e(){return f(d("group",{coordsize:u+" "+u,coordorigin:-l+" "+-l}),{width:u,height:u})}function p(a,u,h){b(w,b(f(e(),{rotation:360/c.lines*a+"deg",left:~~u}),b(f(d("roundrect",{arcsize:c.corners}),
{width:l,height:c.width,left:c.radius,top:-c.width>>1,filter:h}),d("fill",{color:g(c.color,a),opacity:c.opacity}),d("stroke",{opacity:0}))))}var h,l=c.length+c.width,u=2*l;h=2*-(c.width+c.length)+"px";var w=f(e(),{position:"absolute",top:h,left:h});if(c.shadow)for(h=1;c.lines>=h;h++)p(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;c.lines>=h;h++)p(h);return b(a,w)};h.prototype.opacity=function(a,b,d,c){a=a.firstChild;c=c.shadow&&c.lines||0;a&&a.childNodes.length>
b+c&&(a=a.childNodes[b+c],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=d))}}var p,n=["webkit","Moz","ms","O"],q={},x=function(){var d=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],d),d.sheet||d.styleSheet}(),A={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};e(h.prototype,{spin:function(b){this.stop();var d=
this,c=d.opts,e=d.el=f(a(0,{className:c.className}),{position:c.position,width:0,zIndex:c.zIndex});if(c.radius+c.length+c.width,f(e,{left:c.left,top:c.top}),b&&b.insertBefore(e,b.firstChild||null),e.setAttribute("role","progressbar"),d.lines(e,d.opts),!p){var g,h=0,l=(c.lines-1)*(1-c.direction)/2,u=c.fps,w=u/c.speed,v=(1-c.opacity)/(w*c.trail/100),C=w/c.lines;(function V(){h++;for(var a=0;c.lines>a;a++)g=Math.max(1-(h+(c.lines-a)*C)%w*v,c.opacity),d.opacity(e,a*c.direction+l,g,c);d.timeout=d.el&&
...
qq.UploadHandlerForm=function(a,b,c){function d(a){void 0!==q[a]&&(q[a](),delete q[a])}function f(a,b){var c=a.id;E[n[c]]=b;q[c]=qq(a).attach("load",function(){p[c]&&(A("Received iframe load event for CORS upload request (file id "+c+")"),x[c]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+c;A(a,"error");b({error:a})},1E3))});I.receiveMessage(c,function(a){A("Received the following window message: '"+a+"'");var b=qq.parseJson(a),f=b.uuid;f&&E[f]?(clearTimeout(x[c]),
...
d):f.webkitSlice&&(g=f.webkitSlice(u,d));return{part:b,start:u,end:d,count:c,blob:g,size:d-u}}function e(a){a=z.getSize(a);return Math.ceil(a/r.chunking.partSize)}function g(a,b,d,c){var f=new FormData,e=r.demoMode?"GET":"POST",u=r.endpointStore.getEndpoint(c),g=u,h=z.getName(c),l=z.getSize(c),w=m[c].blobData;a[r.uuidParamName]=m[c].uuid;C&&(a[r.totalFileSizeParamName]=l,w&&(a[r.blobs.paramNames.name]=w.name));r.paramsInBody||(C||(a[r.inputName]=h),g=qq.obj2url(a,u));b.open(e,g,!0);r.cors.expected&&
...
m[a].attemptingResume=!1;r.onProgress(a,c,f,f);r.onComplete(a,c,b,d);delete m[a].xhr;y(a)}function p(a){var b=m[a].remainingChunkIdxs[0],c=f(a,b),e=m[a].xhr=new XMLHttpRequest,u=z.getSize(a),l=z.getName(a),v;void 0===m[a].loaded&&(m[a].loaded=0);w&&m[a].file&&A(a,c);e.onreadystatechange=x(a,e);e.upload.onprogress=function(d){if(d.lengthComputable){var c=d.loaded+m[a].loaded;d=d.total;var e=f(a,b);d-=e.size;var u=z.getSize(a),e=e.count,g=d-m[a].initialRequestOverhead;m[a].lastRequestOverhead=d;0===
b?(m[a].lastChunkIdxProgress=0,m[a].initialRequestOverhead=d,m[a].estTotalRequestsSize=u+e*d):m[a].lastChunkIdxProgress!==b&&(m[a].lastChunkIdxProgress=b,m[a].estTotalRequestsSize+=g);r.onProgress(a,l,c,m[a].estTotalRequestsSize)}};r.onUploadChunk(a,l,q(c));v=r.paramsStore.getParams(a);d(a,v,c);m[a].attemptingResume&&(v[r.resume.paramNames.resuming]=!0);v=g(v,e,c.blob,a);h(a,e);K("Sending chunked upload request for item "+a+": bytes "+(c.start+1)+"-"+c.end+" of "+u);e.send(v)}function n(a){K("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");w&&(I(a),m[a].attemptingResume=!1);m[a].remainingChunkIdxs=[];delete m[a].loaded;delete m[a].estTotalRequestsSize;delete m[a].initialRequestOverhead}function q(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function x(a,b){return function(){if(4===b.readyState){var d;if(m[a]){K("xhr - server response received for "+a);K("responseText = "+b.responseText);try{d=qq.parseJson(b.responseText)}catch(c){K("Error when attempting to parse xhr response text ("+c+
...
p(a):(w&&I(a),l(a,d,b))}else l(a,d,b)}}}}function A(a,b){var d=z.getUuid(a),c=m[a].loaded,f=m[a].initialRequestOverhead,e=m[a].estTotalRequestsSize,u=E(a);qq.setCookie(u,d+B+b.part+B+c+B+f+B+e,r.resume.cookiesExpireIn)}function I(a){m[a].file&&(a=E(a),qq.deleteCookie(a))}function E(a){var b=z.getName(a);a=z.getSize(a);var d=r.chunking.partSize,b="qqfilechunk"+B+encodeURIComponent(b)+B+a+B+d;void 0!==v&&(b+=B+v);return b}function t(a){var b=m[a].file||m[a].blobData.blob,d=z.getName(a),c,f;m[a].loaded=
0;c=m[a].xhr=new XMLHttpRequest;c.upload.onprogress=function(b){b.lengthComputable&&(m[a].loaded=b.loaded,r.onProgress(a,d,b.loaded,b.total))};c.onreadystatechange=x(a,c);f=r.paramsStore.getParams(a);b=g(f,c,b,a);h(a,c);K("Sending upload request for "+a);c.send(b)}var r=a,y=b,K=c,m=[],B="|",u=r.chunking.enabled&&qq.supportedFeatures.chunking,w=r.resume.enabled&&u&&qq.supportedFeatures.resume,v;v=null===r.resume.id||void 0===r.resume.id||qq.isFunction(r.resume.id)||qq.isObject(r.resume.id)?void 0:
...
c.appendTo(this.options.container):c.insertAfter(this.$element);var e=this.getPosition(),h=c[0].offsetWidth,l=c[0].offsetHeight;if(g){var p=this.$element.parent(),g=b,n=document.documentElement.scrollTop||document.body.scrollTop,q="body"==this.options.container?window.innerWidth:p.outerWidth(),x="body"==this.options.container?window.innerHeight:p.outerHeight(),p="body"==this.options.container?0:p.offset().left,b="bottom"==b&&e.top+e.height+l-n>x?"top":"top"==b&&0>e.top-n-l?"bottom":"right"==b&&e.right+
...
a.ctrlKey||(a.preventDefault(),q(this))}return t?(ka||(ka=!0,Y.click(function(){G.next()}),Z.click(function(){G.prev()}),U.click(function(){G.close()}),E.click(function(){k.overlayClose&&G.close()}),a(b).bind("keydown."+H,function(a){var b=a.keyCode;R&&k.escKey&&27===b&&(a.preventDefault(),G.close());R&&k.arrowKey&&w[1]&&!a.altKey&&(37===b?(a.preventDefault(),Z.click()):39===b&&(a.preventDefault(),Y.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+H,"."+X,c):a("."+X).live("click."+H,c)),!0):!1}
function I(){var e,f,u,v=G.prep,l=++la;ba=!0;D=!1;M=w[L];p();n(ca);n(da,k.onLoad);k.h=k.height?g(k.height,"y")-S-J:k.innerHeight&&g(k.innerHeight,"y");k.w=k.width?g(k.width,"x")-T-N:k.innerWidth&&g(k.innerWidth,"x");k.mw=k.w;k.mh=k.h;k.maxWidth&&(k.mw=g(k.maxWidth,"x")-T-N,k.mw=k.w&&k.w<k.mw?k.w:k.mw);k.maxHeight&&(k.mh=g(k.maxHeight,"y")-S-J,k.mh=k.h&&k.h<k.mh?k.h:k.mh);e=k.href;na=setTimeout(function(){V.show()},100);k.inline?(u=d(F).hide().insertBefore(a(e)[0]),P.one(ca,function(){u.replaceWith(C.children())}),
v(a(e))):k.iframe?v(" "):k.html?v(k.html):k.photo||k.photoRegex.test(e)?(e=h(k,e),D=b.createElement("img"),a(D).addClass(H+"Photo").bind("error",function(){k.title=!1;v(d(F,"Error").html(k.imgError))}).one("load",function(){var b;l===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(M).attr(c)||a(M).attr("data-"+c);d&&D.setAttribute(c,d)}),k.retinaImage&&1<c.devicePixelRatio&&(D.height/=c.devicePixelRatio,D.width/=c.devicePixelRatio),k.scalePhotos&&(f=function(){D.height-=D.height*
b;D.width-=D.width*b},k.mw&&D.width>k.mw&&(b=(D.width-k.mw)/D.width,f()),k.mh&&D.height>k.mh&&(b=(D.height-k.mh)/D.height,f())),k.h&&(D.style.marginTop=Math.max(k.mh-D.height,0)/2+"px"),w[1]&&(k.loop||w[L+1])&&(D.style.cursor="pointer",D.onclick=function(){G.next()}),D.style.width=D.width+"px",D.style.height=D.height+"px",setTimeout(function(){v(D)},1))}),setTimeout(function(){D.src=e},1)):e&&z.load(e,k.data,function(b,c){l===la&&v("error"===c?d(F,"Error").html(k.xhrError):a(this).contents())})}var E,
t,r,y,K,m,B,u,w,v,C,z,V,fa,ga,W,Y,Z,U,O,k,J,N,S,T,M,L,D,R,ba,aa,na,G,ia,ka,ha={html:!1,photo:!1,iframe:!1,inline:!1,transition:"elastic",speed:300,fadeOut:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,href:!1,title:!1,rel:!1,opacity:.9,preloading:!0,className:!1,overlayClose:!0,escKey:!0,arrowKey:!0,top:!1,bottom:!1,left:!1,right:!1,fixed:!1,data:void 0,closeButton:!0,fastIframe:!0,open:!1,reposition:!0,
...
X=H+"Element",pa=H+"_open",da=H+"_load",ea=H+"_complete",ma=H+"_cleanup",ja=H+"_closed",ca=H+"_purge",P=a("<a/>"),F="div",la=0,oa={},qa=function(){function a(){clearTimeout(u)}function b(){(k.loop||w[L+1])&&(a(),u=setTimeout(G.next,k.slideshowSpeed))}function c(){W.html(k.slideshowStop).unbind(v).one(v,d);P.bind(ea,b).bind(da,a);t.removeClass(g+"off").addClass(g+"on")}function d(){a();P.unbind(ea,b).unbind(da,a);W.html(k.slideshowStart).unbind(v).one(v,function(){G.next();c()});t.removeClass(g+"on").addClass(g+
"off")}function e(){f=!1;W.hide();a();P.unbind(ea,b).unbind(da,a);t.removeClass(g+"off "+g+"on")}var f,u,g=H+"Slideshow_",v="click."+H;return function(){f?k.slideshow||(P.unbind(ma,e),e()):k.slideshow&&w[1]&&(f=!0,P.one(ma,e),k.slideshowAuto?c():d(),W.show())}}();a.colorbox||(a(x),G=a.fn[Q]=a[Q]=function(b,c){var d=this;if(b=b||{},x(),A()){if(a.isFunction(d))d=a("<a/>"),b.open=!0;else if(!d[0])return d;c&&(b.onComplete=c);d.each(function(){a.data(this,Q,a.extend({},a.data(this,Q)||ha,b))}).addClass(X);
(a.isFunction(b.open)&&b.open.call(d)||b.open)&&q(d[0])}return d},G.position=function(b,c){function d(){K[0].style.width=u[0].style.width=y[0].style.width=parseInt(t[0].style.width,10)-N+"px";y[0].style.height=m[0].style.height=B[0].style.height=parseInt(t[0].style.height,10)-J+"px"}var e,h,w,C=0,l=0,z=t.offset();if(v.unbind("resize."+H),t.css({top:-9E4,left:-9E4}),h=v.scrollTop(),w=v.scrollLeft(),k.fixed?(z.top-=h,z.left-=w,t.css({position:"fixed"})):(C=h,l=w,t.css({position:"absolute"})),l+=!1!==
k.right?Math.max(v.width()-k.w-T-N-g(k.right,"x"),0):!1!==k.left?g(k.left,"x"):Math.round(Math.max(v.width()-k.w-T-N,0)/2),C+=!1!==k.bottom?Math.max(f()-k.h-S-J-g(k.bottom,"y"),0):!1!==k.top?g(k.top,"y"):Math.round(Math.max(f()-k.h-S-J,0)/2),t.css({top:z.top,left:z.left,visibility:"visible"}),r[0].style.width=r[0].style.height="9999px",e={width:k.w+T+N,height:k.h+S+J,top:C,left:l},b){var n=0;a.each(e,function(a){return e[a]!==oa[a]?(n=b,void 0):void 0});b=n}oa=e;b||t.css(e);t.dequeue().animate(e,
{duration:b||0,complete:function(){d();ba=!1;r[0].style.width=k.w+T+N+"px";r[0].style.height=k.h+S+J+"px";k.reposition&&setTimeout(function(){v.bind("resize."+H,G.position)},1);c&&c()},step:d})},G.resize=function(a){var b;R&&(a=a||{},a.width&&(k.w=g(a.width,"x")-T-N),a.innerWidth&&(k.w=g(a.innerWidth,"x")),C.css({width:k.w}),a.height&&(k.h=g(a.height,"y")-S-J),a.innerHeight&&(k.h=g(a.innerHeight,"y")),a.innerHeight||a.height||(b=C.scrollTop(),C.css({height:"auto"}),k.h=C.height()),C.css({height:k.h}),
b&&C.scrollTop(b),G.position("none"===k.transition?0:k.speed))},G.prep=function(c){if(R){var f,u="none"===k.transition?0:k.speed;C.empty().remove();C=d(F,"LoadedContent").append(c);C.hide().appendTo(z.show()).css({width:(k.w=k.w||C.width(),k.w=k.mw&&k.mw<k.w?k.mw:k.w,k.w),overflow:k.scrolling?"auto":"hidden"}).css({height:(k.h=k.h||C.height(),k.h=k.mh&&k.mh<k.h?k.mh:k.h,k.h)}).prependTo(y);z.hide();a(D).css({"float":"none"});f=function(){function c(){!1===a.support.opacity&&t[0].style.removeAttribute("filter")}
var f,g,v=w.length;R&&(g=function(){clearTimeout(na);V.hide();n(ea,k.onComplete)},fa.html(k.title).add(C).show(),1<v?("string"==typeof k.current&&ga.html(k.current.replace("{current}",L+1).replace("{total}",v)).show(),Y[k.loop||v-1>L?"show":"hide"]().html(k.next),Z[k.loop||L?"show":"hide"]().html(k.previous),qa(),k.preloading&&a.each([e(-1),e(1)],function(){var c,d,e=w[this],f=a.data(e,Q);f&&f.href?(c=f.href,a.isFunction(c)&&(c=c.call(e))):c=a(e).attr("href");c&&(f.photo||f.photoRegex.test(c))&&(c=
h(f,c),d=b.createElement("img"),d.src=c)})):O.hide(),k.iframe?(f=d("iframe")[0],"frameBorder"in f&&(f.frameBorder=0),"allowTransparency"in f&&(f.allowTransparency="true"),k.scrolling||(f.scrolling="no"),a(f).attr({src:k.href,name:(new Date).getTime(),"class":H+"Iframe",allowFullScreen:!0,webkitAllowFullScreen:!0,mozallowfullscreen:!0}).one("load",g).appendTo(C),P.one(ca,function(){f.src="//about:blank"}),k.fastIframe&&a(f).trigger("load")):g(),"fade"===k.transition?t.fadeTo(u,1,c):c())};"fade"===
k.transition?t.fadeTo(u,0,function(){G.position(0,f)}):G.position(u,f)}},G.next=function(){!ba&&w[1]&&(k.loop||w[L+1])&&(L=e(1),q(w[L]))},G.prev=function(){!ba&&w[1]&&(k.loop||L)&&(L=e(-1),q(w[L]))},G.close=function(){R&&!aa&&(aa=!0,R=!1,n(ma,k.onCleanup),v.unbind("."+H),E.fadeTo(k.fadeOut||0,0),t.stop().fadeTo(k.fadeOut||0,0,function(){t.add(E).css({opacity:1,cursor:"auto"}).hide();n(ca);C.empty().remove();setTimeout(function(){aa=!1;n(ja,k.onClosed)},1)}))},G.remove=function(){t&&(t.stop(),a.colorbox.close(),
...
g=a.nodeName.toLowerCase(),h=a.hasChildNodes&&a.hasChildNodes(),l=[];switch(e){case 1:var p=a.attributes;switch(g){case "b":g="strong";break;case "i":g="em";break;case "font":g="span"}if(b){for(e=0;e<p.length;e++){var n=p[e],q=n.nodeName.toLowerCase(),x=n.nodeValue;if(n.specified&&x&&!bkLib.inArray(this.stripAttributes,q)&&"function"!=typeof x){switch(q){case "style":n=x.replace(/ /g,"");for(itm in this.cssReplace)-1!=n.indexOf(itm)&&(l.push(this.cssReplace[itm]),n=n.replace(itm,""));f+=n;x="";break;
case "class":x=x.replace("Apple-style-span","");break;case "size":f+="font-size:"+this.sizes[x]+";",x=""}x&&(d+=" "+q+'="'+x+'"')}}f&&(d+=' style="'+f+'"');for(e=0;e<l.length;e++)c+="<"+l[e]+">";""==d&&"span"==g&&(b=!1);b&&(c+="<"+g,"br"!=g&&(c+=d))}if(h||bkLib.inArray(this.noShort,q))for(b&&(c+=">"),e=0;e<a.childNodes.length;e++)(q=this.toXHTML(a.childNodes[e],!0,!0))&&(c+=q);else b&&(c+=" />");b&&h&&(c+="</"+g+">");for(e=0;e<l.length;e++)c+="</"+l[e]+">";break;case 3:c+=a.nodeValue}return c}});
...
d.append(J)}g.data("timepicker-input",b);b.data("timepicker-list",g);c.useSelect?(b.val()&&d.val(e(y(b.val()),c)),d.on("focus",function(){a(this).data("timepicker-input").trigger("showTimepicker")}),d.on("blur",function(){a(this).data("timepicker-input").trigger("hideTimepicker")}),d.on("change",function(){x(b,a(this).val(),"select")}),x(b,d.val(),"initial"),b.hide().after(d)):(l=c.appendTo,"string"===typeof l?l=a(l):"function"===typeof l&&(l=l(b)),l.append(g),p(b,d),d.on("mousedown","li",function(c){b.off("focus.timepicker");
