(function(a,b){function c(){a.removeEventListener("load",c,!1);h=!0}function d(a){return m=m||new d.Class(a)}function f(a,b){for(var d in b)a[d]=b[d];return a}function e(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);k.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(k,"$1"));q.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(q,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===b.readyState?h=!0:g&&a.addEventListener("load",c,!1);var k=/\/ath(\/)?$/,q=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,m;d.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};p=a.navigator.userAgent;var t=a.navigator;f(d,{hasToken:"#ath"==b.location.hash||k.test(b.location.href)||q.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(p),isMobileChrome:-1<p.indexOf("Android")&&/Chrome\/[.0-9]*/.test(p)&&-1==p.indexOf("Version"),isMobileIE:-1<p.indexOf("Windows Phone"),language:t.language&&
...
"ios"==d.OS?"8":"4"),this.container=b.documentElement,this.session=(this.session=this.getItem(this.options.appID))?JSON.parse(this.session):void 0,!d.hasToken||d.isCompatible&&this.session||(d.hasToken=!1,e()),d.isCompatible){this.session=this.session||w;try{if(!localStorage)throw Error("localStorage is not defined");localStorage.setItem(this.options.appID,JSON.stringify(this.session));d.hasLocalStorage=!0}catch(q){d.hasLocalStorage=!1,this.options.onPrivate&&this.options.onPrivate.call(this)}c=!this.options.validLocation.length;
...
d[c])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=e(a||{},h.defaults,w)}function k(){function d(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}t.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,c){function e(){return f(d("group",{coordsize:y+" "+y,coordorigin:-k+" "+-k}),{width:y,height:y})}function q(a,y,h){b(v,b(f(e(),{rotation:360/c.lines*a+"deg",left:~~y}),b(f(d("roundrect",{arcsize:c.corners}),
{width:k,height:c.width,left:c.radius,top:-c.width>>1,filter:h}),d("fill",{color:g(c.color,a),opacity:c.opacity}),d("stroke",{opacity:0}))))}var h,k=c.length+c.width,y=2*k;h=2*-(c.width+c.length)+"px";var v=f(e(),{position:"absolute",top:h,left:h});if(c.shadow)for(h=1;c.lines>=h;h++)q(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;c.lines>=h;h++)q(h);return b(a,v)};h.prototype.opacity=function(a,b,d,c){a=a.firstChild;c=c.shadow&&c.lines||0;a&&a.childNodes.length>
b+c&&(a=a.childNodes[b+c],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=d))}}var q,m=["webkit","Moz","ms","O"],p={},t=function(){var d=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],d),d.sheet||d.styleSheet}(),w={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};e(h.prototype,{spin:function(b){this.stop();var d=
this,c=d.opts,e=d.el=f(a(0,{className:c.className}),{position:c.position,width:0,zIndex:c.zIndex});if(c.radius+c.length+c.width,f(e,{left:c.left,top:c.top}),b&&b.insertBefore(e,b.firstChild||null),e.setAttribute("role","progressbar"),d.lines(e,d.opts),!q){var g,h=0,k=(c.lines-1)*(1-c.direction)/2,y=c.fps,v=y/c.speed,m=(1-c.opacity)/(v*c.trail/100),p=v/c.lines;(function V(){h++;for(var a=0;c.lines>a;a++)g=Math.max(1-(h+(c.lines-a)*p)%v*m,c.opacity),d.opacity(e,a*c.direction+k,g,c);d.timeout=d.el&&
setTimeout(V,~~(1E3/y))})()}return d},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(d,e){function h(b,d){return f(a(),{position:"absolute",width:e.length+e.width+"px",height:e.width+"px",background:b,boxShadow:d,transformOrigin:"left",transform:"rotate("+~~(360/e.lines*m+e.rotate)+"deg) translate("+e.radius+"px,0)",borderRadius:(e.corners*e.width>>1)+"px"})}for(var k,m=0,p=(e.lines-1)*(1-e.direction)/
2;e.lines>m;m++)k=f(a(),{position:"absolute",top:1+~(e.width/2)+"px",transform:e.hwaccel?"translate3d(0,0,0)":"",opacity:e.opacity,animation:q&&c(e.opacity,e.trail,p+m*e.direction,e.lines)+" "+1/e.speed+"s linear infinite"}),e.shadow&&b(k,f(h("#000","0 0 4px #000"),{top:"2px"})),b(d,b(k,h(g(e.color,m),"0 0 1px rgba(0,0,0,.1)")));return d},opacity:function(a,b,d){a.childNodes.length>b&&(a.childNodes[b].style.opacity=d)}});var J=f(a("group"),{behavior:"url(#default#VML)"});return!d(J,"transform")&&
J.adj?k():q=d(J,"animation"),h});
...
qq.AjaxRequestor=function(a){function b(a){var b=qq.indexOf(k,a),d=m.maxConnections;delete q[a];k.splice(b,1);k.length>=d&&b<d&&(a=k[d-1],c(a))}function c(a){var b=new XMLHttpRequest,c=e(),k={},D;m.onSend(a);m.paramsStore.getParams&&(k=m.paramsStore.getParams(a));D=k;var u=m.endpointStore.getEndpoint(a),r=q[a].addToPath;void 0!==r&&(u+="/"+r);D=h&&D?qq.obj2url(D,u):u;q[a].xhr=b;b.onreadystatechange=d(a);b.open(c,D,!0);m.cors.expected&&m.cors.sendCredentials&&(b.withCredentials=!0);f(a);g("Sending "+
c+" request for "+a);!h&&k?b.send(qq.obj2url(k,"")):b.send()}function d(a){var d=q[a].xhr;return function(){if(4===d.readyState){var c=q[a].xhr,f=e(),h=!1;b(a);0<=qq.indexOf(m.successfulResponseCodes,c.status)||(h=!0,g(f+" request for "+a+" has failed - response code "+c.status,"error"));m.onComplete(a,c,h)}}}function f(a){var b=q[a].xhr;a=m.customHeaders;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,d){b.setRequestHeader(a,
d)})}function e(){return m.demoMode?"GET":m.method}var g,h,k=[],q=[],m={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(m,a);g=m.log;h="GET"===e()||"DELETE"===e();return{send:function(a,b){q[a]={addToPath:b};k.push(a)<=m.maxConnections&&c(a)},cancel:function(a){var d=q[a].xhr,c=e();d?(d.onreadystatechange=
...
qq.UploadHandlerForm=function(a,b,c){function d(a){void 0!==p[a]&&(p[a](),delete p[a])}function f(a,b){var c=a.id;D[m[c]]=b;p[c]=qq(a).attach("load",function(){q[c]&&(w("Received iframe load event for CORS upload request (file id "+c+")"),t[c]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+c;w(a,"error");b({error:a})},1E3))});J.receiveMessage(c,function(a){w("Received the following window message: '"+a+"'");var b=qq.parseJson(a),f=b.uuid;f&&D[f]?(clearTimeout(t[c]),
delete t[c],d(c),a=D[f],delete D[f],J.stopReceivingMessages(c),a(b)):f||w("'"+a+"' does not contain a UUID - ignoring.")})}function e(a,b){k.cors.expected?f(a,b):p[a.id]=qq(a).attach("load",function(){w("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(d){w("Error when attempting to access iframe during handling of upload response ("+d+")","error")}b()}})}function g(a){var b=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');b.setAttribute("id",a);b.style.display="none";document.body.appendChild(b);return b}function h(a,b){var d=k.paramsStore.getParams(a),c=qq.toElement('<form method="'+(k.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),f=k.endpointStore.getEndpoint(a),e=f;d[k.uuidParamName]=m[a];k.paramsInBody?qq.obj2Inputs(d,c):e=qq.obj2url(d,f);c.setAttribute("action",e);c.setAttribute("target",b.name);c.style.display="none";document.body.appendChild(c);return c}var k=a,q=[],m=[],p={},t=
{},w=c,J=new qq.WindowReceiveMessage({log:w}),D={},u;return u={add:function(a){a.setAttribute("name",k.inputName);var b=q.push(a)-1;m[b]=qq.getUniqueId();a.parentNode&&qq(a).remove();return b},getName:function(a){if(u.isValid(a))return q[a].value.replace(/.*(\/|\\)/,"");w(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==q[a]},reset:function(){q=[];m=[];p={}},getUuid:function(a){return m[a]},cancel:function(a){k.onCancel(a,this.getName(a));delete q[a];delete m[a];delete p[a];
k.cors.expected&&(clearTimeout(t[a]),delete t[a],J.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var c=q[a],f=u.getName(a),m=g(a),p;if(!c)throw Error("file with passed id was not added, or already uploaded or cancelled");k.onUpload(a,this.getName(a));p=h(a,m);p.appendChild(c);e(m,function(c){w("iframe loaded");if(!c){var e;try{var g=m.contentDocument||m.contentWindow.document,h=g.body.innerHTML;
w("converting iframe's innerHTML to JSON");w("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);e=qq.parseJson(h)}catch(q){w("Error when attempting to parse form upload response ("+q+")","error"),e={success:!1}}c=e}d(a);k.cors.expected||qq(m).remove();if(c.success||!k.onAutoRetry(a,f,c))k.onComplete(a,f,c),b(a)});w("Sending upload request for "+a);p.submit();qq(p).remove();return a}}};
qq.UploadHandlerXhr=function(a,b,c){function d(a,b,d){var c=C.getSize(a);a=C.getName(a);b[r.chunking.paramNames.partIndex]=d.part;b[r.chunking.paramNames.partByteOffset]=d.start;b[r.chunking.paramNames.chunkSize]=d.size;b[r.chunking.paramNames.totalParts]=d.count;b[r.totalFileSizeParamName]=c;A&&(b[r.chunking.paramNames.filename]=a)}function f(a,b){var d=r.chunking.partSize,c=C.getSize(a),f=n[a].file||n[a].blobData.blob,g=d*b,d=g+d>=c?c:g+d,c=e(a),h;f.slice?h=f.slice(g,d):f.mozSlice?h=f.mozSlice(g,
d):f.webkitSlice&&(h=f.webkitSlice(g,d));return{part:b,start:g,end:d,count:c,blob:h,size:d-g}}function e(a){a=C.getSize(a);return Math.ceil(a/r.chunking.partSize)}function g(a,b,d,c){var f=new FormData,e=r.demoMode?"GET":"POST",g=r.endpointStore.getEndpoint(c),h=g,y=C.getName(c),k=C.getSize(c),v=n[c].blobData;a[r.uuidParamName]=n[c].uuid;A&&(a[r.totalFileSizeParamName]=k,v&&(a[r.blobs.paramNames.name]=v.name));r.paramsInBody||(A||(a[r.inputName]=y),h=qq.obj2url(a,g));b.open(e,h,!0);r.cors.expected&&
r.cors.sendCredentials&&(b.withCredentials=!0);return A?(r.paramsInBody&&qq.obj2FormData(a,f),f.append(r.inputName,d),f):d}function h(a,b){var d=r.customHeaders,c=n[a].file||n[a].blobData.blob;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");A||(b.setRequestHeader("Content-Type","application/octet-stream"),b.setRequestHeader("X-Mime-Type",c.type));qq.each(d,function(a,d){b.setRequestHeader(a,d)})}function k(a,b,d){var c=C.getName(a),f=C.getSize(a);
n[a].attemptingResume=!1;r.onProgress(a,c,f,f);r.onComplete(a,c,b,d);delete n[a].xhr;x(a)}function q(a){var b=n[a].remainingChunkIdxs[0],c=f(a,b),e=n[a].xhr=new XMLHttpRequest,y=C.getSize(a),k=C.getName(a),E;void 0===n[a].loaded&&(n[a].loaded=0);v&&n[a].file&&w(a,c);e.onreadystatechange=t(a,e);e.upload.onprogress=function(d){if(d.lengthComputable){var c=d.loaded+n[a].loaded;d=d.total;var e=f(a,b);d-=e.size;var g=C.getSize(a),e=e.count,h=d-n[a].initialRequestOverhead;n[a].lastRequestOverhead=d;0===
b?(n[a].lastChunkIdxProgress=0,n[a].initialRequestOverhead=d,n[a].estTotalRequestsSize=g+e*d):n[a].lastChunkIdxProgress!==b&&(n[a].lastChunkIdxProgress=b,n[a].estTotalRequestsSize+=h);r.onProgress(a,k,c,n[a].estTotalRequestsSize)}};r.onUploadChunk(a,k,p(c));E=r.paramsStore.getParams(a);d(a,E,c);n[a].attemptingResume&&(E[r.resume.paramNames.resuming]=!0);E=g(E,e,c.blob,a);h(a,e);I("Sending chunked upload request for item "+a+": bytes "+(c.start+1)+"-"+c.end+" of "+y);e.send(E)}function m(a){I("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");v&&(J(a),n[a].attemptingResume=!1);n[a].remainingChunkIdxs=[];delete n[a].loaded;delete n[a].estTotalRequestsSize;delete n[a].initialRequestOverhead}function p(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function t(a,b){return function(){if(4===b.readyState){var d;if(n[a]){I("xhr - server response received for "+a);I("responseText = "+b.responseText);try{d=qq.parseJson(b.responseText)}catch(c){I("Error when attempting to parse xhr response text ("+c+
")","error"),d={}}if(200!==b.status||!d.success||d.reset)if(d.reset&&m(a),n[a].attemptingResume&&d.reset)n[a].attemptingResume=!1,I("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),m(a),C.upload(a,!0);else{var e=C.getName(a);r.onAutoRetry(a,e,d,b)||k(a,d,b)}else if(y){var e=n[a].remainingChunkIdxs.shift(),g=f(a,e);n[a].attemptingResume=!1;var e=n[a],h=e.loaded,g=g.size;e.loaded=h+(g+(A?n[a].lastRequestOverhead:0));0<n[a].remainingChunkIdxs.length?
q(a):(v&&J(a),k(a,d,b))}else k(a,d,b)}}}}function w(a,b){var d=C.getUuid(a),c=n[a].loaded,f=n[a].initialRequestOverhead,e=n[a].estTotalRequestsSize,g=D(a);qq.setCookie(g,d+z+b.part+z+c+z+f+z+e,r.resume.cookiesExpireIn)}function J(a){n[a].file&&(a=D(a),qq.deleteCookie(a))}function D(a){var b=C.getName(a);a=C.getSize(a);var d=r.chunking.partSize,b="qqfilechunk"+z+encodeURIComponent(b)+z+a+z+d;void 0!==E&&(b+=z+E);return b}function u(a){var b=n[a].file||n[a].blobData.blob,d=C.getName(a),c,f;n[a].loaded=
0;c=n[a].xhr=new XMLHttpRequest;c.upload.onprogress=function(b){b.lengthComputable&&(n[a].loaded=b.loaded,r.onProgress(a,d,b.loaded,b.total))};c.onreadystatechange=t(a,c);f=r.paramsStore.getParams(a);b=g(f,c,b,a);h(a,c);I("Sending upload request for "+a);c.send(b)}var r=a,x=b,I=c,n=[],z="|",y=r.chunking.enabled&&qq.supportedFeatures.chunking,v=r.resume.enabled&&y&&qq.supportedFeatures.resume,E;E=null===r.resume.id||void 0===r.resume.id||qq.isFunction(r.resume.id)||qq.isObject(r.resume.id)?void 0:
r.resume.id;var A=r.forceMultipart||r.paramsInBody,C;return C={add:function(a){if(a instanceof File)a=n.push({file:a})-1;else if(qq.isBlob(a.blob))a=n.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");n[a].uuid=qq.getUniqueId();return a},getName:function(a){if(C.isValid(a)){var b=n[a].file;a=n[a].blobData;return b?null!==b.fileName&&void 0!==b.fileName?b.fileName:b.name:a.name}I(a+" is not a valid item ID.","error")},getSize:function(a){a=n[a].file||
n[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(n[a])return n[a].file||n[a].blobData.blob},getLoaded:function(a){return n[a].loaded||0},isValid:function(a){return void 0!==n[a]},reset:function(){n=[]},getUuid:function(a){return n[a].uuid},upload:function(a,b){var d=this.getName(a);r.onUpload(a,d);if(y){var c=C.getName(a),d=0,g,h;if(!n[a].remainingChunkIdxs||0===n[a].remainingChunkIdxs.length){n[a].remainingChunkIdxs=[];if(v&&!b&&n[a].file){a:{g=
qq.getCookie(D(a));h=C.getName(a);var k,E,l;if(g){g=g.split(z);if(5===g.length){h=g[0];k=parseInt(g[1],10);E=parseInt(g[2],10);l=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:k,lastByteSent:E,initialRequestOverhead:l,estTotalRequestsSize:g};break a}I("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=f(a,g.part),!1!==r.onResume(a,c,p(h))&&(d=g.part,n[a].uuid=g.uuid,n[a].loaded=g.lastByteSent,n[a].estTotalRequestsSize=g.estTotalRequestsSize,
n[a].initialRequestOverhead=g.initialRequestOverhead,n[a].attemptingResume=!0,I("Resuming "+c+" at partition index "+d)))}for(c=e(a)-1;c>=d;--c)n[a].remainingChunkIdxs.unshift(c)}q(a)}else u(a)},cancel:function(a){var b=n[a].xhr;r.onCancel(a,this.getName(a));b&&(b.onreadystatechange=null,b.abort());v&&J(a);delete n[a]},getResumableFilesData:function(){var a=[],b=[];return y&&v?(a=void 0===E?qq.getCookieNames(RegExp("^qqfilechunk\\"+z+".+\\"+z+"\\d+\\"+z+r.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
z+".+\\"+z+"\\d+\\"+z+r.chunking.partSize+"\\"+z+E+"=")),qq.each(a,function(a,d){var c=d.split(z),f=qq.getCookie(d).split(z);b.push({name:decodeURIComponent(c[1]),size:c[2],uuid:f[0],partIdx:f[1]})}),b):[]}}};
(function(a){var b,c,d,f,e,g,h,k,q,m;g=["uploaderType"];d=function(a){a&&(a=k(a),h(a),"basic"===e("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return c};f=function(a,b){var d=c.data("fineuploader");if(b)void 0===d&&(d={}),d[a]=b,c.data("fineuploader",d);else return void 0===d?null:d[a]};b=function(a){return f("uploader",a)};e=function(a,b){return f(a,b)};h=function(b){var d=b.callbacks={};b=new qq.FineUploaderBasic;a.each(b._options.callbacks,function(a){var b,f;b=/^on(\w+)/.exec(a)[1];
...
c.appendTo(this.options.container):c.insertAfter(this.$element);var e=this.getPosition(),h=c[0].offsetWidth,k=c[0].offsetHeight;if(g){var q=this.$element.parent(),g=b,m=document.documentElement.scrollTop||document.body.scrollTop,p="body"==this.options.container?window.innerWidth:q.outerWidth(),t="body"==this.options.container?window.innerHeight:q.outerHeight(),q="body"==this.options.container?0:q.offset().left,b="bottom"==b&&e.top+e.height+k-m>t?"top":"top"==b&&0>e.top-m-k?"bottom":"right"==b&&e.right+
h>p?"left":"left"==b&&e.left-h<q?"right":b;c.removeClass(g).addClass(b)}c=this.getCalculatedOffset(b,e,h,k);this.applyPlacement(c,b);this.$element.trigger("shown.bs."+this.type)}};b.prototype.applyPlacement=function(a,b){var c,g=this.tip(),h=g[0].offsetWidth,k=g[0].offsetHeight,q=parseInt(g.css("margin-top"),10),m=parseInt(g.css("margin-left"),10);isNaN(q)&&(q=0);isNaN(m)&&(m=0);a.top+=q;a.left+=m;g.offset(a).addClass("in");q=g[0].offsetWidth;m=g[0].offsetHeight;("top"==b&&m!=k&&(c=!0,a.top=a.top+
k-m),/bottom|top/.test(b))?(k=0,0>a.left&&(k=-2*a.left,a.left=0,g.offset(a),q=g[0].offsetWidth),this.replaceArrow(k-h+q,q,"left")):this.replaceArrow(m-k,m,"top");c&&g.offset(a)};b.prototype.replaceArrow=function(a,b,c){this.arrow().css(c,a?50*(1-a/b)+"%":"")};b.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};b.prototype.hide=function(){function b(){"in"!=c.hoverState&&e.detach()}
...
(function(a,b,c){function d(c,d,e){c=b.createElement(c);return d&&(c.id=H+d),e&&(c.style.cssText=e),a(c)}function f(){return c.innerHeight?c.innerHeight:a(c).height()}function e(a){var b=v.length;a=(L+a)%b;return 0>a?b+a:a}function g(a,b){return Math.round((/%/.test(a)?("x"===b?E.width():f())/100:1)*parseInt(a,10))}function h(a,b){return a.retinaUrl&&1<c.devicePixelRatio?b.replace(a.photoRegex,a.retinaSuffix):b}function k(a){"contains"in u[0]&&!u[0].contains(a.target)&&(a.stopPropagation(),u.focus())}
function q(){var b,c=a.data(M,Q);null==c?(l=a.extend({},ha),console&&console.log&&console.log("Error: cboxElement missing settings object")):l=a.extend({},c);for(b in l)a.isFunction(l[b])&&"on"!==b.slice(0,2)&&(l[b]=l[b].call(M));l.rel=l.rel||M.rel||a(M).data("rel")||"nofollow";l.href=l.href||a(M).attr("href");l.title=l.title||M.title;"string"==typeof l.href&&(l.href=a.trim(l.href))}function m(c,d){a(b).trigger(c);P.triggerHandler(c);a.isFunction(d)&&d.call(M)}function p(c){aa||(M=c,q(),v=a(M),L=
0,"nofollow"!==l.rel&&(v=a("."+X).filter(function(){var b,c=a.data(this,Q);return c&&(b=a(this).data("rel")||c.rel||this.rel),b===l.rel}),L=v.index(M),-1===L&&(v=v.add(M),L=v.length-1)),D.css({opacity:parseFloat(l.opacity),cursor:l.overlayClose?"pointer":"auto",visibility:"visible"}).show(),ia&&u.add(D).removeClass(ia),l.className&&u.add(D).addClass(l.className),ia=l.className,l.closeButton?U.html(l.close).appendTo(x):U.appendTo("<div/>"),R||(R=ba=!0,u.css({visibility:"hidden",display:"block"}),A=
d(F,"LoadedContent","width:0; height:0; overflow:hidden"),x.css({width:"",height:""}).append(A),K=I.height()+y.height()+x.outerHeight(!0)-x.height(),N=n.width()+z.width()+x.outerWidth(!0)-x.width(),S=A.outerHeight(!0),T=A.outerWidth(!0),l.w=g(l.initialWidth,"x"),l.h=g(l.initialHeight,"y"),A.css({width:"",height:l.h}),G.position(),m(pa,l.onOpen),O.add(fa).hide(),u.focus(),l.trapFocus&&b.addEventListener&&(b.addEventListener("focus",k,!0),P.one(ja,function(){b.removeEventListener("focus",k,!0)})),l.returnFocus&&
P.one(ja,function(){a(M).focus()})),J())}function t(){!u&&b.body&&(ka=!1,E=a(c),u=d(F).attr({id:Q,"class":!1===a.support.opacity?H+"IE":"",role:"dialog",tabindex:"-1"}).hide(),D=d(F,"Overlay").hide(),V=a([d(F,"LoadingOverlay")[0],d(F,"LoadingGraphic")[0]]),r=d(F,"Wrapper"),x=d(F,"Content").append(fa=d(F,"Title"),ga=d(F,"Current"),Z=a('<button type="button"/>').attr({id:H+"Previous"}),Y=a('<button type="button"/>').attr({id:H+"Next"}),W=d("button","Slideshow"),V),U=a('<button type="button"/>').attr({id:H+
"Close"}),r.append(d(F).append(d(F,"TopLeft"),I=d(F,"TopCenter"),d(F,"TopRight")),d(F,!1,"clear:left").append(n=d(F,"MiddleLeft"),x,z=d(F,"MiddleRight")),d(F,!1,"clear:left").append(d(F,"BottomLeft"),y=d(F,"BottomCenter"),d(F,"BottomRight"))).find("div div").css({"float":"left"}),C=d(F,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=Y.add(Z).add(ga).add(W),a(b.body).append(D,u.append(r,C)))}function w(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),p(this))}return u?(ka||(ka=!0,Y.click(function(){G.next()}),Z.click(function(){G.prev()}),U.click(function(){G.close()}),D.click(function(){l.overlayClose&&G.close()}),a(b).bind("keydown."+H,function(a){var b=a.keyCode;R&&l.escKey&&27===b&&(a.preventDefault(),G.close());R&&l.arrowKey&&v[1]&&!a.altKey&&(37===b?(a.preventDefault(),Z.click()):39===b&&(a.preventDefault(),Y.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+H,"."+X,c):a("."+X).live("click."+H,c)),!0):!1}
function J(){var e,f,y,k=G.prep,E=++la;ba=!0;B=!1;M=v[L];q();m(ca);m(da,l.onLoad);l.h=l.height?g(l.height,"y")-S-K:l.innerHeight&&g(l.innerHeight,"y");l.w=l.width?g(l.width,"x")-T-N:l.innerWidth&&g(l.innerWidth,"x");l.mw=l.w;l.mh=l.h;l.maxWidth&&(l.mw=g(l.maxWidth,"x")-T-N,l.mw=l.w&&l.w<l.mw?l.w:l.mw);l.maxHeight&&(l.mh=g(l.maxHeight,"y")-S-K,l.mh=l.h&&l.h<l.mh?l.h:l.mh);e=l.href;na=setTimeout(function(){V.show()},100);l.inline?(y=d(F).hide().insertBefore(a(e)[0]),P.one(ca,function(){y.replaceWith(A.children())}),
k(a(e))):l.iframe?k(" "):l.html?k(l.html):l.photo||l.photoRegex.test(e)?(e=h(l,e),B=b.createElement("img"),a(B).addClass(H+"Photo").bind("error",function(){l.title=!1;k(d(F,"Error").html(l.imgError))}).one("load",function(){var b;E===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(M).attr(c)||a(M).attr("data-"+c);d&&B.setAttribute(c,d)}),l.retinaImage&&1<c.devicePixelRatio&&(B.height/=c.devicePixelRatio,B.width/=c.devicePixelRatio),l.scalePhotos&&(f=function(){B.height-=B.height*
b;B.width-=B.width*b},l.mw&&B.width>l.mw&&(b=(B.width-l.mw)/B.width,f()),l.mh&&B.height>l.mh&&(b=(B.height-l.mh)/B.height,f())),l.h&&(B.style.marginTop=Math.max(l.mh-B.height,0)/2+"px"),v[1]&&(l.loop||v[L+1])&&(B.style.cursor="pointer",B.onclick=function(){G.next()}),B.style.width=B.width+"px",B.style.height=B.height+"px",setTimeout(function(){k(B)},1))}),setTimeout(function(){B.src=e},1)):e&&C.load(e,l.data,function(b,c){E===la&&k("error"===c?d(F,"Error").html(l.xhrError):a(this).contents())})}var D,
u,r,x,I,n,z,y,v,E,A,C,V,fa,ga,W,Y,Z,U,O,l,K,N,S,T,M,L,B,R,ba,aa,na,G,ia,ka,ha={html:!1,photo:!1,iframe:!1,inline:!1,transition:"elastic",speed:300,fadeOut:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,href:!1,title:!1,rel:!1,opacity:.9,preloading:!0,className:!1,overlayClose:!0,escKey:!0,arrowKey:!0,top:!1,bottom:!1,left:!1,right:!1,fixed:!1,data:void 0,closeButton:!0,fastIframe:!0,open:!1,reposition:!0,
...
X=H+"Element",pa=H+"_open",da=H+"_load",ea=H+"_complete",ma=H+"_cleanup",ja=H+"_closed",ca=H+"_purge",P=a("<a/>"),F="div",la=0,oa={},qa=function(){function a(){clearTimeout(g)}function b(){(l.loop||v[L+1])&&(a(),g=setTimeout(G.next,l.slideshowSpeed))}function c(){W.html(l.slideshowStop).unbind(y).one(y,d);P.bind(ea,b).bind(da,a);u.removeClass(h+"off").addClass(h+"on")}function d(){a();P.unbind(ea,b).unbind(da,a);W.html(l.slideshowStart).unbind(y).one(y,function(){G.next();c()});u.removeClass(h+"on").addClass(h+
"off")}function e(){f=!1;W.hide();a();P.unbind(ea,b).unbind(da,a);u.removeClass(h+"off "+h+"on")}var f,g,h=H+"Slideshow_",y="click."+H;return function(){f?l.slideshow||(P.unbind(ma,e),e()):l.slideshow&&v[1]&&(f=!0,P.one(ma,e),l.slideshowAuto?c():d(),W.show())}}();a.colorbox||(a(t),G=a.fn[Q]=a[Q]=function(b,c){var d=this;if(b=b||{},t(),w()){if(a.isFunction(d))d=a("<a/>"),b.open=!0;else if(!d[0])return d;c&&(b.onComplete=c);d.each(function(){a.data(this,Q,a.extend({},a.data(this,Q)||ha,b))}).addClass(X);
(a.isFunction(b.open)&&b.open.call(d)||b.open)&&p(d[0])}return d},G.position=function(b,c){function d(){I[0].style.width=y[0].style.width=x[0].style.width=parseInt(u[0].style.width,10)-N+"px";x[0].style.height=n[0].style.height=z[0].style.height=parseInt(u[0].style.height,10)-K+"px"}var e,h,k,v=0,A=0,q=u.offset();if(E.unbind("resize."+H),u.css({top:-9E4,left:-9E4}),h=E.scrollTop(),k=E.scrollLeft(),l.fixed?(q.top-=h,q.left-=k,u.css({position:"fixed"})):(v=h,A=k,u.css({position:"absolute"})),A+=!1!==
l.right?Math.max(E.width()-l.w-T-N-g(l.right,"x"),0):!1!==l.left?g(l.left,"x"):Math.round(Math.max(E.width()-l.w-T-N,0)/2),v+=!1!==l.bottom?Math.max(f()-l.h-S-K-g(l.bottom,"y"),0):!1!==l.top?g(l.top,"y"):Math.round(Math.max(f()-l.h-S-K,0)/2),u.css({top:q.top,left:q.left,visibility:"visible"}),r[0].style.width=r[0].style.height="9999px",e={width:l.w+T+N,height:l.h+S+K,top:v,left:A},b){var C=0;a.each(e,function(a){return e[a]!==oa[a]?(C=b,void 0):void 0});b=C}oa=e;b||u.css(e);u.dequeue().animate(e,
{duration:b||0,complete:function(){d();ba=!1;r[0].style.width=l.w+T+N+"px";r[0].style.height=l.h+S+K+"px";l.reposition&&setTimeout(function(){E.bind("resize."+H,G.position)},1);c&&c()},step:d})},G.resize=function(a){var b;R&&(a=a||{},a.width&&(l.w=g(a.width,"x")-T-N),a.innerWidth&&(l.w=g(a.innerWidth,"x")),A.css({width:l.w}),a.height&&(l.h=g(a.height,"y")-S-K),a.innerHeight&&(l.h=g(a.innerHeight,"y")),a.innerHeight||a.height||(b=A.scrollTop(),A.css({height:"auto"}),l.h=A.height()),A.css({height:l.h}),
b&&A.scrollTop(b),G.position("none"===l.transition?0:l.speed))},G.prep=function(c){if(R){var f,g="none"===l.transition?0:l.speed;A.empty().remove();A=d(F,"LoadedContent").append(c);A.hide().appendTo(C.show()).css({width:(l.w=l.w||A.width(),l.w=l.mw&&l.mw<l.w?l.mw:l.w,l.w),overflow:l.scrolling?"auto":"hidden"}).css({height:(l.h=l.h||A.height(),l.h=l.mh&&l.mh<l.h?l.mh:l.h,l.h)}).prependTo(x);C.hide();a(B).css({"float":"none"});f=function(){function c(){!1===a.support.opacity&&u[0].style.removeAttribute("filter")}
var f,y,k=v.length;R&&(y=function(){clearTimeout(na);V.hide();m(ea,l.onComplete)},fa.html(l.title).add(A).show(),1<k?("string"==typeof l.current&&ga.html(l.current.replace("{current}",L+1).replace("{total}",k)).show(),Y[l.loop||k-1>L?"show":"hide"]().html(l.next),Z[l.loop||L?"show":"hide"]().html(l.previous),qa(),l.preloading&&a.each([e(-1),e(1)],function(){var c,d,e=v[this],f=a.data(e,Q);f&&f.href?(c=f.href,a.isFunction(c)&&(c=c.call(e))):c=a(e).attr("href");c&&(f.photo||f.photoRegex.test(c))&&(c=
h(f,c),d=b.createElement("img"),d.src=c)})):O.hide(),l.iframe?(f=d("iframe")[0],"frameBorder"in f&&(f.frameBorder=0),"allowTransparency"in f&&(f.allowTransparency="true"),l.scrolling||(f.scrolling="no"),a(f).attr({src:l.href,name:(new Date).getTime(),"class":H+"Iframe",allowFullScreen:!0,webkitAllowFullScreen:!0,mozallowfullscreen:!0}).one("load",y).appendTo(A),P.one(ca,function(){f.src="//about:blank"}),l.fastIframe&&a(f).trigger("load")):y(),"fade"===l.transition?u.fadeTo(g,1,c):c())};"fade"===
l.transition?u.fadeTo(g,0,function(){G.position(0,f)}):G.position(g,f)}},G.next=function(){!ba&&v[1]&&(l.loop||v[L+1])&&(L=e(1),p(v[L]))},G.prev=function(){!ba&&v[1]&&(l.loop||L)&&(L=e(-1),p(v[L]))},G.close=function(){R&&!aa&&(aa=!0,R=!1,m(ma,l.onCleanup),E.unbind("."+H),D.fadeTo(l.fadeOut||0,0),u.stop().fadeTo(l.fadeOut||0,0,function(){u.add(D).css({opacity:1,cursor:"auto"}).hide();m(ca);A.empty().remove();setTimeout(function(){aa=!1;m(ja,l.onClosed)},1)}))},G.remove=function(){u&&(u.stop(),a.colorbox.close(),
...
"undefined"!=typeof jQuery&&!function(a){a.fn.noosSlider=function(){var b={slide:function(b,c){var d,e,f=(a(this).data("s"),a(this)),p="",t="";return c.index()>b.index()?(p="100%",t="-100%"):(p="-100%",t="100%"),f.hasClass("animated"),c.css("left"),c.css({left:p}),f.hasClass("animated"),c.css("left"),f.addClass("animated"),d=c.css("transition-delay"),e=c.css("transition-duration"),d=/\d+\.*\d*[s|ms]/.exec(d),d=d[0],e=/\d+\.*\d*[s|ms]/.exec(e),e=e[0],b.css({left:t}),c.css({left:0}),d=/ms/.test(d)?
10*parseInt(d):/s/.test(d)?1E3*parseFloat(d):0,e=/ms/.test(e)?10*parseInt(e):/s/.test(e)?1E3*parseFloat(e):0,e+d?setTimeout(function(){f.removeClass("animated");b.removeClass("active");c.addClass("active")},e+d):(f.removeClass("animated"),b.removeClass("active"),c.addClass("active")),e+d},fade:function(b,c){var d,e,f=(a(this).data("s"),a(this));return c.css("opacity"),c.css({"z-index":99,opacity:0}),b.css({"z-index":1}),b.css("opacity"),c.css("opacity"),f.addClass("animated"),c.css({opacity:1}),d=
c.css("transition-delay"),e=c.css("transition-duration"),d=/\d+\.*\d*[s|ms]/.exec(d),d=d[0],e=/\d+\.*\d*[s|ms]/.exec(e),e=e[0],d=/ms/.test(d)?10*parseInt(d):/s/.test(d)?1E3*parseFloat(d):0,e=/ms/.test(e)?10*parseInt(e):/s/.test(e)?1E3*parseFloat(e):0,e+d?setTimeout(function(){f.removeClass("animated");c.addClass("active");b.css("opacity");c.css("opacity");b.css({"z-index":1,opacity:0}).removeClass("active")},e+d):(f.removeClass("animated"),c.addClass("active"),b.css("opacity"),c.css("opacity"),b.css({"z-index":1,
opacity:0}).removeClass("active")),e+d}},c={init:function(d){if(!a(this).hasClass("noos-slider")){var e=a(this),f=e.data();d=a.extend({},a.fn.noosSlider.defaults,d);d=a.extend({},d,f);var f=a("."+d.slides,this),q=a("."+d.slides+" > li",this),m=a("."+d.slides+" > li.active",this);a("."+d.pagination,this);var p=a("."+d.pagination+" > li",this),t=a("."+d.pagination+" > li.active",this),w="";if(d.animation=a.extend({},b,d.animation),e.data("s",d),e.addClass(d.animateType+" noos-slider"),d.autopagination){w=
'<ul class="'+d.pagination+'">';for(p=0;p<q.size();p++)w+="<li><span></span></li>";e.append(w+"</ul>");a("."+d.pagination,this);p=a("."+d.pagination+" > li",this)}t.size()||(t=p.eq(0).addClass("active"));m.size()||(m=q.eq(0).addClass("active"));"auto"==d.height?f.css({height:m.outerHeight()}):f.css({height:d.height});c.checkInWindow.call(this);d.onInit.call(this);e.on("mouseover",function(){var b=a(this).data("s");b.hover=!0;a(this).data("s",b);c.stop.call(this)}).on("mouseleave",function(){var b=
a(this).data("s");b.hover=!1;a(this).data("s",b);c.start.call(this)}).on("click","."+d.pagination+" li",function(){a(this).hasClass("active")||c.animate.call(a(this).closest(".noos-slider"),a(this).index())}).on("click"," .nav.next",function(b){b.preventDefault();c.animate.call(a(this).closest(".noos-slider").get(0),"next")}).on("click"," .nav.prev",function(b){b.preventDefault();c.animate.call(a(this).closest(".noos-slider").get(0),"prev")});a(window).on("scroll.noosSlider",function(){a(".noos-slider").noosSlider("checkInWindow")})}},
animate:function(b){if(null!=b&&"string"!=typeof b&&"number"!=typeof b)return!1;var d=this,e=a(d),f=e.data("s");if(f.timeout&&(clearTimeout(f.timeout),f.timeout=!1),!e.hasClass("animated")){var e=a("."+f.slides,d),m=a("."+f.slides+" > li",d),p=a("."+f.slides+" > li.active",d),t=!1;a("."+f.pagination,d);var w=a("."+f.pagination+" > li",d),J=a("."+f.pagination+" > li.active",d);if("number"==typeof b?t=m.eq(b):("next"==b&&(t=p.next(),t.size()||(t=m.eq(0))),"prev"==b&&(t=p.prev(),t.size()||(t=m.eq(m.size()-
1)))),t.length&&p.length&&f.animation[f.animateType]){if("auto"==f.height&&e.css({height:t.outerHeight()}),f.beforeAnimation.call(d),J.removeClass("active"),w.eq(t.index()).addClass("active"),t.index()>p.index())if(vs=validate_slider(1),0==vs&&1==t.index())a("#publish_btn").css("opacity","0.4"),a(".slide_ctrl_prev").css("opacity","1"),disableprev=0,disablepublishandsave=1,a("#step_title").css("background-position-y","246px");else if(0==vs&&2==t.index())a("#classes_year_select").addClass("required"),
a("#classes_subject_select").addClass("required"),a("#deadline_date").addClass("required"),a("#deadline_time").addClass("required"),a("#publish_btn").css("opacity","1"),a(".slide_ctrl_next").css("opacity","0.2"),disablenext=1,disablepublishandsave=0,a("#step_title").css("background-position-y","65px");else{if(1==vs)return 1==t.index()?sid=".s1":sid=".s2",b=a(a(sid).parent()),a(".slides").css("height",b.outerHeight()+50),!1}else 0==t.index()?(a("#publish_btn").css("opacity","0.4"),a(".slide_ctrl_prev").css("opacity",
"0.2"),disableprev=1,disablepublishandsave=1,a("#step_title").css("background-position-y","411px")):1==t.index()&&(a("#classes_year_select").removeClass("required"),a("#classes_subject_select").removeClass("required"),a("#deadline_date").removeClass("required"),a("#deadline_time").removeClass("required"),a("#publish_btn").css("opacity","0.4"),a(".slide_ctrl_next").css("opacity","1"),disablenext=0,disablepublishandsave=1,a("#step_title").css("background-position-y","246px")),vs=validate_slider(0);
(time=f.animation[f.animateType].call(d,p,t))?setTimeout(function(){f.afterAnimation.call(d);c.start.call(d)},time):(f.afterAnimation.call(d),c.start.call(d))}}},start:function(){var b=this,d=a(b),e=d.data("s");e.autoAnimate&&e.inFocus&&!e.hover&&!e.timeout&&(e.timeout=setTimeout(function(){c.animate.call(b,"next")},e.autoAnimate),d.data("s",e))},stop:function(){var b=a(this),c=b.data("s");clearTimeout(c.timeout);c.timeout=!1;b.data("s",c)},checkInWindow:function(){var b=a(this),d=b.data("s"),e=a(window).height();
b.outerHeight();var f=b.offset().top,m=a(window).scrollTop();f>m&&f<m+(e-e/4)?(d.inFocus=!0,c.start.call(this)):(d.inFocus=!1,c.stop.call(this));b.data("s",d)}};if(arguments&&1==arguments.length&&"object"==typeof arguments[0]||!arguments.length){var d=a.extend({},a.fn.noosSlider.defaults,arguments[0]);return this.each(function(){a(this).hasClass("slider-init")||c.init.call(this,d)})}if(arguments&&"string"==typeof arguments[0]&&c[arguments[0]]){var f=arguments,e=arguments;return 1<arguments.lengtn&&
e.shift(),this.each(function(){c[f[0]].apply(this,e)})}};a.fn.noosSlider.defaults={autoAnimate:5E3,slides:"slides",pagination:"pagination",autopagination:!1,prevButton:"prev",nextButton:"next",animateType:"slide",width:"100%",height:"auto",afterAnimation:function(){SlideCompleted()},beforeAnimation:function(){},onInit:function(){},animation:{}}}(jQuery);
...
!1));if(c.useSelect)var g=d=a("<select />",{"class":"ui-timepicker-select"});else d=a("<ul />",{"class":"ui-timepicker-list"}),g=a("<div />",{"class":"ui-timepicker-wrapper",tabindex:-1}),g.css({display:"none",position:"absolute"}).append(d);if(c.noneOption)if(!0===c.noneOption&&(c.noneOption=c.useSelect?"Time...":"None"),a.isArray(c.noneOption))for(var k in c.noneOption){if(parseInt(k,10)==k){var m=f(c.noneOption[k],c.useSelect);d.append(m)}}else m=f(c.noneOption,c.useSelect),d.append(m);c.className&&
g.addClass(c.className);null===c.minTime&&null===c.durationTime||!c.showDuration||(g.addClass("ui-timepicker-with-duration"),g.addClass("ui-timepicker-step-"+c.step));m=c.minTime;"function"===typeof c.durationTime?m=x(c.durationTime()):null!==c.durationTime&&(m=c.durationTime);k=null!==c.minTime?c.minTime:0;var n=null!==c.maxTime?c.maxTime:k+86400-1;n<k&&(n+=86400);86399===n&&"string"===a.type(c.timeFormat)&&c.show2400&&(n=86400);var p=c.disableTimeRanges,w=0,J=p.length,I=c.step;"function"!=typeof I&&
(I=function(){return c.step});for(var U=0;k<=n;U++,k+=60*I(U)){var O=k,l=r(O,c);if(c.useSelect)var K=a("<option />",{value:l});else K=a("<li />"),K.data("time",86400>=O?O:O%86400);K.text(l);if((null!==c.minTime||null!==c.durationTime)&&c.showDuration)if(l=u(k-m,c.step),c.useSelect)K.text(K.text()+" ("+l+")");else{var N=a("<span />",{"class":"ui-timepicker-duration"});N.text(" ("+l+")");K.append(N)}w<J&&(O>=p[w][1]&&(w+=1),p[w]&&O>=p[w][0]&&O<p[w][1]&&(c.useSelect?K.prop("disabled",!0):K.addClass("ui-timepicker-disabled")));
d.append(K)}g.data("timepicker-input",b);b.data("timepicker-list",g);c.useSelect?(b.val()&&d.val(e(x(b.val()),c)),d.on("focus",function(){a(this).data("timepicker-input").trigger("showTimepicker")}),d.on("blur",function(){a(this).data("timepicker-input").trigger("hideTimepicker")}),d.on("change",function(){t(b,a(this).val(),"select")}),t(b,d.val(),"initial"),b.hide().after(d)):(k=c.appendTo,"string"===typeof k?k=a(k):"function"===typeof k&&(k=k(b)),k.append(g),q(b,d),d.on("mousedown","li",function(c){b.off("focus.timepicker");
