...
function addCButton(a){$("#cboxContent").append('<a class="cdownload" href="/df/index/'+a+'" style="font-size: 24px; color: #e74c3c; position: absolute; bottom: 0; right: 0; margin-right: 30px; margin-bottom: -5px;"><span class="fa fa-download"></span></a>')}function removeCButton(){$("#cboxContent").remove(".cdownload")};
