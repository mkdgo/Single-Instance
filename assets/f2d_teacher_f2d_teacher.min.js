...
b[e])}return a}function g(a,c){return"string"==typeof a?a:a[c%a.length]}function h(a){this.opts=f(a||{},h.defaults,A)}function l(){function c(b,e){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}E.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,d){function f(){return e(c("group",{coordsize:u+" "+u,coordorigin:-l+" "+-l}),{width:u,height:u})}function p(a,u,h){b(w,b(e(f(),{rotation:360/d.lines*a+"deg",left:~~u}),b(e(c("roundrect",{arcsize:d.corners}),
...
c+e&&(a=a.childNodes[c+e],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=b))}}var p,n=["webkit","Moz","ms","O"],r={},E=function(){var c=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],c),c.sheet||c.styleSheet}(),A={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};f(h.prototype,{spin:function(c){this.stop();var b=
...
qq.UploadHandlerForm=function(a,b,d){function c(a){void 0!==r[a]&&(r[a](),delete r[a])}function e(a,b){var e=a.id;D[n[e]]=b;r[e]=qq(a).attach("load",function(){p[e]&&(A("Received iframe load event for CORS upload request (file id "+e+")"),E[e]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+e;A(a,"error");b({error:a})},1E3))});I.receiveMessage(e,function(a){A("Received the following window message: '"+a+"'");var b=qq.parseJson(a),d=b.uuid;d&&D[d]?(clearTimeout(E[e]),
delete E[e],c(e),a=D[d],delete D[d],I.stopReceivingMessages(e),a(b)):d||A("'"+a+"' does not contain a UUID - ignoring.")})}function f(a,c){l.cors.expected?e(a,c):r[a.id]=qq(a).attach("load",function(){A("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(b){A("Error when attempting to access iframe during handling of upload response ("+b+")","error")}c()}})}function g(a){var c=qq.toElement('<iframe src="javascript:false;" name="'+
...
{},A=d,I=new qq.WindowReceiveMessage({log:A}),D={},t;return t={add:function(a){a.setAttribute("name",l.inputName);var c=p.push(a)-1;n[c]=qq.getUniqueId();a.parentNode&&qq(a).remove();return c},getName:function(a){if(t.isValid(a))return p[a].value.replace(/.*(\/|\\)/,"");A(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==p[a]},reset:function(){p=[];n=[];r={}},getUuid:function(a){return n[a]},cancel:function(a){l.onCancel(a,this.getName(a));delete p[a];delete n[a];delete r[a];
l.cors.expected&&(clearTimeout(E[a]),delete E[a],I.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var e=p[a],d=t.getName(a),m=g(a),n;if(!e)throw Error("file with passed id was not added, or already uploaded or cancelled");l.onUpload(a,this.getName(a));n=h(a,m);n.appendChild(e);f(m,function(e){A("iframe loaded");if(!e){var f;try{var g=m.contentDocument||m.contentWindow.document,h=g.body.innerHTML;
A("converting iframe's innerHTML to JSON");A("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);f=qq.parseJson(h)}catch(y){A("Error when attempting to parse form upload response ("+y+")","error"),f={success:!1}}e=f}c(a);l.cors.expected||qq(m).remove();if(e.success||!l.onAutoRetry(a,d,e))l.onComplete(a,d,e),b(a)});A("Sending upload request for "+a);n.submit();qq(n).remove();return a}}};
...
b):d.webkitSlice&&(g=d.webkitSlice(u,b));return{part:c,start:u,end:b,count:e,blob:g,size:b-u}}function f(a){a=y.getSize(a);return Math.ceil(a/q.chunking.partSize)}function g(a,c,b,e){var d=new FormData,f=q.demoMode?"GET":"POST",u=q.endpointStore.getEndpoint(e),g=u,h=y.getName(e),w=y.getSize(e),l=m[e].blobData;a[q.uuidParamName]=m[e].uuid;B&&(a[q.totalFileSizeParamName]=w,l&&(a[q.blobs.paramNames.name]=l.name));q.paramsInBody||(B||(a[q.inputName]=h),g=qq.obj2url(a,u));c.open(f,g,!0);q.cors.expected&&
...
p(a):(w&&I(a),l(a,b,c))}else l(a,b,c)}}}}function A(a,c){var b=y.getUuid(a),e=m[a].loaded,d=m[a].initialRequestOverhead,f=m[a].estTotalRequestsSize,u=D(a);qq.setCookie(u,b+z+c.part+z+e+z+d+z+f,q.resume.cookiesExpireIn)}function I(a){m[a].file&&(a=D(a),qq.deleteCookie(a))}function D(a){var c=y.getName(a);a=y.getSize(a);var b=q.chunking.partSize,c="qqfilechunk"+z+encodeURIComponent(c)+z+a+z+b;void 0!==v&&(c+=z+v);return c}function t(a){var c=m[a].file||m[a].blobData.blob,b=y.getName(a),e,d;m[a].loaded=
0;e=m[a].xhr=new XMLHttpRequest;e.upload.onprogress=function(c){c.lengthComputable&&(m[a].loaded=c.loaded,q.onProgress(a,b,c.loaded,c.total))};e.onreadystatechange=E(a,e);d=q.paramsStore.getParams(a);c=g(d,e,c,a);h(a,e);K("Sending upload request for "+a);e.send(c)}var q=a,x=b,K=d,m=[],z="|",u=q.chunking.enabled&&qq.supportedFeatures.chunking,w=q.resume.enabled&&u&&qq.supportedFeatures.resume,v;v=null===q.resume.id||void 0===q.resume.id||qq.isFunction(q.resume.id)||qq.isObject(q.resume.id)?void 0:
...
+function(a){var b=function(b){this.element=a(b)};b.prototype.show=function(){var b=this.element,d=b.closest("ul:not(.dropdown-menu)"),f=b.attr("data-target");if(f||(f=b.attr("href"),f=f&&f.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var g=d.find(".active:last a")[0],h=a.Event("show.bs.tab",{relatedTarget:g});(b.trigger(h),h.isDefaultPrevented())||(f=a(f),this.activate(b.parent("li"),d),this.activate(f,f.parent(),function(){b.trigger({type:"shown.bs.tab",relatedTarget:g})}))}};
b.prototype.activate=function(b,d,f){function g(){h.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");b.addClass("active");l?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade");b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active");f&&f()}var h=d.find("> .active"),l=f&&a.support.transition&&h.hasClass("fade");l?h.one(a.support.transition.end,g).emulateTransitionEnd(150):g();h.removeClass("in")};var d=a.fn.tab;a.fn.tab=function(c){return this.each(function(){var d=
...
c(F,"LoadedContent","width:0; height:0; overflow:hidden"),x.css({width:"",height:""}).append(B),J=K.height()+u.height()+x.outerHeight(!0)-x.height(),N=m.width()+z.width()+x.outerWidth(!0)-x.width(),S=B.outerHeight(!0),T=B.outerWidth(!0),k.w=g(k.initialWidth,"x"),k.h=g(k.initialHeight,"y"),B.css({width:"",height:k.h}),G.position(),n(pa,k.onOpen),O.add(fa).hide(),t.focus(),k.trapFocus&&b.addEventListener&&(b.addEventListener("focus",l,!0),P.one(ja,function(){b.removeEventListener("focus",l,!0)})),k.returnFocus&&
...
"Close"}),q.append(c(F).append(c(F,"TopLeft"),K=c(F,"TopCenter"),c(F,"TopRight")),c(F,!1,"clear:left").append(m=c(F,"MiddleLeft"),x,z=c(F,"MiddleRight")),c(F,!1,"clear:left").append(c(F,"BottomLeft"),u=c(F,"BottomCenter"),c(F,"BottomRight"))).find("div div").css({"float":"left"}),y=c(F,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=Y.add(Z).add(ga).add(W),a(b.body).append(D,t.append(q,y)))}function A(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
...
g.addClass(c.className);null===c.minTime&&null===c.durationTime||!c.showDuration||(g.addClass("ui-timepicker-with-duration"),g.addClass("ui-timepicker-step-"+c.step));m=c.minTime;"function"===typeof c.durationTime?m=x(c.durationTime()):null!==c.durationTime&&(m=c.durationTime);l=null!==c.minTime?c.minTime:0;var n=null!==c.maxTime?c.maxTime:l+86400-1;n<l&&(n+=86400);86399===n&&"string"===a.type(c.timeFormat)&&c.show2400&&(n=86400);var r=c.disableTimeRanges,A=0,K=r.length,I=c.step;"function"!=typeof I&&
(I=function(){return c.step});for(var U=0;l<=n;U++,l+=60*I(U)){var O=l,k=q(O,c);if(c.useSelect)var J=a("<option />",{value:k});else J=a("<li />"),J.data("time",86400>=O?O:O%86400);J.text(k);if((null!==c.minTime||null!==c.durationTime)&&c.showDuration)if(k=t(l-m,c.step),c.useSelect)J.text(J.text()+" ("+k+")");else{var N=a("<span />",{"class":"ui-timepicker-duration"});N.text(" ("+k+")");J.append(N)}A<K&&(O>=r[A][1]&&(A+=1),r[A]&&O>=r[A][0]&&O<r[A][1]&&(c.useSelect?J.prop("disabled",!0):J.addClass("ui-timepicker-disabled")));
...
b.on("focus.timepicker-ie-hack",function(){b.off("focus.timepicker-ie-hack");b.on("focus.timepicker",z.show)});h(b)||b[0].focus();d.find("li").removeClass("ui-timepicker-selected");a(this).addClass("ui-timepicker-selected");D(b)&&(b.trigger("hideTimepicker"),d.on("mouseup.timepicker","li",function(a){d.off("mouseup.timepicker");g.hide()}))}))}function e(b,c){var d,e,f;"object"==typeof b?(d=b.label,e=b.className,f=b.value):"string"==typeof b?d=b:a.error("Invalid noneOption value");return c?a("<option />",
{value:f,"class":e,text:d}):a("<li />",{"class":e,text:d}).data("time",f)}function f(a,b){a=b.roundingFunction(a,b);if(null!==a)return q(a,b)}function g(b){b=a(b.target);0===b.closest(".ui-timepicker-input").length&&0===b.closest(".ui-timepicker-wrapper").length&&(z.hide(),a(document).unbind(".ui-timepicker"),a(window).unbind(".ui-timepicker"))}function h(a){a=a.data("timepicker-settings");return(window.navigator.msMaxTouchPoints||"ontouchstart"in document)&&a.disableTouchKeyboard}function l(b,c,
