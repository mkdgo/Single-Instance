(function(a,b){function d(){a.removeEventListener("load",d,!1);h=!0}function c(a){return n=n||new c.Class(a)}function e(a,c){for(var b in c)a[b]=c[b];return a}function f(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);l.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(l,"$1"));q.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(q,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===b.readyState?h=!0:g&&a.addEventListener("load",d,!1);var l=/\/ath(\/)?$/,q=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,n;c.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};r=a.navigator.userAgent;var E=a.navigator;e(c,{hasToken:"#ath"==b.location.hash||l.test(b.location.href)||q.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(r),isMobileChrome:-1<r.indexOf("Android")&&/Chrome\/[.0-9]*/.test(r)&&-1==r.indexOf("Version"),isMobileIE:-1<r.indexOf("Windows Phone"),language:E.language&&
E.language.toLowerCase().replace("-","_")||""});c.language=c.language&&c.language in c.intl?c.language:"en_us";c.isMobileSafari=c.isIDevice&&-1<r.indexOf("Safari")&&0>r.indexOf("CriOS");c.OS=c.isIDevice?"ios":c.isMobileChrome?"android":c.isMobileIE?"windows":"unsupported";c.OSVersion=r.match(/(OS|Android) (\d+[_\.]\d+)/);c.OSVersion=c.OSVersion&&c.OSVersion[2]?+c.OSVersion[2].replace("_","."):0;c.isStandalone="standalone"in a.navigator&&a.navigator.standalone;c.isTablet=c.isMobileSafari&&-1<r.indexOf("iPad")||
c.isMobileChrome&&0>r.indexOf("Mobile");c.isCompatible=c.isMobileSafari&&6<=c.OSVersion||c.isMobileChrome;var z={lastDisplayTime:0,returningVisitor:!1,displayCount:0,optedout:!1,added:!1};c.removeSession=function(a){try{if(!localStorage)throw Error("localStorage is not defined");localStorage.removeItem(a||c.defaults.appID)}catch(b){}};c.doLog=function(a){this.options.logging&&console.log(a)};c.Class=function(d){this.doLog=c.doLog;this.options=e({},c.defaults);e(this.options,d);d&&d.debug&&"undefined"===
...
"ios"==c.OS?"8":"4"),this.container=b.documentElement,this.session=(this.session=this.getItem(this.options.appID))?JSON.parse(this.session):void 0,!c.hasToken||c.isCompatible&&this.session||(c.hasToken=!1,f()),c.isCompatible){this.session=this.session||z;try{if(!localStorage)throw Error("localStorage is not defined");localStorage.setItem(this.options.appID,JSON.stringify(this.session));c.hasLocalStorage=!0}catch(q){c.hasLocalStorage=!1,this.options.onPrivate&&this.options.onPrivate.call(this)}d=!this.options.validLocation.length;
...
(function(a,b){"object"==typeof exports?module.exports=b():"function"==typeof define&&define.amd?define(b):a.Spinner=b()})(this,function(){function a(a,c){var b,e=document.createElement(a||"div");for(b in c)e[b]=c[b];return e}function b(a){for(var c=1,b=arguments.length;b>c;c++)a.appendChild(arguments[c]);return a}function d(a,c,b,e){var d=["opacity",c,~~(100*a),b,e].join("-");b=.01+b/e*100;e=Math.max(1-(1-a)/c*(100-b),a);var f=q.substring(0,q.indexOf("Animation")).toLowerCase();return r[d]||(E.insertRule("@"+
(f&&"-"+f+"-"||"")+"keyframes "+d+"{0%{opacity:"+e+"}"+b+"%{opacity:"+a+"}"+(b+.01)+"%{opacity:1}"+(b+c)%100+"%{opacity:"+a+"}100%{opacity:"+e+"}}",E.cssRules.length),r[d]=1),d}function c(a,c){var b,e,d=a.style;c=c.charAt(0).toUpperCase()+c.slice(1);for(e=0;n.length>e;e++)if(b=n[e]+c,void 0!==d[b])return b;return void 0!==d[c]?c:void 0}function e(a,b){for(var e in b)a.style[c(a,e)||e]=b[e];return a}function f(a){for(var c=1;arguments.length>c;c++){var b=arguments[c],e;for(e in b)void 0===a[e]&&(a[e]=
b[e])}return a}function g(a,c){return"string"==typeof a?a:a[c%a.length]}function h(a){this.opts=f(a||{},h.defaults,z)}function l(){function c(b,e){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}E.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,d){function f(){return e(c("group",{coordsize:u+" "+u,coordorigin:-l+" "+-l}),{width:u,height:u})}function q(a,u,h){b(w,b(e(f(),{rotation:360/d.lines*a+"deg",left:~~u}),b(e(c("roundrect",{arcsize:d.corners}),
{width:l,height:d.width,left:d.radius,top:-d.width>>1,filter:h}),c("fill",{color:g(d.color,a),opacity:d.opacity}),c("stroke",{opacity:0}))))}var h,l=d.length+d.width,u=2*l;h=2*-(d.width+d.length)+"px";var w=e(f(),{position:"absolute",top:h,left:h});if(d.shadow)for(h=1;d.lines>=h;h++)q(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;d.lines>=h;h++)q(h);return b(a,w)};h.prototype.opacity=function(a,c,b,e){a=a.firstChild;e=e.shadow&&e.lines||0;a&&a.childNodes.length>
c+e&&(a=a.childNodes[c+e],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=b))}}var q,n=["webkit","Moz","ms","O"],r={},E=function(){var c=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],c),c.sheet||c.styleSheet}(),z={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};f(h.prototype,{spin:function(c){this.stop();var b=
this,d=b.opts,f=b.el=e(a(0,{className:d.className}),{position:d.position,width:0,zIndex:d.zIndex});if(d.radius+d.length+d.width,e(f,{left:d.left,top:d.top}),c&&c.insertBefore(f,c.firstChild||null),f.setAttribute("role","progressbar"),b.lines(f,b.opts),!q){var g,h=0,l=(d.lines-1)*(1-d.direction)/2,u=d.fps,w=u/d.speed,v=(1-d.opacity)/(w*d.trail/100),B=w/d.lines;(function V(){h++;for(var a=0;d.lines>a;a++)g=Math.max(1-(h+(d.lines-a)*B)%w*v,d.opacity),b.opacity(f,a*d.direction+l,g,d);b.timeout=b.el&&
setTimeout(V,~~(1E3/u))})()}return b},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(c,f){function h(c,b){return e(a(),{position:"absolute",width:f.length+f.width+"px",height:f.width+"px",background:c,boxShadow:b,transformOrigin:"left",transform:"rotate("+~~(360/f.lines*n+f.rotate)+"deg) translate("+f.radius+"px,0)",borderRadius:(f.corners*f.width>>1)+"px"})}for(var l,n=0,r=(f.lines-1)*(1-f.direction)/
2;f.lines>n;n++)l=e(a(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:q&&d(f.opacity,f.trail,r+n*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&b(l,e(h("#000","0 0 4px #000"),{top:"2px"})),b(c,b(l,h(g(f.color,n),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,c,b){a.childNodes.length>c&&(a.childNodes[c].style.opacity=b)}});var I=e(a("group"),{behavior:"url(#default#VML)"});return!c(I,"transform")&&
I.adj?l():q=c(I,"animation"),h});
...
qq.AjaxRequestor=function(a){function b(a){var c=qq.indexOf(l,a),b=n.maxConnections;delete q[a];l.splice(c,1);l.length>=b&&c<b&&(a=l[b-1],d(a))}function d(a){var b=new XMLHttpRequest,d=f(),l={},D;n.onSend(a);n.paramsStore.getParams&&(l=n.paramsStore.getParams(a));D=l;var t=n.endpointStore.getEndpoint(a),p=q[a].addToPath;void 0!==p&&(t+="/"+p);D=h&&D?qq.obj2url(D,t):t;q[a].xhr=b;b.onreadystatechange=c(a);b.open(d,D,!0);n.cors.expected&&n.cors.sendCredentials&&(b.withCredentials=!0);e(a);g("Sending "+
d+" request for "+a);!h&&l?b.send(qq.obj2url(l,"")):b.send()}function c(a){var c=q[a].xhr;return function(){if(4===c.readyState){var e=q[a].xhr,d=f(),h=!1;b(a);0<=qq.indexOf(n.successfulResponseCodes,e.status)||(h=!0,g(d+" request for "+a+" has failed - response code "+e.status,"error"));n.onComplete(a,e,h)}}}function e(a){var c=q[a].xhr;a=n.customHeaders;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,b){c.setRequestHeader(a,
b)})}function f(){return n.demoMode?"GET":n.method}var g,h,l=[],q=[],n={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(n,a);g=n.log;h="GET"===f()||"DELETE"===f();return{send:function(a,c){q[a]={addToPath:c};l.push(a)<=n.maxConnections&&d(a)},cancel:function(a){var c=q[a].xhr,e=f();c?(c.onreadystatechange=
...
qq.UploadHandlerForm=function(a,b,d){function c(a){void 0!==r[a]&&(r[a](),delete r[a])}function e(a,b){var e=a.id;D[n[e]]=b;r[e]=qq(a).attach("load",function(){q[e]&&(z("Received iframe load event for CORS upload request (file id "+e+")"),E[e]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+e;z(a,"error");b({error:a})},1E3))});I.receiveMessage(e,function(a){z("Received the following window message: '"+a+"'");var b=qq.parseJson(a),d=b.uuid;d&&D[d]?(clearTimeout(E[e]),
delete E[e],c(e),a=D[d],delete D[d],I.stopReceivingMessages(e),a(b)):d||z("'"+a+"' does not contain a UUID - ignoring.")})}function f(a,c){l.cors.expected?e(a,c):r[a.id]=qq(a).attach("load",function(){z("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(b){z("Error when attempting to access iframe during handling of upload response ("+b+")","error")}c()}})}function g(a){var c=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');c.setAttribute("id",a);c.style.display="none";document.body.appendChild(c);return c}function h(a,c){var b=l.paramsStore.getParams(a),e=qq.toElement('<form method="'+(l.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),d=l.endpointStore.getEndpoint(a),f=d;b[l.uuidParamName]=n[a];l.paramsInBody?qq.obj2Inputs(b,e):f=qq.obj2url(b,d);e.setAttribute("action",f);e.setAttribute("target",c.name);e.style.display="none";document.body.appendChild(e);return e}var l=a,q=[],n=[],r={},E=
{},z=d,I=new qq.WindowReceiveMessage({log:z}),D={},t;return t={add:function(a){a.setAttribute("name",l.inputName);var c=q.push(a)-1;n[c]=qq.getUniqueId();a.parentNode&&qq(a).remove();return c},getName:function(a){if(t.isValid(a))return q[a].value.replace(/.*(\/|\\)/,"");z(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==q[a]},reset:function(){q=[];n=[];r={}},getUuid:function(a){return n[a]},cancel:function(a){l.onCancel(a,this.getName(a));delete q[a];delete n[a];delete r[a];
l.cors.expected&&(clearTimeout(E[a]),delete E[a],I.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var e=q[a],d=t.getName(a),m=g(a),n;if(!e)throw Error("file with passed id was not added, or already uploaded or cancelled");l.onUpload(a,this.getName(a));n=h(a,m);n.appendChild(e);f(m,function(e){z("iframe loaded");if(!e){var f;try{var g=m.contentDocument||m.contentWindow.document,h=g.body.innerHTML;
z("converting iframe's innerHTML to JSON");z("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);f=qq.parseJson(h)}catch(y){z("Error when attempting to parse form upload response ("+y+")","error"),f={success:!1}}e=f}c(a);l.cors.expected||qq(m).remove();if(e.success||!l.onAutoRetry(a,d,e))l.onComplete(a,d,e),b(a)});z("Sending upload request for "+a);n.submit();qq(n).remove();return a}}};
qq.UploadHandlerXhr=function(a,b,d){function c(a,c,b){var e=y.getSize(a);a=y.getName(a);c[p.chunking.paramNames.partIndex]=b.part;c[p.chunking.paramNames.partByteOffset]=b.start;c[p.chunking.paramNames.chunkSize]=b.size;c[p.chunking.paramNames.totalParts]=b.count;c[p.totalFileSizeParamName]=e;B&&(c[p.chunking.paramNames.filename]=a)}function e(a,c){var b=p.chunking.partSize,e=y.getSize(a),d=m[a].file||m[a].blobData.blob,u=b*c,b=u+b>=e?e:u+b,e=f(a),g;d.slice?g=d.slice(u,b):d.mozSlice?g=d.mozSlice(u,
b):d.webkitSlice&&(g=d.webkitSlice(u,b));return{part:c,start:u,end:b,count:e,blob:g,size:b-u}}function f(a){a=y.getSize(a);return Math.ceil(a/p.chunking.partSize)}function g(a,c,b,e){var d=new FormData,f=p.demoMode?"GET":"POST",u=p.endpointStore.getEndpoint(e),g=u,h=y.getName(e),l=y.getSize(e),w=m[e].blobData;a[p.uuidParamName]=m[e].uuid;B&&(a[p.totalFileSizeParamName]=l,w&&(a[p.blobs.paramNames.name]=w.name));p.paramsInBody||(B||(a[p.inputName]=h),g=qq.obj2url(a,u));c.open(f,g,!0);p.cors.expected&&
p.cors.sendCredentials&&(c.withCredentials=!0);return B?(p.paramsInBody&&qq.obj2FormData(a,d),d.append(p.inputName,b),d):b}function h(a,c){var b=p.customHeaders,e=m[a].file||m[a].blobData.blob;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");B||(c.setRequestHeader("Content-Type","application/octet-stream"),c.setRequestHeader("X-Mime-Type",e.type));qq.each(b,function(a,b){c.setRequestHeader(a,b)})}function l(a,c,b){var e=y.getName(a),d=y.getSize(a);
m[a].attemptingResume=!1;p.onProgress(a,e,d,d);p.onComplete(a,e,c,b);delete m[a].xhr;x(a)}function q(a){var b=m[a].remainingChunkIdxs[0],d=e(a,b),f=m[a].xhr=new XMLHttpRequest,u=y.getSize(a),l=y.getName(a),v;void 0===m[a].loaded&&(m[a].loaded=0);w&&m[a].file&&z(a,d);f.onreadystatechange=E(a,f);f.upload.onprogress=function(c){if(c.lengthComputable){var d=c.loaded+m[a].loaded;c=c.total;var f=e(a,b);c-=f.size;var u=y.getSize(a),f=f.count,g=c-m[a].initialRequestOverhead;m[a].lastRequestOverhead=c;0===
b?(m[a].lastChunkIdxProgress=0,m[a].initialRequestOverhead=c,m[a].estTotalRequestsSize=u+f*c):m[a].lastChunkIdxProgress!==b&&(m[a].lastChunkIdxProgress=b,m[a].estTotalRequestsSize+=g);p.onProgress(a,l,d,m[a].estTotalRequestsSize)}};p.onUploadChunk(a,l,r(d));v=p.paramsStore.getParams(a);c(a,v,d);m[a].attemptingResume&&(v[p.resume.paramNames.resuming]=!0);v=g(v,f,d.blob,a);h(a,f);K("Sending chunked upload request for item "+a+": bytes "+(d.start+1)+"-"+d.end+" of "+u);f.send(v)}function n(a){K("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");w&&(I(a),m[a].attemptingResume=!1);m[a].remainingChunkIdxs=[];delete m[a].loaded;delete m[a].estTotalRequestsSize;delete m[a].initialRequestOverhead}function r(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function E(a,c){return function(){if(4===c.readyState){var b;if(m[a]){K("xhr - server response received for "+a);K("responseText = "+c.responseText);try{b=qq.parseJson(c.responseText)}catch(d){K("Error when attempting to parse xhr response text ("+d+
")","error"),b={}}if(200!==c.status||!b.success||b.reset)if(b.reset&&n(a),m[a].attemptingResume&&b.reset)m[a].attemptingResume=!1,K("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),n(a),y.upload(a,!0);else{var f=y.getName(a);p.onAutoRetry(a,f,b,c)||l(a,b,c)}else if(u){var f=m[a].remainingChunkIdxs.shift(),g=e(a,f);m[a].attemptingResume=!1;var f=m[a],h=f.loaded,g=g.size;f.loaded=h+(g+(B?m[a].lastRequestOverhead:0));0<m[a].remainingChunkIdxs.length?
q(a):(w&&I(a),l(a,b,c))}else l(a,b,c)}}}}function z(a,c){var b=y.getUuid(a),e=m[a].loaded,d=m[a].initialRequestOverhead,f=m[a].estTotalRequestsSize,u=D(a);qq.setCookie(u,b+A+c.part+A+e+A+d+A+f,p.resume.cookiesExpireIn)}function I(a){m[a].file&&(a=D(a),qq.deleteCookie(a))}function D(a){var c=y.getName(a);a=y.getSize(a);var b=p.chunking.partSize,c="qqfilechunk"+A+encodeURIComponent(c)+A+a+A+b;void 0!==v&&(c+=A+v);return c}function t(a){var c=m[a].file||m[a].blobData.blob,b=y.getName(a),e,d;m[a].loaded=
0;e=m[a].xhr=new XMLHttpRequest;e.upload.onprogress=function(c){c.lengthComputable&&(m[a].loaded=c.loaded,p.onProgress(a,b,c.loaded,c.total))};e.onreadystatechange=E(a,e);d=p.paramsStore.getParams(a);c=g(d,e,c,a);h(a,e);K("Sending upload request for "+a);e.send(c)}var p=a,x=b,K=d,m=[],A="|",u=p.chunking.enabled&&qq.supportedFeatures.chunking,w=p.resume.enabled&&u&&qq.supportedFeatures.resume,v;v=null===p.resume.id||void 0===p.resume.id||qq.isFunction(p.resume.id)||qq.isObject(p.resume.id)?void 0:
p.resume.id;var B=p.forceMultipart||p.paramsInBody,y;return y={add:function(a){if(a instanceof File)a=m.push({file:a})-1;else if(qq.isBlob(a.blob))a=m.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");m[a].uuid=qq.getUniqueId();return a},getName:function(a){if(y.isValid(a)){var c=m[a].file;a=m[a].blobData;return c?null!==c.fileName&&void 0!==c.fileName?c.fileName:c.name:a.name}K(a+" is not a valid item ID.","error")},getSize:function(a){a=m[a].file||
m[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(m[a])return m[a].file||m[a].blobData.blob},getLoaded:function(a){return m[a].loaded||0},isValid:function(a){return void 0!==m[a]},reset:function(){m=[]},getUuid:function(a){return m[a].uuid},upload:function(a,c){var b=this.getName(a);p.onUpload(a,b);if(u){var d=y.getName(a),b=0,g,h;if(!m[a].remainingChunkIdxs||0===m[a].remainingChunkIdxs.length){m[a].remainingChunkIdxs=[];if(w&&!c&&m[a].file){a:{g=
qq.getCookie(D(a));h=y.getName(a);var l,v,k;if(g){g=g.split(A);if(5===g.length){h=g[0];l=parseInt(g[1],10);v=parseInt(g[2],10);k=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:l,lastByteSent:v,initialRequestOverhead:k,estTotalRequestsSize:g};break a}K("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=e(a,g.part),!1!==p.onResume(a,d,r(h))&&(b=g.part,m[a].uuid=g.uuid,m[a].loaded=g.lastByteSent,m[a].estTotalRequestsSize=g.estTotalRequestsSize,
m[a].initialRequestOverhead=g.initialRequestOverhead,m[a].attemptingResume=!0,K("Resuming "+d+" at partition index "+b)))}for(d=f(a)-1;d>=b;--d)m[a].remainingChunkIdxs.unshift(d)}q(a)}else t(a)},cancel:function(a){var c=m[a].xhr;p.onCancel(a,this.getName(a));c&&(c.onreadystatechange=null,c.abort());w&&I(a);delete m[a]},getResumableFilesData:function(){var a=[],c=[];return u&&w?(a=void 0===v?qq.getCookieNames(RegExp("^qqfilechunk\\"+A+".+\\"+A+"\\d+\\"+A+p.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
A+".+\\"+A+"\\d+\\"+A+p.chunking.partSize+"\\"+A+v+"=")),qq.each(a,function(a,b){var e=b.split(A),d=qq.getCookie(b).split(A);c.push({name:decodeURIComponent(e[1]),size:e[2],uuid:d[0],partIdx:d[1]})}),c):[]}}};
(function(a){var b,d,c,e,f,g,h,l,q,n;g=["uploaderType"];c=function(a){a&&(a=l(a),h(a),"basic"===f("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return d};e=function(a,c){var b=d.data("fineuploader");if(c)void 0===b&&(b={}),b[a]=c,d.data("fineuploader",b);else return void 0===b?null:b[a]};b=function(a){return e("uploader",a)};f=function(a,c){return e(a,c)};h=function(c){var b=c.callbacks={};c=new qq.FineUploaderBasic;a.each(c._options.callbacks,function(a){var c,e;c=/^on(\w+)/.exec(a)[1];
c=c.substring(0,1).toLowerCase()+c.substring(1);e=d;b[a]=function(){var a=Array.prototype.slice.call(arguments);return e.triggerHandler(c,a)}})};l=function(c,b){var e,h;e=void 0===b?"basic"!==c.uploaderType?{element:d[0]}:{}:b;a.each(c,function(c,b){0<=a.inArray(c,g)?f(c,b):b instanceof a?e[c]=b[0]:a.isPlainObject(b)?(e[c]={},l(b,e[c])):a.isArray(b)?(h=[],a.each(b,function(c,b){b instanceof a?a.merge(h,b):h.push(b)}),e[c]=h):e[c]=b});if(void 0===b)return e};q=function(c){return"string"===a.type(c)&&
!c.match(/^_/)&&void 0!==b()[c]};n=function(a){var c=[],e=Array.prototype.slice.call(arguments,1);l(e,c);return b()[a].apply(b(),c)};a.fn.fineUploader=function(e){var f=this,g=arguments,h=[];this.each(function(l,t){d=a(t);if(b()&&q(e)){if(h.push(n.apply(f,g)),1===f.length)return!1}else"object"!==typeof e&&e?a.error("Method "+e+" does not exist on jQuery.fineUploader"):c.apply(f,g)});return 1===h.length?h[0]:1<h.length?h:this}})(jQuery);
...
function(c){return c||(this.paused=!0),this.$element.find(".next, .prev").length&&a.support.transition.end&&(this.$element.trigger(a.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this};b.prototype.next=function(){return this.sliding?void 0:this.slide("next")};b.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")};b.prototype.slide=function(c,b){var d=this.$element.find(".item.active"),g=b||d[c](),h=this.interval,l="next"==c?"left":"right",q=
"next"==c?"first":"last",n=this;if(!g.length){if(!this.options.wrap)return;g=this.$element.find(".item")[q]()}this.sliding=!0;h&&this.pause();q=a.Event("slide.bs.carousel",{relatedTarget:g[0],direction:l});if(!g.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var c=a(n.$indicators.children()[n.getActiveIndex()]);c&&c.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(q),
q.isDefaultPrevented())return;g.addClass(c);g[0].offsetWidth;d.addClass(l);g.addClass(l);d.one(a.support.transition.end,function(){g.removeClass([c,l].join(" ")).addClass("active");d.removeClass(["active",l].join(" "));n.sliding=!1;setTimeout(function(){n.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{if(this.$element.trigger(q),q.isDefaultPrevented())return;d.removeClass("active");g.addClass("active");this.sliding=!1;this.$element.trigger("slid")}return h&&this.cycle(),this}};var d=
...
b.appendTo(this.options.container):b.insertAfter(this.$element);var d=this.getPosition(),h=b[0].offsetWidth,l=b[0].offsetHeight;if(g){var q=this.$element.parent(),g=c,n=document.documentElement.scrollTop||document.body.scrollTop,r="body"==this.options.container?window.innerWidth:q.outerWidth(),E="body"==this.options.container?window.innerHeight:q.outerHeight(),q="body"==this.options.container?0:q.offset().left,c="bottom"==c&&d.top+d.height+l-n>E?"top":"top"==c&&0>d.top-n-l?"bottom":"right"==c&&d.right+
h>r?"left":"left"==c&&d.left-h<q?"right":c;b.removeClass(g).addClass(c)}b=this.getCalculatedOffset(c,d,h,l);this.applyPlacement(b,c);this.$element.trigger("shown.bs."+this.type)}};b.prototype.applyPlacement=function(a,b){var d,g=this.tip(),h=g[0].offsetWidth,l=g[0].offsetHeight,q=parseInt(g.css("margin-top"),10),n=parseInt(g.css("margin-left"),10);isNaN(q)&&(q=0);isNaN(n)&&(n=0);a.top+=q;a.left+=n;g.offset(a).addClass("in");q=g[0].offsetWidth;n=g[0].offsetHeight;("top"==b&&n!=l&&(d=!0,a.top=a.top+
l-n),/bottom|top/.test(b))?(l=0,0>a.left&&(l=-2*a.left,a.left=0,g.offset(a),q=g[0].offsetWidth),this.replaceArrow(l-h+q,q,"left")):this.replaceArrow(n-l,n,"top");d&&g.offset(a)};b.prototype.replaceArrow=function(a,b,d){this.arrow().css(d,a?50*(1-a/b)+"%":"")};b.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};b.prototype.hide=function(){function c(){"in"!=b.hoverState&&d.detach()}
...
(function(a,b,d){function c(c,d,e){c=b.createElement(c);return d&&(c.id=H+d),e&&(c.style.cssText=e),a(c)}function e(){return d.innerHeight?d.innerHeight:a(d).height()}function f(a){var b=w.length;a=(L+a)%b;return 0>a?b+a:a}function g(a,b){return Math.round((/%/.test(a)?("x"===b?v.width():e())/100:1)*parseInt(a,10))}function h(a,b){return a.retinaUrl&&1<d.devicePixelRatio?b.replace(a.photoRegex,a.retinaSuffix):b}function l(a){"contains"in t[0]&&!t[0].contains(a.target)&&(a.stopPropagation(),t.focus())}
function q(){var b,c=a.data(M,Q);null==c?(k=a.extend({},ha),console&&console.log&&console.log("Error: cboxElement missing settings object")):k=a.extend({},c);for(b in k)a.isFunction(k[b])&&"on"!==b.slice(0,2)&&(k[b]=k[b].call(M));k.rel=k.rel||M.rel||a(M).data("rel")||"nofollow";k.href=k.href||a(M).attr("href");k.title=k.title||M.title;"string"==typeof k.href&&(k.href=a.trim(k.href))}function n(c,d){a(b).trigger(c);P.triggerHandler(c);a.isFunction(d)&&d.call(M)}function r(d){aa||(M=d,q(),w=a(M),L=
0,"nofollow"!==k.rel&&(w=a("."+X).filter(function(){var b,c=a.data(this,Q);return c&&(b=a(this).data("rel")||c.rel||this.rel),b===k.rel}),L=w.index(M),-1===L&&(w=w.add(M),L=w.length-1)),D.css({opacity:parseFloat(k.opacity),cursor:k.overlayClose?"pointer":"auto",visibility:"visible"}).show(),ia&&t.add(D).removeClass(ia),k.className&&t.add(D).addClass(k.className),ia=k.className,k.closeButton?U.html(k.close).appendTo(x):U.appendTo("<div/>"),R||(R=ba=!0,t.css({visibility:"hidden",display:"block"}),B=
c(F,"LoadedContent","width:0; height:0; overflow:hidden"),x.css({width:"",height:""}).append(B),J=K.height()+u.height()+x.outerHeight(!0)-x.height(),N=m.width()+A.width()+x.outerWidth(!0)-x.width(),S=B.outerHeight(!0),T=B.outerWidth(!0),k.w=g(k.initialWidth,"x"),k.h=g(k.initialHeight,"y"),B.css({width:"",height:k.h}),G.position(),n(pa,k.onOpen),O.add(fa).hide(),t.focus(),k.trapFocus&&b.addEventListener&&(b.addEventListener("focus",l,!0),P.one(ja,function(){b.removeEventListener("focus",l,!0)})),k.returnFocus&&
P.one(ja,function(){a(M).focus()})),I())}function E(){!t&&b.body&&(ka=!1,v=a(d),t=c(F).attr({id:Q,"class":!1===a.support.opacity?H+"IE":"",role:"dialog",tabindex:"-1"}).hide(),D=c(F,"Overlay").hide(),V=a([c(F,"LoadingOverlay")[0],c(F,"LoadingGraphic")[0]]),p=c(F,"Wrapper"),x=c(F,"Content").append(fa=c(F,"Title"),ga=c(F,"Current"),Z=a('<button type="button"/>').attr({id:H+"Previous"}),Y=a('<button type="button"/>').attr({id:H+"Next"}),W=c("button","Slideshow"),V),U=a('<button type="button"/>').attr({id:H+
"Close"}),p.append(c(F).append(c(F,"TopLeft"),K=c(F,"TopCenter"),c(F,"TopRight")),c(F,!1,"clear:left").append(m=c(F,"MiddleLeft"),x,A=c(F,"MiddleRight")),c(F,!1,"clear:left").append(c(F,"BottomLeft"),u=c(F,"BottomCenter"),c(F,"BottomRight"))).find("div div").css({"float":"left"}),y=c(F,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=Y.add(Z).add(ga).add(W),a(b.body).append(D,t.append(p,y)))}function z(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),r(this))}return t?(ka||(ka=!0,Y.click(function(){G.next()}),Z.click(function(){G.prev()}),U.click(function(){G.close()}),D.click(function(){k.overlayClose&&G.close()}),a(b).bind("keydown."+H,function(a){var b=a.keyCode;R&&k.escKey&&27===b&&(a.preventDefault(),G.close());R&&k.arrowKey&&w[1]&&!a.altKey&&(37===b?(a.preventDefault(),Z.click()):39===b&&(a.preventDefault(),Y.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+H,"."+X,c):a("."+X).live("click."+H,c)),!0):!1}
function I(){var e,f,u,v=G.prep,l=++la;ba=!0;C=!1;M=w[L];q();n(ca);n(da,k.onLoad);k.h=k.height?g(k.height,"y")-S-J:k.innerHeight&&g(k.innerHeight,"y");k.w=k.width?g(k.width,"x")-T-N:k.innerWidth&&g(k.innerWidth,"x");k.mw=k.w;k.mh=k.h;k.maxWidth&&(k.mw=g(k.maxWidth,"x")-T-N,k.mw=k.w&&k.w<k.mw?k.w:k.mw);k.maxHeight&&(k.mh=g(k.maxHeight,"y")-S-J,k.mh=k.h&&k.h<k.mh?k.h:k.mh);e=k.href;na=setTimeout(function(){V.show()},100);k.inline?(u=c(F).hide().insertBefore(a(e)[0]),P.one(ca,function(){u.replaceWith(B.children())}),
v(a(e))):k.iframe?v(" "):k.html?v(k.html):k.photo||k.photoRegex.test(e)?(e=h(k,e),C=b.createElement("img"),a(C).addClass(H+"Photo").bind("error",function(){k.title=!1;v(c(F,"Error").html(k.imgError))}).one("load",function(){var b;l===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(M).attr(c)||a(M).attr("data-"+c);d&&C.setAttribute(c,d)}),k.retinaImage&&1<d.devicePixelRatio&&(C.height/=d.devicePixelRatio,C.width/=d.devicePixelRatio),k.scalePhotos&&(f=function(){C.height-=C.height*
b;C.width-=C.width*b},k.mw&&C.width>k.mw&&(b=(C.width-k.mw)/C.width,f()),k.mh&&C.height>k.mh&&(b=(C.height-k.mh)/C.height,f())),k.h&&(C.style.marginTop=Math.max(k.mh-C.height,0)/2+"px"),w[1]&&(k.loop||w[L+1])&&(C.style.cursor="pointer",C.onclick=function(){G.next()}),C.style.width=C.width+"px",C.style.height=C.height+"px",setTimeout(function(){v(C)},1))}),setTimeout(function(){C.src=e},1)):e&&y.load(e,k.data,function(b,d){l===la&&v("error"===d?c(F,"Error").html(k.xhrError):a(this).contents())})}var D,
t,p,x,K,m,A,u,w,v,B,y,V,fa,ga,W,Y,Z,U,O,k,J,N,S,T,M,L,C,R,ba,aa,na,G,ia,ka,ha={html:!1,photo:!1,iframe:!1,inline:!1,transition:"elastic",speed:300,fadeOut:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,href:!1,title:!1,rel:!1,opacity:.9,preloading:!0,className:!1,overlayClose:!0,escKey:!0,arrowKey:!0,top:!1,bottom:!1,left:!1,right:!1,fixed:!1,data:void 0,closeButton:!0,fastIframe:!0,open:!1,reposition:!0,
...
"off")}function e(){f=!1;W.hide();a();P.unbind(ea,b).unbind(da,a);t.removeClass(g+"off "+g+"on")}var f,u,g=H+"Slideshow_",v="click."+H;return function(){f?k.slideshow||(P.unbind(ma,e),e()):k.slideshow&&w[1]&&(f=!0,P.one(ma,e),k.slideshowAuto?c():d(),W.show())}}();a.colorbox||(a(E),G=a.fn[Q]=a[Q]=function(b,c){var d=this;if(b=b||{},E(),z()){if(a.isFunction(d))d=a("<a/>"),b.open=!0;else if(!d[0])return d;c&&(b.onComplete=c);d.each(function(){a.data(this,Q,a.extend({},a.data(this,Q)||ha,b))}).addClass(X);
(a.isFunction(b.open)&&b.open.call(d)||b.open)&&r(d[0])}return d},G.position=function(b,c){function d(){K[0].style.width=u[0].style.width=x[0].style.width=parseInt(t[0].style.width,10)-N+"px";x[0].style.height=m[0].style.height=A[0].style.height=parseInt(t[0].style.height,10)-J+"px"}var f,h,w,B=0,l=0,y=t.offset();if(v.unbind("resize."+H),t.css({top:-9E4,left:-9E4}),h=v.scrollTop(),w=v.scrollLeft(),k.fixed?(y.top-=h,y.left-=w,t.css({position:"fixed"})):(B=h,l=w,t.css({position:"absolute"})),l+=!1!==
k.right?Math.max(v.width()-k.w-T-N-g(k.right,"x"),0):!1!==k.left?g(k.left,"x"):Math.round(Math.max(v.width()-k.w-T-N,0)/2),B+=!1!==k.bottom?Math.max(e()-k.h-S-J-g(k.bottom,"y"),0):!1!==k.top?g(k.top,"y"):Math.round(Math.max(e()-k.h-S-J,0)/2),t.css({top:y.top,left:y.left,visibility:"visible"}),p[0].style.width=p[0].style.height="9999px",f={width:k.w+T+N,height:k.h+S+J,top:B,left:l},b){var n=0;a.each(f,function(a){return f[a]!==oa[a]?(n=b,void 0):void 0});b=n}oa=f;b||t.css(f);t.dequeue().animate(f,
{duration:b||0,complete:function(){d();ba=!1;p[0].style.width=k.w+T+N+"px";p[0].style.height=k.h+S+J+"px";k.reposition&&setTimeout(function(){v.bind("resize."+H,G.position)},1);c&&c()},step:d})},G.resize=function(a){var b;R&&(a=a||{},a.width&&(k.w=g(a.width,"x")-T-N),a.innerWidth&&(k.w=g(a.innerWidth,"x")),B.css({width:k.w}),a.height&&(k.h=g(a.height,"y")-S-J),a.innerHeight&&(k.h=g(a.innerHeight,"y")),a.innerHeight||a.height||(b=B.scrollTop(),B.css({height:"auto"}),k.h=B.height()),B.css({height:k.h}),
b&&B.scrollTop(b),G.position("none"===k.transition?0:k.speed))},G.prep=function(d){if(R){var e,u="none"===k.transition?0:k.speed;B.empty().remove();B=c(F,"LoadedContent").append(d);B.hide().appendTo(y.show()).css({width:(k.w=k.w||B.width(),k.w=k.mw&&k.mw<k.w?k.mw:k.w,k.w),overflow:k.scrolling?"auto":"hidden"}).css({height:(k.h=k.h||B.height(),k.h=k.mh&&k.mh<k.h?k.mh:k.h,k.h)}).prependTo(x);y.hide();a(C).css({"float":"none"});e=function(){function d(){!1===a.support.opacity&&t[0].style.removeAttribute("filter")}
var e,g,v=w.length;R&&(g=function(){clearTimeout(na);V.hide();n(ea,k.onComplete)},fa.html(k.title).add(B).show(),1<v?("string"==typeof k.current&&ga.html(k.current.replace("{current}",L+1).replace("{total}",v)).show(),Y[k.loop||v-1>L?"show":"hide"]().html(k.next),Z[k.loop||L?"show":"hide"]().html(k.previous),qa(),k.preloading&&a.each([f(-1),f(1)],function(){var c,d,e=w[this],f=a.data(e,Q);f&&f.href?(c=f.href,a.isFunction(c)&&(c=c.call(e))):c=a(e).attr("href");c&&(f.photo||f.photoRegex.test(c))&&(c=
h(f,c),d=b.createElement("img"),d.src=c)})):O.hide(),k.iframe?(e=c("iframe")[0],"frameBorder"in e&&(e.frameBorder=0),"allowTransparency"in e&&(e.allowTransparency="true"),k.scrolling||(e.scrolling="no"),a(e).attr({src:k.href,name:(new Date).getTime(),"class":H+"Iframe",allowFullScreen:!0,webkitAllowFullScreen:!0,mozallowfullscreen:!0}).one("load",g).appendTo(B),P.one(ca,function(){e.src="//about:blank"}),k.fastIframe&&a(e).trigger("load")):g(),"fade"===k.transition?t.fadeTo(u,1,d):d())};"fade"===
k.transition?t.fadeTo(u,0,function(){G.position(0,e)}):G.position(u,e)}},G.next=function(){!ba&&w[1]&&(k.loop||w[L+1])&&(L=f(1),r(w[L]))},G.prev=function(){!ba&&w[1]&&(k.loop||L)&&(L=f(-1),r(w[L]))},G.close=function(){R&&!aa&&(aa=!0,R=!1,n(ma,k.onCleanup),v.unbind("."+H),D.fadeTo(k.fadeOut||0,0),t.stop().fadeTo(k.fadeOut||0,0,function(){t.add(D).css({opacity:1,cursor:"auto"}).hide();n(ca);B.empty().remove();setTimeout(function(){aa=!1;n(ja,k.onClosed)},1)}))},G.remove=function(){t&&(t.stop(),a.colorbox.close(),
t.stop().remove(),D.remove(),aa=!1,t=null,a("."+X).removeData(Q).removeClass(X),a(b).unbind("click."+H))},G.element=function(){return a(M)},G.settings=ha)})(jQuery,document,window);
(function(a){"object"===typeof exports&&exports&&"object"===typeof module&&module&&module.exports===exports?a(require("jquery")):"function"===typeof define&&define.amd?define(["jquery"],a):a(jQuery)})(function(a){function b(a){a=a[0];return 0<a.offsetWidth&&0<a.offsetHeight}function d(b){b.minTime&&(b.minTime=x(b.minTime));b.maxTime&&(b.maxTime=x(b.maxTime));b.durationTime&&"function"!==typeof b.durationTime&&(b.durationTime=x(b.durationTime));if("now"==b.scrollDefault)b.scrollDefault=function(){return b.roundingFunction(x(new Date),
...
b.disableTimeRanges=b.disableTimeRanges.sort(function(a,b){return a[0]-b[0]});for(d=b.disableTimeRanges.length-1;0<d;d--)b.disableTimeRanges[d][0]<=b.disableTimeRanges[d-1][1]&&(b.disableTimeRanges[d-1]=[Math.min(b.disableTimeRanges[d][0],b.disableTimeRanges[d-1][0]),Math.max(b.disableTimeRanges[d][1],b.disableTimeRanges[d-1][1])],b.disableTimeRanges.splice(d,1))}return b}function c(b){var c=b.data("timepicker-settings"),d=b.data("timepicker-list");d&&d.length&&(d.remove(),b.data("timepicker-list",
!1));if(c.useSelect)var g=d=a("<select />",{"class":"ui-timepicker-select"});else d=a("<ul />",{"class":"ui-timepicker-list"}),g=a("<div />",{"class":"ui-timepicker-wrapper",tabindex:-1}),g.css({display:"none",position:"absolute"}).append(d);if(c.noneOption)if(!0===c.noneOption&&(c.noneOption=c.useSelect?"Time...":"None"),a.isArray(c.noneOption))for(var l in c.noneOption){if(parseInt(l,10)==l){var m=e(c.noneOption[l],c.useSelect);d.append(m)}}else m=e(c.noneOption,c.useSelect),d.append(m);c.className&&
g.addClass(c.className);null===c.minTime&&null===c.durationTime||!c.showDuration||(g.addClass("ui-timepicker-with-duration"),g.addClass("ui-timepicker-step-"+c.step));m=c.minTime;"function"===typeof c.durationTime?m=x(c.durationTime()):null!==c.durationTime&&(m=c.durationTime);l=null!==c.minTime?c.minTime:0;var n=null!==c.maxTime?c.maxTime:l+86400-1;n<l&&(n+=86400);86399===n&&"string"===a.type(c.timeFormat)&&c.show2400&&(n=86400);var r=c.disableTimeRanges,z=0,K=r.length,I=c.step;"function"!=typeof I&&
(I=function(){return c.step});for(var U=0;l<=n;U++,l+=60*I(U)){var O=l,k=p(O,c);if(c.useSelect)var J=a("<option />",{value:k});else J=a("<li />"),J.data("time",86400>=O?O:O%86400);J.text(k);if((null!==c.minTime||null!==c.durationTime)&&c.showDuration)if(k=t(l-m,c.step),c.useSelect)J.text(J.text()+" ("+k+")");else{var N=a("<span />",{"class":"ui-timepicker-duration"});N.text(" ("+k+")");J.append(N)}z<K&&(O>=r[z][1]&&(z+=1),r[z]&&O>=r[z][0]&&O<r[z][1]&&(c.useSelect?J.prop("disabled",!0):J.addClass("ui-timepicker-disabled")));
d.append(J)}g.data("timepicker-input",b);b.data("timepicker-list",g);c.useSelect?(b.val()&&d.val(f(x(b.val()),c)),d.on("focus",function(){a(this).data("timepicker-input").trigger("showTimepicker")}),d.on("blur",function(){a(this).data("timepicker-input").trigger("hideTimepicker")}),d.on("change",function(){E(b,a(this).val(),"select")}),E(b,d.val(),"initial"),b.hide().after(d)):(l=c.appendTo,"string"===typeof l?l=a(l):"function"===typeof l&&(l=l(b)),l.append(g),q(b,d),d.on("mousedown","li",function(c){b.off("focus.timepicker");
b.on("focus.timepicker-ie-hack",function(){b.off("focus.timepicker-ie-hack");b.on("focus.timepicker",A.show)});h(b)||b[0].focus();d.find("li").removeClass("ui-timepicker-selected");a(this).addClass("ui-timepicker-selected");D(b)&&(b.trigger("hideTimepicker"),d.on("mouseup.timepicker","li",function(a){d.off("mouseup.timepicker");g.hide()}))}))}function e(b,c){var d,e,f;"object"==typeof b?(d=b.label,e=b.className,f=b.value):"string"==typeof b?d=b:a.error("Invalid noneOption value");return c?a("<option />",
{value:f,"class":e,text:d}):a("<li />",{"class":e,text:d}).data("time",f)}function f(a,b){a=b.roundingFunction(a,b);if(null!==a)return p(a,b)}function g(b){b=a(b.target);0===b.closest(".ui-timepicker-input").length&&0===b.closest(".ui-timepicker-wrapper").length&&(A.hide(),a(document).unbind(".ui-timepicker"),a(window).unbind(".ui-timepicker"))}function h(a){a=a.data("timepicker-settings");return(window.navigator.msMaxTouchPoints||"ontouchstart"in document)&&a.disableTouchKeyboard}function l(b,c,
d){if(!d&&0!==d)return!1;b=b.data("timepicker-settings");var e=!1;d=b.roundingFunction(d,b);c.find("li").each(function(b,c){var f=a(c);if("number"==typeof f.data("time")&&f.data("time")==d)return e=f,!1});return e}function q(a,b){b.find("li").removeClass("ui-timepicker-selected");var c=x(r(a),a.data("timepicker-settings"));if(null!==c&&(c=l(a,b,c))){var d=c.offset().top-b.offset().top;(d+c.outerHeight()>b.outerHeight()||0>d)&&b.scrollTop(b.scrollTop()+c.position().top-c.outerHeight());c.addClass("ui-timepicker-selected")}}
function n(b,c){if(""!==this.value&&"timepicker"!=c){var d=a(this);if(!d.is(":focus")||b&&"change"==b.type){var e=d.data("timepicker-settings"),f=x(this.value,e);if(null===f)d.trigger("timeFormatError");else{var g=!1;null!==e.minTime&&f<e.minTime?g=!0:null!==e.maxTime&&f>e.maxTime&&(g=!0);a.each(e.disableTimeRanges,function(){if(f>=this[0]&&f<this[1])return g=!0,!1});e.forceRoundTime&&(f=e.roundingFunction(f,e));e=p(f,e);g?E(d,e,"error")&&d.trigger("timeRangeError"):E(d,e)}}}}function r(a){return a.is("input")?
a.val():a.data("ui-timepicker-value")}function E(a,b,c){if(a.is("input")){a.val(b);var d=a.data("timepicker-settings");d.useSelect&&"select"!=c&&"initial"!=c&&a.data("timepicker-list").val(f(x(b),d))}if(a.data("ui-timepicker-value")!=b)return a.data("ui-timepicker-value",b),"select"==c?a.trigger("selectTime").trigger("changeTime").trigger("change","timepicker"):"error"!=c&&a.trigger("changeTime"),!0;a.trigger("selectTime");return!1}function z(c){var d=a(this),e=d.data("timepicker-list");if(!e||!b(e))if(40==
c.keyCode)A.show.call(d.get(0)),e=d.data("timepicker-list"),h(d)||d.focus();else return!0;switch(c.keyCode){case 13:return D(d)&&A.hide.apply(this),c.preventDefault(),!1;case 38:var f=e.find(".ui-timepicker-selected");f.length?f.is(":first-child")||(f.removeClass("ui-timepicker-selected"),f.prev().addClass("ui-timepicker-selected"),f.prev().position().top<f.outerHeight()&&e.scrollTop(e.scrollTop()-f.outerHeight())):(e.find("li").each(function(b,c){if(0<a(c).position().top)return f=a(c),!1}),f.addClass("ui-timepicker-selected"));
return!1;case 40:return f=e.find(".ui-timepicker-selected"),0===f.length?(e.find("li").each(function(b,c){if(0<a(c).position().top)return f=a(c),!1}),f.addClass("ui-timepicker-selected")):f.is(":last-child")||(f.removeClass("ui-timepicker-selected"),f.next().addClass("ui-timepicker-selected"),f.next().position().top+2*f.outerHeight()>e.outerHeight()&&e.scrollTop(e.scrollTop()+f.outerHeight())),!1;case 27:e.find("li").removeClass("ui-timepicker-selected");A.hide();break;case 9:A.hide();break;default:return!0}}
...
f,b);f.lang&&(m=a.extend(m,f.lang));f=d(f);e.data("timepicker-settings",f);e.addClass("ui-timepicker-input");if(f.useSelect)c(e);else{e.prop("autocomplete","off");e.on("click.timepicker focus.timepicker",A.show);e.on("change.timepicker",n);e.on("keydown.timepicker",z);e.on("keyup.timepicker",I);if(f.disableTextInput)e.on("keypress.timepicker",function(a){a.preventDefault()});n.call(e.get(0))}})},show:function(d){var e=a(this),f=e.data("timepicker-settings");if(d){if(f.showOn!==d.type)return!0;d.preventDefault()}if(f.useSelect)e.data("timepicker-list").focus();
else if(h(e)&&e.blur(),d=e.data("timepicker-list"),!e.prop("readonly")&&(d&&0!==d.length&&"function"!==typeof f.durationTime||(c(e),d=e.data("timepicker-list")),!b(d))){e.data("ui-timepicker-value",e.val());q(e,d);A.hide();d.show();var m={};f.orientation.match(/r/)?m.left=e.offset().left+e.outerWidth()-d.outerWidth()+parseInt(d.css("marginLeft").replace("px",""),10):m.left=e.offset().left+parseInt(d.css("marginLeft").replace("px",""),10);"t"==(f.orientation.match(/t/)?"t":f.orientation.match(/b/)?
"b":e.offset().top+e.outerHeight(!0)+d.outerHeight()>a(window).height()+a(window).scrollTop()?"t":"b")?(d.addClass("ui-timepicker-positioned-top"),m.top=e.offset().top-d.outerHeight()+parseInt(d.css("marginTop").replace("px",""),10)):(d.removeClass("ui-timepicker-positioned-top"),m.top=e.offset().top+e.outerHeight()+parseInt(d.css("marginTop").replace("px",""),10));d.offset(m);m=d.find(".ui-timepicker-selected");m.length||(r(e)?m=l(e,d,x(r(e))):f.scrollDefault&&(m=l(e,d,f.scrollDefault())));m&&m.length?
...
typeof b)return g[b];g=d(g);f.data("timepicker-settings",g);h&&(h.remove(),f.data("timepicker-list",!1));g.useSelect&&c(f)})},getSecondsFromMidnight:function(){return x(r(this))},getTime:function(a){var b=r(this);if(!b)return null;b=x(b);if(null===b)return null;a||(a=new Date);a=new Date(a);a.setHours(b/3600);a.setMinutes(b%3600/60);a.setSeconds(b%60);a.setMilliseconds(0);return a},setTime:function(a){var b=this.data("timepicker-settings"),c=b.forceRoundTime?f(x(a),b):p(x(a),b);a&&null===c&&b.noneOption&&
(c=a);E(this,c);this.data("timepicker-list")&&q(this,this.data("timepicker-list"));return this},remove:function(){if(this.hasClass("ui-timepicker-input")){var a=this.data("timepicker-settings");this.removeAttr("autocomplete","off");this.removeClass("ui-timepicker-input");this.removeData("timepicker-settings");this.off(".timepicker");this.data("timepicker-list")&&this.data("timepicker-list").remove();a.useSelect&&this.show();this.removeData("timepicker-list");return this}}};a.fn.timepicker=function(b){if(!this.length)return this;
if(A[b])return this.hasClass("ui-timepicker-input")?A[b].apply(this,Array.prototype.slice.call(arguments,1)):this;if("object"!==typeof b&&b)a.error("Method "+b+" does not exist on jQuery.timepicker");else return A.init.apply(this,arguments)};a.fn.timepicker.defaults={className:null,minTime:null,maxTime:null,durationTime:null,step:30,showDuration:!1,showOnFocus:!0,showOn:"focus",timeFormat:"g:ia",scrollDefault:null,selectOnBlur:!1,disableTextInput:!1,disableTouchKeyboard:!1,forceRoundTime:!1,roundingFunction:function(a,
