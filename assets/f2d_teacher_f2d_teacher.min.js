(function(a,c){function d(){a.removeEventListener("load",d,!1);h=!0}function b(a){return n=n||new b.Class(a)}function e(a,b){for(var c in b)a[c]=b[c];return a}function f(){"#ath"==c.location.hash&&history.replaceState("",a.document.title,c.location.href.split("#")[0]);l.test(c.location.href)&&history.replaceState("",a.document.title,c.location.href.replace(l,"$1"));q.test(c.location.search)&&history.replaceState("",a.document.title,c.location.href.replace(q,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===c.readyState?h=!0:g&&a.addEventListener("load",d,!1);var l=/\/ath(\/)?$/,q=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,n;b.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
a),e=$("> input#keystudents_a",a),f=e.val(),g=b.val();kest=f.slice(1,-1);kest1=g.slice(1,-1);var f=kest.split(","),g=kest1.split(","),h=function(d,f,g){if(d){if(!g){g=e.val();var h=b.val(),h=h+f+",";e.val(g+d+",");b.val(h)}$(".input-container",a).before('<div class="keystudent"><span>'+d+'</span><a class="remove"></a></div>');$(".list").html("")}};e.css({display:"none"});d.append('<div class="input-container"><input value="" type="text"><div><div class="list"></div>');f.length&&$.each(f,function(a,
b){h(b,a,!0)});d.on("keyup",".input-container input",function(){var a=$(this).val(),b=d.data("to");b&&clearTimeout(b);b=!1;a&&(b=setTimeout(function(){$.ajax({url:"/f2c_teacher/suggestKeystudents",data:{q:a},dataType:"json",success:function(a){var b="";$.each(a,function(a,c){b+='<li rel="'+a+'">'+c+"</li>"});$(".list").html("<ul>"+b+"</ul>");updateSlideHeight(".step.s3")}})},200),d.data("to",b))}).on("keydown",".input-container input",function(a){var b=$(this).val(),c=$(this).attr("rel");13==a.keyCode&&
b&&($(this).val(""),h(b,c))}).on("click",".list li",function(){var b=$(this).text(),e=$(this).attr("rel");b&&($(".input-container input",a).val(""),h(b,e))}).on("click",".keystudent .remove",function(){var a=e.val(),a=a.split(","),a=a.toString(),a=a.replace(/[\])}[{(]/g,""),a=a.split(","),b=$(this).parent().index()-2;a.splice(b,1);e.val(a);$(this).parent().remove();$(".list").html("")});$(document).click(function(a){var b=$(".input-container input").val();""!=b&&(h(b),$(".input-container input").val(""));
...
(function(a,c){"object"==typeof exports?module.exports=c():"function"==typeof define&&define.amd?define(c):a.Spinner=c()})(this,function(){function a(a,b){var c,e=document.createElement(a||"div");for(c in b)e[c]=b[c];return e}function c(a){for(var b=1,c=arguments.length;c>b;b++)a.appendChild(arguments[b]);return a}function d(a,b,c,e){var d=["opacity",b,~~(100*a),c,e].join("-");c=.01+c/e*100;e=Math.max(1-(1-a)/b*(100-c),a);var f=q.substring(0,q.indexOf("Animation")).toLowerCase();return r[d]||(E.insertRule("@"+
(f&&"-"+f+"-"||"")+"keyframes "+d+"{0%{opacity:"+e+"}"+c+"%{opacity:"+a+"}"+(c+.01)+"%{opacity:1}"+(c+b)%100+"%{opacity:"+a+"}100%{opacity:"+e+"}}",E.cssRules.length),r[d]=1),d}function b(a,b){var c,e,d=a.style;b=b.charAt(0).toUpperCase()+b.slice(1);for(e=0;n.length>e;e++)if(c=n[e]+b,void 0!==d[c])return c;return void 0!==d[b]?b:void 0}function e(a,c){for(var e in c)a.style[b(a,e)||e]=c[e];return a}function f(a){for(var b=1;arguments.length>b;b++){var c=arguments[b],e;for(e in c)void 0===a[e]&&(a[e]=
c[e])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=f(a||{},h.defaults,z)}function l(){function b(c,e){return a("<"+c+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}E.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,d){function f(){return e(b("group",{coordsize:u+" "+u,coordorigin:-l+" "+-l}),{width:u,height:u})}function q(a,u,h){c(w,c(e(f(),{rotation:360/d.lines*a+"deg",left:~~u}),c(e(b("roundrect",{arcsize:d.corners}),
{width:l,height:d.width,left:d.radius,top:-d.width>>1,filter:h}),b("fill",{color:g(d.color,a),opacity:d.opacity}),b("stroke",{opacity:0}))))}var h,l=d.length+d.width,u=2*l;h=2*-(d.width+d.length)+"px";var w=e(f(),{position:"absolute",top:h,left:h});if(d.shadow)for(h=1;d.lines>=h;h++)q(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;d.lines>=h;h++)q(h);return c(a,w)};h.prototype.opacity=function(a,b,c,e){a=a.firstChild;e=e.shadow&&e.lines||0;a&&a.childNodes.length>
b+e&&(a=a.childNodes[b+e],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=c))}}var q,n=["webkit","Moz","ms","O"],r={},E=function(){var b=a("style",{type:"text/css"});return c(document.getElementsByTagName("head")[0],b),b.sheet||b.styleSheet}(),z={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};f(h.prototype,{spin:function(b){this.stop();var c=
this,d=c.opts,f=c.el=e(a(0,{className:d.className}),{position:d.position,width:0,zIndex:d.zIndex});if(d.radius+d.length+d.width,e(f,{left:d.left,top:d.top}),b&&b.insertBefore(f,b.firstChild||null),f.setAttribute("role","progressbar"),c.lines(f,c.opts),!q){var g,h=0,l=(d.lines-1)*(1-d.direction)/2,u=d.fps,w=u/d.speed,v=(1-d.opacity)/(w*d.trail/100),B=w/d.lines;(function V(){h++;for(var a=0;d.lines>a;a++)g=Math.max(1-(h+(d.lines-a)*B)%w*v,d.opacity),c.opacity(f,a*d.direction+l,g,d);c.timeout=c.el&&
setTimeout(V,~~(1E3/u))})()}return c},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(b,f){function h(b,c){return e(a(),{position:"absolute",width:f.length+f.width+"px",height:f.width+"px",background:b,boxShadow:c,transformOrigin:"left",transform:"rotate("+~~(360/f.lines*n+f.rotate)+"deg) translate("+f.radius+"px,0)",borderRadius:(f.corners*f.width>>1)+"px"})}for(var l,n=0,r=(f.lines-1)*(1-f.direction)/
2;f.lines>n;n++)l=e(a(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:q&&d(f.opacity,f.trail,r+n*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&c(l,e(h("#000","0 0 4px #000"),{top:"2px"})),c(b,c(l,h(g(f.color,n),"0 0 1px rgba(0,0,0,.1)")));return b},opacity:function(a,b,c){a.childNodes.length>b&&(a.childNodes[b].style.opacity=c)}});var I=e(a("group"),{behavior:"url(#default#VML)"});return!b(I,"transform")&&
I.adj?l():q=b(I,"animation"),h});
...
qq.AjaxRequestor=function(a){function c(a){var b=qq.indexOf(l,a),c=n.maxConnections;delete q[a];l.splice(b,1);l.length>=c&&b<c&&(a=l[c-1],d(a))}function d(a){var c=new XMLHttpRequest,d=f(),l={},D;n.onSend(a);n.paramsStore.getParams&&(l=n.paramsStore.getParams(a));D=l;var t=n.endpointStore.getEndpoint(a),p=q[a].addToPath;void 0!==p&&(t+="/"+p);D=h&&D?qq.obj2url(D,t):t;q[a].xhr=c;c.onreadystatechange=b(a);c.open(d,D,!0);n.cors.expected&&n.cors.sendCredentials&&(c.withCredentials=!0);e(a);g("Sending "+
d+" request for "+a);!h&&l?c.send(qq.obj2url(l,"")):c.send()}function b(a){var b=q[a].xhr;return function(){if(4===b.readyState){var e=q[a].xhr,d=f(),h=!1;c(a);0<=qq.indexOf(n.successfulResponseCodes,e.status)||(h=!0,g(d+" request for "+a+" has failed - response code "+e.status,"error"));n.onComplete(a,e,h)}}}function e(a){var b=q[a].xhr;a=n.customHeaders;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,c){b.setRequestHeader(a,
c)})}function f(){return n.demoMode?"GET":n.method}var g,h,l=[],q=[],n={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(n,a);g=n.log;h="GET"===f()||"DELETE"===f();return{send:function(a,b){q[a]={addToPath:b};l.push(a)<=n.maxConnections&&d(a)},cancel:function(a){var b=q[a].xhr,e=f();b?(b.onreadystatechange=
...
qq.UploadHandlerForm=function(a,c,d){function b(a){void 0!==r[a]&&(r[a](),delete r[a])}function e(a,c){var e=a.id;D[n[e]]=c;r[e]=qq(a).attach("load",function(){q[e]&&(z("Received iframe load event for CORS upload request (file id "+e+")"),E[e]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+e;z(a,"error");c({error:a})},1E3))});I.receiveMessage(e,function(a){z("Received the following window message: '"+a+"'");var c=qq.parseJson(a),d=c.uuid;d&&D[d]?(clearTimeout(E[e]),
delete E[e],b(e),a=D[d],delete D[d],I.stopReceivingMessages(e),a(c)):d||z("'"+a+"' does not contain a UUID - ignoring.")})}function f(a,b){l.cors.expected?e(a,b):r[a.id]=qq(a).attach("load",function(){z("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(c){z("Error when attempting to access iframe during handling of upload response ("+c+")","error")}b()}})}function g(a){var b=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');b.setAttribute("id",a);b.style.display="none";document.body.appendChild(b);return b}function h(a,b){var c=l.paramsStore.getParams(a),e=qq.toElement('<form method="'+(l.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),d=l.endpointStore.getEndpoint(a),f=d;c[l.uuidParamName]=n[a];l.paramsInBody?qq.obj2Inputs(c,e):f=qq.obj2url(c,d);e.setAttribute("action",f);e.setAttribute("target",b.name);e.style.display="none";document.body.appendChild(e);return e}var l=a,q=[],n=[],r={},E=
{},z=d,I=new qq.WindowReceiveMessage({log:z}),D={},t;return t={add:function(a){a.setAttribute("name",l.inputName);var b=q.push(a)-1;n[b]=qq.getUniqueId();a.parentNode&&qq(a).remove();return b},getName:function(a){if(t.isValid(a))return q[a].value.replace(/.*(\/|\\)/,"");z(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==q[a]},reset:function(){q=[];n=[];r={}},getUuid:function(a){return n[a]},cancel:function(a){l.onCancel(a,this.getName(a));delete q[a];delete n[a];delete r[a];
...
z("converting iframe's innerHTML to JSON");z("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);f=qq.parseJson(h)}catch(y){z("Error when attempting to parse form upload response ("+y+")","error"),f={success:!1}}e=f}b(a);l.cors.expected||qq(m).remove();if(e.success||!l.onAutoRetry(a,d,e))l.onComplete(a,d,e),c(a)});z("Sending upload request for "+a);n.submit();qq(n).remove();return a}}};
qq.UploadHandlerXhr=function(a,c,d){function b(a,b,c){var e=y.getSize(a);a=y.getName(a);b[p.chunking.paramNames.partIndex]=c.part;b[p.chunking.paramNames.partByteOffset]=c.start;b[p.chunking.paramNames.chunkSize]=c.size;b[p.chunking.paramNames.totalParts]=c.count;b[p.totalFileSizeParamName]=e;B&&(b[p.chunking.paramNames.filename]=a)}function e(a,b){var c=p.chunking.partSize,e=y.getSize(a),d=m[a].file||m[a].blobData.blob,u=c*b,c=u+c>=e?e:u+c,e=f(a),g;d.slice?g=d.slice(u,c):d.mozSlice?g=d.mozSlice(u,
c):d.webkitSlice&&(g=d.webkitSlice(u,c));return{part:b,start:u,end:c,count:e,blob:g,size:c-u}}function f(a){a=y.getSize(a);return Math.ceil(a/p.chunking.partSize)}function g(a,b,c,e){var d=new FormData,f=p.demoMode?"GET":"POST",u=p.endpointStore.getEndpoint(e),g=u,h=y.getName(e),l=y.getSize(e),w=m[e].blobData;a[p.uuidParamName]=m[e].uuid;B&&(a[p.totalFileSizeParamName]=l,w&&(a[p.blobs.paramNames.name]=w.name));p.paramsInBody||(B||(a[p.inputName]=h),g=qq.obj2url(a,u));b.open(f,g,!0);p.cors.expected&&
p.cors.sendCredentials&&(b.withCredentials=!0);return B?(p.paramsInBody&&qq.obj2FormData(a,d),d.append(p.inputName,c),d):c}function h(a,b){var c=p.customHeaders,e=m[a].file||m[a].blobData.blob;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");B||(b.setRequestHeader("Content-Type","application/octet-stream"),b.setRequestHeader("X-Mime-Type",e.type));qq.each(c,function(a,c){b.setRequestHeader(a,c)})}function l(a,b,c){var e=y.getName(a),d=y.getSize(a);
m[a].attemptingResume=!1;p.onProgress(a,e,d,d);p.onComplete(a,e,b,c);delete m[a].xhr;x(a)}function q(a){var c=m[a].remainingChunkIdxs[0],d=e(a,c),f=m[a].xhr=new XMLHttpRequest,u=y.getSize(a),l=y.getName(a),v;void 0===m[a].loaded&&(m[a].loaded=0);w&&m[a].file&&z(a,d);f.onreadystatechange=E(a,f);f.upload.onprogress=function(b){if(b.lengthComputable){var d=b.loaded+m[a].loaded;b=b.total;var f=e(a,c);b-=f.size;var u=y.getSize(a),f=f.count,g=b-m[a].initialRequestOverhead;m[a].lastRequestOverhead=b;0===
c?(m[a].lastChunkIdxProgress=0,m[a].initialRequestOverhead=b,m[a].estTotalRequestsSize=u+f*b):m[a].lastChunkIdxProgress!==c&&(m[a].lastChunkIdxProgress=c,m[a].estTotalRequestsSize+=g);p.onProgress(a,l,d,m[a].estTotalRequestsSize)}};p.onUploadChunk(a,l,r(d));v=p.paramsStore.getParams(a);b(a,v,d);m[a].attemptingResume&&(v[p.resume.paramNames.resuming]=!0);v=g(v,f,d.blob,a);h(a,f);K("Sending chunked upload request for item "+a+": bytes "+(d.start+1)+"-"+d.end+" of "+u);f.send(v)}function n(a){K("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");w&&(I(a),m[a].attemptingResume=!1);m[a].remainingChunkIdxs=[];delete m[a].loaded;delete m[a].estTotalRequestsSize;delete m[a].initialRequestOverhead}function r(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function E(a,b){return function(){if(4===b.readyState){var c;if(m[a]){K("xhr - server response received for "+a);K("responseText = "+b.responseText);try{c=qq.parseJson(b.responseText)}catch(d){K("Error when attempting to parse xhr response text ("+d+
")","error"),c={}}if(200!==b.status||!c.success||c.reset)if(c.reset&&n(a),m[a].attemptingResume&&c.reset)m[a].attemptingResume=!1,K("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),n(a),y.upload(a,!0);else{var f=y.getName(a);p.onAutoRetry(a,f,c,b)||l(a,c,b)}else if(u){var f=m[a].remainingChunkIdxs.shift(),g=e(a,f);m[a].attemptingResume=!1;var f=m[a],h=f.loaded,g=g.size;f.loaded=h+(g+(B?m[a].lastRequestOverhead:0));0<m[a].remainingChunkIdxs.length?
q(a):(w&&I(a),l(a,c,b))}else l(a,c,b)}}}}function z(a,b){var c=y.getUuid(a),e=m[a].loaded,d=m[a].initialRequestOverhead,f=m[a].estTotalRequestsSize,u=D(a);qq.setCookie(u,c+A+b.part+A+e+A+d+A+f,p.resume.cookiesExpireIn)}function I(a){m[a].file&&(a=D(a),qq.deleteCookie(a))}function D(a){var b=y.getName(a);a=y.getSize(a);var c=p.chunking.partSize,b="qqfilechunk"+A+encodeURIComponent(b)+A+a+A+c;void 0!==v&&(b+=A+v);return b}function t(a){var b=m[a].file||m[a].blobData.blob,c=y.getName(a),e,d;m[a].loaded=
0;e=m[a].xhr=new XMLHttpRequest;e.upload.onprogress=function(b){b.lengthComputable&&(m[a].loaded=b.loaded,p.onProgress(a,c,b.loaded,b.total))};e.onreadystatechange=E(a,e);d=p.paramsStore.getParams(a);b=g(d,e,b,a);h(a,e);K("Sending upload request for "+a);e.send(b)}var p=a,x=c,K=d,m=[],A="|",u=p.chunking.enabled&&qq.supportedFeatures.chunking,w=p.resume.enabled&&u&&qq.supportedFeatures.resume,v;v=null===p.resume.id||void 0===p.resume.id||qq.isFunction(p.resume.id)||qq.isObject(p.resume.id)?void 0:
p.resume.id;var B=p.forceMultipart||p.paramsInBody,y;return y={add:function(a){if(a instanceof File)a=m.push({file:a})-1;else if(qq.isBlob(a.blob))a=m.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");m[a].uuid=qq.getUniqueId();return a},getName:function(a){if(y.isValid(a)){var b=m[a].file;a=m[a].blobData;return b?null!==b.fileName&&void 0!==b.fileName?b.fileName:b.name:a.name}K(a+" is not a valid item ID.","error")},getSize:function(a){a=m[a].file||
m[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(m[a])return m[a].file||m[a].blobData.blob},getLoaded:function(a){return m[a].loaded||0},isValid:function(a){return void 0!==m[a]},reset:function(){m=[]},getUuid:function(a){return m[a].uuid},upload:function(a,b){var c=this.getName(a);p.onUpload(a,c);if(u){var d=y.getName(a),c=0,g,h;if(!m[a].remainingChunkIdxs||0===m[a].remainingChunkIdxs.length){m[a].remainingChunkIdxs=[];if(w&&!b&&m[a].file){a:{g=
qq.getCookie(D(a));h=y.getName(a);var l,v,k;if(g){g=g.split(A);if(5===g.length){h=g[0];l=parseInt(g[1],10);v=parseInt(g[2],10);k=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:l,lastByteSent:v,initialRequestOverhead:k,estTotalRequestsSize:g};break a}K("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=e(a,g.part),!1!==p.onResume(a,d,r(h))&&(c=g.part,m[a].uuid=g.uuid,m[a].loaded=g.lastByteSent,m[a].estTotalRequestsSize=g.estTotalRequestsSize,
m[a].initialRequestOverhead=g.initialRequestOverhead,m[a].attemptingResume=!0,K("Resuming "+d+" at partition index "+c)))}for(d=f(a)-1;d>=c;--d)m[a].remainingChunkIdxs.unshift(d)}q(a)}else t(a)},cancel:function(a){var b=m[a].xhr;p.onCancel(a,this.getName(a));b&&(b.onreadystatechange=null,b.abort());w&&I(a);delete m[a]},getResumableFilesData:function(){var a=[],b=[];return u&&w?(a=void 0===v?qq.getCookieNames(RegExp("^qqfilechunk\\"+A+".+\\"+A+"\\d+\\"+A+p.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
A+".+\\"+A+"\\d+\\"+A+p.chunking.partSize+"\\"+A+v+"=")),qq.each(a,function(a,c){var e=c.split(A),d=qq.getCookie(c).split(A);b.push({name:decodeURIComponent(e[1]),size:e[2],uuid:d[0],partIdx:d[1]})}),b):[]}}};
(function(a){var c,d,b,e,f,g,h,l,q,n;g=["uploaderType"];b=function(a){a&&(a=l(a),h(a),"basic"===f("uploaderType")?c(new qq.FineUploaderBasic(a)):c(new qq.FineUploader(a)));return d};e=function(a,b){var c=d.data("fineuploader");if(b)void 0===c&&(c={}),c[a]=b,d.data("fineuploader",c);else return void 0===c?null:c[a]};c=function(a){return e("uploader",a)};f=function(a,b){return e(a,b)};h=function(b){var c=b.callbacks={};b=new qq.FineUploaderBasic;a.each(b._options.callbacks,function(a){var b,e;b=/^on(\w+)/.exec(a)[1];
...
!b.match(/^_/)&&void 0!==c()[b]};n=function(a){var b=[],e=Array.prototype.slice.call(arguments,1);l(e,b);return c()[a].apply(c(),b)};a.fn.fineUploader=function(e){var f=this,g=arguments,h=[];this.each(function(l,t){d=a(t);if(c()&&q(e)){if(h.push(n.apply(f,g)),1===f.length)return!1}else"object"!==typeof e&&e?a.error("Method "+e+" does not exist on jQuery.fineUploader"):b.apply(f,g)});return 1===h.length?h[0]:1<h.length?h:this}})(jQuery);
...
"next"==b?"first":"last",n=this;if(!g.length){if(!this.options.wrap)return;g=this.$element.find(".item")[q]()}this.sliding=!0;h&&this.pause();q=a.Event("slide.bs.carousel",{relatedTarget:g[0],direction:l});if(!g.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var b=a(n.$indicators.children()[n.getActiveIndex()]);b&&b.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(q),
q.isDefaultPrevented())return;g.addClass(b);g[0].offsetWidth;d.addClass(l);g.addClass(l);d.one(a.support.transition.end,function(){g.removeClass([b,l].join(" ")).addClass("active");d.removeClass(["active",l].join(" "));n.sliding=!1;setTimeout(function(){n.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{if(this.$element.trigger(q),q.isDefaultPrevented())return;d.removeClass("active");g.addClass("active");this.sliding=!1;this.$element.trigger("slid")}return h&&this.cycle(),this}};var d=
...
c.appendTo(this.options.container):c.insertAfter(this.$element);var d=this.getPosition(),h=c[0].offsetWidth,l=c[0].offsetHeight;if(g){var q=this.$element.parent(),g=b,n=document.documentElement.scrollTop||document.body.scrollTop,r="body"==this.options.container?window.innerWidth:q.outerWidth(),E="body"==this.options.container?window.innerHeight:q.outerHeight(),q="body"==this.options.container?0:q.offset().left,b="bottom"==b&&d.top+d.height+l-n>E?"top":"top"==b&&0>d.top-n-l?"bottom":"right"==b&&d.right+
h>r?"left":"left"==b&&d.left-h<q?"right":b;c.removeClass(g).addClass(b)}c=this.getCalculatedOffset(b,d,h,l);this.applyPlacement(c,b);this.$element.trigger("shown.bs."+this.type)}};c.prototype.applyPlacement=function(a,c){var d,g=this.tip(),h=g[0].offsetWidth,l=g[0].offsetHeight,q=parseInt(g.css("margin-top"),10),n=parseInt(g.css("margin-left"),10);isNaN(q)&&(q=0);isNaN(n)&&(n=0);a.top+=q;a.left+=n;g.offset(a).addClass("in");q=g[0].offsetWidth;n=g[0].offsetHeight;("top"==c&&n!=l&&(d=!0,a.top=a.top+
l-n),/bottom|top/.test(c))?(l=0,0>a.left&&(l=-2*a.left,a.left=0,g.offset(a),q=g[0].offsetWidth),this.replaceArrow(l-h+q,q,"left")):this.replaceArrow(n-l,n,"top");d&&g.offset(a)};c.prototype.replaceArrow=function(a,c,d){this.arrow().css(d,a?50*(1-a/c)+"%":"")};c.prototype.setContent=function(){var a=this.tip(),c=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](c);a.removeClass("fade in top bottom left right")};c.prototype.hide=function(){function b(){"in"!=c.hoverState&&d.detach()}
...
b(F,"LoadedContent","width:0; height:0; overflow:hidden"),x.css({width:"",height:""}).append(B),J=K.height()+u.height()+x.outerHeight(!0)-x.height(),N=m.width()+A.width()+x.outerWidth(!0)-x.width(),S=B.outerHeight(!0),T=B.outerWidth(!0),k.w=g(k.initialWidth,"x"),k.h=g(k.initialHeight,"y"),B.css({width:"",height:k.h}),G.position(),n(pa,k.onOpen),O.add(fa).hide(),t.focus(),k.trapFocus&&c.addEventListener&&(c.addEventListener("focus",l,!0),P.one(ja,function(){c.removeEventListener("focus",l,!0)})),k.returnFocus&&
P.one(ja,function(){a(M).focus()})),I())}function E(){!t&&c.body&&(ka=!1,v=a(d),t=b(F).attr({id:Q,"class":!1===a.support.opacity?H+"IE":"",role:"dialog",tabindex:"-1"}).hide(),D=b(F,"Overlay").hide(),V=a([b(F,"LoadingOverlay")[0],b(F,"LoadingGraphic")[0]]),p=b(F,"Wrapper"),x=b(F,"Content").append(fa=b(F,"Title"),ga=b(F,"Current"),Z=a('<button type="button"/>').attr({id:H+"Previous"}),Y=a('<button type="button"/>').attr({id:H+"Next"}),W=b("button","Slideshow"),V),U=a('<button type="button"/>').attr({id:H+
"Close"}),p.append(b(F).append(b(F,"TopLeft"),K=b(F,"TopCenter"),b(F,"TopRight")),b(F,!1,"clear:left").append(m=b(F,"MiddleLeft"),x,A=b(F,"MiddleRight")),b(F,!1,"clear:left").append(b(F,"BottomLeft"),u=b(F,"BottomCenter"),b(F,"BottomRight"))).find("div div").css({"float":"left"}),y=b(F,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=Y.add(Z).add(ga).add(W),a(c.body).append(D,t.append(p,y)))}function z(){function b(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),r(this))}return t?(ka||(ka=!0,Y.click(function(){G.next()}),Z.click(function(){G.prev()}),U.click(function(){G.close()}),D.click(function(){k.overlayClose&&G.close()}),a(c).bind("keydown."+H,function(a){var b=a.keyCode;R&&k.escKey&&27===b&&(a.preventDefault(),G.close());R&&k.arrowKey&&w[1]&&!a.altKey&&(37===b?(a.preventDefault(),Z.click()):39===b&&(a.preventDefault(),Y.click()))}),a.isFunction(a.fn.on)?a(c).on("click."+H,"."+X,b):a("."+X).live("click."+H,b)),!0):!1}
function I(){var e,f,u,v=G.prep,l=++la;ba=!0;C=!1;M=w[L];q();n(ca);n(da,k.onLoad);k.h=k.height?g(k.height,"y")-S-J:k.innerHeight&&g(k.innerHeight,"y");k.w=k.width?g(k.width,"x")-T-N:k.innerWidth&&g(k.innerWidth,"x");k.mw=k.w;k.mh=k.h;k.maxWidth&&(k.mw=g(k.maxWidth,"x")-T-N,k.mw=k.w&&k.w<k.mw?k.w:k.mw);k.maxHeight&&(k.mh=g(k.maxHeight,"y")-S-J,k.mh=k.h&&k.h<k.mh?k.h:k.mh);e=k.href;na=setTimeout(function(){V.show()},100);k.inline?(u=b(F).hide().insertBefore(a(e)[0]),P.one(ca,function(){u.replaceWith(B.children())}),
v(a(e))):k.iframe?v(" "):k.html?v(k.html):k.photo||k.photoRegex.test(e)?(e=h(k,e),C=c.createElement("img"),a(C).addClass(H+"Photo").bind("error",function(){k.title=!1;v(b(F,"Error").html(k.imgError))}).one("load",function(){var b;l===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(M).attr(c)||a(M).attr("data-"+c);d&&C.setAttribute(c,d)}),k.retinaImage&&1<d.devicePixelRatio&&(C.height/=d.devicePixelRatio,C.width/=d.devicePixelRatio),k.scalePhotos&&(f=function(){C.height-=C.height*
b;C.width-=C.width*b},k.mw&&C.width>k.mw&&(b=(C.width-k.mw)/C.width,f()),k.mh&&C.height>k.mh&&(b=(C.height-k.mh)/C.height,f())),k.h&&(C.style.marginTop=Math.max(k.mh-C.height,0)/2+"px"),w[1]&&(k.loop||w[L+1])&&(C.style.cursor="pointer",C.onclick=function(){G.next()}),C.style.width=C.width+"px",C.style.height=C.height+"px",setTimeout(function(){v(C)},1))}),setTimeout(function(){C.src=e},1)):e&&y.load(e,k.data,function(c,d){l===la&&v("error"===d?b(F,"Error").html(k.xhrError):a(this).contents())})}var D,
...
b&&B.scrollTop(b),G.position("none"===k.transition?0:k.speed))},G.prep=function(d){if(R){var e,u="none"===k.transition?0:k.speed;B.empty().remove();B=b(F,"LoadedContent").append(d);B.hide().appendTo(y.show()).css({width:(k.w=k.w||B.width(),k.w=k.mw&&k.mw<k.w?k.mw:k.w,k.w),overflow:k.scrolling?"auto":"hidden"}).css({height:(k.h=k.h||B.height(),k.h=k.mh&&k.mh<k.h?k.mh:k.h,k.h)}).prependTo(x);y.hide();a(C).css({"float":"none"});e=function(){function d(){!1===a.support.opacity&&t[0].style.removeAttribute("filter")}
var e,g,v=w.length;R&&(g=function(){clearTimeout(na);V.hide();n(ea,k.onComplete)},fa.html(k.title).add(B).show(),1<v?("string"==typeof k.current&&ga.html(k.current.replace("{current}",L+1).replace("{total}",v)).show(),Y[k.loop||v-1>L?"show":"hide"]().html(k.next),Z[k.loop||L?"show":"hide"]().html(k.previous),qa(),k.preloading&&a.each([f(-1),f(1)],function(){var b,d,e=w[this],f=a.data(e,Q);f&&f.href?(b=f.href,a.isFunction(b)&&(b=b.call(e))):b=a(e).attr("href");b&&(f.photo||f.photoRegex.test(b))&&(b=
h(f,b),d=c.createElement("img"),d.src=b)})):O.hide(),k.iframe?(e=b("iframe")[0],"frameBorder"in e&&(e.frameBorder=0),"allowTransparency"in e&&(e.allowTransparency="true"),k.scrolling||(e.scrolling="no"),a(e).attr({src:k.href,name:(new Date).getTime(),"class":H+"Iframe",allowFullScreen:!0,webkitAllowFullScreen:!0,mozallowfullscreen:!0}).one("load",g).appendTo(B),P.one(ca,function(){e.src="//about:blank"}),k.fastIframe&&a(e).trigger("load")):g(),"fade"===k.transition?t.fadeTo(u,1,d):d())};"fade"===
...
a.val():a.data("ui-timepicker-value")}function E(a,b,c){if(a.is("input")){a.val(b);var d=a.data("timepicker-settings");d.useSelect&&"select"!=c&&"initial"!=c&&a.data("timepicker-list").val(f(x(b),d))}if(a.data("ui-timepicker-value")!=b)return a.data("ui-timepicker-value",b),"select"==c?a.trigger("selectTime").trigger("changeTime").trigger("change","timepicker"):"error"!=c&&a.trigger("changeTime"),!0;a.trigger("selectTime");return!1}function z(b){var d=a(this),e=d.data("timepicker-list");if(!e||!c(e))if(40==
b.keyCode)A.show.call(d.get(0)),e=d.data("timepicker-list"),h(d)||d.focus();else return!0;switch(b.keyCode){case 13:return D(d)&&A.hide.apply(this),b.preventDefault(),!1;case 38:var f=e.find(".ui-timepicker-selected");f.length?f.is(":first-child")||(f.removeClass("ui-timepicker-selected"),f.prev().addClass("ui-timepicker-selected"),f.prev().position().top<f.outerHeight()&&e.scrollTop(e.scrollTop()-f.outerHeight())):(e.find("li").each(function(b,c){if(0<a(c).position().top)return f=a(c),!1}),f.addClass("ui-timepicker-selected"));
...
(m=d.scrollTop()+m.position().top-m.outerHeight(),d.scrollTop(m)):d.scrollTop(0);if(f.stopScrollPropagation)a(document).on("wheel.ui-timepicker",".ui-timepicker-wrapper",function(b){b.preventDefault();var c=a(this).scrollTop();a(this).scrollTop(c+b.originalEvent.deltaY)});a(document).on("touchstart.ui-timepicker mousedown.ui-timepicker",g);a(window).on("resize.ui-timepicker",g);if(f.closeOnWindowScroll)a(document).on("scroll.ui-timepicker",g);e.trigger("showTimepicker");return this}},hide:function(b){b=
a(this);var d=b.data("timepicker-settings");d&&d.useSelect&&b.blur();a(".ui-timepicker-wrapper").each(function(){var b=a(this);if(c(b)){var d=b.data("timepicker-input"),e=d.data("timepicker-settings");e&&e.selectOnBlur&&D(d);b.hide();d.trigger("hideTimepicker")}});return this},option:function(c,e){return this.each(function(){var f=a(this),g=f.data("timepicker-settings"),h=f.data("timepicker-list");if("object"==typeof c)g=a.extend(g,c);else if("string"==typeof c&&"undefined"!=typeof e)g[c]=e;else if("string"==
typeof c)return g[c];g=d(g);f.data("timepicker-settings",g);h&&(h.remove(),f.data("timepicker-list",!1));g.useSelect&&b(f)})},getSecondsFromMidnight:function(){return x(r(this))},getTime:function(a){var b=r(this);if(!b)return null;b=x(b);if(null===b)return null;a||(a=new Date);a=new Date(a);a.setHours(b/3600);a.setMinutes(b%3600/60);a.setSeconds(b%60);a.setMilliseconds(0);return a},setTime:function(a){var b=this.data("timepicker-settings"),c=b.forceRoundTime?f(x(a),b):p(x(a),b);a&&null===c&&b.noneOption&&
