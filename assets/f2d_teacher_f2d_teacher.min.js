(function(a,b){function d(){a.removeEventListener("load",d,!1);h=!0}function c(a){return n=n||new c.Class(a)}function e(a,c){for(var b in c)a[b]=c[b];return a}function f(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);l.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(l,"$1"));p.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(p,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===b.readyState?h=!0:g&&a.addEventListener("load",d,!1);var l=/\/ath(\/)?$/,p=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,n;c.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};r=a.navigator.userAgent;var E=a.navigator;e(c,{hasToken:"#ath"==b.location.hash||l.test(b.location.href)||p.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(r),isMobileChrome:-1<r.indexOf("Android")&&/Chrome\/[.0-9]*/.test(r)&&-1==r.indexOf("Version"),isMobileIE:-1<r.indexOf("Windows Phone"),language:E.language&&
...
b[e])}return a}function g(a,c){return"string"==typeof a?a:a[c%a.length]}function h(a){this.opts=f(a||{},h.defaults,z)}function l(){function c(b,e){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}E.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,d){function f(){return e(c("group",{coordsize:u+" "+u,coordorigin:-l+" "+-l}),{width:u,height:u})}function p(a,u,h){b(w,b(e(f(),{rotation:360/d.lines*a+"deg",left:~~u}),b(e(c("roundrect",{arcsize:d.corners}),
{width:l,height:d.width,left:d.radius,top:-d.width>>1,filter:h}),c("fill",{color:g(d.color,a),opacity:d.opacity}),c("stroke",{opacity:0}))))}var h,l=d.length+d.width,u=2*l;h=2*-(d.width+d.length)+"px";var w=e(f(),{position:"absolute",top:h,left:h});if(d.shadow)for(h=1;d.lines>=h;h++)p(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;d.lines>=h;h++)p(h);return b(a,w)};h.prototype.opacity=function(a,c,b,e){a=a.firstChild;e=e.shadow&&e.lines||0;a&&a.childNodes.length>
c+e&&(a=a.childNodes[c+e],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=b))}}var p,n=["webkit","Moz","ms","O"],r={},E=function(){var c=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],c),c.sheet||c.styleSheet}(),z={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};f(h.prototype,{spin:function(c){this.stop();var b=
this,d=b.opts,f=b.el=e(a(0,{className:d.className}),{position:d.position,width:0,zIndex:d.zIndex});if(d.radius+d.length+d.width,e(f,{left:d.left,top:d.top}),c&&c.insertBefore(f,c.firstChild||null),f.setAttribute("role","progressbar"),b.lines(f,b.opts),!p){var g,h=0,l=(d.lines-1)*(1-d.direction)/2,u=d.fps,w=u/d.speed,v=(1-d.opacity)/(w*d.trail/100),B=w/d.lines;(function V(){h++;for(var a=0;d.lines>a;a++)g=Math.max(1-(h+(d.lines-a)*B)%w*v,d.opacity),b.opacity(f,a*d.direction+l,g,d);b.timeout=b.el&&
...
2;f.lines>n;n++)l=e(a(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:p&&d(f.opacity,f.trail,r+n*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&b(l,e(h("#000","0 0 4px #000"),{top:"2px"})),b(c,b(l,h(g(f.color,n),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,c,b){a.childNodes.length>c&&(a.childNodes[c].style.opacity=b)}});var I=e(a("group"),{behavior:"url(#default#VML)"});return!c(I,"transform")&&
I.adj?l():p=c(I,"animation"),h});
...
qq.AjaxRequestor=function(a){function b(a){var c=qq.indexOf(l,a),b=n.maxConnections;delete p[a];l.splice(c,1);l.length>=b&&c<b&&(a=l[b-1],d(a))}function d(a){var b=new XMLHttpRequest,d=f(),l={},D;n.onSend(a);n.paramsStore.getParams&&(l=n.paramsStore.getParams(a));D=l;var t=n.endpointStore.getEndpoint(a),q=p[a].addToPath;void 0!==q&&(t+="/"+q);D=h&&D?qq.obj2url(D,t):t;p[a].xhr=b;b.onreadystatechange=c(a);b.open(d,D,!0);n.cors.expected&&n.cors.sendCredentials&&(b.withCredentials=!0);e(a);g("Sending "+
...
b)})}function f(){return n.demoMode?"GET":n.method}var g,h,l=[],p=[],n={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(n,a);g=n.log;h="GET"===f()||"DELETE"===f();return{send:function(a,c){p[a]={addToPath:c};l.push(a)<=n.maxConnections&&d(a)},cancel:function(a){var c=p[a].xhr,e=f();c?(c.onreadystatechange=
...
qq.UploadHandlerForm=function(a,b,d){function c(a){void 0!==r[a]&&(r[a](),delete r[a])}function e(a,b){var e=a.id;D[n[e]]=b;r[e]=qq(a).attach("load",function(){p[e]&&(z("Received iframe load event for CORS upload request (file id "+e+")"),E[e]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+e;z(a,"error");b({error:a})},1E3))});I.receiveMessage(e,function(a){z("Received the following window message: '"+a+"'");var b=qq.parseJson(a),d=b.uuid;d&&D[d]?(clearTimeout(E[e]),
...
a+'" />');c.setAttribute("id",a);c.style.display="none";document.body.appendChild(c);return c}function h(a,c){var b=l.paramsStore.getParams(a),e=qq.toElement('<form method="'+(l.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),d=l.endpointStore.getEndpoint(a),f=d;b[l.uuidParamName]=n[a];l.paramsInBody?qq.obj2Inputs(b,e):f=qq.obj2url(b,d);e.setAttribute("action",f);e.setAttribute("target",c.name);e.style.display="none";document.body.appendChild(e);return e}var l=a,p=[],n=[],r={},E=
{},z=d,I=new qq.WindowReceiveMessage({log:z}),D={},t;return t={add:function(a){a.setAttribute("name",l.inputName);var c=p.push(a)-1;n[c]=qq.getUniqueId();a.parentNode&&qq(a).remove();return c},getName:function(a){if(t.isValid(a))return p[a].value.replace(/.*(\/|\\)/,"");z(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==p[a]},reset:function(){p=[];n=[];r={}},getUuid:function(a){return n[a]},cancel:function(a){l.onCancel(a,this.getName(a));delete p[a];delete n[a];delete r[a];
l.cors.expected&&(clearTimeout(E[a]),delete E[a],I.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var e=p[a],d=t.getName(a),m=g(a),n;if(!e)throw Error("file with passed id was not added, or already uploaded or cancelled");l.onUpload(a,this.getName(a));n=h(a,m);n.appendChild(e);f(m,function(e){z("iframe loaded");if(!e){var f;try{var g=m.contentDocument||m.contentWindow.document,h=g.body.innerHTML;
...
qq.UploadHandlerXhr=function(a,b,d){function c(a,c,b){var e=y.getSize(a);a=y.getName(a);c[q.chunking.paramNames.partIndex]=b.part;c[q.chunking.paramNames.partByteOffset]=b.start;c[q.chunking.paramNames.chunkSize]=b.size;c[q.chunking.paramNames.totalParts]=b.count;c[q.totalFileSizeParamName]=e;B&&(c[q.chunking.paramNames.filename]=a)}function e(a,c){var b=q.chunking.partSize,e=y.getSize(a),d=m[a].file||m[a].blobData.blob,u=b*c,b=u+b>=e?e:u+b,e=f(a),g;d.slice?g=d.slice(u,b):d.mozSlice?g=d.mozSlice(u,
b):d.webkitSlice&&(g=d.webkitSlice(u,b));return{part:c,start:u,end:b,count:e,blob:g,size:b-u}}function f(a){a=y.getSize(a);return Math.ceil(a/q.chunking.partSize)}function g(a,c,b,e){var d=new FormData,f=q.demoMode?"GET":"POST",u=q.endpointStore.getEndpoint(e),g=u,h=y.getName(e),l=y.getSize(e),w=m[e].blobData;a[q.uuidParamName]=m[e].uuid;B&&(a[q.totalFileSizeParamName]=l,w&&(a[q.blobs.paramNames.name]=w.name));q.paramsInBody||(B||(a[q.inputName]=h),g=qq.obj2url(a,u));c.open(f,g,!0);q.cors.expected&&
q.cors.sendCredentials&&(c.withCredentials=!0);return B?(q.paramsInBody&&qq.obj2FormData(a,d),d.append(q.inputName,b),d):b}function h(a,c){var b=q.customHeaders,e=m[a].file||m[a].blobData.blob;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");B||(c.setRequestHeader("Content-Type","application/octet-stream"),c.setRequestHeader("X-Mime-Type",e.type));qq.each(b,function(a,b){c.setRequestHeader(a,b)})}function l(a,c,b){var e=y.getName(a),d=y.getSize(a);
m[a].attemptingResume=!1;q.onProgress(a,e,d,d);q.onComplete(a,e,c,b);delete m[a].xhr;x(a)}function p(a){var b=m[a].remainingChunkIdxs[0],d=e(a,b),f=m[a].xhr=new XMLHttpRequest,u=y.getSize(a),l=y.getName(a),v;void 0===m[a].loaded&&(m[a].loaded=0);w&&m[a].file&&z(a,d);f.onreadystatechange=E(a,f);f.upload.onprogress=function(c){if(c.lengthComputable){var d=c.loaded+m[a].loaded;c=c.total;var f=e(a,b);c-=f.size;var u=y.getSize(a),f=f.count,g=c-m[a].initialRequestOverhead;m[a].lastRequestOverhead=c;0===
b?(m[a].lastChunkIdxProgress=0,m[a].initialRequestOverhead=c,m[a].estTotalRequestsSize=u+f*c):m[a].lastChunkIdxProgress!==b&&(m[a].lastChunkIdxProgress=b,m[a].estTotalRequestsSize+=g);q.onProgress(a,l,d,m[a].estTotalRequestsSize)}};q.onUploadChunk(a,l,r(d));v=q.paramsStore.getParams(a);c(a,v,d);m[a].attemptingResume&&(v[q.resume.paramNames.resuming]=!0);v=g(v,f,d.blob,a);h(a,f);K("Sending chunked upload request for item "+a+": bytes "+(d.start+1)+"-"+d.end+" of "+u);f.send(v)}function n(a){K("Server has ordered chunking effort to be restarted on next attempt for item ID "+
...
")","error"),b={}}if(200!==c.status||!b.success||b.reset)if(b.reset&&n(a),m[a].attemptingResume&&b.reset)m[a].attemptingResume=!1,K("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),n(a),y.upload(a,!0);else{var f=y.getName(a);q.onAutoRetry(a,f,b,c)||l(a,b,c)}else if(u){var f=m[a].remainingChunkIdxs.shift(),g=e(a,f);m[a].attemptingResume=!1;var f=m[a],h=f.loaded,g=g.size;f.loaded=h+(g+(B?m[a].lastRequestOverhead:0));0<m[a].remainingChunkIdxs.length?
p(a):(w&&I(a),l(a,b,c))}else l(a,b,c)}}}}function z(a,c){var b=y.getUuid(a),e=m[a].loaded,d=m[a].initialRequestOverhead,f=m[a].estTotalRequestsSize,u=D(a);qq.setCookie(u,b+A+c.part+A+e+A+d+A+f,q.resume.cookiesExpireIn)}function I(a){m[a].file&&(a=D(a),qq.deleteCookie(a))}function D(a){var c=y.getName(a);a=y.getSize(a);var b=q.chunking.partSize,c="qqfilechunk"+A+encodeURIComponent(c)+A+a+A+b;void 0!==v&&(c+=A+v);return c}function t(a){var c=m[a].file||m[a].blobData.blob,b=y.getName(a),e,d;m[a].loaded=
0;e=m[a].xhr=new XMLHttpRequest;e.upload.onprogress=function(c){c.lengthComputable&&(m[a].loaded=c.loaded,q.onProgress(a,b,c.loaded,c.total))};e.onreadystatechange=E(a,e);d=q.paramsStore.getParams(a);c=g(d,e,c,a);h(a,e);K("Sending upload request for "+a);e.send(c)}var q=a,x=b,K=d,m=[],A="|",u=q.chunking.enabled&&qq.supportedFeatures.chunking,w=q.resume.enabled&&u&&qq.supportedFeatures.resume,v;v=null===q.resume.id||void 0===q.resume.id||qq.isFunction(q.resume.id)||qq.isObject(q.resume.id)?void 0:
q.resume.id;var B=q.forceMultipart||q.paramsInBody,y;return y={add:function(a){if(a instanceof File)a=m.push({file:a})-1;else if(qq.isBlob(a.blob))a=m.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");m[a].uuid=qq.getUniqueId();return a},getName:function(a){if(y.isValid(a)){var c=m[a].file;a=m[a].blobData;return c?null!==c.fileName&&void 0!==c.fileName?c.fileName:c.name:a.name}K(a+" is not a valid item ID.","error")},getSize:function(a){a=m[a].file||
m[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(m[a])return m[a].file||m[a].blobData.blob},getLoaded:function(a){return m[a].loaded||0},isValid:function(a){return void 0!==m[a]},reset:function(){m=[]},getUuid:function(a){return m[a].uuid},upload:function(a,c){var b=this.getName(a);q.onUpload(a,b);if(u){var d=y.getName(a),b=0,g,h;if(!m[a].remainingChunkIdxs||0===m[a].remainingChunkIdxs.length){m[a].remainingChunkIdxs=[];if(w&&!c&&m[a].file){a:{g=
qq.getCookie(D(a));h=y.getName(a);var l,v,k;if(g){g=g.split(A);if(5===g.length){h=g[0];l=parseInt(g[1],10);v=parseInt(g[2],10);k=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:l,lastByteSent:v,initialRequestOverhead:k,estTotalRequestsSize:g};break a}K("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=e(a,g.part),!1!==q.onResume(a,d,r(h))&&(b=g.part,m[a].uuid=g.uuid,m[a].loaded=g.lastByteSent,m[a].estTotalRequestsSize=g.estTotalRequestsSize,
m[a].initialRequestOverhead=g.initialRequestOverhead,m[a].attemptingResume=!0,K("Resuming "+d+" at partition index "+b)))}for(d=f(a)-1;d>=b;--d)m[a].remainingChunkIdxs.unshift(d)}p(a)}else t(a)},cancel:function(a){var c=m[a].xhr;q.onCancel(a,this.getName(a));c&&(c.onreadystatechange=null,c.abort());w&&I(a);delete m[a]},getResumableFilesData:function(){var a=[],c=[];return u&&w?(a=void 0===v?qq.getCookieNames(RegExp("^qqfilechunk\\"+A+".+\\"+A+"\\d+\\"+A+q.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
A+".+\\"+A+"\\d+\\"+A+q.chunking.partSize+"\\"+A+v+"=")),qq.each(a,function(a,b){var e=b.split(A),d=qq.getCookie(b).split(A);c.push({name:decodeURIComponent(e[1]),size:e[2],uuid:d[0],partIdx:d[1]})}),c):[]}}};
(function(a){var b,d,c,e,f,g,h,l,p,n;g=["uploaderType"];c=function(a){a&&(a=l(a),h(a),"basic"===f("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return d};e=function(a,c){var b=d.data("fineuploader");if(c)void 0===b&&(b={}),b[a]=c,d.data("fineuploader",b);else return void 0===b?null:b[a]};b=function(a){return e("uploader",a)};f=function(a,c){return e(a,c)};h=function(c){var b=c.callbacks={};c=new qq.FineUploaderBasic;a.each(c._options.callbacks,function(a){var c,e;c=/^on(\w+)/.exec(a)[1];
...
"next"==c?"first":"last",n=this;if(!g.length){if(!this.options.wrap)return;g=this.$element.find(".item")[p]()}this.sliding=!0;h&&this.pause();p=a.Event("slide.bs.carousel",{relatedTarget:g[0],direction:l});if(!g.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var c=a(n.$indicators.children()[n.getActiveIndex()]);c&&c.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(p),
p.isDefaultPrevented())return;g.addClass(c);g[0].offsetWidth;d.addClass(l);g.addClass(l);d.one(a.support.transition.end,function(){g.removeClass([c,l].join(" ")).addClass("active");d.removeClass(["active",l].join(" "));n.sliding=!1;setTimeout(function(){n.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{if(this.$element.trigger(p),p.isDefaultPrevented())return;d.removeClass("active");g.addClass("active");this.sliding=!1;this.$element.trigger("slid")}return h&&this.cycle(),this}};var d=
...
b.appendTo(this.options.container):b.insertAfter(this.$element);var d=this.getPosition(),h=b[0].offsetWidth,l=b[0].offsetHeight;if(g){var p=this.$element.parent(),g=c,n=document.documentElement.scrollTop||document.body.scrollTop,r="body"==this.options.container?window.innerWidth:p.outerWidth(),E="body"==this.options.container?window.innerHeight:p.outerHeight(),p="body"==this.options.container?0:p.offset().left,c="bottom"==c&&d.top+d.height+l-n>E?"top":"top"==c&&0>d.top-n-l?"bottom":"right"==c&&d.right+
...
l-n),/bottom|top/.test(b))?(l=0,0>a.left&&(l=-2*a.left,a.left=0,g.offset(a),p=g[0].offsetWidth),this.replaceArrow(l-h+p,p,"left")):this.replaceArrow(n-l,n,"top");d&&g.offset(a)};b.prototype.replaceArrow=function(a,b,d){this.arrow().css(d,a?50*(1-a/b)+"%":"")};b.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};b.prototype.hide=function(){function c(){"in"!=b.hoverState&&d.detach()}
...
P.one(ja,function(){a(M).focus()})),I())}function E(){!t&&b.body&&(ka=!1,v=a(d),t=c(F).attr({id:Q,"class":!1===a.support.opacity?H+"IE":"",role:"dialog",tabindex:"-1"}).hide(),D=c(F,"Overlay").hide(),V=a([c(F,"LoadingOverlay")[0],c(F,"LoadingGraphic")[0]]),q=c(F,"Wrapper"),x=c(F,"Content").append(fa=c(F,"Title"),ga=c(F,"Current"),Z=a('<button type="button"/>').attr({id:H+"Previous"}),Y=a('<button type="button"/>').attr({id:H+"Next"}),W=c("button","Slideshow"),V),U=a('<button type="button"/>').attr({id:H+
"Close"}),q.append(c(F).append(c(F,"TopLeft"),K=c(F,"TopCenter"),c(F,"TopRight")),c(F,!1,"clear:left").append(m=c(F,"MiddleLeft"),x,A=c(F,"MiddleRight")),c(F,!1,"clear:left").append(c(F,"BottomLeft"),u=c(F,"BottomCenter"),c(F,"BottomRight"))).find("div div").css({"float":"left"}),y=c(F,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),O=Y.add(Z).add(ga).add(W),a(b.body).append(D,t.append(q,y)))}function z(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
...
(I=function(){return c.step});for(var U=0;l<=n;U++,l+=60*I(U)){var O=l,k=q(O,c);if(c.useSelect)var J=a("<option />",{value:k});else J=a("<li />"),J.data("time",86400>=O?O:O%86400);J.text(k);if((null!==c.minTime||null!==c.durationTime)&&c.showDuration)if(k=t(l-m,c.step),c.useSelect)J.text(J.text()+" ("+k+")");else{var N=a("<span />",{"class":"ui-timepicker-duration"});N.text(" ("+k+")");J.append(N)}z<K&&(O>=r[z][1]&&(z+=1),r[z]&&O>=r[z][0]&&O<r[z][1]&&(c.useSelect?J.prop("disabled",!0):J.addClass("ui-timepicker-disabled")));
d.append(J)}g.data("timepicker-input",b);b.data("timepicker-list",g);c.useSelect?(b.val()&&d.val(f(x(b.val()),c)),d.on("focus",function(){a(this).data("timepicker-input").trigger("showTimepicker")}),d.on("blur",function(){a(this).data("timepicker-input").trigger("hideTimepicker")}),d.on("change",function(){E(b,a(this).val(),"select")}),E(b,d.val(),"initial"),b.hide().after(d)):(l=c.appendTo,"string"===typeof l?l=a(l):"function"===typeof l&&(l=l(b)),l.append(g),p(b,d),d.on("mousedown","li",function(c){b.off("focus.timepicker");
...
function I(c){var d=a(this),e=d.data("timepicker-list"),f=d.data("timepicker-settings");if(!e||!b(e)||f.disableTextInput)return!0;switch(c.keyCode){case 96:case 97:case 98:case 99:case 100:case 101:case 102:case 103:case 104:case 105:case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:case 65:case 77:case 80:case 186:case 8:case 46:f.typeaheadHighlight?p(d,e):e.hide()}}function D(a){var b=a.data("timepicker-settings"),c=null,d=a.data("timepicker-list").find(".ui-timepicker-selected");
if(d.hasClass("ui-timepicker-disabled"))return!1;d.length&&(c=d.data("time"));null!==c&&("string"!=typeof c&&(c=q(c,b)),E(a,c,"select"));return!0}function t(a,b){a=Math.abs(a);var c=Math.round(a/60),d=[],e;60>c?d=[c,m.mins]:(e=Math.floor(c/60),c%=60,30==b&&30==c&&(e+=m.decimal+5),d.push(e),d.push(1==e?m.hr:m.hrs),30!=b&&c&&(d.push(c),d.push(m.mins)));return d.join(" ")}function q(b,c){if(null===b)return null;var d=new Date(K.valueOf()+1E3*b);if(isNaN(d.getTime()))return null;if("function"===a.type(c.timeFormat))return c.timeFormat(d);
