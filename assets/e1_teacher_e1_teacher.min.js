(function(a,b){function d(){a.removeEventListener("load",d,!1);h=!0}function c(a){return m=m||new c.Class(a)}function e(a,c){for(var b in c)a[b]=c[b];return a}function f(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);k.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(k,"$1"));q.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(q,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===b.readyState?h=!0:g&&a.addEventListener("load",d,!1);var k=/\/ath(\/)?$/,q=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,m;c.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};r=a.navigator.userAgent;var x=a.navigator;e(c,{hasToken:"#ath"==b.location.hash||k.test(b.location.href)||q.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(r),isMobileChrome:-1<r.indexOf("Android")&&/Chrome\/[.0-9]*/.test(r)&&-1==r.indexOf("Version"),isMobileIE:-1<r.indexOf("Windows Phone"),language:x.language&&
x.language.toLowerCase().replace("-","_")||""});c.language=c.language&&c.language in c.intl?c.language:"en_us";c.isMobileSafari=c.isIDevice&&-1<r.indexOf("Safari")&&0>r.indexOf("CriOS");c.OS=c.isIDevice?"ios":c.isMobileChrome?"android":c.isMobileIE?"windows":"unsupported";c.OSVersion=r.match(/(OS|Android) (\d+[_\.]\d+)/);c.OSVersion=c.OSVersion&&c.OSVersion[2]?+c.OSVersion[2].replace("_","."):0;c.isStandalone="standalone"in a.navigator&&a.navigator.standalone;c.isTablet=c.isMobileSafari&&-1<r.indexOf("iPad")||
c.isMobileChrome&&0>r.indexOf("Mobile");c.isCompatible=c.isMobileSafari&&6<=c.OSVersion||c.isMobileChrome;var u={lastDisplayTime:0,returningVisitor:!1,displayCount:0,optedout:!1,added:!1};c.removeSession=function(a){try{if(!localStorage)throw Error("localStorage is not defined");localStorage.removeItem(a||c.defaults.appID)}catch(b){}};c.doLog=function(a){this.options.logging&&console.log(a)};c.Class=function(d){this.doLog=c.doLog;this.options=e({},c.defaults);e(this.options,d);d&&d.debug&&"undefined"===
...
(function(a,b){"object"==typeof exports?module.exports=b():"function"==typeof define&&define.amd?define(b):a.Spinner=b()})(this,function(){function a(a,c){var b,e=document.createElement(a||"div");for(b in c)e[b]=c[b];return e}function b(a){for(var c=1,b=arguments.length;b>c;c++)a.appendChild(arguments[c]);return a}function d(a,c,b,e){var d=["opacity",c,~~(100*a),b,e].join("-");b=.01+b/e*100;e=Math.max(1-(1-a)/c*(100-b),a);var f=q.substring(0,q.indexOf("Animation")).toLowerCase();return r[d]||(x.insertRule("@"+
(f&&"-"+f+"-"||"")+"keyframes "+d+"{0%{opacity:"+e+"}"+b+"%{opacity:"+a+"}"+(b+.01)+"%{opacity:1}"+(b+c)%100+"%{opacity:"+a+"}100%{opacity:"+e+"}}",x.cssRules.length),r[d]=1),d}function c(a,c){var b,e,d=a.style;c=c.charAt(0).toUpperCase()+c.slice(1);for(e=0;m.length>e;e++)if(b=m[e]+c,void 0!==d[b])return b;return void 0!==d[c]?c:void 0}function e(a,b){for(var e in b)a.style[c(a,e)||e]=b[e];return a}function f(a){for(var c=1;arguments.length>c;c++){var b=arguments[c],e;for(e in b)void 0===a[e]&&(a[e]=
b[e])}return a}function g(a,c){return"string"==typeof a?a:a[c%a.length]}function h(a){this.opts=f(a||{},h.defaults,u)}function k(){function c(b,e){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}x.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,d){function f(){return e(c("group",{coordsize:m+" "+m,coordorigin:-k+" "+-k}),{width:m,height:m})}function q(a,h,m){b(r,b(e(f(),{rotation:360/d.lines*a+"deg",left:~~h}),b(e(c("roundrect",{arcsize:d.corners}),
{width:k,height:d.width,left:d.radius,top:-d.width>>1,filter:m}),c("fill",{color:g(d.color,a),opacity:d.opacity}),c("stroke",{opacity:0}))))}var h,k=d.length+d.width,m=2*k;h=2*-(d.width+d.length)+"px";var r=e(f(),{position:"absolute",top:h,left:h});if(d.shadow)for(h=1;d.lines>=h;h++)q(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;d.lines>=h;h++)q(h);return b(a,r)};h.prototype.opacity=function(a,c,b,e){a=a.firstChild;e=e.shadow&&e.lines||0;a&&a.childNodes.length>
c+e&&(a=a.childNodes[c+e],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=b))}}var q,m=["webkit","Moz","ms","O"],r={},x=function(){var c=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],c),c.sheet||c.styleSheet}(),u={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};f(h.prototype,{spin:function(c){this.stop();var b=
this,d=b.opts,f=b.el=e(a(0,{className:d.className}),{position:d.position,width:0,zIndex:d.zIndex});if(d.radius+d.length+d.width,e(f,{left:d.left,top:d.top}),c&&c.insertBefore(f,c.firstChild||null),f.setAttribute("role","progressbar"),b.lines(f,b.opts),!q){var g,h=0,k=(d.lines-1)*(1-d.direction)/2,m=d.fps,r=m/d.speed,u=(1-d.opacity)/(r*d.trail/100),x=r/d.lines;(function T(){h++;for(var a=0;d.lines>a;a++)g=Math.max(1-(h+(d.lines-a)*x)%r*u,d.opacity),b.opacity(f,a*d.direction+k,g,d);b.timeout=b.el&&
setTimeout(T,~~(1E3/m))})()}return b},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(c,f){function p(c,b){return e(a(),{position:"absolute",width:f.length+f.width+"px",height:f.width+"px",background:c,boxShadow:b,transformOrigin:"left",transform:"rotate("+~~(360/f.lines*k+f.rotate)+"deg) translate("+f.radius+"px,0)",borderRadius:(f.corners*f.width>>1)+"px"})}for(var h,k=0,m=(f.lines-1)*(1-f.direction)/
2;f.lines>k;k++)h=e(a(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:q&&d(f.opacity,f.trail,m+k*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&b(h,e(p("#000","0 0 4px #000"),{top:"2px"})),b(c,b(h,p(g(f.color,k),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,c,b){a.childNodes.length>c&&(a.childNodes[c].style.opacity=b)}});var H=e(a("group"),{behavior:"url(#default#VML)"});return!c(H,"transform")&&
H.adj?k():q=c(H,"animation"),h});
(function(a,b){"object"==typeof exports?module.exports=b(require("spin.js")):"function"==typeof define&&define.amd?define(["spin"],b):a.Ladda=b(a.Spinner)})(this,function(a){function b(b){if(void 0===b)return console.warn("Ladda button target must be defined."),void 0;b.querySelector(".ladda-label")||(b.innerHTML='<span class="ladda-label">'+b.innerHTML+"</span>");var d,g=b.querySelector(".ladda-spinner");g||(g=document.createElement("span"),g.className="ladda-spinner");b.appendChild(g);var h,k={start:function(){if(!d){var c,
k=b.offsetHeight;0===k&&(k=parseFloat(window.getComputedStyle(b).height));32<k&&(k*=.8);b.hasAttribute("data-spinner-size")&&(k=parseInt(b.getAttribute("data-spinner-size"),10));b.hasAttribute("data-spinner-color")&&(c=b.getAttribute("data-spinner-color"));k*=.2;d=new a({color:c||"#fff",lines:12,radius:k,length:.6*k,width:7>k?2:3,zIndex:"auto",top:"auto",left:"auto",className:""})}return b.setAttribute("disabled",""),b.setAttribute("data-loading",""),clearTimeout(h),d.spin(g),this.setProgress(0),
this},startAfter:function(a){return clearTimeout(h),h=setTimeout(function(){k.start()},a),this},stop:function(){return b.removeAttribute("disabled"),b.removeAttribute("data-loading"),clearTimeout(h),d&&(h=setTimeout(function(){d.stop()},1E3)),this},toggle:function(){return this.isLoading()?this.stop():this.start(),this},setProgress:function(a){a=Math.max(Math.min(a,1),0);var c=b.querySelector(".ladda-progress");0===a&&c&&c.parentNode?c.parentNode.removeChild(c):(c||(c=document.createElement("div"),
c.className="ladda-progress",b.appendChild(c)),c.style.width=(a||0)*b.offsetWidth+"px")},enable:function(){return this.stop(),this},disable:function(){return this.stop(),b.setAttribute("disabled",""),this},isLoading:function(){return b.hasAttribute("data-loading")},remove:function(){clearTimeout(h);b.removeAttribute("disabled","");b.removeAttribute("data-loading","");d&&(d.stop(),d=null);for(var a=0,g=c.length;g>a;a++)if(k===c[a]){c.splice(a,1);break}}};return c.push(k),k}function d(a){for(var c=
[],b=0;a.length>b;b++)c.push(a[b]);return c}var c=[];return{bind:function(a,c){c=c||{};var g=[];"string"==typeof a?g=d(document.querySelectorAll(a)):"object"==typeof a&&"string"==typeof a.nodeName&&(g=[a]);for(var h=0,k=g.length;k>h;h++)(function(){var a=g[h];if("function"==typeof a.addEventListener){var e=b(a),d=-1;a.addEventListener("click",function(){for(var b=!0,g,h=a;h.parentNode&&"FORM"!==h.tagName;)h=h.parentNode;g="FORM"===h.tagName?h:void 0;if(void 0!==g){for(var k=["input","textarea","select"],
...
"error");d.failure()}));return d}function d(a){var c,e,d=[],k=new qq.Promise;f.callbacks.processingDroppedFiles();g.dropDisabled(!0);if(1<a.files.length&&!f.allowMultipleItems)f.callbacks.processingDroppedFilesComplete([]),f.callbacks.dropError("tooManyFilesError",""),g.dropDisabled(!1),k.failure();else{h=[];if(qq.isFolderDropSupported(a))for(c=a.items,a=0;a<c.length;a+=1)(e=c[a].webkitGetAsEntry())&&(e.isFile?h.push(c[a].getAsFile()):d.push(b(e).done(function(){d.pop();0===d.length&&k.success()})));
else h=a.files;0===d.length&&k.success()}return k}function c(a){g=new qq.UploadDropZone({element:a,onEnter:function(c){qq(a).addClass(f.classes.dropActive);c.stopPropagation()},onLeaveNotDescendants:function(){qq(a).removeClass(f.classes.dropActive)},onDrop:function(c){f.hideDropZonesBeforeEnter&&qq(a).hide();qq(a).removeClass(f.classes.dropActive);d(c.dataTransfer).done(function(){var a=h;f.callbacks.dropLog("Grabbed "+a.length+" dropped files.");g.dropDisabled(!1);f.callbacks.processingDroppedFilesComplete(a)})}});
k.addDisposer(function(){g.dispose()});f.hideDropZonesBeforeEnter&&qq(a).hide()}function e(a){var c;qq.each(a.dataTransfer.types,function(a,b){if("Files"===b)return c=!0,!1});return c}var f,g,h=[],k=new qq.DisposeSupport;f={dropZoneElements:[],hideDropZonesBeforeEnter:!1,allowMultipleItems:!0,classes:{dropActive:null},callbacks:new qq.DragAndDrop.callbacks};qq.extend(f,a,!0);(function(){var a=f.dropZoneElements;qq.each(a,function(a,b){c(b)});a.length&&(!qq.ie()||qq.ie10())&&k.attach(document,"dragenter",
function(c){!g.dropDisabled()&&e(c)&&qq.each(a,function(a,c){qq(c).css({display:"block"})})});k.attach(document,"dragleave",function(c){f.hideDropZonesBeforeEnter&&qq.FineUploader.prototype._leaving_document_out(c)&&qq.each(a,function(a,c){qq(c).hide()})});k.attach(document,"drop",function(c){f.hideDropZonesBeforeEnter&&qq.each(a,function(a,c){qq(c).hide()});c.preventDefault()})})();return{setupExtraDropzone:function(a){f.dropZoneElements.push(a);c(a)},removeDropzone:function(a){var c,b=f.dropZoneElements;
for(c in b)if(b[c]===a)return b.splice(c,1)},dispose:function(){k.dispose();g.dispose()}}};qq.DragAndDrop.callbacks=function(){return{processingDroppedFiles:function(){},processingDroppedFilesComplete:function(){},dropError:function(a,b){qq.log("Drag & drop error code '"+a+" with these specifics: '"+b+"'","error")},dropLog:function(a,b){qq.log(a,b)}}};
qq.UploadDropZone=function(a){function b(){return qq.safari()||qq.firefox()&&qq.windows()}function d(a){if(qq.ie()&&!qq.ie10())return!1;var c=a.dataTransfer,b=qq.safari();a=qq.ie10()?!0:"none"!==c.effectAllowed;return c&&a&&(c.files||!b&&c.types.contains&&c.types.contains("Files"))}function c(a){void 0!==a&&(g=a);return g}var e,f,g,h,k=new qq.DisposeSupport;e={element:null,onEnter:function(){},onLeave:function(){},onLeaveNotDescendants:function(){},onDrop:function(){}};qq.extend(e,a);f=e.element;
(function(){h||(b?k.attach(document,"dragover",function(a){a.preventDefault()}):k.attach(document,"dragover",function(a){a.dataTransfer&&(a.dataTransfer.dropEffect="none",a.preventDefault())}),h=!0)})();(function(){k.attach(f,"dragover",function(a){if(d(a)){var c=qq.ie()?null:a.dataTransfer.effectAllowed;a.dataTransfer.dropEffect="move"===c||"linkMove"===c?"move":"copy";a.stopPropagation();a.preventDefault()}});k.attach(f,"dragenter",function(a){if(!c()&&d(a))e.onEnter(a)});k.attach(f,"dragleave",
function(a){if(d(a)){e.onLeave(a);var c=document.elementFromPoint(a.clientX,a.clientY);if(!qq(this).contains(c))e.onLeaveNotDescendants(a)}});k.attach(f,"drop",function(a){!c()&&d(a)&&(a.preventDefault(),e.onDrop(a))})})();return{dropDisabled:function(a){return c(a)},dispose:function(){k.dispose()}}};
...
qq.AjaxRequestor=function(a){function b(a){var c=qq.indexOf(k,a),b=m.maxConnections;delete q[a];k.splice(c,1);k.length>=b&&c<b&&(a=k[b-1],d(a))}function d(a){var b=new XMLHttpRequest,d=f(),k={},B;m.onSend(a);m.paramsStore.getParams&&(k=m.paramsStore.getParams(a));B=k;var t=m.endpointStore.getEndpoint(a),p=q[a].addToPath;void 0!==p&&(t+="/"+p);B=h&&B?qq.obj2url(B,t):t;q[a].xhr=b;b.onreadystatechange=c(a);b.open(d,B,!0);m.cors.expected&&m.cors.sendCredentials&&(b.withCredentials=!0);e(a);g("Sending "+
d+" request for "+a);!h&&k?b.send(qq.obj2url(k,"")):b.send()}function c(a){var c=q[a].xhr;return function(){if(4===c.readyState){var e=q[a].xhr,d=f(),h=!1;b(a);0<=qq.indexOf(m.successfulResponseCodes,e.status)||(h=!0,g(d+" request for "+a+" has failed - response code "+e.status,"error"));m.onComplete(a,e,h)}}}function e(a){var c=q[a].xhr;a=m.customHeaders;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,b){c.setRequestHeader(a,
b)})}function f(){return m.demoMode?"GET":m.method}var g,h,k=[],q=[],m={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(m,a);g=m.log;h="GET"===f()||"DELETE"===f();return{send:function(a,c){q[a]={addToPath:c};k.push(a)<=m.maxConnections&&d(a)},cancel:function(a){var c=q[a].xhr,e=f();c?(c.onreadystatechange=
...
qq.UploadHandlerForm=function(a,b,d){function c(a){void 0!==r[a]&&(r[a](),delete r[a])}function e(a,b){var e=a.id;B[m[e]]=b;r[e]=qq(a).attach("load",function(){q[e]&&(u("Received iframe load event for CORS upload request (file id "+e+")"),x[e]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+e;u(a,"error");b({error:a})},1E3))});H.receiveMessage(e,function(a){u("Received the following window message: '"+a+"'");var b=qq.parseJson(a),d=b.uuid;d&&B[d]?(clearTimeout(x[e]),
delete x[e],c(e),a=B[d],delete B[d],H.stopReceivingMessages(e),a(b)):d||u("'"+a+"' does not contain a UUID - ignoring.")})}function f(a,c){k.cors.expected?e(a,c):r[a.id]=qq(a).attach("load",function(){u("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(b){u("Error when attempting to access iframe during handling of upload response ("+b+")","error")}c()}})}function g(a){var c=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');c.setAttribute("id",a);c.style.display="none";document.body.appendChild(c);return c}function h(a,c){var b=k.paramsStore.getParams(a),e=qq.toElement('<form method="'+(k.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),d=k.endpointStore.getEndpoint(a),f=d;b[k.uuidParamName]=m[a];k.paramsInBody?qq.obj2Inputs(b,e):f=qq.obj2url(b,d);e.setAttribute("action",f);e.setAttribute("target",c.name);e.style.display="none";document.body.appendChild(e);return e}var k=a,q=[],m=[],r={},x=
{},u=d,H=new qq.WindowReceiveMessage({log:u}),B={},t;return t={add:function(a){a.setAttribute("name",k.inputName);var c=q.push(a)-1;m[c]=qq.getUniqueId();a.parentNode&&qq(a).remove();return c},getName:function(a){if(t.isValid(a))return q[a].value.replace(/.*(\/|\\)/,"");u(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==q[a]},reset:function(){q=[];m=[];r={}},getUuid:function(a){return m[a]},cancel:function(a){k.onCancel(a,this.getName(a));delete q[a];delete m[a];delete r[a];
...
u("converting iframe's innerHTML to JSON");u("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);f=qq.parseJson(h)}catch(m){u("Error when attempting to parse form upload response ("+m+")","error"),f={success:!1}}e=f}c(a);k.cors.expected||qq(n).remove();if(e.success||!k.onAutoRetry(a,d,e))k.onComplete(a,d,e),b(a)});u("Sending upload request for "+a);m.submit();qq(m).remove();return a}}};
qq.UploadHandlerXhr=function(a,b,d){function c(a,c,b){var e=A.getSize(a);a=A.getName(a);c[p.chunking.paramNames.partIndex]=b.part;c[p.chunking.paramNames.partByteOffset]=b.start;c[p.chunking.paramNames.chunkSize]=b.size;c[p.chunking.paramNames.totalParts]=b.count;c[p.totalFileSizeParamName]=e;z&&(c[p.chunking.paramNames.filename]=a)}function e(a,c){var b=p.chunking.partSize,e=A.getSize(a),d=n[a].file||n[a].blobData.blob,g=b*c,b=g+b>=e?e:g+b,e=f(a),h;d.slice?h=d.slice(g,b):d.mozSlice?h=d.mozSlice(g,
b):d.webkitSlice&&(h=d.webkitSlice(g,b));return{part:c,start:g,end:b,count:e,blob:h,size:b-g}}function f(a){a=A.getSize(a);return Math.ceil(a/p.chunking.partSize)}function g(a,c,b,e){var d=new FormData,f=p.demoMode?"GET":"POST",g=p.endpointStore.getEndpoint(e),h=g,k=A.getName(e),m=A.getSize(e),v=n[e].blobData;a[p.uuidParamName]=n[e].uuid;z&&(a[p.totalFileSizeParamName]=m,v&&(a[p.blobs.paramNames.name]=v.name));p.paramsInBody||(z||(a[p.inputName]=k),h=qq.obj2url(a,g));c.open(f,h,!0);p.cors.expected&&
p.cors.sendCredentials&&(c.withCredentials=!0);return z?(p.paramsInBody&&qq.obj2FormData(a,d),d.append(p.inputName,b),d):b}function h(a,c){var b=p.customHeaders,e=n[a].file||n[a].blobData.blob;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");z||(c.setRequestHeader("Content-Type","application/octet-stream"),c.setRequestHeader("X-Mime-Type",e.type));qq.each(b,function(a,b){c.setRequestHeader(a,b)})}function k(a,c,b){var e=A.getName(a),d=A.getSize(a);
n[a].attemptingResume=!1;p.onProgress(a,e,d,d);p.onComplete(a,e,c,b);delete n[a].xhr;v(a)}function q(a){var b=n[a].remainingChunkIdxs[0],d=e(a,b),f=n[a].xhr=new XMLHttpRequest,k=A.getSize(a),m=A.getName(a),v;void 0===n[a].loaded&&(n[a].loaded=0);y&&n[a].file&&u(a,d);f.onreadystatechange=x(a,f);f.upload.onprogress=function(c){if(c.lengthComputable){var d=c.loaded+n[a].loaded;c=c.total;var f=e(a,b);c-=f.size;var g=A.getSize(a),f=f.count,h=c-n[a].initialRequestOverhead;n[a].lastRequestOverhead=c;0===
b?(n[a].lastChunkIdxProgress=0,n[a].initialRequestOverhead=c,n[a].estTotalRequestsSize=g+f*c):n[a].lastChunkIdxProgress!==b&&(n[a].lastChunkIdxProgress=b,n[a].estTotalRequestsSize+=h);p.onProgress(a,m,d,n[a].estTotalRequestsSize)}};p.onUploadChunk(a,m,r(d));v=p.paramsStore.getParams(a);c(a,v,d);n[a].attemptingResume&&(v[p.resume.paramNames.resuming]=!0);v=g(v,f,d.blob,a);h(a,f);K("Sending chunked upload request for item "+a+": bytes "+(d.start+1)+"-"+d.end+" of "+k);f.send(v)}function m(a){K("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");y&&(H(a),n[a].attemptingResume=!1);n[a].remainingChunkIdxs=[];delete n[a].loaded;delete n[a].estTotalRequestsSize;delete n[a].initialRequestOverhead}function r(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function x(a,c){return function(){if(4===c.readyState){var b;if(n[a]){K("xhr - server response received for "+a);K("responseText = "+c.responseText);try{b=qq.parseJson(c.responseText)}catch(d){K("Error when attempting to parse xhr response text ("+d+
")","error"),b={}}if(200!==c.status||!b.success||b.reset)if(b.reset&&m(a),n[a].attemptingResume&&b.reset)n[a].attemptingResume=!1,K("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),m(a),A.upload(a,!0);else{var f=A.getName(a);p.onAutoRetry(a,f,b,c)||k(a,b,c)}else if(Q){var f=n[a].remainingChunkIdxs.shift(),g=e(a,f);n[a].attemptingResume=!1;var f=n[a],h=f.loaded,g=g.size;f.loaded=h+(g+(z?n[a].lastRequestOverhead:0));0<n[a].remainingChunkIdxs.length?
q(a):(y&&H(a),k(a,b,c))}else k(a,b,c)}}}}function u(a,c){var b=A.getUuid(a),e=n[a].loaded,d=n[a].initialRequestOverhead,f=n[a].estTotalRequestsSize,g=B(a);qq.setCookie(g,b+F+c.part+F+e+F+d+F+f,p.resume.cookiesExpireIn)}function H(a){n[a].file&&(a=B(a),qq.deleteCookie(a))}function B(a){var c=A.getName(a);a=A.getSize(a);var b=p.chunking.partSize,c="qqfilechunk"+F+encodeURIComponent(c)+F+a+F+b;void 0!==J&&(c+=F+J);return c}function t(a){var c=n[a].file||n[a].blobData.blob,b=A.getName(a),e,d;n[a].loaded=
0;e=n[a].xhr=new XMLHttpRequest;e.upload.onprogress=function(c){c.lengthComputable&&(n[a].loaded=c.loaded,p.onProgress(a,b,c.loaded,c.total))};e.onreadystatechange=x(a,e);d=p.paramsStore.getParams(a);c=g(d,e,c,a);h(a,e);K("Sending upload request for "+a);e.send(c)}var p=a,v=b,K=d,n=[],F="|",Q=p.chunking.enabled&&qq.supportedFeatures.chunking,y=p.resume.enabled&&Q&&qq.supportedFeatures.resume,J;J=null===p.resume.id||void 0===p.resume.id||qq.isFunction(p.resume.id)||qq.isObject(p.resume.id)?void 0:
p.resume.id;var z=p.forceMultipart||p.paramsInBody,A;return A={add:function(a){if(a instanceof File)a=n.push({file:a})-1;else if(qq.isBlob(a.blob))a=n.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");n[a].uuid=qq.getUniqueId();return a},getName:function(a){if(A.isValid(a)){var c=n[a].file;a=n[a].blobData;return c?null!==c.fileName&&void 0!==c.fileName?c.fileName:c.name:a.name}K(a+" is not a valid item ID.","error")},getSize:function(a){a=n[a].file||
n[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(n[a])return n[a].file||n[a].blobData.blob},getLoaded:function(a){return n[a].loaded||0},isValid:function(a){return void 0!==n[a]},reset:function(){n=[]},getUuid:function(a){return n[a].uuid},upload:function(a,c){var b=this.getName(a);p.onUpload(a,b);if(Q){var d=A.getName(a),b=0,g,h;if(!n[a].remainingChunkIdxs||0===n[a].remainingChunkIdxs.length){n[a].remainingChunkIdxs=[];if(y&&!c&&n[a].file){a:{g=
qq.getCookie(B(a));h=A.getName(a);var k,v,l;if(g){g=g.split(F);if(5===g.length){h=g[0];k=parseInt(g[1],10);v=parseInt(g[2],10);l=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:k,lastByteSent:v,initialRequestOverhead:l,estTotalRequestsSize:g};break a}K("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=e(a,g.part),!1!==p.onResume(a,d,r(h))&&(b=g.part,n[a].uuid=g.uuid,n[a].loaded=g.lastByteSent,n[a].estTotalRequestsSize=g.estTotalRequestsSize,
n[a].initialRequestOverhead=g.initialRequestOverhead,n[a].attemptingResume=!0,K("Resuming "+d+" at partition index "+b)))}for(d=f(a)-1;d>=b;--d)n[a].remainingChunkIdxs.unshift(d)}q(a)}else t(a)},cancel:function(a){var c=n[a].xhr;p.onCancel(a,this.getName(a));c&&(c.onreadystatechange=null,c.abort());y&&H(a);delete n[a]},getResumableFilesData:function(){var a=[],c=[];return Q&&y?(a=void 0===J?qq.getCookieNames(RegExp("^qqfilechunk\\"+F+".+\\"+F+"\\d+\\"+F+p.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
F+".+\\"+F+"\\d+\\"+F+p.chunking.partSize+"\\"+F+J+"=")),qq.each(a,function(a,b){var e=b.split(F),d=qq.getCookie(b).split(F);c.push({name:decodeURIComponent(e[1]),size:e[2],uuid:d[0],partIdx:d[1]})}),c):[]}}};
(function(a){var b,d,c,e,f,g,h,k,q,m;g=["uploaderType"];c=function(a){a&&(a=k(a),h(a),"basic"===f("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return d};e=function(a,c){var b=d.data("fineuploader");if(c)void 0===b&&(b={}),b[a]=c,d.data("fineuploader",b);else return void 0===b?null:b[a]};b=function(a){return e("uploader",a)};f=function(a,c){return e(a,c)};h=function(c){var b=c.callbacks={};c=new qq.FineUploaderBasic;a.each(c._options.callbacks,function(a){var c,e;c=/^on(\w+)/.exec(a)[1];
c=c.substring(0,1).toLowerCase()+c.substring(1);e=d;b[a]=function(){var a=Array.prototype.slice.call(arguments);return e.triggerHandler(c,a)}})};k=function(c,b){var e,h;e=void 0===b?"basic"!==c.uploaderType?{element:d[0]}:{}:b;a.each(c,function(c,b){0<=a.inArray(c,g)?f(c,b):b instanceof a?e[c]=b[0]:a.isPlainObject(b)?(e[c]={},k(b,e[c])):a.isArray(b)?(h=[],a.each(b,function(c,b){b instanceof a?a.merge(h,b):h.push(b)}),e[c]=h):e[c]=b});if(void 0===b)return e};q=function(c){return"string"===a.type(c)&&
!c.match(/^_/)&&void 0!==b()[c]};m=function(a){var c=[],e=Array.prototype.slice.call(arguments,1);k(e,c);return b()[a].apply(b(),c)};a.fn.fineUploader=function(e){var f=this,g=arguments,h=[];this.each(function(k,t){d=a(t);if(b()&&q(e)){if(h.push(m.apply(f,g)),1===f.length)return!1}else"object"!==typeof e&&e?a.error("Method "+e+" does not exist on jQuery.fineUploader"):c.apply(f,g)});return 1===h.length?h[0]:1<h.length?h:this}})(jQuery);
...
function(c){return c||(this.paused=!0),this.$element.find(".next, .prev").length&&a.support.transition.end&&(this.$element.trigger(a.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this};b.prototype.next=function(){return this.sliding?void 0:this.slide("next")};b.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")};b.prototype.slide=function(c,b){var d=this.$element.find(".item.active"),g=b||d[c](),h=this.interval,k="next"==c?"left":"right",q=
"next"==c?"first":"last",m=this;if(!g.length){if(!this.options.wrap)return;g=this.$element.find(".item")[q]()}this.sliding=!0;h&&this.pause();q=a.Event("slide.bs.carousel",{relatedTarget:g[0],direction:k});if(!g.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var c=a(m.$indicators.children()[m.getActiveIndex()]);c&&c.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(q),
q.isDefaultPrevented())return;g.addClass(c);g[0].offsetWidth;d.addClass(k);g.addClass(k);d.one(a.support.transition.end,function(){g.removeClass([c,k].join(" ")).addClass("active");d.removeClass(["active",k].join(" "));m.sliding=!1;setTimeout(function(){m.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{if(this.$element.trigger(q),q.isDefaultPrevented())return;d.removeClass("active");g.addClass("active");this.sliding=!1;this.$element.trigger("slid")}return h&&this.cycle(),this}};var d=
a.fn.carousel;a.fn.carousel=function(c){return this.each(function(){var d=a(this),f=d.data("bs.carousel"),g=a.extend({},b.DEFAULTS,d.data(),"object"==typeof c&&c),h="string"==typeof c?c:g.slide;f||d.data("bs.carousel",f=new b(this,g));"number"==typeof c?f.to(c):h?f[h]():g.interval&&f.pause().cycle()})};a.fn.carousel.Constructor=b;a.fn.carousel.noConflict=function(){return a.fn.carousel=d,this};a(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(c){var b,d=a(this),
...
b.appendTo(this.options.container):b.insertAfter(this.$element);var d=this.getPosition(),h=b[0].offsetWidth,k=b[0].offsetHeight;if(g){var q=this.$element.parent(),g=c,m=document.documentElement.scrollTop||document.body.scrollTop,r="body"==this.options.container?window.innerWidth:q.outerWidth(),x="body"==this.options.container?window.innerHeight:q.outerHeight(),q="body"==this.options.container?0:q.offset().left,c="bottom"==c&&d.top+d.height+k-m>x?"top":"top"==c&&0>d.top-m-k?"bottom":"right"==c&&d.right+
h>r?"left":"left"==c&&d.left-h<q?"right":c;b.removeClass(g).addClass(c)}b=this.getCalculatedOffset(c,d,h,k);this.applyPlacement(b,c);this.$element.trigger("shown.bs."+this.type)}};b.prototype.applyPlacement=function(a,b){var d,g=this.tip(),h=g[0].offsetWidth,k=g[0].offsetHeight,q=parseInt(g.css("margin-top"),10),m=parseInt(g.css("margin-left"),10);isNaN(q)&&(q=0);isNaN(m)&&(m=0);a.top+=q;a.left+=m;g.offset(a).addClass("in");q=g[0].offsetWidth;m=g[0].offsetHeight;("top"==b&&m!=k&&(d=!0,a.top=a.top+
k-m),/bottom|top/.test(b))?(k=0,0>a.left&&(k=-2*a.left,a.left=0,g.offset(a),q=g[0].offsetWidth),this.replaceArrow(k-h+q,q,"left")):this.replaceArrow(m-k,m,"top");d&&g.offset(a)};b.prototype.replaceArrow=function(a,b,d){this.arrow().css(d,a?50*(1-a/b)+"%":"")};b.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};b.prototype.hide=function(){function c(){"in"!=b.hoverState&&d.detach()}
...
this.options.offset,d=(this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight)-this.$scrollElement.height(),g=this.offsets,h=this.targets,k=this.activeTarget;if(b>=d)return k!=(a=h.last()[0])&&this.activate(a);for(a=g.length;a--;)k!=h[a]&&b>=g[a]&&(!g[a+1]||b<=g[a+1])&&this.activate(h[a])};b.prototype.activate=function(c){this.activeTarget=c;a(this.selector).parents(".active").removeClass("active");c=a(this.selector+'[data-target="'+c+'"],'+this.selector+'[href="'+c+'"]').parents("li").addClass("active");
...
b.prototype.activate=function(b,d,f){function g(){h.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");b.addClass("active");k?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade");b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active");f&&f()}var h=d.find("> .active"),k=f&&a.support.transition&&h.hasClass("fade");k?h.one(a.support.transition.end,g).emulateTransitionEnd(150):g();h.removeClass("in")};var d=a.fn.tab;a.fn.tab=function(c){return this.each(function(){var d=
...
a(document).height(),d=this.$window.scrollTop(),f=this.$element.offset(),g=this.options.offset,h=g.top,k=g.bottom;"object"!=typeof g&&(k=h=g);"function"==typeof h&&(h=g.top());"function"==typeof k&&(k=g.bottom());c=null!=this.unpin&&d+this.unpin<=f.top?!1:null!=k&&f.top+this.$element.height()>=c-k?"bottom":null!=h&&h>=d?"top":!1;this.affixed!==c&&(this.unpin&&this.$element.css("top",""),this.affixed=c,this.unpin="bottom"==c?f.top-d:null,this.$element.removeClass(b.RESET).addClass("affix"+(c?"-"+c:
...
(function(a,b,d){function c(c,d,e){c=b.createElement(c);return d&&(c.id=E+d),e&&(c.style.cssText=e),a(c)}function e(){return d.innerHeight?d.innerHeight:a(d).height()}function f(a){var b=y.length;a=(G+a)%b;return 0>a?b+a:a}function g(a,b){return Math.round((/%/.test(a)?("x"===b?J.width():e())/100:1)*parseInt(a,10))}function h(a,b){return a.retinaUrl&&1<d.devicePixelRatio?b.replace(a.photoRegex,a.retinaSuffix):b}function k(a){"contains"in t[0]&&!t[0].contains(a.target)&&(a.stopPropagation(),t.focus())}
function q(){var b,c=a.data(I,O);null==c?(l=a.extend({},ha),console&&console.log&&console.log("Error: cboxElement missing settings object")):l=a.extend({},c);for(b in l)a.isFunction(l[b])&&"on"!==b.slice(0,2)&&(l[b]=l[b].call(I));l.rel=l.rel||I.rel||a(I).data("rel")||"nofollow";l.href=l.href||a(I).attr("href");l.title=l.title||I.title;"string"==typeof l.href&&(l.href=a.trim(l.href))}function m(c,d){a(b).trigger(c);L.triggerHandler(c);a.isFunction(d)&&d.call(I)}function r(d){Y||(I=d,q(),y=a(I),G=0,
...
l.returnFocus&&L.one(ja,function(){a(I).focus()})),H())}function x(){!t&&b.body&&(ka=!1,J=a(d),t=c(C).attr({id:O,"class":!1===a.support.opacity?E+"IE":"",role:"dialog",tabindex:"-1"}).hide(),B=c(C,"Overlay").hide(),T=a([c(C,"LoadingOverlay")[0],c(C,"LoadingGraphic")[0]]),p=c(C,"Wrapper"),v=c(C,"Content").append(ea=c(C,"Title"),fa=c(C,"Current"),X=a('<button type="button"/>').attr({id:E+"Previous"}),W=a('<button type="button"/>').attr({id:E+"Next"}),U=c("button","Slideshow"),T),aa=a('<button type="button"/>').attr({id:E+
"Close"}),p.append(c(C).append(c(C,"TopLeft"),K=c(C,"TopCenter"),c(C,"TopRight")),c(C,!1,"clear:left").append(n=c(C,"MiddleLeft"),v,F=c(C,"MiddleRight")),c(C,!1,"clear:left").append(c(C,"BottomLeft"),Q=c(C,"BottomCenter"),c(C,"BottomRight"))).find("div div").css({"float":"left"}),A=c(C,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),ga=W.add(X).add(fa).add(U),a(b.body).append(B,t.append(p,A)))}function u(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),r(this))}return t?(ka||(ka=!0,W.click(function(){D.next()}),X.click(function(){D.prev()}),aa.click(function(){D.close()}),B.click(function(){l.overlayClose&&D.close()}),a(b).bind("keydown."+E,function(a){var b=a.keyCode;P&&l.escKey&&27===b&&(a.preventDefault(),D.close());P&&l.arrowKey&&y[1]&&!a.altKey&&(37===b?(a.preventDefault(),X.click()):39===b&&(a.preventDefault(),W.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+E,"."+V,c):a("."+V).live("click."+E,c)),!0):!1}
function H(){var e,f,p,k=D.prep,n=++la;Z=!0;w=!1;I=y[G];q();m(ba);m(ca,l.onLoad);l.h=l.height?g(l.height,"y")-R-M:l.innerHeight&&g(l.innerHeight,"y");l.w=l.width?g(l.width,"x")-S-N:l.innerWidth&&g(l.innerWidth,"x");l.mw=l.w;l.mh=l.h;l.maxWidth&&(l.mw=g(l.maxWidth,"x")-S-N,l.mw=l.w&&l.w<l.mw?l.w:l.mw);l.maxHeight&&(l.mh=g(l.maxHeight,"y")-R-M,l.mh=l.h&&l.h<l.mh?l.h:l.mh);e=l.href;na=setTimeout(function(){T.show()},100);l.inline?(p=c(C).hide().insertBefore(a(e)[0]),L.one(ba,function(){p.replaceWith(z.children())}),
k(a(e))):l.iframe?k(" "):l.html?k(l.html):l.photo||l.photoRegex.test(e)?(e=h(l,e),w=b.createElement("img"),a(w).addClass(E+"Photo").bind("error",function(){l.title=!1;k(c(C,"Error").html(l.imgError))}).one("load",function(){var b;n===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(I).attr(c)||a(I).attr("data-"+c);d&&w.setAttribute(c,d)}),l.retinaImage&&1<d.devicePixelRatio&&(w.height/=d.devicePixelRatio,w.width/=d.devicePixelRatio),l.scalePhotos&&(f=function(){w.height-=w.height*
b;w.width-=w.width*b},l.mw&&w.width>l.mw&&(b=(w.width-l.mw)/w.width,f()),l.mh&&w.height>l.mh&&(b=(w.height-l.mh)/w.height,f())),l.h&&(w.style.marginTop=Math.max(l.mh-w.height,0)/2+"px"),y[1]&&(l.loop||y[G+1])&&(w.style.cursor="pointer",w.onclick=function(){D.next()}),w.style.width=w.width+"px",w.style.height=w.height+"px",setTimeout(function(){k(w)},1))}),setTimeout(function(){w.src=e},1)):e&&A.load(e,l.data,function(b,d){n===la&&k("error"===d?c(C,"Error").html(l.xhrError):a(this).contents())})}var B,
...
pullPlaceholder:!0,serialize:function(b,c,d){b=a.extend({},b.data());if(d)return[c];c[0]&&(b.children=c);delete b.subContainers;delete b.sortable;return b},tolerance:0},u={},H=0,B={left:0,top:0,bottom:0,right:0};m={start:"touchstart.sortable mousedown.sortable",drop:"touchend.sortable touchcancel.sortable mouseup.sortable",drag:"touchmove.sortable mousemove.sortable",scroll:"scroll.sortable"};k.get=function(a){u[a.group]||(a.group===c&&(a.group=H++),u[a.group]=new k(a));return u[a.group]};k.prototype=
...
a.extend(q.prototype,t);a.fn[d]=function(b){var e=Array.prototype.slice.call(arguments,1);return this.map(function(){var f=a(this),g=f.data(d);if(g&&t[b])return t[b].apply(g,e)||this;g||b!==c&&"object"!==typeof b||f.data(d,new q(f,b));return this})}}(jQuery,window,"sortable");
function delRequest(a,b){$("#popupDelBT").attr("delrel",a);$("#popupDel").modal("show");$(".modal-body p").html("").append('Please confirm you would like to delete this Slide <span style="color:#e74c3c;text-decoration:underline;">'+b+"</span> ?")}function doDel(){document.location=$("#popupDelBT").attr("delrel")}function addNew(){$("#addPopup").modal("show")}function cancelPopup(){$("#popupDel").popup("close")}
...
function doPubl(){$.post("/e1_teacher/saveajax",{data:$("#int_lesson_form").serializeArray()},function(a,b){$("#publish").val(a);1==a?($(".publish_btn").addClass("active"),$(".publish_btn span").text("PUBLISHED"),$(".publish_btn").attr("rel","")):($(".publish_btn").removeClass("active"),$(".publish_btn span").text("PUBLISH"));$("#popupPubl").modal("hide");$($($("#message").find("div")[0]).find("div")[0]).hide();1==a?showFooterMessage({status:"success",mess:"Successfully Published",clrT:"#fff",clr:"#128c44",
anim_a:2E3,anim_b:1700}):showFooterMessage({status:"alert",mess:"Successfully Unpublished",clrT:"#fff",clr:"#128c44",anim_a:2E3,anim_b:1700})},"json")}function sortRequest(){var a=[];$("ul.menu2 li").each(function(b){"e2"!=$(this).attr("idn").substr(0,2)&&"e3"!=$(this).attr("idn").substr(0,2)||a.push($(this).attr("idn"))});$("#resources_order").val(a.join())}
$(function(){$("ul.menu2").sortable({axis:"x",handle:"a.question-m",isValidTarget:function(a,b){return itIs=!0},onDrop:function(a,b,d){$("#temp_item").detach();sortRequest();d(a)},onDragStart:function(a,b,d){var c=a.offset(),e=b.rootGroup.pointer,f=$('<li id="temp_item" style="float:left;height: '+a.height()+"px; width: "+a.width()+'px; background-color:lightyellow" class="temp_item"><div class="temp_item_inside"></div></li>');a.before(f);adjustment={left:e.left-c.left,top:e.top-c.top};d(a,b)},pullPlaceholder:!0,
tolerance:10,onDrag:function(a,b){a.css({left:b.left-adjustment.left,top:b.top-adjustment.top})},afterMove:function(a,b,d){"temp_item"==d.attr("class")?a.hide():a.show();"addnew"==d.attr("idn")?a.hide():a.show()}});sortRequest()});
