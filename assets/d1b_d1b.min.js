...
$(function(){bkLib.onDomLoaded(function(){(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_objectives");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_teaching_activities");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_assessment_opportunities");
