...
$(function(){initPublishButton("#publish_btn","publish","PUBLISHED","PUBLISH");bkLib.onDomLoaded(function(){(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_objectives");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_teaching_activities");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("subject_assessment_opportunities");
...
function publishModal(){$("#message").modal("hide");$(".publish_btn").hasClass("active")?$($("#popupPubl").find("p")[0]).html("Please confirm you would like to unpublish the Curriculum"):$($("#popupPubl").find("p")[0]).html("Please confirm you would like to publish the Curriculum");$($("#popupPubl").find("h4")[0]).text("");$("#popupPubl").modal("show")}
function doPubl(){$.post("/d1b/saveajax",{data:$("#saveform").serializeArray()},function(a,b){$("#publish").val(a);1==a?($(".publish_btn").addClass("active"),$(".publish_btn span").text("PUBLISHED")):($(".publish_btn").removeClass("active"),$(".publish_btn span").text("PUBLISH"));$("#popupPubl").modal("hide");$($($("#message").find("div")[0]).find("div")[0]).hide();1==a?showFooterMessage({status:"success",mess:"Successfully Published",clrT:"#fff",clr:"#128c44",anim_a:2E3,anim_b:1700}):showFooterMessage({status:"success",
