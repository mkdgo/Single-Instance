(function(a,b){function c(){a.removeEventListener("load",c,!1);h=!0}function d(a){return m=m||new d.Class(a)}function f(a,b){for(var d in b)a[d]=b[d];return a}function e(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);l.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(l,"$1"));p.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(p,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===b.readyState?h=!0:g&&a.addEventListener("load",c,!1);var l=/\/ath(\/)?$/,p=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,m;d.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};q=a.navigator.userAgent;var u=a.navigator;f(d,{hasToken:"#ath"==b.location.hash||l.test(b.location.href)||p.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(q),isMobileChrome:-1<q.indexOf("Android")&&/Chrome\/[.0-9]*/.test(q)&&-1==q.indexOf("Version"),isMobileIE:-1<q.indexOf("Windows Phone"),language:u.language&&
...
d[c])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=e(a||{},h.defaults,z)}function l(){function d(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}u.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,c){function e(){return f(d("group",{coordsize:m+" "+m,coordorigin:-l+" "+-l}),{width:m,height:m})}function p(a,h,m){b(q,b(f(e(),{rotation:360/c.lines*a+"deg",left:~~h}),b(f(d("roundrect",{arcsize:c.corners}),
{width:l,height:c.width,left:c.radius,top:-c.width>>1,filter:m}),d("fill",{color:g(c.color,a),opacity:c.opacity}),d("stroke",{opacity:0}))))}var h,l=c.length+c.width,m=2*l;h=2*-(c.width+c.length)+"px";var q=f(e(),{position:"absolute",top:h,left:h});if(c.shadow)for(h=1;c.lines>=h;h++)p(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;c.lines>=h;h++)p(h);return b(a,q)};h.prototype.opacity=function(a,b,d,c){a=a.firstChild;c=c.shadow&&c.lines||0;a&&a.childNodes.length>
b+c&&(a=a.childNodes[b+c],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=d))}}var p,m=["webkit","Moz","ms","O"],q={},u=function(){var d=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],d),d.sheet||d.styleSheet}(),z={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};e(h.prototype,{spin:function(b){this.stop();var d=
this,c=d.opts,e=d.el=f(a(0,{className:c.className}),{position:c.position,width:0,zIndex:c.zIndex});if(c.radius+c.length+c.width,f(e,{left:c.left,top:c.top}),b&&b.insertBefore(e,b.firstChild||null),e.setAttribute("role","progressbar"),d.lines(e,d.opts),!p){var g,h=0,l=(c.lines-1)*(1-c.direction)/2,m=c.fps,q=m/c.speed,u=(1-c.opacity)/(q*c.trail/100),z=q/c.lines;(function T(){h++;for(var a=0;c.lines>a;a++)g=Math.max(1-(h+(c.lines-a)*z)%q*u,c.opacity),d.opacity(e,a*c.direction+l,g,c);d.timeout=d.el&&
setTimeout(T,~~(1E3/m))})()}return d},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(d,e){function h(b,d){return f(a(),{position:"absolute",width:e.length+e.width+"px",height:e.width+"px",background:b,boxShadow:d,transformOrigin:"left",transform:"rotate("+~~(360/e.lines*l+e.rotate)+"deg) translate("+e.radius+"px,0)",borderRadius:(e.corners*e.width>>1)+"px"})}for(var m,l=0,q=(e.lines-1)*(1-e.direction)/
2;e.lines>l;l++)m=f(a(),{position:"absolute",top:1+~(e.width/2)+"px",transform:e.hwaccel?"translate3d(0,0,0)":"",opacity:e.opacity,animation:p&&c(e.opacity,e.trail,q+l*e.direction,e.lines)+" "+1/e.speed+"s linear infinite"}),e.shadow&&b(m,f(h("#000","0 0 4px #000"),{top:"2px"})),b(d,b(m,h(g(e.color,l),"0 0 1px rgba(0,0,0,.1)")));return d},opacity:function(a,b,d){a.childNodes.length>b&&(a.childNodes[b].style.opacity=d)}});var K=f(a("group"),{behavior:"url(#default#VML)"});return!d(K,"transform")&&
K.adj?l():p=d(K,"animation"),h});
...
qq.AjaxRequestor=function(a){function b(a){var b=qq.indexOf(l,a),d=m.maxConnections;delete p[a];l.splice(b,1);l.length>=d&&b<d&&(a=l[d-1],c(a))}function c(a){var b=new XMLHttpRequest,c=e(),l={},B;m.onSend(a);m.paramsStore.getParams&&(l=m.paramsStore.getParams(a));B=l;var t=m.endpointStore.getEndpoint(a),r=p[a].addToPath;void 0!==r&&(t+="/"+r);B=h&&B?qq.obj2url(B,t):t;p[a].xhr=b;b.onreadystatechange=d(a);b.open(c,B,!0);m.cors.expected&&m.cors.sendCredentials&&(b.withCredentials=!0);f(a);g("Sending "+
c+" request for "+a);!h&&l?b.send(qq.obj2url(l,"")):b.send()}function d(a){var d=p[a].xhr;return function(){if(4===d.readyState){var c=p[a].xhr,f=e(),h=!1;b(a);0<=qq.indexOf(m.successfulResponseCodes,c.status)||(h=!0,g(f+" request for "+a+" has failed - response code "+c.status,"error"));m.onComplete(a,c,h)}}}function f(a){var b=p[a].xhr;a=m.customHeaders;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,d){b.setRequestHeader(a,
d)})}function e(){return m.demoMode?"GET":m.method}var g,h,l=[],p=[],m={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(m,a);g=m.log;h="GET"===e()||"DELETE"===e();return{send:function(a,b){p[a]={addToPath:b};l.push(a)<=m.maxConnections&&c(a)},cancel:function(a){var d=p[a].xhr,c=e();d?(d.onreadystatechange=
...
qq.UploadHandlerForm=function(a,b,c){function d(a){void 0!==q[a]&&(q[a](),delete q[a])}function f(a,b){var c=a.id;B[m[c]]=b;q[c]=qq(a).attach("load",function(){p[c]&&(z("Received iframe load event for CORS upload request (file id "+c+")"),u[c]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+c;z(a,"error");b({error:a})},1E3))});K.receiveMessage(c,function(a){z("Received the following window message: '"+a+"'");var b=qq.parseJson(a),f=b.uuid;f&&B[f]?(clearTimeout(u[c]),
delete u[c],d(c),a=B[f],delete B[f],K.stopReceivingMessages(c),a(b)):f||z("'"+a+"' does not contain a UUID - ignoring.")})}function e(a,b){l.cors.expected?f(a,b):q[a.id]=qq(a).attach("load",function(){z("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(d){z("Error when attempting to access iframe during handling of upload response ("+d+")","error")}b()}})}function g(a){var b=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');b.setAttribute("id",a);b.style.display="none";document.body.appendChild(b);return b}function h(a,b){var d=l.paramsStore.getParams(a),c=qq.toElement('<form method="'+(l.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),f=l.endpointStore.getEndpoint(a),e=f;d[l.uuidParamName]=m[a];l.paramsInBody?qq.obj2Inputs(d,c):e=qq.obj2url(d,f);c.setAttribute("action",e);c.setAttribute("target",b.name);c.style.display="none";document.body.appendChild(c);return c}var l=a,p=[],m=[],q={},u=
{},z=c,K=new qq.WindowReceiveMessage({log:z}),B={},t;return t={add:function(a){a.setAttribute("name",l.inputName);var b=p.push(a)-1;m[b]=qq.getUniqueId();a.parentNode&&qq(a).remove();return b},getName:function(a){if(t.isValid(a))return p[a].value.replace(/.*(\/|\\)/,"");z(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==p[a]},reset:function(){p=[];m=[];q={}},getUuid:function(a){return m[a]},cancel:function(a){l.onCancel(a,this.getName(a));delete p[a];delete m[a];delete q[a];
l.cors.expected&&(clearTimeout(u[a]),delete u[a],K.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var c=p[a],f=t.getName(a),m=g(a),q;if(!c)throw Error("file with passed id was not added, or already uploaded or cancelled");l.onUpload(a,this.getName(a));q=h(a,m);q.appendChild(c);e(m,function(c){z("iframe loaded");if(!c){var e;try{var g=m.contentDocument||m.contentWindow.document,h=g.body.innerHTML;
z("converting iframe's innerHTML to JSON");z("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);e=qq.parseJson(h)}catch(q){z("Error when attempting to parse form upload response ("+q+")","error"),e={success:!1}}c=e}d(a);l.cors.expected||qq(m).remove();if(c.success||!l.onAutoRetry(a,f,c))l.onComplete(a,f,c),b(a)});z("Sending upload request for "+a);q.submit();qq(q).remove();return a}}};
qq.UploadHandlerXhr=function(a,b,c){function d(a,b,d){var c=x.getSize(a);a=x.getName(a);b[r.chunking.paramNames.partIndex]=d.part;b[r.chunking.paramNames.partByteOffset]=d.start;b[r.chunking.paramNames.chunkSize]=d.size;b[r.chunking.paramNames.totalParts]=d.count;b[r.totalFileSizeParamName]=c;w&&(b[r.chunking.paramNames.filename]=a)}function f(a,b){var d=r.chunking.partSize,c=x.getSize(a),f=n[a].file||n[a].blobData.blob,g=d*b,d=g+d>=c?c:g+d,c=e(a),h;f.slice?h=f.slice(g,d):f.mozSlice?h=f.mozSlice(g,
d):f.webkitSlice&&(h=f.webkitSlice(g,d));return{part:b,start:g,end:d,count:c,blob:h,size:d-g}}function e(a){a=x.getSize(a);return Math.ceil(a/r.chunking.partSize)}function g(a,b,d,c){var f=new FormData,e=r.demoMode?"GET":"POST",g=r.endpointStore.getEndpoint(c),h=g,l=x.getName(c),m=x.getSize(c),q=n[c].blobData;a[r.uuidParamName]=n[c].uuid;w&&(a[r.totalFileSizeParamName]=m,q&&(a[r.blobs.paramNames.name]=q.name));r.paramsInBody||(w||(a[r.inputName]=l),h=qq.obj2url(a,g));b.open(e,h,!0);r.cors.expected&&
r.cors.sendCredentials&&(b.withCredentials=!0);return w?(r.paramsInBody&&qq.obj2FormData(a,f),f.append(r.inputName,d),f):d}function h(a,b){var d=r.customHeaders,c=n[a].file||n[a].blobData.blob;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");w||(b.setRequestHeader("Content-Type","application/octet-stream"),b.setRequestHeader("X-Mime-Type",c.type));qq.each(d,function(a,d){b.setRequestHeader(a,d)})}function l(a,b,d){var c=x.getName(a),f=x.getSize(a);
n[a].attemptingResume=!1;r.onProgress(a,c,f,f);r.onComplete(a,c,b,d);delete n[a].xhr;F(a)}function p(a){var b=n[a].remainingChunkIdxs[0],c=f(a,b),e=n[a].xhr=new XMLHttpRequest,l=x.getSize(a),m=x.getName(a),p;void 0===n[a].loaded&&(n[a].loaded=0);y&&n[a].file&&z(a,c);e.onreadystatechange=u(a,e);e.upload.onprogress=function(d){if(d.lengthComputable){var c=d.loaded+n[a].loaded;d=d.total;var e=f(a,b);d-=e.size;var g=x.getSize(a),e=e.count,h=d-n[a].initialRequestOverhead;n[a].lastRequestOverhead=d;0===
b?(n[a].lastChunkIdxProgress=0,n[a].initialRequestOverhead=d,n[a].estTotalRequestsSize=g+e*d):n[a].lastChunkIdxProgress!==b&&(n[a].lastChunkIdxProgress=b,n[a].estTotalRequestsSize+=h);r.onProgress(a,m,c,n[a].estTotalRequestsSize)}};r.onUploadChunk(a,m,q(c));p=r.paramsStore.getParams(a);d(a,p,c);n[a].attemptingResume&&(p[r.resume.paramNames.resuming]=!0);p=g(p,e,c.blob,a);h(a,e);J("Sending chunked upload request for item "+a+": bytes "+(c.start+1)+"-"+c.end+" of "+l);e.send(p)}function m(a){J("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");y&&(K(a),n[a].attemptingResume=!1);n[a].remainingChunkIdxs=[];delete n[a].loaded;delete n[a].estTotalRequestsSize;delete n[a].initialRequestOverhead}function q(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function u(a,b){return function(){if(4===b.readyState){var d;if(n[a]){J("xhr - server response received for "+a);J("responseText = "+b.responseText);try{d=qq.parseJson(b.responseText)}catch(c){J("Error when attempting to parse xhr response text ("+c+
")","error"),d={}}if(200!==b.status||!d.success||d.reset)if(d.reset&&m(a),n[a].attemptingResume&&d.reset)n[a].attemptingResume=!1,J("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),m(a),x.upload(a,!0);else{var e=x.getName(a);r.onAutoRetry(a,e,d,b)||l(a,d,b)}else if(Q){var e=n[a].remainingChunkIdxs.shift(),g=f(a,e);n[a].attemptingResume=!1;var e=n[a],h=e.loaded,g=g.size;e.loaded=h+(g+(w?n[a].lastRequestOverhead:0));0<n[a].remainingChunkIdxs.length?
p(a):(y&&K(a),l(a,d,b))}else l(a,d,b)}}}}function z(a,b){var d=x.getUuid(a),c=n[a].loaded,f=n[a].initialRequestOverhead,e=n[a].estTotalRequestsSize,g=B(a);qq.setCookie(g,d+E+b.part+E+c+E+f+E+e,r.resume.cookiesExpireIn)}function K(a){n[a].file&&(a=B(a),qq.deleteCookie(a))}function B(a){var b=x.getName(a);a=x.getSize(a);var d=r.chunking.partSize,b="qqfilechunk"+E+encodeURIComponent(b)+E+a+E+d;void 0!==I&&(b+=E+I);return b}function t(a){var b=n[a].file||n[a].blobData.blob,d=x.getName(a),c,f;n[a].loaded=
0;c=n[a].xhr=new XMLHttpRequest;c.upload.onprogress=function(b){b.lengthComputable&&(n[a].loaded=b.loaded,r.onProgress(a,d,b.loaded,b.total))};c.onreadystatechange=u(a,c);f=r.paramsStore.getParams(a);b=g(f,c,b,a);h(a,c);J("Sending upload request for "+a);c.send(b)}var r=a,F=b,J=c,n=[],E="|",Q=r.chunking.enabled&&qq.supportedFeatures.chunking,y=r.resume.enabled&&Q&&qq.supportedFeatures.resume,I;I=null===r.resume.id||void 0===r.resume.id||qq.isFunction(r.resume.id)||qq.isObject(r.resume.id)?void 0:
r.resume.id;var w=r.forceMultipart||r.paramsInBody,x;return x={add:function(a){if(a instanceof File)a=n.push({file:a})-1;else if(qq.isBlob(a.blob))a=n.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");n[a].uuid=qq.getUniqueId();return a},getName:function(a){if(x.isValid(a)){var b=n[a].file;a=n[a].blobData;return b?null!==b.fileName&&void 0!==b.fileName?b.fileName:b.name:a.name}J(a+" is not a valid item ID.","error")},getSize:function(a){a=n[a].file||
n[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(n[a])return n[a].file||n[a].blobData.blob},getLoaded:function(a){return n[a].loaded||0},isValid:function(a){return void 0!==n[a]},reset:function(){n=[]},getUuid:function(a){return n[a].uuid},upload:function(a,b){var d=this.getName(a);r.onUpload(a,d);if(Q){var c=x.getName(a),d=0,g,h;if(!n[a].remainingChunkIdxs||0===n[a].remainingChunkIdxs.length){n[a].remainingChunkIdxs=[];if(y&&!b&&n[a].file){a:{g=
qq.getCookie(B(a));h=x.getName(a);var l,m,k;if(g){g=g.split(E);if(5===g.length){h=g[0];l=parseInt(g[1],10);m=parseInt(g[2],10);k=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:l,lastByteSent:m,initialRequestOverhead:k,estTotalRequestsSize:g};break a}J("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=f(a,g.part),!1!==r.onResume(a,c,q(h))&&(d=g.part,n[a].uuid=g.uuid,n[a].loaded=g.lastByteSent,n[a].estTotalRequestsSize=g.estTotalRequestsSize,
n[a].initialRequestOverhead=g.initialRequestOverhead,n[a].attemptingResume=!0,J("Resuming "+c+" at partition index "+d)))}for(c=e(a)-1;c>=d;--c)n[a].remainingChunkIdxs.unshift(c)}p(a)}else t(a)},cancel:function(a){var b=n[a].xhr;r.onCancel(a,this.getName(a));b&&(b.onreadystatechange=null,b.abort());y&&K(a);delete n[a]},getResumableFilesData:function(){var a=[],b=[];return Q&&y?(a=void 0===I?qq.getCookieNames(RegExp("^qqfilechunk\\"+E+".+\\"+E+"\\d+\\"+E+r.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
...
(function(a){var b,c,d,f,e,g,h,l,p,m;g=["uploaderType"];d=function(a){a&&(a=l(a),h(a),"basic"===e("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return c};f=function(a,b){var d=c.data("fineuploader");if(b)void 0===d&&(d={}),d[a]=b,c.data("fineuploader",d);else return void 0===d?null:d[a]};b=function(a){return f("uploader",a)};e=function(a,b){return f(a,b)};h=function(b){var d=b.callbacks={};b=new qq.FineUploaderBasic;a.each(b._options.callbacks,function(a){var b,f;b=/^on(\w+)/.exec(a)[1];
...
c.appendTo(this.options.container):c.insertAfter(this.$element);var e=this.getPosition(),h=c[0].offsetWidth,l=c[0].offsetHeight;if(g){var p=this.$element.parent(),g=b,m=document.documentElement.scrollTop||document.body.scrollTop,q="body"==this.options.container?window.innerWidth:p.outerWidth(),u="body"==this.options.container?window.innerHeight:p.outerHeight(),p="body"==this.options.container?0:p.offset().left,b="bottom"==b&&e.top+e.height+l-m>u?"top":"top"==b&&0>e.top-m-l?"bottom":"right"==b&&e.right+
...
l-m),/bottom|top/.test(b))?(l=0,0>a.left&&(l=-2*a.left,a.left=0,g.offset(a),p=g[0].offsetWidth),this.replaceArrow(l-h+p,p,"left")):this.replaceArrow(m-l,m,"top");c&&g.offset(a)};b.prototype.replaceArrow=function(a,b,c){this.arrow().css(c,a?50*(1-a/b)+"%":"")};b.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};b.prototype.hide=function(){function b(){"in"!=c.hoverState&&e.detach()}
...
function p(){var b,c=a.data(H,O);null==c?(k=a.extend({},ha),console&&console.log&&console.log("Error: cboxElement missing settings object")):k=a.extend({},c);for(b in k)a.isFunction(k[b])&&"on"!==b.slice(0,2)&&(k[b]=k[b].call(H));k.rel=k.rel||H.rel||a(H).data("rel")||"nofollow";k.href=k.href||a(H).attr("href");k.title=k.title||H.title;"string"==typeof k.href&&(k.href=a.trim(k.href))}function m(c,d){a(b).trigger(c);L.triggerHandler(c);a.isFunction(d)&&d.call(H)}function q(c){Y||(H=c,p(),y=a(H),G=0,
"nofollow"!==k.rel&&(y=a("."+V).filter(function(){var b,c=a.data(this,O);return c&&(b=a(this).data("rel")||c.rel||this.rel),b===k.rel}),G=y.index(H),-1===G&&(y=y.add(H),G=y.length-1)),B.css({opacity:parseFloat(k.opacity),cursor:k.overlayClose?"pointer":"auto",visibility:"visible"}).show(),ia&&t.add(B).removeClass(ia),k.className&&t.add(B).addClass(k.className),ia=k.className,k.closeButton?aa.html(k.close).appendTo(F):aa.appendTo("<div/>"),P||(P=Z=!0,t.css({visibility:"hidden",display:"block"}),w=
d(A,"LoadedContent","width:0; height:0; overflow:hidden"),F.css({width:"",height:""}).append(w),M=J.height()+Q.height()+F.outerHeight(!0)-F.height(),N=n.width()+E.width()+F.outerWidth(!0)-F.width(),R=w.outerHeight(!0),S=w.outerWidth(!0),k.w=g(k.initialWidth,"x"),k.h=g(k.initialHeight,"y"),w.css({width:"",height:k.h}),C.position(),m(pa,k.onOpen),ga.add(ea).hide(),t.focus(),k.trapFocus&&b.addEventListener&&(b.addEventListener("focus",l,!0),L.one(ja,function(){b.removeEventListener("focus",l,!0)})),
k.returnFocus&&L.one(ja,function(){a(H).focus()})),K())}function u(){!t&&b.body&&(ka=!1,I=a(c),t=d(A).attr({id:O,"class":!1===a.support.opacity?D+"IE":"",role:"dialog",tabindex:"-1"}).hide(),B=d(A,"Overlay").hide(),T=a([d(A,"LoadingOverlay")[0],d(A,"LoadingGraphic")[0]]),r=d(A,"Wrapper"),F=d(A,"Content").append(ea=d(A,"Title"),fa=d(A,"Current"),X=a('<button type="button"/>').attr({id:D+"Previous"}),W=a('<button type="button"/>').attr({id:D+"Next"}),U=d("button","Slideshow"),T),aa=a('<button type="button"/>').attr({id:D+
"Close"}),r.append(d(A).append(d(A,"TopLeft"),J=d(A,"TopCenter"),d(A,"TopRight")),d(A,!1,"clear:left").append(n=d(A,"MiddleLeft"),F,E=d(A,"MiddleRight")),d(A,!1,"clear:left").append(d(A,"BottomLeft"),Q=d(A,"BottomCenter"),d(A,"BottomRight"))).find("div div").css({"float":"left"}),x=d(A,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),ga=W.add(X).add(fa).add(U),a(b.body).append(B,t.append(r,x)))}function z(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),q(this))}return t?(ka||(ka=!0,W.click(function(){C.next()}),X.click(function(){C.prev()}),aa.click(function(){C.close()}),B.click(function(){k.overlayClose&&C.close()}),a(b).bind("keydown."+D,function(a){var b=a.keyCode;P&&k.escKey&&27===b&&(a.preventDefault(),C.close());P&&k.arrowKey&&y[1]&&!a.altKey&&(37===b?(a.preventDefault(),X.click()):39===b&&(a.preventDefault(),W.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+D,"."+V,c):a("."+V).live("click."+D,c)),!0):!1}
function K(){var e,f,l,n=C.prep,q=++la;Z=!0;v=!1;H=y[G];p();m(ba);m(ca,k.onLoad);k.h=k.height?g(k.height,"y")-R-M:k.innerHeight&&g(k.innerHeight,"y");k.w=k.width?g(k.width,"x")-S-N:k.innerWidth&&g(k.innerWidth,"x");k.mw=k.w;k.mh=k.h;k.maxWidth&&(k.mw=g(k.maxWidth,"x")-S-N,k.mw=k.w&&k.w<k.mw?k.w:k.mw);k.maxHeight&&(k.mh=g(k.maxHeight,"y")-R-M,k.mh=k.h&&k.h<k.mh?k.h:k.mh);e=k.href;na=setTimeout(function(){T.show()},100);k.inline?(l=d(A).hide().insertBefore(a(e)[0]),L.one(ba,function(){l.replaceWith(w.children())}),
n(a(e))):k.iframe?n(" "):k.html?n(k.html):k.photo||k.photoRegex.test(e)?(e=h(k,e),v=b.createElement("img"),a(v).addClass(D+"Photo").bind("error",function(){k.title=!1;n(d(A,"Error").html(k.imgError))}).one("load",function(){var b;q===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(H).attr(c)||a(H).attr("data-"+c);d&&v.setAttribute(c,d)}),k.retinaImage&&1<c.devicePixelRatio&&(v.height/=c.devicePixelRatio,v.width/=c.devicePixelRatio),k.scalePhotos&&(f=function(){v.height-=v.height*
b;v.width-=v.width*b},k.mw&&v.width>k.mw&&(b=(v.width-k.mw)/v.width,f()),k.mh&&v.height>k.mh&&(b=(v.height-k.mh)/v.height,f())),k.h&&(v.style.marginTop=Math.max(k.mh-v.height,0)/2+"px"),y[1]&&(k.loop||y[G+1])&&(v.style.cursor="pointer",v.onclick=function(){C.next()}),v.style.width=v.width+"px",v.style.height=v.height+"px",setTimeout(function(){n(v)},1))}),setTimeout(function(){v.src=e},1)):e&&x.load(e,k.data,function(b,c){q===la&&n("error"===c?d(A,"Error").html(k.xhrError):a(this).contents())})}var B,
t,r,F,J,n,E,Q,y,I,w,x,T,ea,fa,U,W,X,aa,ga,k,M,N,R,S,H,G,v,P,Z,Y,na,C,ia,ka,ha={html:!1,photo:!1,iframe:!1,inline:!1,transition:"elastic",speed:300,fadeOut:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,href:!1,title:!1,rel:!1,opacity:.9,preloading:!0,className:!1,overlayClose:!0,escKey:!0,arrowKey:!0,top:!1,bottom:!1,left:!1,right:!1,fixed:!1,data:void 0,closeButton:!0,fastIframe:!0,open:!1,reposition:!0,
...
V=D+"Element",pa=D+"_open",ca=D+"_load",da=D+"_complete",ma=D+"_cleanup",ja=D+"_closed",ba=D+"_purge",L=a("<a/>"),A="div",la=0,oa={},qa=function(){function a(){clearTimeout(g)}function b(){(k.loop||y[G+1])&&(a(),g=setTimeout(C.next,k.slideshowSpeed))}function c(){U.html(k.slideshowStop).unbind(l).one(l,d);L.bind(da,b).bind(ca,a);t.removeClass(h+"off").addClass(h+"on")}function d(){a();L.unbind(da,b).unbind(ca,a);U.html(k.slideshowStart).unbind(l).one(l,function(){C.next();c()});t.removeClass(h+"on").addClass(h+
"off")}function e(){f=!1;U.hide();a();L.unbind(da,b).unbind(ca,a);t.removeClass(h+"off "+h+"on")}var f,g,h=D+"Slideshow_",l="click."+D;return function(){f?k.slideshow||(L.unbind(ma,e),e()):k.slideshow&&y[1]&&(f=!0,L.one(ma,e),k.slideshowAuto?c():d(),U.show())}}();a.colorbox||(a(u),C=a.fn[O]=a[O]=function(b,c){var d=this;if(b=b||{},u(),z()){if(a.isFunction(d))d=a("<a/>"),b.open=!0;else if(!d[0])return d;c&&(b.onComplete=c);d.each(function(){a.data(this,O,a.extend({},a.data(this,O)||ha,b))}).addClass(V);
(a.isFunction(b.open)&&b.open.call(d)||b.open)&&q(d[0])}return d},C.position=function(b,c){function d(){J[0].style.width=Q[0].style.width=F[0].style.width=parseInt(t[0].style.width,10)-N+"px";F[0].style.height=n[0].style.height=E[0].style.height=parseInt(t[0].style.height,10)-M+"px"}var e,h,l,m=0,p=0,q=t.offset();if(I.unbind("resize."+D),t.css({top:-9E4,left:-9E4}),h=I.scrollTop(),l=I.scrollLeft(),k.fixed?(q.top-=h,q.left-=l,t.css({position:"fixed"})):(m=h,p=l,t.css({position:"absolute"})),p+=!1!==
k.right?Math.max(I.width()-k.w-S-N-g(k.right,"x"),0):!1!==k.left?g(k.left,"x"):Math.round(Math.max(I.width()-k.w-S-N,0)/2),m+=!1!==k.bottom?Math.max(f()-k.h-R-M-g(k.bottom,"y"),0):!1!==k.top?g(k.top,"y"):Math.round(Math.max(f()-k.h-R-M,0)/2),t.css({top:q.top,left:q.left,visibility:"visible"}),r[0].style.width=r[0].style.height="9999px",e={width:k.w+S+N,height:k.h+R+M,top:m,left:p},b){var u=0;a.each(e,function(a){return e[a]!==oa[a]?(u=b,void 0):void 0});b=u}oa=e;b||t.css(e);t.dequeue().animate(e,
{duration:b||0,complete:function(){d();Z=!1;r[0].style.width=k.w+S+N+"px";r[0].style.height=k.h+R+M+"px";k.reposition&&setTimeout(function(){I.bind("resize."+D,C.position)},1);c&&c()},step:d})},C.resize=function(a){var b;P&&(a=a||{},a.width&&(k.w=g(a.width,"x")-S-N),a.innerWidth&&(k.w=g(a.innerWidth,"x")),w.css({width:k.w}),a.height&&(k.h=g(a.height,"y")-R-M),a.innerHeight&&(k.h=g(a.innerHeight,"y")),a.innerHeight||a.height||(b=w.scrollTop(),w.css({height:"auto"}),k.h=w.height()),w.css({height:k.h}),
b&&w.scrollTop(b),C.position("none"===k.transition?0:k.speed))},C.prep=function(c){if(P){var f,g="none"===k.transition?0:k.speed;w.empty().remove();w=d(A,"LoadedContent").append(c);w.hide().appendTo(x.show()).css({width:(k.w=k.w||w.width(),k.w=k.mw&&k.mw<k.w?k.mw:k.w,k.w),overflow:k.scrolling?"auto":"hidden"}).css({height:(k.h=k.h||w.height(),k.h=k.mh&&k.mh<k.h?k.mh:k.h,k.h)}).prependTo(F);x.hide();a(v).css({"float":"none"});f=function(){function c(){!1===a.support.opacity&&t[0].style.removeAttribute("filter")}
var f,l,n=y.length;P&&(l=function(){clearTimeout(na);T.hide();m(da,k.onComplete)},ea.html(k.title).add(w).show(),1<n?("string"==typeof k.current&&fa.html(k.current.replace("{current}",G+1).replace("{total}",n)).show(),W[k.loop||n-1>G?"show":"hide"]().html(k.next),X[k.loop||G?"show":"hide"]().html(k.previous),qa(),k.preloading&&a.each([e(-1),e(1)],function(){var c,d,e=y[this],f=a.data(e,O);f&&f.href?(c=f.href,a.isFunction(c)&&(c=c.call(e))):c=a(e).attr("href");c&&(f.photo||f.photoRegex.test(c))&&(c=
h(f,c),d=b.createElement("img"),d.src=c)})):ga.hide(),k.iframe?(f=d("iframe")[0],"frameBorder"in f&&(f.frameBorder=0),"allowTransparency"in f&&(f.allowTransparency="true"),k.scrolling||(f.scrolling="no"),a(f).attr({src:k.href,name:(new Date).getTime(),"class":D+"Iframe",allowFullScreen:!0,webkitAllowFullScreen:!0,mozallowfullscreen:!0}).one("load",l).appendTo(w),L.one(ba,function(){f.src="//about:blank"}),k.fastIframe&&a(f).trigger("load")):l(),"fade"===k.transition?t.fadeTo(g,1,c):c())};"fade"===
k.transition?t.fadeTo(g,0,function(){C.position(0,f)}):C.position(g,f)}},C.next=function(){!Z&&y[1]&&(k.loop||y[G+1])&&(G=e(1),q(y[G]))},C.prev=function(){!Z&&y[1]&&(k.loop||G)&&(G=e(-1),q(y[G]))},C.close=function(){P&&!Y&&(Y=!0,P=!1,m(ma,k.onCleanup),I.unbind("."+D),B.fadeTo(k.fadeOut||0,0),t.stop().fadeTo(k.fadeOut||0,0,function(){t.add(B).css({opacity:1,cursor:"auto"}).hide();m(ba);w.empty().remove();setTimeout(function(){Y=!1;m(ja,k.onClosed)},1)}))},C.remove=function(){t&&(t.stop(),a.colorbox.close(),
...
g=a.nodeName.toLowerCase(),h=a.hasChildNodes&&a.hasChildNodes(),l=[];switch(e){case 1:var p=a.attributes;switch(g){case "b":g="strong";break;case "i":g="em";break;case "font":g="span"}if(b){for(e=0;e<p.length;e++){var m=p[e],q=m.nodeName.toLowerCase(),u=m.nodeValue;if(m.specified&&u&&!bkLib.inArray(this.stripAttributes,q)&&"function"!=typeof u){switch(q){case "style":m=u.replace(/ /g,"");for(itm in this.cssReplace)-1!=m.indexOf(itm)&&(l.push(this.cssReplace[itm]),m=m.replace(itm,""));f+=m;u="";break;
case "class":u=u.replace("Apple-style-span","");break;case "size":f+="font-size:"+this.sizes[u]+";",u=""}u&&(d+=" "+q+'="'+u+'"')}}f&&(d+=' style="'+f+'"');for(e=0;e<l.length;e++)c+="<"+l[e]+">";""==d&&"span"==g&&(b=!1);b&&(c+="<"+g,"br"!=g&&(c+=d))}if(h||bkLib.inArray(this.noShort,q))for(b&&(c+=">"),e=0;e<a.childNodes.length;e++)(q=this.toXHTML(a.childNodes[e],!0,!0))&&(c+=q);else b&&(c+=" />");b&&h&&(c+="</"+g+">");for(e=0;e<l.length;e++)c+="</"+l[e]+">";break;case 3:c+=a.nodeValue}return c}});
...
$(function(){bkLib.onDomLoaded(function(){(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_intro");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_objectives");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_teaching_activities");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_assessment_opportunities");
(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_notes")})});
function publishModal(){$("#message").modal("hide");$(".publish_btn").hasClass("active")?$($("#popupPubl").find("p")[0]).html("This act will unpublish all related slides. Please confirm you would like to unpublish the Lesson Plan"):""!=$(".publish_btn").attr("rel")?$($("#popupPubl").find("p")[0]).html("You are trying to publish lesson from a "+$(".publish_btn").attr("rel")+" that are unpublished. Please confirm if you would like to publish the parent "+$(".publish_btn").attr("rel")+" , otherwise please cancel."):
$($("#popupPubl").find("p")[0]).html("Please confirm you would like to publish the Lesson Plan");$($("#popupPubl").find("h4")[0]).text("");$("#popupPubl").modal("show")}
function doPubl(){$("#lesson_intro").val(nicEditors.findEditor("lesson_intro").getContent());$("#lesson_objectives").val(nicEditors.findEditor("lesson_objectives").getContent());$("#lesson_teaching_activities").val(nicEditors.findEditor("lesson_teaching_activities").getContent());$("#lesson_assessment_opportunities").val(nicEditors.findEditor("lesson_assessment_opportunities").getContent());$("#lesson_notes").val(nicEditors.findEditor("lesson_notes").getContent());$.post("/d5_teacher/saveajax",{data:$("#saveform").serializeArray()},
function(a,b){sid=$("input[name=subject_id]").val();mid=$("input[name=module_id]").val();lid=$("input[name=lesson_id]").val();"0"==lid&&(lid=a.publish,document.location="/d5_teacher/index/"+sid+"/"+mid+"/"+a.lesson_id);$("#popupPubl").modal("hide");$("#publish").val(a.publish);1==a.publish?($(".publish_btn").addClass("active"),$(".publish_btn span").text("PUBLISHED")):($(".publish_btn").removeClass("active"),$(".publish_btn span").text("PUBLISH"));$(".publish_btn").attr("rel","");$($($("#message").find("div")[0]).find("div")[0]).hide();
1==a.publish?showFooterMessage({status:"success",mess:"Successfully Published",clrT:"#fff",clr:"#128c44",anim_a:2E3,anim_b:1700}):showFooterMessage({status:"alert",mess:"Successfully Unpublished",clrT:"#fff",clr:"#128c44",anim_a:2E3,anim_b:1700})},"json")}$(document).bind("mobileinit",function(){$.mobile.ignoreContentEnabled=!0});$(document).bind("pageinit",function(){});
