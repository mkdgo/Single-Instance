...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};p=a.navigator.userAgent;var u=a.navigator;f(d,{hasToken:"#ath"==b.location.hash||l.test(b.location.href)||q.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(p),isMobileChrome:-1<p.indexOf("Android")&&/Chrome\/[.0-9]*/.test(p)&&-1==p.indexOf("Version"),isMobileIE:-1<p.indexOf("Windows Phone"),language:u.language&&
u.language.toLowerCase().replace("-","_")||""});d.language=d.language&&d.language in d.intl?d.language:"en_us";d.isMobileSafari=d.isIDevice&&-1<p.indexOf("Safari")&&0>p.indexOf("CriOS");d.OS=d.isIDevice?"ios":d.isMobileChrome?"android":d.isMobileIE?"windows":"unsupported";d.OSVersion=p.match(/(OS|Android) (\d+[_\.]\d+)/);d.OSVersion=d.OSVersion&&d.OSVersion[2]?+d.OSVersion[2].replace("_","."):0;d.isStandalone="standalone"in a.navigator&&a.navigator.standalone;d.isTablet=d.isMobileSafari&&-1<p.indexOf("iPad")||
...
(function(a,b){"object"==typeof exports?module.exports=b():"function"==typeof define&&define.amd?define(b):a.Spinner=b()})(this,function(){function a(a,b){var d,c=document.createElement(a||"div");for(d in b)c[d]=b[d];return c}function b(a){for(var b=1,d=arguments.length;d>b;b++)a.appendChild(arguments[b]);return a}function c(a,b,d,c){var f=["opacity",b,~~(100*a),d,c].join("-");d=.01+d/c*100;c=Math.max(1-(1-a)/b*(100-d),a);var e=q.substring(0,q.indexOf("Animation")).toLowerCase();return p[f]||(u.insertRule("@"+
(e&&"-"+e+"-"||"")+"keyframes "+f+"{0%{opacity:"+c+"}"+d+"%{opacity:"+a+"}"+(d+.01)+"%{opacity:1}"+(d+b)%100+"%{opacity:"+a+"}100%{opacity:"+c+"}}",u.cssRules.length),p[f]=1),f}function d(a,b){var d,c,f=a.style;b=b.charAt(0).toUpperCase()+b.slice(1);for(c=0;m.length>c;c++)if(d=m[c]+b,void 0!==f[d])return d;return void 0!==f[b]?b:void 0}function f(a,b){for(var c in b)a.style[d(a,c)||c]=b[c];return a}function e(a){for(var b=1;arguments.length>b;b++){var d=arguments[b],c;for(c in d)void 0===a[c]&&(a[c]=
d[c])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=e(a||{},h.defaults,z)}function l(){function d(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}u.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,c){function e(){return f(d("group",{coordsize:m+" "+m,coordorigin:-l+" "+-l}),{width:m,height:m})}function q(a,h,m){b(p,b(f(e(),{rotation:360/c.lines*a+"deg",left:~~h}),b(f(d("roundrect",{arcsize:c.corners}),
{width:l,height:c.width,left:c.radius,top:-c.width>>1,filter:m}),d("fill",{color:g(c.color,a),opacity:c.opacity}),d("stroke",{opacity:0}))))}var h,l=c.length+c.width,m=2*l;h=2*-(c.width+c.length)+"px";var p=f(e(),{position:"absolute",top:h,left:h});if(c.shadow)for(h=1;c.lines>=h;h++)q(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;c.lines>=h;h++)q(h);return b(a,p)};h.prototype.opacity=function(a,b,d,c){a=a.firstChild;c=c.shadow&&c.lines||0;a&&a.childNodes.length>
b+c&&(a=a.childNodes[b+c],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=d))}}var q,m=["webkit","Moz","ms","O"],p={},u=function(){var d=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],d),d.sheet||d.styleSheet}(),z={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};e(h.prototype,{spin:function(b){this.stop();var d=
this,c=d.opts,e=d.el=f(a(0,{className:c.className}),{position:c.position,width:0,zIndex:c.zIndex});if(c.radius+c.length+c.width,f(e,{left:c.left,top:c.top}),b&&b.insertBefore(e,b.firstChild||null),e.setAttribute("role","progressbar"),d.lines(e,d.opts),!q){var g,h=0,l=(c.lines-1)*(1-c.direction)/2,m=c.fps,p=m/c.speed,u=(1-c.opacity)/(p*c.trail/100),z=p/c.lines;(function T(){h++;for(var a=0;c.lines>a;a++)g=Math.max(1-(h+(c.lines-a)*z)%p*u,c.opacity),d.opacity(e,a*c.direction+l,g,c);d.timeout=d.el&&
...
qq.UploadHandlerForm=function(a,b,c){function d(a){void 0!==p[a]&&(p[a](),delete p[a])}function f(a,b){var c=a.id;B[m[c]]=b;p[c]=qq(a).attach("load",function(){q[c]&&(z("Received iframe load event for CORS upload request (file id "+c+")"),u[c]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+c;z(a,"error");b({error:a})},1E3))});K.receiveMessage(c,function(a){z("Received the following window message: '"+a+"'");var b=qq.parseJson(a),f=b.uuid;f&&B[f]?(clearTimeout(u[c]),
delete u[c],d(c),a=B[f],delete B[f],K.stopReceivingMessages(c),a(b)):f||z("'"+a+"' does not contain a UUID - ignoring.")})}function e(a,b){l.cors.expected?f(a,b):p[a.id]=qq(a).attach("load",function(){z("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(d){z("Error when attempting to access iframe during handling of upload response ("+d+")","error")}b()}})}function g(a){var b=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');b.setAttribute("id",a);b.style.display="none";document.body.appendChild(b);return b}function h(a,b){var d=l.paramsStore.getParams(a),c=qq.toElement('<form method="'+(l.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),f=l.endpointStore.getEndpoint(a),e=f;d[l.uuidParamName]=m[a];l.paramsInBody?qq.obj2Inputs(d,c):e=qq.obj2url(d,f);c.setAttribute("action",e);c.setAttribute("target",b.name);c.style.display="none";document.body.appendChild(c);return c}var l=a,q=[],m=[],p={},u=
{},z=c,K=new qq.WindowReceiveMessage({log:z}),B={},t;return t={add:function(a){a.setAttribute("name",l.inputName);var b=q.push(a)-1;m[b]=qq.getUniqueId();a.parentNode&&qq(a).remove();return b},getName:function(a){if(t.isValid(a))return q[a].value.replace(/.*(\/|\\)/,"");z(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==q[a]},reset:function(){q=[];m=[];p={}},getUuid:function(a){return m[a]},cancel:function(a){l.onCancel(a,this.getName(a));delete q[a];delete m[a];delete p[a];
l.cors.expected&&(clearTimeout(u[a]),delete u[a],K.stopReceivingMessages(a));if(a=document.getElementById(a))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()},upload:function(a){var c=q[a],f=t.getName(a),m=g(a),p;if(!c)throw Error("file with passed id was not added, or already uploaded or cancelled");l.onUpload(a,this.getName(a));p=h(a,m);p.appendChild(c);e(m,function(c){z("iframe loaded");if(!c){var e;try{var g=m.contentDocument||m.contentWindow.document,h=g.body.innerHTML;
z("converting iframe's innerHTML to JSON");z("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);e=qq.parseJson(h)}catch(p){z("Error when attempting to parse form upload response ("+p+")","error"),e={success:!1}}c=e}d(a);l.cors.expected||qq(m).remove();if(c.success||!l.onAutoRetry(a,f,c))l.onComplete(a,f,c),b(a)});z("Sending upload request for "+a);p.submit();qq(p).remove();return a}}};
...
n[a].attemptingResume=!1;r.onProgress(a,c,f,f);r.onComplete(a,c,b,d);delete n[a].xhr;F(a)}function q(a){var b=n[a].remainingChunkIdxs[0],c=f(a,b),e=n[a].xhr=new XMLHttpRequest,l=x.getSize(a),m=x.getName(a),q;void 0===n[a].loaded&&(n[a].loaded=0);y&&n[a].file&&z(a,c);e.onreadystatechange=u(a,e);e.upload.onprogress=function(d){if(d.lengthComputable){var c=d.loaded+n[a].loaded;d=d.total;var e=f(a,b);d-=e.size;var g=x.getSize(a),e=e.count,h=d-n[a].initialRequestOverhead;n[a].lastRequestOverhead=d;0===
b?(n[a].lastChunkIdxProgress=0,n[a].initialRequestOverhead=d,n[a].estTotalRequestsSize=g+e*d):n[a].lastChunkIdxProgress!==b&&(n[a].lastChunkIdxProgress=b,n[a].estTotalRequestsSize+=h);r.onProgress(a,m,c,n[a].estTotalRequestsSize)}};r.onUploadChunk(a,m,p(c));q=r.paramsStore.getParams(a);d(a,q,c);n[a].attemptingResume&&(q[r.resume.paramNames.resuming]=!0);q=g(q,e,c.blob,a);h(a,e);J("Sending chunked upload request for item "+a+": bytes "+(c.start+1)+"-"+c.end+" of "+l);e.send(q)}function m(a){J("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");y&&(K(a),n[a].attemptingResume=!1);n[a].remainingChunkIdxs=[];delete n[a].loaded;delete n[a].estTotalRequestsSize;delete n[a].initialRequestOverhead}function p(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function u(a,b){return function(){if(4===b.readyState){var d;if(n[a]){J("xhr - server response received for "+a);J("responseText = "+b.responseText);try{d=qq.parseJson(b.responseText)}catch(c){J("Error when attempting to parse xhr response text ("+c+
...
c.appendTo(this.options.container):c.insertAfter(this.$element);var e=this.getPosition(),h=c[0].offsetWidth,l=c[0].offsetHeight;if(g){var q=this.$element.parent(),g=b,m=document.documentElement.scrollTop||document.body.scrollTop,p="body"==this.options.container?window.innerWidth:q.outerWidth(),u="body"==this.options.container?window.innerHeight:q.outerHeight(),q="body"==this.options.container?0:q.offset().left,b="bottom"==b&&e.top+e.height+l-m>u?"top":"top"==b&&0>e.top-m-l?"bottom":"right"==b&&e.right+
...
function q(){var b,c=a.data(H,O);null==c?(k=a.extend({},ha),console&&console.log&&console.log("Error: cboxElement missing settings object")):k=a.extend({},c);for(b in k)a.isFunction(k[b])&&"on"!==b.slice(0,2)&&(k[b]=k[b].call(H));k.rel=k.rel||H.rel||a(H).data("rel")||"nofollow";k.href=k.href||a(H).attr("href");k.title=k.title||H.title;"string"==typeof k.href&&(k.href=a.trim(k.href))}function m(c,d){a(b).trigger(c);L.triggerHandler(c);a.isFunction(d)&&d.call(H)}function p(c){Y||(H=c,q(),y=a(H),G=0,
...
(a.isFunction(b.open)&&b.open.call(d)||b.open)&&p(d[0])}return d},C.position=function(b,c){function d(){J[0].style.width=Q[0].style.width=F[0].style.width=parseInt(t[0].style.width,10)-N+"px";F[0].style.height=n[0].style.height=E[0].style.height=parseInt(t[0].style.height,10)-M+"px"}var e,h,l,m=0,q=0,p=t.offset();if(I.unbind("resize."+D),t.css({top:-9E4,left:-9E4}),h=I.scrollTop(),l=I.scrollLeft(),k.fixed?(p.top-=h,p.left-=l,t.css({position:"fixed"})):(m=h,q=l,t.css({position:"absolute"})),q+=!1!==
k.right?Math.max(I.width()-k.w-S-N-g(k.right,"x"),0):!1!==k.left?g(k.left,"x"):Math.round(Math.max(I.width()-k.w-S-N,0)/2),m+=!1!==k.bottom?Math.max(f()-k.h-R-M-g(k.bottom,"y"),0):!1!==k.top?g(k.top,"y"):Math.round(Math.max(f()-k.h-R-M,0)/2),t.css({top:p.top,left:p.left,visibility:"visible"}),r[0].style.width=r[0].style.height="9999px",e={width:k.w+S+N,height:k.h+R+M,top:m,left:q},b){var u=0;a.each(e,function(a){return e[a]!==oa[a]?(u=b,void 0):void 0});b=u}oa=e;b||t.css(e);t.dequeue().animate(e,
...
k.transition?t.fadeTo(g,0,function(){C.position(0,f)}):C.position(g,f)}},C.next=function(){!Z&&y[1]&&(k.loop||y[G+1])&&(G=e(1),p(y[G]))},C.prev=function(){!Z&&y[1]&&(k.loop||G)&&(G=e(-1),p(y[G]))},C.close=function(){P&&!Y&&(Y=!0,P=!1,m(ma,k.onCleanup),I.unbind("."+D),B.fadeTo(k.fadeOut||0,0),t.stop().fadeTo(k.fadeOut||0,0,function(){t.add(B).css({opacity:1,cursor:"auto"}).hide();m(ba);w.empty().remove();setTimeout(function(){Y=!1;m(ja,k.onClosed)},1)}))},C.remove=function(){t&&(t.stop(),a.colorbox.close(),
