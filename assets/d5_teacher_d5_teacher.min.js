...
$(function(){$("ul.sortable").sortable({update:function(a,b){var c=$("ul.sortable").sortable("toArray",{attribute:"id"});$.post("/d5_teacher/saveorder/",{data:JSON.stringify(c),lesson_id:$("#lesson_id").val()},function(a,b){},"json")}});$("ul.sortable").disableSelection();bkLib.onDomLoaded(function(){(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_intro");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_objectives");
(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_teaching_activities");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_assessment_opportunities");(new nicEditor({buttonList:"bold italic underline left center justify ol ul removeformat forecolor bgcolor link unlink fontSize fontFamily".split(" ")})).panelInstance("lesson_notes")})});
