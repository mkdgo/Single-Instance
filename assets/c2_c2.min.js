(function(a,b){function d(){a.removeEventListener("load",d,!1);h=!0}function c(a){return m=m||new c.Class(a)}function e(a,c){for(var b in c)a[b]=c[b];return a}function f(){"#ath"==b.location.hash&&history.replaceState("",a.document.title,b.location.href.split("#")[0]);k.test(b.location.href)&&history.replaceState("",a.document.title,b.location.href.replace(k,"$1"));n.test(b.location.search)&&history.replaceState("",a.document.title,b.location.href.replace(n,"$2"))}var g="addEventListener"in a,h=!1;
"complete"===b.readyState?h=!0:g&&a.addEventListener("load",d,!1);var k=/\/ath(\/)?$/,n=/([\?&]ath=[^&]*$|&ath=[^&]*(&))/,m;c.intl={de_de:{ios:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, tippen Sie auf %icon und dann <strong>Zum Home-Bildschirm</strong>.",android:"Um diese Web-App zum Home-Bildschirm hinzuzuf\u00fcgen, \u00f6ffnen Sie das Men\u00fc und tippen dann auf <strong>Zum Startbildschirm hinzuf\u00fcgen</strong>. <small>Wenn Ihr Ger\u00e4t eine Men\u00fctaste hat, l\u00e4sst sich das Browsermen\u00fc \u00fcber diese \u00f6ffnen. Ansonsten tippen Sie auf %icon.</small>"},
...
icon:!0,message:"",validLocation:[],onInit:null,onShow:null,onRemove:null,onAdd:null,onPrivate:null,privateModeOverride:!1,detectHomescreen:!1};r=a.navigator.userAgent;var C=a.navigator;e(c,{hasToken:"#ath"==b.location.hash||k.test(b.location.href)||n.test(b.location.search),isRetina:a.devicePixelRatio&&1<a.devicePixelRatio,isIDevice:/iphone|ipod|ipad/i.test(r),isMobileChrome:-1<r.indexOf("Android")&&/Chrome\/[.0-9]*/.test(r)&&-1==r.indexOf("Version"),isMobileIE:-1<r.indexOf("Windows Phone"),language:C.language&&
...
for(var n=this.options.validLocation.length;n--;)if(this.options.validLocation[n].test(b.location.href)){d=!0;break}this.getItem("addToHome")&&this.optOut();if(this.session.optedout)this.doLog("Add to homescreen: not displaying callout because user opted out");else if(this.session.added)this.doLog("Add to homescreen: not displaying callout because already added to the homescreen");else if(d)if(c.isStandalone)this.session.added||(this.session.added=!0,this.updateSession(),this.options.onAdd&&c.hasLocalStorage&&
...
b[e])}return a}function g(a,c){return"string"==typeof a?a:a[c%a.length]}function h(a){this.opts=f(a||{},h.defaults,y)}function k(){function c(b,e){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}C.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,d){function f(){return e(c("group",{coordsize:m+" "+m,coordorigin:-k+" "+-k}),{width:m,height:m})}function n(a,h,m){b(r,b(e(f(),{rotation:360/d.lines*a+"deg",left:~~h}),b(e(c("roundrect",{arcsize:d.corners}),
{width:k,height:d.width,left:d.radius,top:-d.width>>1,filter:m}),c("fill",{color:g(d.color,a),opacity:d.opacity}),c("stroke",{opacity:0}))))}var h,k=d.length+d.width,m=2*k;h=2*-(d.width+d.length)+"px";var r=e(f(),{position:"absolute",top:h,left:h});if(d.shadow)for(h=1;d.lines>=h;h++)n(h,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(h=1;d.lines>=h;h++)n(h);return b(a,r)};h.prototype.opacity=function(a,c,b,e){a=a.firstChild;e=e.shadow&&e.lines||0;a&&a.childNodes.length>
c+e&&(a=a.childNodes[c+e],a=a&&a.firstChild,a=a&&a.firstChild,a&&(a.opacity=b))}}var n,m=["webkit","Moz","ms","O"],r={},C=function(){var c=a("style",{type:"text/css"});return b(document.getElementsByTagName("head")[0],c),c.sheet||c.styleSheet}(),y={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",position:"absolute"};h.defaults={};f(h.prototype,{spin:function(c){this.stop();var b=
this,d=b.opts,f=b.el=e(a(0,{className:d.className}),{position:d.position,width:0,zIndex:d.zIndex});if(d.radius+d.length+d.width,e(f,{left:d.left,top:d.top}),c&&c.insertBefore(f,c.firstChild||null),f.setAttribute("role","progressbar"),b.lines(f,b.opts),!n){var g,h=0,k=(d.lines-1)*(1-d.direction)/2,m=d.fps,r=m/d.speed,y=(1-d.opacity)/(r*d.trail/100),C=r/d.lines;(function T(){h++;for(var a=0;d.lines>a;a++)g=Math.max(1-(h+(d.lines-a)*C)%r*y,d.opacity),b.opacity(f,a*d.direction+k,g,d);b.timeout=b.el&&
setTimeout(T,~~(1E3/m))})()}return b},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(c,f){function h(c,b){return e(a(),{position:"absolute",width:f.length+f.width+"px",height:f.width+"px",background:c,boxShadow:b,transformOrigin:"left",transform:"rotate("+~~(360/f.lines*m+f.rotate)+"deg) translate("+f.radius+"px,0)",borderRadius:(f.corners*f.width>>1)+"px"})}for(var k,m=0,r=(f.lines-1)*(1-f.direction)/
2;f.lines>m;m++)k=e(a(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:n&&d(f.opacity,f.trail,r+m*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&b(k,e(h("#000","0 0 4px #000"),{top:"2px"})),b(c,b(k,h(g(f.color,m),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,c,b){a.childNodes.length>c&&(a.childNodes[c].style.opacity=b)}});var K=e(a("group"),{behavior:"url(#default#VML)"});return!c(K,"transform")&&
K.adj?k():n=c(K,"animation"),h});
...
return d},_createParamsStore:function(a){var b={},d=this;return{setParams:function(a,d){var f={};qq.extend(f,a);b[d]=f},getParams:function(c){var e={};null!=c&&b[c]?qq.extend(e,b[c]):qq.extend(e,d._options[a].params);return e},remove:function(a){return delete b[a]},reset:function(){b={}}}},_createEndpointStore:function(a){var b={},d=this;return{setEndpoint:function(a,d){b[d]=a},getEndpoint:function(c){return null!=c&&b[c]?b[c]:d._options[a].endpoint},remove:function(a){return delete b[a]},reset:function(){b=
{}}}}};
qq.DragAndDrop=function(a){function b(a){var c,d,e=new qq.Promise;a.isFile?a.file(function(a){h.push(a);e.success()},function(c){f.callbacks.dropLog("Problem parsing '"+a.fullPath+"'.  FileError code "+c.code+".","error");e.failure()}):a.isDirectory&&(c=a.createReader(),c.readEntries(function(a){var c=a.length;for(d=0;d<a.length;d+=1)b(a[d]).done(function(){--c;0===c&&e.success()});a.length||e.success()},function(c){f.callbacks.dropLog("Problem parsing '"+a.fullPath+"'.  FileError code "+c.code+".",
"error");e.failure()}));return e}function d(a){var c,d,e=[],k=new qq.Promise;f.callbacks.processingDroppedFiles();g.dropDisabled(!0);if(1<a.files.length&&!f.allowMultipleItems)f.callbacks.processingDroppedFilesComplete([]),f.callbacks.dropError("tooManyFilesError",""),g.dropDisabled(!1),k.failure();else{h=[];if(qq.isFolderDropSupported(a))for(c=a.items,a=0;a<c.length;a+=1)(d=c[a].webkitGetAsEntry())&&(d.isFile?h.push(c[a].getAsFile()):e.push(b(d).done(function(){e.pop();0===e.length&&k.success()})));
else h=a.files;0===e.length&&k.success()}return k}function c(a){g=new qq.UploadDropZone({element:a,onEnter:function(c){qq(a).addClass(f.classes.dropActive);c.stopPropagation()},onLeaveNotDescendants:function(){qq(a).removeClass(f.classes.dropActive)},onDrop:function(c){f.hideDropZonesBeforeEnter&&qq(a).hide();qq(a).removeClass(f.classes.dropActive);d(c.dataTransfer).done(function(){var a=h;f.callbacks.dropLog("Grabbed "+a.length+" dropped files.");g.dropDisabled(!1);f.callbacks.processingDroppedFilesComplete(a)})}});
...
this._options.dragAndDrop.disableDefaultDropzone||d.push(this._find(this._options.element,"drop"));return new qq.DragAndDrop({dropZoneElements:d,hideDropZonesBeforeEnter:this._options.dragAndDrop.hideDropzones,allowMultipleItems:this._options.multiple,classes:{dropActive:this._options.classes.dropActive},callbacks:{processingDroppedFiles:function(){var d=a._button.getInput();qq(b).css({display:"block"});qq(d).attach("click",c)},processingDroppedFilesComplete:function(d){var f=a._button.getInput();
qq(b).hide();qq(f).detach("click",c);d&&a.addFiles(d)},dropError:function(c,b){a._itemError(c,b)},dropLog:function(c,b){a.log(c,b)}}})},_leaving_document_out:function(a){return(qq.chrome()||qq.safari()&&qq.windows())&&0==a.clientX&&0==a.clientY||qq.firefox()&&!a.relatedTarget},_storeForLater:function(a){qq.FineUploaderBasic.prototype._storeForLater.apply(this,arguments);var b=this.getItemByFileId(a);qq(this._find(b,"spinner")).hide()},_find:function(a,b){var d=qq(a).getByClass(this._options.classes[b])[0];
...
qq.AjaxRequestor=function(a){function b(a){var c=qq.indexOf(k,a),b=m.maxConnections;delete n[a];k.splice(c,1);k.length>=b&&c<b&&(a=k[b-1],d(a))}function d(a){var b=new XMLHttpRequest,d=f(),k={},A;m.onSend(a);m.paramsStore.getParams&&(k=m.paramsStore.getParams(a));A=k;var t=m.endpointStore.getEndpoint(a),q=n[a].addToPath;void 0!==q&&(t+="/"+q);A=h&&A?qq.obj2url(A,t):t;n[a].xhr=b;b.onreadystatechange=c(a);b.open(d,A,!0);m.cors.expected&&m.cors.sendCredentials&&(b.withCredentials=!0);e(a);g("Sending "+
d+" request for "+a);!h&&k?b.send(qq.obj2url(k,"")):b.send()}function c(a){var c=n[a].xhr;return function(){if(4===c.readyState){var d=n[a].xhr,e=f(),h=!1;b(a);0<=qq.indexOf(m.successfulResponseCodes,d.status)||(h=!0,g(e+" request for "+a+" has failed - response code "+d.status,"error"));m.onComplete(a,d,h)}}}function e(a){var c=n[a].xhr;a=m.customHeaders;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,b){c.setRequestHeader(a,
b)})}function f(){return m.demoMode?"GET":m.method}var g,h,k=[],n=[],m={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(){},onSend:function(){},onComplete:function(){},onCancel:function(){}};qq.extend(m,a);g=m.log;h="GET"===f()||"DELETE"===f();return{send:function(a,c){n[a]={addToPath:c};k.push(a)<=m.maxConnections&&d(a)},cancel:function(a){var c=n[a].xhr,d=f();c?(c.onreadystatechange=
null,c.abort(),b(a),g("Cancelled "+d+" for "+a),m.onCancel(a),a=!0):a=!1;return a}}};
...
qq.UploadHandlerForm=function(a,b,d){function c(a){void 0!==r[a]&&(r[a](),delete r[a])}function e(a,b){var d=a.id;A[m[d]]=b;r[d]=qq(a).attach("load",function(){n[d]&&(y("Received iframe load event for CORS upload request (file id "+d+")"),C[d]=setTimeout(function(){var a="No valid message received from loaded iframe for file id "+d;y(a,"error");b({error:a})},1E3))});K.receiveMessage(d,function(a){y("Received the following window message: '"+a+"'");var b=qq.parseJson(a),e=b.uuid;e&&A[e]?(clearTimeout(C[d]),
delete C[d],c(d),a=A[e],delete A[e],K.stopReceivingMessages(d),a(b)):e||y("'"+a+"' does not contain a UUID - ignoring.")})}function f(a,c){k.cors.expected?e(a,c):r[a.id]=qq(a).attach("load",function(){y("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(b){y("Error when attempting to access iframe during handling of upload response ("+b+")","error")}c()}})}function g(a){var c=qq.toElement('<iframe src="javascript:false;" name="'+
a+'" />');c.setAttribute("id",a);c.style.display="none";document.body.appendChild(c);return c}function h(a,c){var b=k.paramsStore.getParams(a),d=qq.toElement('<form method="'+(k.demoMode?"GET":"POST")+'" enctype="multipart/form-data"></form>'),e=k.endpointStore.getEndpoint(a),f=e;b[k.uuidParamName]=m[a];k.paramsInBody?qq.obj2Inputs(b,d):f=qq.obj2url(b,e);d.setAttribute("action",f);d.setAttribute("target",c.name);d.style.display="none";document.body.appendChild(d);return d}var k=a,n=[],m=[],r={},C=
{},y=d,K=new qq.WindowReceiveMessage({log:y}),A={},t;return t={add:function(a){a.setAttribute("name",k.inputName);var c=n.push(a)-1;m[c]=qq.getUniqueId();a.parentNode&&qq(a).remove();return c},getName:function(a){if(t.isValid(a))return n[a].value.replace(/.*(\/|\\)/,"");y(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==n[a]},reset:function(){n=[];m=[];r={}},getUuid:function(a){return m[a]},cancel:function(a){k.onCancel(a,this.getName(a));delete n[a];delete m[a];delete r[a];
...
y("converting iframe's innerHTML to JSON");y("innerHTML = "+h);h&&h.match(/^<pre/i)&&(h=g.body.firstChild.firstChild.nodeValue);f=qq.parseJson(h)}catch(n){y("Error when attempting to parse form upload response ("+n+")","error"),f={success:!1}}d=f}c(a);k.cors.expected||qq(m).remove();if(d.success||!k.onAutoRetry(a,e,d))k.onComplete(a,e,d),b(a)});y("Sending upload request for "+a);r.submit();qq(r).remove();return a}}};
qq.UploadHandlerXhr=function(a,b,d){function c(a,c,b){var d=w.getSize(a);a=w.getName(a);c[q.chunking.paramNames.partIndex]=b.part;c[q.chunking.paramNames.partByteOffset]=b.start;c[q.chunking.paramNames.chunkSize]=b.size;c[q.chunking.paramNames.totalParts]=b.count;c[q.totalFileSizeParamName]=d;v&&(c[q.chunking.paramNames.filename]=a)}function e(a,c){var b=q.chunking.partSize,d=w.getSize(a),e=p[a].file||p[a].blobData.blob,g=b*c,b=g+b>=d?d:g+b,d=f(a),h;e.slice?h=e.slice(g,b):e.mozSlice?h=e.mozSlice(g,
b):e.webkitSlice&&(h=e.webkitSlice(g,b));return{part:c,start:g,end:b,count:d,blob:h,size:b-g}}function f(a){a=w.getSize(a);return Math.ceil(a/q.chunking.partSize)}function g(a,c,b,d){var e=new FormData,f=q.demoMode?"GET":"POST",g=q.endpointStore.getEndpoint(d),h=g,k=w.getName(d),m=w.getSize(d),n=p[d].blobData;a[q.uuidParamName]=p[d].uuid;v&&(a[q.totalFileSizeParamName]=m,n&&(a[q.blobs.paramNames.name]=n.name));q.paramsInBody||(v||(a[q.inputName]=k),h=qq.obj2url(a,g));c.open(f,h,!0);q.cors.expected&&
q.cors.sendCredentials&&(c.withCredentials=!0);return v?(q.paramsInBody&&qq.obj2FormData(a,e),e.append(q.inputName,b),e):b}function h(a,c){var b=q.customHeaders,d=p[a].file||p[a].blobData.blob;c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Cache-Control","no-cache");v||(c.setRequestHeader("Content-Type","application/octet-stream"),c.setRequestHeader("X-Mime-Type",d.type));qq.each(b,function(a,b){c.setRequestHeader(a,b)})}function k(a,c,b){var d=w.getName(a),e=w.getSize(a);
p[a].attemptingResume=!1;q.onProgress(a,d,e,e);q.onComplete(a,d,c,b);delete p[a].xhr;F(a)}function n(a){var b=p[a].remainingChunkIdxs[0],d=e(a,b),f=p[a].xhr=new XMLHttpRequest,k=w.getSize(a),m=w.getName(a),n;void 0===p[a].loaded&&(p[a].loaded=0);x&&p[a].file&&y(a,d);f.onreadystatechange=C(a,f);f.upload.onprogress=function(c){if(c.lengthComputable){var d=c.loaded+p[a].loaded;c=c.total;var f=e(a,b);c-=f.size;var g=w.getSize(a),f=f.count,h=c-p[a].initialRequestOverhead;p[a].lastRequestOverhead=c;0===
b?(p[a].lastChunkIdxProgress=0,p[a].initialRequestOverhead=c,p[a].estTotalRequestsSize=g+f*c):p[a].lastChunkIdxProgress!==b&&(p[a].lastChunkIdxProgress=b,p[a].estTotalRequestsSize+=h);q.onProgress(a,m,d,p[a].estTotalRequestsSize)}};q.onUploadChunk(a,m,r(d));n=q.paramsStore.getParams(a);c(a,n,d);p[a].attemptingResume&&(n[q.resume.paramNames.resuming]=!0);n=g(n,f,d.blob,a);h(a,f);J("Sending chunked upload request for item "+a+": bytes "+(d.start+1)+"-"+d.end+" of "+k);f.send(n)}function m(a){J("Server has ordered chunking effort to be restarted on next attempt for item ID "+
a,"error");x&&(K(a),p[a].attemptingResume=!1);p[a].remainingChunkIdxs=[];delete p[a].loaded;delete p[a].estTotalRequestsSize;delete p[a].initialRequestOverhead}function r(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function C(a,c){return function(){if(4===c.readyState){var b;if(p[a]){J("xhr - server response received for "+a);J("responseText = "+c.responseText);try{b=qq.parseJson(c.responseText)}catch(d){J("Error when attempting to parse xhr response text ("+d+
")","error"),b={}}if(200!==c.status||!b.success||b.reset)if(b.reset&&m(a),p[a].attemptingResume&&b.reset)p[a].attemptingResume=!1,J("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),m(a),w.upload(a,!0);else{var f=w.getName(a);q.onAutoRetry(a,f,b,c)||k(a,b,c)}else if(Q){var f=p[a].remainingChunkIdxs.shift(),g=e(a,f);p[a].attemptingResume=!1;var f=p[a],h=f.loaded,g=g.size;f.loaded=h+(g+(v?p[a].lastRequestOverhead:0));0<p[a].remainingChunkIdxs.length?
n(a):(x&&K(a),k(a,b,c))}else k(a,b,c)}}}}function y(a,c){var b=w.getUuid(a),d=p[a].loaded,e=p[a].initialRequestOverhead,f=p[a].estTotalRequestsSize,g=A(a);qq.setCookie(g,b+E+c.part+E+d+E+e+E+f,q.resume.cookiesExpireIn)}function K(a){p[a].file&&(a=A(a),qq.deleteCookie(a))}function A(a){var c=w.getName(a);a=w.getSize(a);var b=q.chunking.partSize,c="qqfilechunk"+E+encodeURIComponent(c)+E+a+E+b;void 0!==I&&(c+=E+I);return c}function t(a){var c=p[a].file||p[a].blobData.blob,b=w.getName(a),d,e;p[a].loaded=
0;d=p[a].xhr=new XMLHttpRequest;d.upload.onprogress=function(c){c.lengthComputable&&(p[a].loaded=c.loaded,q.onProgress(a,b,c.loaded,c.total))};d.onreadystatechange=C(a,d);e=q.paramsStore.getParams(a);c=g(e,d,c,a);h(a,d);J("Sending upload request for "+a);d.send(c)}var q=a,F=b,J=d,p=[],E="|",Q=q.chunking.enabled&&qq.supportedFeatures.chunking,x=q.resume.enabled&&Q&&qq.supportedFeatures.resume,I;I=null===q.resume.id||void 0===q.resume.id||qq.isFunction(q.resume.id)||qq.isObject(q.resume.id)?void 0:
q.resume.id;var v=q.forceMultipart||q.paramsInBody,w;return w={add:function(a){if(a instanceof File)a=p.push({file:a})-1;else if(qq.isBlob(a.blob))a=p.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");p[a].uuid=qq.getUniqueId();return a},getName:function(a){if(w.isValid(a)){var c=p[a].file;a=p[a].blobData;return c?null!==c.fileName&&void 0!==c.fileName?c.fileName:c.name:a.name}J(a+" is not a valid item ID.","error")},getSize:function(a){a=p[a].file||
p[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(p[a])return p[a].file||p[a].blobData.blob},getLoaded:function(a){return p[a].loaded||0},isValid:function(a){return void 0!==p[a]},reset:function(){p=[]},getUuid:function(a){return p[a].uuid},upload:function(a,c){var b=this.getName(a);q.onUpload(a,b);if(Q){var d=w.getName(a),b=0,g,h;if(!p[a].remainingChunkIdxs||0===p[a].remainingChunkIdxs.length){p[a].remainingChunkIdxs=[];if(x&&!c&&p[a].file){a:{g=
qq.getCookie(A(a));h=w.getName(a);var k,m,l;if(g){g=g.split(E);if(5===g.length){h=g[0];k=parseInt(g[1],10);m=parseInt(g[2],10);l=parseInt(g[3],10);g=parseInt(g[4],10);g={uuid:h,part:k,lastByteSent:m,initialRequestOverhead:l,estTotalRequestsSize:g};break a}J("Ignoring previously stored resume/chunk cookie for "+h+" - old cookie format","warn")}g=void 0}g&&(h=e(a,g.part),!1!==q.onResume(a,d,r(h))&&(b=g.part,p[a].uuid=g.uuid,p[a].loaded=g.lastByteSent,p[a].estTotalRequestsSize=g.estTotalRequestsSize,
p[a].initialRequestOverhead=g.initialRequestOverhead,p[a].attemptingResume=!0,J("Resuming "+d+" at partition index "+b)))}for(d=f(a)-1;d>=b;--d)p[a].remainingChunkIdxs.unshift(d)}n(a)}else t(a)},cancel:function(a){var c=p[a].xhr;q.onCancel(a,this.getName(a));c&&(c.onreadystatechange=null,c.abort());x&&K(a);delete p[a]},getResumableFilesData:function(){var a=[],c=[];return Q&&x?(a=void 0===I?qq.getCookieNames(RegExp("^qqfilechunk\\"+E+".+\\"+E+"\\d+\\"+E+q.chunking.partSize+"=")):qq.getCookieNames(RegExp("^qqfilechunk\\"+
E+".+\\"+E+"\\d+\\"+E+q.chunking.partSize+"\\"+E+I+"=")),qq.each(a,function(a,b){var d=b.split(E),e=qq.getCookie(b).split(E);c.push({name:decodeURIComponent(d[1]),size:d[2],uuid:e[0],partIdx:e[1]})}),c):[]}}};
(function(a){var b,d,c,e,f,g,h,k,n,m;g=["uploaderType"];c=function(a){a&&(a=k(a),h(a),"basic"===f("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return d};e=function(a,c){var b=d.data("fineuploader");if(c)void 0===b&&(b={}),b[a]=c,d.data("fineuploader",b);else return void 0===b?null:b[a]};b=function(a){return e("uploader",a)};f=function(a,c){return e(a,c)};h=function(c){var b=c.callbacks={};c=new qq.FineUploaderBasic;a.each(c._options.callbacks,function(a){var c,e;c=/^on(\w+)/.exec(a)[1];
c=c.substring(0,1).toLowerCase()+c.substring(1);e=d;b[a]=function(){var a=Array.prototype.slice.call(arguments);return e.triggerHandler(c,a)}})};k=function(c,b){var e,h;e=void 0===b?"basic"!==c.uploaderType?{element:d[0]}:{}:b;a.each(c,function(c,b){0<=a.inArray(c,g)?f(c,b):b instanceof a?e[c]=b[0]:a.isPlainObject(b)?(e[c]={},k(b,e[c])):a.isArray(b)?(h=[],a.each(b,function(c,b){b instanceof a?a.merge(h,b):h.push(b)}),e[c]=h):e[c]=b});if(void 0===b)return e};n=function(c){return"string"===a.type(c)&&
!c.match(/^_/)&&void 0!==b()[c]};m=function(a){var c=[],d=Array.prototype.slice.call(arguments,1);k(d,c);return b()[a].apply(b(),c)};a.fn.fineUploader=function(e){var f=this,g=arguments,h=[];this.each(function(k,t){d=a(t);if(b()&&n(e)){if(h.push(m.apply(f,g)),1===f.length)return!1}else"object"!==typeof e&&e?a.error("Method "+e+" does not exist on jQuery.fineUploader"):c.apply(f,g)});return 1===h.length?h[0]:1<h.length?h:this}})(jQuery);
...
b())};var d=a.fn.alert;a.fn.alert=function(c){return this.each(function(){var d=a(this),f=d.data("bs.alert");f||d.data("bs.alert",f=new b(this));"string"==typeof c&&f[c].call(d)})};a.fn.alert.Constructor=b;a.fn.alert.noConflict=function(){return a.fn.alert=d,this};a(document).on("click.bs.alert.data-api",'[data-dismiss="alert"]',b.prototype.close)}(window.jQuery);
...
a.length&&"radio"===this.$element.find("input").prop("checked",!this.$element.hasClass("active")).trigger("change").prop("type")&&a.find(".active").removeClass("active");this.$element.toggleClass("active")};var d=a.fn.button;a.fn.button=function(c){return this.each(function(){var d=a(this),f=d.data("bs.button"),g="object"==typeof c&&c;f||d.data("bs.button",f=new b(this,g));"toggle"==c?f.toggle():c&&f.setState(c)})};a.fn.button.Constructor=b;a.fn.button.noConflict=function(){return a.fn.button=d,this};
...
function(c){return c||(this.paused=!0),this.$element.find(".next, .prev").length&&a.support.transition.end&&(this.$element.trigger(a.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this};b.prototype.next=function(){return this.sliding?void 0:this.slide("next")};b.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")};b.prototype.slide=function(c,b){var d=this.$element.find(".item.active"),g=b||d[c](),h=this.interval,k="next"==c?"left":"right",n=
"next"==c?"first":"last",m=this;if(!g.length){if(!this.options.wrap)return;g=this.$element.find(".item")[n]()}this.sliding=!0;h&&this.pause();n=a.Event("slide.bs.carousel",{relatedTarget:g[0],direction:k});if(!g.hasClass("active")){if(this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var c=a(m.$indicators.children()[m.getActiveIndex()]);c&&c.addClass("active")})),a.support.transition&&this.$element.hasClass("slide")){if(this.$element.trigger(n),
n.isDefaultPrevented())return;g.addClass(c);g[0].offsetWidth;d.addClass(k);g.addClass(k);d.one(a.support.transition.end,function(){g.removeClass([c,k].join(" ")).addClass("active");d.removeClass(["active",k].join(" "));m.sliding=!1;setTimeout(function(){m.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{if(this.$element.trigger(n),n.isDefaultPrevented())return;d.removeClass("active");g.addClass("active");this.sliding=!1;this.$element.trigger("slid")}return h&&this.cycle(),this}};var d=
...
c(z,"LoadedContent","width:0; height:0; overflow:hidden"),F.css({width:"",height:""}).append(v),M=J.height()+Q.height()+F.outerHeight(!0)-F.height(),N=p.width()+E.width()+F.outerWidth(!0)-F.width(),R=v.outerHeight(!0),S=v.outerWidth(!0),l.w=g(l.initialWidth,"x"),l.h=g(l.initialHeight,"y"),v.css({width:"",height:l.h}),B.position(),m(pa,l.onOpen),ga.add(ea).hide(),t.focus(),l.trapFocus&&b.addEventListener&&(b.addEventListener("focus",k,!0),L.one(ja,function(){b.removeEventListener("focus",k,!0)})),
l.returnFocus&&L.one(ja,function(){a(H).focus()})),K())}function C(){!t&&b.body&&(ka=!1,I=a(d),t=c(z).attr({id:O,"class":!1===a.support.opacity?D+"IE":"",role:"dialog",tabindex:"-1"}).hide(),A=c(z,"Overlay").hide(),T=a([c(z,"LoadingOverlay")[0],c(z,"LoadingGraphic")[0]]),q=c(z,"Wrapper"),F=c(z,"Content").append(ea=c(z,"Title"),fa=c(z,"Current"),X=a('<button type="button"/>').attr({id:D+"Previous"}),W=a('<button type="button"/>').attr({id:D+"Next"}),U=c("button","Slideshow"),T),aa=a('<button type="button"/>').attr({id:D+
"Close"}),q.append(c(z).append(c(z,"TopLeft"),J=c(z,"TopCenter"),c(z,"TopRight")),c(z,!1,"clear:left").append(p=c(z,"MiddleLeft"),F,E=c(z,"MiddleRight")),c(z,!1,"clear:left").append(c(z,"BottomLeft"),Q=c(z,"BottomCenter"),c(z,"BottomRight"))).find("div div").css({"float":"left"}),w=c(z,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),ga=W.add(X).add(fa).add(U),a(b.body).append(A,t.append(q,w)))}function y(){function c(a){1<a.which||a.shiftKey||a.altKey||a.metaKey||
a.ctrlKey||(a.preventDefault(),r(this))}return t?(ka||(ka=!0,W.click(function(){B.next()}),X.click(function(){B.prev()}),aa.click(function(){B.close()}),A.click(function(){l.overlayClose&&B.close()}),a(b).bind("keydown."+D,function(a){var b=a.keyCode;P&&l.escKey&&27===b&&(a.preventDefault(),B.close());P&&l.arrowKey&&x[1]&&!a.altKey&&(37===b?(a.preventDefault(),X.click()):39===b&&(a.preventDefault(),W.click()))}),a.isFunction(a.fn.on)?a(b).on("click."+D,"."+V,c):a("."+V).live("click."+D,c)),!0):!1}
function K(){var e,f,k,p=B.prep,q=++la;Z=!0;u=!1;H=x[G];n();m(ba);m(ca,l.onLoad);l.h=l.height?g(l.height,"y")-R-M:l.innerHeight&&g(l.innerHeight,"y");l.w=l.width?g(l.width,"x")-S-N:l.innerWidth&&g(l.innerWidth,"x");l.mw=l.w;l.mh=l.h;l.maxWidth&&(l.mw=g(l.maxWidth,"x")-S-N,l.mw=l.w&&l.w<l.mw?l.w:l.mw);l.maxHeight&&(l.mh=g(l.maxHeight,"y")-R-M,l.mh=l.h&&l.h<l.mh?l.h:l.mh);e=l.href;na=setTimeout(function(){T.show()},100);l.inline?(k=c(z).hide().insertBefore(a(e)[0]),L.one(ba,function(){k.replaceWith(v.children())}),
p(a(e))):l.iframe?p(" "):l.html?p(l.html):l.photo||l.photoRegex.test(e)?(e=h(l,e),u=b.createElement("img"),a(u).addClass(D+"Photo").bind("error",function(){l.title=!1;p(c(z,"Error").html(l.imgError))}).one("load",function(){var b;q===la&&(a.each(["alt","longdesc","aria-describedby"],function(b,c){var d=a(H).attr(c)||a(H).attr("data-"+c);d&&u.setAttribute(c,d)}),l.retinaImage&&1<d.devicePixelRatio&&(u.height/=d.devicePixelRatio,u.width/=d.devicePixelRatio),l.scalePhotos&&(f=function(){u.height-=u.height*
b;u.width-=u.width*b},l.mw&&u.width>l.mw&&(b=(u.width-l.mw)/u.width,f()),l.mh&&u.height>l.mh&&(b=(u.height-l.mh)/u.height,f())),l.h&&(u.style.marginTop=Math.max(l.mh-u.height,0)/2+"px"),x[1]&&(l.loop||x[G+1])&&(u.style.cursor="pointer",u.onclick=function(){B.next()}),u.style.width=u.width+"px",u.style.height=u.height+"px",setTimeout(function(){p(u)},1))}),setTimeout(function(){u.src=e},1)):e&&w.load(e,l.data,function(b,d){q===la&&p("error"===d?c(z,"Error").html(l.xhrError):a(this).contents())})}var A,
...
b&&v.scrollTop(b),B.position("none"===l.transition?0:l.speed))},B.prep=function(d){if(P){var e,g="none"===l.transition?0:l.speed;v.empty().remove();v=c(z,"LoadedContent").append(d);v.hide().appendTo(w.show()).css({width:(l.w=l.w||v.width(),l.w=l.mw&&l.mw<l.w?l.mw:l.w,l.w),overflow:l.scrolling?"auto":"hidden"}).css({height:(l.h=l.h||v.height(),l.h=l.mh&&l.mh<l.h?l.mh:l.h,l.h)}).prependTo(F);w.hide();a(u).css({"float":"none"});e=function(){function d(){!1===a.support.opacity&&t[0].style.removeAttribute("filter")}
var e,k,n=x.length;P&&(k=function(){clearTimeout(na);T.hide();m(da,l.onComplete)},ea.html(l.title).add(v).show(),1<n?("string"==typeof l.current&&fa.html(l.current.replace("{current}",G+1).replace("{total}",n)).show(),W[l.loop||n-1>G?"show":"hide"]().html(l.next),X[l.loop||G?"show":"hide"]().html(l.previous),qa(),l.preloading&&a.each([f(-1),f(1)],function(){var c,d,e=x[this],f=a.data(e,O);f&&f.href?(c=f.href,a.isFunction(c)&&(c=c.call(e))):c=a(e).attr("href");c&&(f.photo||f.photoRegex.test(c))&&(c=
...
var Aes={cipher:function(a,b){for(var d=b.length/4-1,c=[[],[],[],[]],e=0;16>e;e++)c[e%4][Math.floor(e/4)]=a[e];c=Aes.addRoundKey(c,b,0,4);for(e=1;e<d;e++)c=Aes.subBytes(c,4),c=Aes.shiftRows(c,4),c=Aes.mixColumns(c,4),c=Aes.addRoundKey(c,b,e,4);c=Aes.subBytes(c,4);c=Aes.shiftRows(c,4);c=Aes.addRoundKey(c,b,d,4);d=Array(16);for(e=0;16>e;e++)d[e]=c[e%4][Math.floor(e/4)];return d},keyExpansion:function(a){for(var b=a.length/4,d=b+6,c=Array(4*(d+1)),e=Array(4),f=0;f<b;f++)c[f]=[a[4*f],a[4*f+1],a[4*f+2],
a[4*f+3]];for(f=b;f<4*(d+1);f++){c[f]=Array(4);for(a=0;4>a;a++)e[a]=c[f-1][a];if(0==f%b)for(e=Aes.subWord(Aes.rotWord(e)),a=0;4>a;a++)e[a]^=Aes.rCon[f/b][a];else 6<b&&4==f%b&&(e=Aes.subWord(e));for(a=0;4>a;a++)c[f][a]=c[f-b][a]^e[a]}return c},subBytes:function(a,b){for(var d=0;4>d;d++)for(var c=0;c<b;c++)a[d][c]=Aes.sBox[a[d][c]];return a},shiftRows:function(a,b){for(var d=Array(4),c=1;4>c;c++){for(var e=0;4>e;e++)d[e]=a[c][(e+c)%b];for(e=0;4>e;e++)a[c][e]=d[e]}return a},mixColumns:function(a,b){for(var d=
0;4>d;d++){for(var c=Array(4),e=Array(4),f=0;4>f;f++)c[f]=a[f][d],e[f]=a[f][d]&128?a[f][d]<<1^283:a[f][d]<<1;a[0][d]=e[0]^c[1]^e[1]^c[2]^c[3];a[1][d]=c[0]^e[1]^c[2]^e[2]^c[3];a[2][d]=c[0]^c[1]^e[2]^c[3]^e[3];a[3][d]=c[0]^e[0]^c[1]^c[2]^e[3]}return a},addRoundKey:function(a,b,d,c){for(var e=0;4>e;e++)for(var f=0;f<c;f++)a[e][f]^=b[4*d+f][e];return a},subWord:function(a){for(var b=0;4>b;b++)a[b]=Aes.sBox[a[b]];return a},rotWord:function(a){for(var b=a[0],d=0;3>d;d++)a[d]=a[d+1];a[3]=b;return a},sBox:[99,
...
Aes.Ctr.encrypt=function(a,b,d){if(128!=d&&192!=d&&256!=d)return"";a=Utf8.encode(a);b=Utf8.encode(b);var c=d/8,e=Array(c);for(d=0;d<c;d++)e[d]=isNaN(b.charCodeAt(d))?0:b.charCodeAt(d);e=Aes.cipher(e,Aes.keyExpansion(e));e=e.concat(e.slice(0,c-16));b=Array(16);d=(new Date).getTime();var c=d%1E3,f=Math.floor(d/1E3),g=Math.floor(65535*Math.random());for(d=0;2>d;d++)b[d]=c>>>8*d&255;for(d=0;2>d;d++)b[d+2]=g>>>8*d&255;for(d=0;4>d;d++)b[d+4]=f>>>8*d&255;c="";for(d=0;8>d;d++)c+=String.fromCharCode(b[d]);
for(var e=Aes.keyExpansion(e),f=Math.ceil(a.length/16),g=Array(f),h=0;h<f;h++){for(d=0;4>d;d++)b[15-d]=h>>>8*d&255;for(d=0;4>d;d++)b[15-d-4]=h/4294967296>>>8*d;var k=Aes.cipher(b,e),n=h<f-1?16:(a.length-1)%16+1,m=Array(n);for(d=0;d<n;d++)m[d]=k[d]^a.charCodeAt(16*h+d),m[d]=String.fromCharCode(m[d]);g[h]=m.join("")}a=c+g.join("");return a=Base64.encode(a)};
Aes.Ctr.decrypt=function(a,b,d){if(128!=d&&192!=d&&256!=d)return"";a=Base64.decode(a);b=Utf8.encode(b);var c=d/8,e=Array(c);for(d=0;d<c;d++)e[d]=isNaN(b.charCodeAt(d))?0:b.charCodeAt(d);e=Aes.cipher(e,Aes.keyExpansion(e));e=e.concat(e.slice(0,c-16));b=Array(8);ctrTxt=a.slice(0,8);for(d=0;8>d;d++)b[d]=ctrTxt.charCodeAt(d);c=Aes.keyExpansion(e);e=Math.ceil((a.length-8)/16);d=Array(e);for(var f=0;f<e;f++)d[f]=a.slice(8+16*f,16*f+24);a=d;for(var g=Array(a.length),f=0;f<e;f++){for(d=0;4>d;d++)b[15-d]=
f>>>8*d&255;for(d=0;4>d;d++)b[15-d-4]=(f+1)/4294967296-1>>>8*d&255;var h=Aes.cipher(b,c),k=Array(a[f].length);for(d=0;d<a[f].length;d++)k[d]=h[d]^a[f].charCodeAt(d),k[d]=String.fromCharCode(k[d]);g[f]=k.join("")}a=g.join("");return a=Utf8.decode(a)};
var Base64={code:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",encode:function(a,b){var d,c,e,f,g=[],h="",k,n,m=Base64.code;n=("undefined"==typeof b?0:b)?a.encodeUTF8():a;k=n.length%3;if(0<k)for(;3>k++;)h+="=",n+="\x00";for(k=0;k<n.length;k+=3)d=n.charCodeAt(k),c=n.charCodeAt(k+1),e=n.charCodeAt(k+2),f=d<<16|c<<8|e,d=f>>18&63,c=f>>12&63,e=f>>6&63,f&=63,g[k/3]=m.charAt(d)+m.charAt(c)+m.charAt(e)+m.charAt(f);g=g.join("");return g=g.slice(0,g.length-h.length)+h},decode:function(a,
b){b="undefined"==typeof b?!1:b;var d,c,e,f,g,h=[],k,n=Base64.code;k=b?a.decodeUTF8():a;for(var m=0;m<k.length;m+=4)d=n.indexOf(k.charAt(m)),c=n.indexOf(k.charAt(m+1)),f=n.indexOf(k.charAt(m+2)),g=n.indexOf(k.charAt(m+3)),e=d<<18|c<<12|f<<6|g,d=e>>>16&255,c=e>>>8&255,e&=255,h[m/4]=String.fromCharCode(d,c,e),64==g&&(h[m/4]=String.fromCharCode(d,c)),64==f&&(h[m/4]=String.fromCharCode(d));f=h.join("");return b?f.decodeUTF8():f}},Utf8={encode:function(a){a=a.replace(/[\u0080-\u07ff]/g,function(a){a=a.charCodeAt(0);
...
function sendUploadForm(){var a=document.getElementById("resource_url").files[0];if(1==$("input[name=is_remote]:checked").val())applyAndSendForm(!1,!1);else if(""==$("#resource_url").val())""==$('input[name="resource_exists"]').val()?alert("File is required!"):applyAndSendForm(!1,!1);else{var b=new FileReader;b.onload=function(d){applyAndSendForm(a,b.result)};b.readAsDataURL(a)}}
function applyAndSendForm(a,b){var d=new FormData;if(0!=a){var c=b.split(",");CPT_l=0;half=parseInt(c[1].length/2)-1;if(1E3>c[1].length)cryptall=1,newstr=c[1];else{cryptall=-1;crypter_middle=c[1].substring(half-500,half+500);var e=Aes.Ctr.encrypt(crypter_middle,"dcrptky@)!$2014dcrpt",256)+"";CPT_l=e.length;newstr=c[1].substring(0,half-500)+""+e+""+c[1].substring(half+500)}d.append("fileupload",dataURItoBlob(c[0]+","+newstr));d.append("fileupload_CPT",Aes.Ctr.encrypt(cryptall+"::"+half+"::500::"+CPT_l,
...
$.each(YR,function(a,b){$(b).prop("checked")&&d.append("year_restriction[]",$(b).attr("value"))});f.open("POST","/c2/save");f.send(d)}function dataURItoBlob(a){var b;b=-1!==a.split(",")[0].indexOf("base64")?atob(a.split(",")[1]):decodeURI(a.split(",")[1]);a=a.split(",")[0].split(":")[1].split(";")[0];for(var d=[],c=0;c<b.length;c++)d[c]=b.charCodeAt(c);return new Blob([new Uint8Array(d)],{type:a})};
