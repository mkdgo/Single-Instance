        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <div class="controls" style="position: relative;">
                ...
                <div class="c2_radios upload_box" style="float: left;margin: 10px;display: none;">
                    ...
                    <label for="file_uploaded_f" id="file_uploaded_label" style="height: 40px;width:auto!important;float: left;line-height: 18px;" ></label>
                </div>
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <div class="controls options">
                <div class="option row" style="margin-right: 0; margin-left: 0; margin-bottom:10px;">
                    <input onclick="setCheck(this)" class="col-lg-1 col-md-1 col-sm-1 col-xs-12" type="checkbox" name="content[answer][0][true]" id="answer_true_0" value="1" style="width: 12%; float: left;" >
                    <label class="col-lg-1 col-md-1 col-sm-1 col-xs-12" for="answer_true_0" style="padding-top: 17px; padding-bottom: 17px; width: 12%; float: left;" > true</label>
                    ...
                    <input class="col-lg-2 col-md-2 col-sm-2 col-xs-12" type="text" name="content[answer][0][value]" id="answer_value_0" data-validation-required-message="Please fill Evaluation" placeholder="Score" value="" style="width: 7%; float: left; margin-top: 0;" />
...
*/
    ...
    function addNewOption() {
        ...
        $('.options').append('<div class="option row" style="margin-left: 0; margin-right: 0;margin-bottom:10px;">'
            +'<input onclick="setCheck(this)" class="col-lg-1 col-md-1 col-sm-1 col-xs-12" type="checkbox" name="content[answer]['+co+'][true]" id="answer_true_'+co+'" data-validation-required-message="" value="1" style="width: 12%; float: left;">'
            ...
            +'<input class="col-lg-2 col-md-2 col-sm-2 col-xs-12" type="text" name="content[answer]['+co+'][value]" id="answer_value_'+co+'" data-validation-required-message="" placeholder="Score" value="" style="width: 7%; float: left; margin-top: 0;">'
