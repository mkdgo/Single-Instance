<div id="multiple_choice" class="form-group-question resource_type" template="result">
    ...
    <div class="form-group-question row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="question-row"><label style="line-height: 2;/*margin: 50px;*/">[ANSWERS]</label></div>
        </div>
    </div>
</div>
