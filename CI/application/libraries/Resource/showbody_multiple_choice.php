...
<div id="multiple_choice" class="form-group grey resource_type no-margin" style="padding-top:21px;margin-left: 0; margin-right: 0;">
    ...
    <div class="form-group grey no-margin row" style="margin-left: 0; margin-right: 0; margin-bottom: 30px;">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <div class="" style="text-align: left;"><label for="" class="scaled">[TEXT]</label></div>
        </div>
    </div>
    ...
    <div class="form-group grey no-margin row" style="margin-left: 0; margin-right: 0; margin-bottom: 30px;">
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            <div class="" style="text-align: left; margin-left: 20px;"><label for="" class="scaled">[QUESTION]</label></div>
        </div>
    </div>
    ...
    <div class="form-group grey no-margin row" style="margin-left: 0; margin-right: 0;">
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            <div class="" style="text-align: left; margin-left: 20px;"><label for="" class="scaled">[ANSWERS]</label></div>
        </div>
    </div>
