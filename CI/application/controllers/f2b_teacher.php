...
//        foreach($classes_years as $k=>$CY) {
        foreach($classes_years__ as $k=>$CY) {
            ...
            $classes_year_subjects__ = array_merge( $this->assignment_model->get_teacher_subjects_assigment($this->user_id, $CY->year),$this->assignment_model->get_teacher_subjects_not_assigned($this->user_id, $CY->year));
