                        ...
                        <ul class="ul1 resources">
                            ...
                            <li>
                                ...
                                <div style="width: 140px;" class="r">
                                    {preview}
                                    <a style="display: none; display{del_hide}: block;" class="remove" href="javascript:deleteFile('{assignment_id}', '{resource_id}');"><span class="glyphicon glyphicon-remove"></span></a>
                                </div>
