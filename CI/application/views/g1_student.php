...
<div class="blue_gradient_bg">
    ...
    <div class="container">
        ...
        <?php foreach ($this->_data['subjects'] as $subject): ?>
            <div class="row">
                <div class="col-xs-12">
                    <h3 style="padding-left: 10px; padding-bottom: 15px; border-bottom: 1px solid #ccc;">
                        <?php echo $subject['name']; ?>
                    </h3>
                    <a class="arrow_link" href="/g1_student/index/<?php echo $subject['next']; ?>"></a>
                </div>
                <?php if ($subject['primary']): ?>
                    ...
                    <table class="table2" style="padding-left: 20px;">
                        ...
                        <?php foreach ($this->_data['works'] as $work): ?>
                            <tr class="ediface-inner tr-work-<?php echo $this->_data['subject_id']; ?>">
                                ...
                                <td style="width: 40%;">
                                    <span class="work-item" data-work-id="<?php echo $work->id; ?>" style="color: #4d4d4d; cursor: pointer;">
                                        <a id="work-<?php echo $work->id; ?>" data-offset="<?php echo $work->offset; ?>" data-parent-subject-id="<?php echo $this->_data['subject_id']; ?>" role="button" data-toggle="collapse" href="#work-item-<?php echo $work->id; ?>" aria-expanded="false" aria-controls="work-item-<?php echo $work->id; ?>">
                                            <?php echo $work->title; ?>
                                        </a>
                                    </span>
                                        ...
                                        <div class="panel-body">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item" style="background-color: inherit; border: 0 none;">
                                                    ...
                                                    <a href="/f5_student/index/<?php echo $this->_data['subject_id']; ?>/<?php echo $wi->work_id; ?>/<?php echo $wi->work_item_id; ?>" style="padding-left:5px"><?php echo $wi->item_name; ?></a>
                                                </li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
