...
<div class="blue_gradient_bg">
    ...
    <div class="container">
        ...
        <?php foreach ($this->_data['subjects'] as $s_key=> $subject): ?>
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="acc_title" id="subject-<?php echo $subject['id']; ?>" data-subject-id="<?php echo $subject['id']; ?>" data-offset="<?php echo $subject['offset']; ?>" style="padding-left: 0px; padding-bottom: 15px; border-bottom: 1px solid #ccc;">
