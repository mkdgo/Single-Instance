    ...
    <div class='universal_search' style="margin-left: -10px;" >
        ...
        <div id="all_resources">
            ...
            <ul class="nav nav-pills " role="tablist">
                <li role="presentation<?php if($this->session->userdata('user_type') != 'teacher') {echo "_stud"} ?>" class="active" ><a href="#all_tabs" aria-controls="all_tab" role="tab" data-toggle="tab">All</a></li>
                <li role="presentation<?php if($this->session->userdata('user_type') != 'teacher') {echo "_stud"} ?>" ><a href="#modules_tab" aria-controls="modules_tab" role="tab" data-toggle="tab">Modules ({modules_count})</a></li>
                <li role="presentation<?php if($this->session->userdata('user_type') != 'teacher') {echo "_stud"} ?>" ><a href="#lessons_tab" aria-controls="lessons_tab" role="tab" data-toggle="tab">Lessons ({lessons_count})</a></li>
                <li role="presentation<?php if($this->session->userdata('user_type') != 'teacher') {echo "_stud"} ?>" ><a href="#resources_tab" aria-controls="resources_tab" role="tab" data-toggle="tab">Resources ({resources_count})</a></li>
                ...
                <?php endif; ?>
                <li role="presentation<?php if($this->session->userdata('user_type') != 'teacher') {echo "_stud"} ?>" ><a href="#works_tab" aria-controls="works_tab" role="tab" data-toggle="tab">Work (0)</a></li>
            </ul>
