...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>res/js/bootbox.min.js"></script>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>res/css/admin.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo base_url() ?>res/css/admin-sidebar.css" type="text/css" />
