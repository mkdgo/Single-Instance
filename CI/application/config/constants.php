...
$SCHOOLS = array(
  'first.dev.ediface.org'=>array(
      'full_url'=>'http://first.dev.ediface.org',
      'db_enviroment'=>'default',
      'TITLE' => 'EDIFACE - DEV VERSION for the `second` school',
      'custom'=> array('onelogin')
  ),
  'elearn.linuxrules.com'=>array(
      'full_url'=>'http://elearn.linuxrules.com',
      'db_enviroment'=>'second',
      'TITLE' => 'EDIFACE - DEV VERSION for the `second` school',
      'custom'=> array('onelogin')
  ),
   'ediface.dev'=>array(
