...
$db['stoysolutions']['hostname'] = 'localhost';
$db['stoysolutions']['username'] = 'p1stoyso_dbuser';
$db['stoysolutions']['password'] = 'edi1234';
$db['stoysolutions']['database'] = 'p1stoyso_ediface';
$db['stoysolutions']['dbdriver'] = 'mysql';
$db['stoysolutions']['dbprefix'] = '';
$db['stoysolutions']['pconnect'] = TRUE;
$db['stoysolutions']['db_debug'] = TRUE;
$db['stoysolutions']['cache_on'] = FALSE;
$db['stoysolutions']['cachedir'] = '';
$db['stoysolutions']['char_set'] = 'utf8';
$db['stoysolutions']['dbcollat'] = 'utf8_general_ci';
$db['stoysolutions']['swap_pre'] = '';
$db['stoysolutions']['autoinit'] = TRUE;
$db['stoysolutions']['stricton'] = FALSE;
