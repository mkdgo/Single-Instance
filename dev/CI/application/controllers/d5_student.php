...
class D5_student extends MY_Controller {
	...
	function index($subject_id = '', $module_id = '', $lesson_id = '') {	
		...
		if ($interactive_content_exists > 0) {
			...
			$this->_data['view_interactive_lesson'] = '<div class="gray_top_field"><a href="/e1_student/index/'.$subject_id.'/'.$module_id.'/'.$lesson_id.'" style="margin:0 30px 0 20px;" class="add_resource_butt black_button new_lesson_butt ui-link">VIEW INTERACTIVE LESSON</a>    <div class="clear"></div></div>';
		} else {
