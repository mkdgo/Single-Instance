...
class E3 extends MY_Controller {
	...
	function index($subject_id = '', $module_id = '', $lesson_id = '', $int_assessment_id = '0') {
	...
	public function save() {
		...
		foreach ($form_questions as $question) {
			...
			//log_message('error', "quest: ".self::str($question));
			//log_message('error', $question['question_text']);
	...
	public function delete_assessment($subject_id = '', $module_id = '', $lesson_id = '', $assessment_id = '') {
		$this->_data['subject_id'] = $subject_id;
		$this->_data['module_id'] = $module_id;
		$this->_data['lesson_id'] = $lesson_id;
