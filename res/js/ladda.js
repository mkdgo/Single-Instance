...
/*
                if(e>0&& n!=null){
                    ...
                    t.appendChild(n);
                   // n.style.width = e * (t.offsetWidth + "px")
                    n.style.width + "1px"

                }
 0 === e && n && n.parentNode ? n.parentNode.removeChild(n) : (n || (n = document.createElement("div"), n.className = "ladda-progress", t.appendChild(n)), n.style.width = (e) * t.offsetWidth + "px")

 */

               0 === e && n && n.parentNode ? '' : (n || (n = document.createElement("div"), n.className = "ladda-progress", t.appendChild(n)), n.style.width = (e) * t.offsetWidth + "px")
            }, enable: function () {
